#!/usr/bin/env python3
# file: scripts/deploy-instruction-files.py
# version: 1.0.0
# guid: d5b0a90e-8e45-473c-9e72-8e8519ed18b1

"""
Python equivalent of deploy-instruction-files.sh
...
Original shell script: /home/runner/work/gcommon/gcommon/scripts/deploy-instruction-files.sh
...
class DeployInstructionFiles:
    """Python equivalent of deploy-instruction-files.sh shell script."""
