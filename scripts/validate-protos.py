#!/usr/bin/env python3
# file: scripts/validate-protos.py
# version: 1.0.0
# guid: 8479ae2c-e5e9-4fe8-bc2a-a32813d39d00

"""
Python equivalent of validate-protos.sh
...
Original shell script: /home/runner/work/gcommon/gcommon/scripts/validate-protos.sh
...
class ValidateProtos:
    """Python equivalent of validate-protos.sh shell script."""
