...
class DomainMigrator:
    ...
    def convert_import_path(self, old_import: str) -> str:
        ...
        if len(parts) >= 2:
            ...
            return f"gcommon/v1/{domain}/{category}/{filename}"
