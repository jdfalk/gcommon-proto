...
# Domain folders
DOMAINS = [
    "auth", "backend", "common", "frontend", 
    "infrastructure", "public", "queue", "system"
]
        ...
        for domain in DOMAINS:
            ...
            for category in CATEGORIES:
                ...
                for proto_file in category_path.glob("*.proto"):
                    ...
                    self.import_fixes[f"{domain}/{import_name}"] = f"{domain}/{category}/{import_name}"
            ...
            try:
                ...
                if content != original_content:
                    with open(md_file, 'w', encoding='utf-8') as f:
                        f.write(content)
                    logger.info(f"Fixed references in {md_file.relative_to(PROJECT_ROOT)}")
