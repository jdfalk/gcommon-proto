...
class WebAuthConfig(_message.Message):
    ...
    def __init__(self, enable_auth: bool = ..., allowed_roles: _Optional[_Iterable[str]] = ..., required_scopes: _Optional[_Iterable[str]] = ..., options: _Optional[_Mapping[str, str]] = ...) -> None: ...
