...
class TemplateData(_message.Message):
    ...
    def __init__(self, name: _Optional[str] = ..., context: _Optional[_Union[_any_pb2.Any, _Mapping]] = ..., template_body: _Optional[str] = ..., compiled_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
