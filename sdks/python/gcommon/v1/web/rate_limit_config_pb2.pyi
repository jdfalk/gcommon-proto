...
class WebRateLimitConfig(_message.Message):
    ...
    def __init__(self, enabled: _Optional[bool] = ..., requests_per_second: _Optional[int] = ..., burst_size: _Optional[int] = ..., strategy: _Optional[_Union[_rate_limit_strategy_pb2.RateLimitStrategy, str]] = ..., key_extractor: _Optional[str] = ..., skip_conditions: _Optional[_Iterable[str]] = ...) -> None: ...
