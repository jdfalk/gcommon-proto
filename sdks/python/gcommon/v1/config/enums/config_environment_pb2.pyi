...
from gcommon.v1.config.enums import environment_status_pb2 as _environment_status_pb2
from gcommon.v1.config.enums import environment_type_pb2 as _environment_type_pb2
from gcommon.v1.config.messages import approval_workflow_pb2 as _approval_workflow_pb2
from gcommon.v1.config.messages import audit_settings_pb2 as _audit_settings_pb2
from gcommon.v1.config.messages import backup_policy_pb2 as _backup_policy_pb2
from gcommon.v1.config.messages import deployment_info_pb2 as _deployment_info_pb2
from gcommon.v1.config.messages import encryption_settings_pb2 as _encryption_settings_pb2
from gcommon.v1.config.messages import monitoring_config_pb2 as _monitoring_config_pb2
from gcommon.v1.config.messages import promotion_rule_pb2 as _promotion_rule_pb2
from gcommon.v1.config.messages import sync_settings_pb2 as _sync_settings_pb2
from gcommon.v1.metrics.messages import retention_policy_pb2 as _retention_policy_pb2
from gcommon.v1.organization.messages import access_control_pb2 as _access_control_pb2
from gcommon.v1.organization.messages import compliance_settings_pb2 as _compliance_settings_pb2
from gcommon.v1.organization.messages import notification_settings_pb2 as _notification_settings_pb2
from gcommon.v1.organization.messages import resource_limits_pb2 as _resource_limits_pb2
...
class ConfigEnvironment(_message.Message):
    ...
    access_controls: _containers.RepeatedCompositeFieldContainer[_access_control_pb2.OrganizationAccessControl]
    ...
    compliance_settings: _compliance_settings_pb2.OrganizationComplianceSettings
    encryption_settings: _encryption_settings_pb2.EncryptionSettings
    audit_settings: _audit_settings_pb2.AuditSettings
    notification_settings: _notification_settings_pb2.OrganizationNotificationSettings
    sync_settings: _sync_settings_pb2.SyncSettings
    version: str
    def __init__(self, environment_id: _Optional[str] = ..., name: _Optional[str] = ..., description: _Optional[str] = ..., type: _Optional[_Union[_environment_type_pb2.EnvironmentType, str]] = ..., status: _Optional[_Union[_environment_status_pb2.EnvironmentStatus, str]] = ..., created_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., updated_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., owner: _Optional[str] = ..., tags: _Optional[_Iterable[str]] = ..., metadata: _Optional[_Mapping[str, str]] = ..., config: _Optional[_Mapping[str, str]] = ..., secrets: _Optional[_Mapping[str, str]] = ..., variables: _Optional[_Mapping[str, str]] = ..., parent_environment_id: _Optional[str] = ..., child_environment_ids: _Optional[_Iterable[str]] = ..., promotion_rules: _Optional[_Iterable[_Union[_promotion_rule_pb2.PromotionRule, _Mapping]]] = ..., access_controls: _Optional[_Iterable[_Union[_access_control_pb2.OrganizationAccessControl, _Mapping]]] = ..., deployment_info: _Optional[_Union[_deployment_info_pb2.DeploymentInfo, _Mapping]] = ..., health_status: _Optional[_Union[_health_status_pb2.CommonHealthStatus, str]] = ..., resource_limits: _Optional[_Union[_resource_limits_pb2.OrganizationResourceLimits, _Mapping]] = ..., backup_policy: _Optional[_Union[_backup_policy_pb2.BackupPolicy, _Mapping]] = ..., approval_workflow: _Optional[_Union[_approval_workflow_pb2.ApprovalWorkflow, _Mapping]] = ..., monitoring_config: _Optional[_Union[_monitoring_config_pb2.ConfigMonitoringConfig, _Mapping]] = ..., retention_policy: _Optional[_Union[_retention_policy_pb2.MetricsRetentionPolicy, str]] = ..., compliance_settings: _Optional[_Union[_compliance_settings_pb2.OrganizationComplianceSettings, _Mapping]] = ..., encryption_settings: _Optional[_Union[_encryption_settings_pb2.EncryptionSettings, _Mapping]] = ..., audit_settings: _Optional[_Union[_audit_settings_pb2.AuditSettings, _Mapping]] = ..., notification_settings: _Optional[_Union[_notification_settings_pb2.OrganizationNotificationSettings, _Mapping]] = ..., sync_settings: _Optional[_Union[_sync_settings_pb2.SyncSettings, _Mapping]] = ..., version: _Optional[str] = ...) -> None: ...
