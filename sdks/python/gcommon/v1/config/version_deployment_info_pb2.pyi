...
from gcommon.v1.common import (
    version_deployment_status_pb2 as _version_deployment_status_pb2,
)
...
class VersionDeploymentInfo(_message.Message):
    ...
    def __init__(
        self,
        status: _Optional[
            _Union[_version_deployment_status_pb2.VersionDeploymentStatus, str]
        ] = ...,
        deployed_at: _Optional[
            _Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]
        ] = ...,
        environment: _Optional[str] = ...,
        method: _Optional[str] = ...,
        deployed_by: _Optional[str] = ...,
        config: _Optional[_Mapping[str, str]] = ...,
        artifacts: _Optional[_Iterable[str]] = ...,
        health: _Optional[
            _Union[_version_health_status_pb2.VersionHealthStatus, str]
        ] = ...,
