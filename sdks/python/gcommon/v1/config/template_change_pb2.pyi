...
class TemplateChange(_message.Message):
    ...
    def __init__(
        ...
        type: _Optional[_Union[_config_change_type_pb2.TemplateChangeType, str]] = ...,
        breaking: _Optional[bool] = ...,
        details: _Optional[_Iterable[str]] = ...,
        migration_notes: _Optional[str] = ...,
    ) -> None: ...
