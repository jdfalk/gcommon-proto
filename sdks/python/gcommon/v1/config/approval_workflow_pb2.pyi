...
class ApprovalWorkflow(_message.Message):
    ...
    enabled: bool
    type: str
    stages: _containers.RepeatedCompositeFieldContainer[
        _approval_stage_pb2.ApprovalStage
    ]
    timeout_hours: int
    ...
    def __init__(
        ...
        type: _Optional[str] = ...,
        stages: _Optional[
            _Iterable[_Union[_approval_stage_pb2.ApprovalStage, _Mapping]]
        ] = ...,
        timeout_hours: _Optional[int] = ...,
        conditions: _Optional[_Iterable[str]] = ...,
        notifications: _Optional[_Iterable[str]] = ...,
    ) -> None: ...
