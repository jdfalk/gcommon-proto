from gcommon.v1.config.messages import config_diff_entry_pb2 as _config_diff_entry_pb2
...
class ConfigDiff(_message.Message):
    ...
    def __init__(self, diff_id: _Optional[str] = ..., source_version: _Optional[str] = ..., target_version: _Optional[str] = ..., added: _Optional[_Iterable[_Union[_config_diff_entry_pb2.ConfigDiffEntry, _Mapping]]] = ..., modified: _Optional[_Iterable[_Union[_config_diff_entry_pb2.ConfigDiffEntry, _Mapping]]] = ..., removed: _Optional[_Iterable[_Union[_config_diff_entry_pb2.ConfigDiffEntry, _Mapping]]] = ..., computed_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., requested_by: _Optional[str] = ..., metadata: _Optional[_Mapping[str, str]] = ...) -> None: ...
