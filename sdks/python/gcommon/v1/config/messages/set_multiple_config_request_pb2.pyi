...
class SetMultipleConfigRequest(_message.Message):
    ...
    def __init__(self, entries: _Optional[_Mapping[str, _config_value_pb2.ConfigValue]] = ..., namespace: _Optional[str] = ..., metadata: _Optional[_Mapping[str, str]] = ..., encrypt: bool = ..., request_metadata: _Optional[_Union[_request_metadata_pb2.RequestMetadata, _Mapping]] = ...) -> None: ...
