from gcommon.v1.config.enums import backoff_strategy_pb2 as _backoff_strategy_pb2
...
class ConfigRetrySettings(_message.Message):
    ...
    def __init__(self, enabled: bool = ..., max_retries: _Optional[int] = ..., delay_seconds: _Optional[int] = ..., backoff_strategy: _Optional[_Union[_backoff_strategy_pb2.BackoffStrategy, str]] = ..., conditions: _Optional[_Iterable[str]] = ...) -> None: ...
