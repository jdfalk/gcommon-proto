from gcommon.v1.config.enums import notification_trigger_pb2 as _notification_trigger_pb2
from gcommon.v1.config.messages import batching_settings_pb2 as _batching_settings_pb2
from gcommon.v1.config.messages import notification_channel_pb2 as _notification_channel_pb2
...
class ConfigNotificationSettings(_message.Message):
    __slots__ = ("enabled", "channels", "triggers", "template", "recipients", "delay_minutes", "batching")
    ...
    enabled: bool
    channels: _containers.RepeatedCompositeFieldContainer[_notification_channel_pb2.ConfigNotificationChannel]
    triggers: _containers.RepeatedScalarFieldContainer[_notification_trigger_pb2.NotificationTrigger]
    template: str
