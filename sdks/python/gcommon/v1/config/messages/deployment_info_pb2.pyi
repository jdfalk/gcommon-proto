from gcommon.v1.config.enums import deployment_status_pb2 as _deployment_status_pb2
from gcommon.v1.config.messages import deployment_rollback_info_pb2 as _deployment_rollback_info_pb2
from gcommon.v1.config.messages import health_check_pb2 as _health_check_pb2
...
class DeploymentInfo(_message.Message):
    __slots__ = ("status", "last_deployed_at", "version", "method", "target", "config", "health_checks", "rollback_info")
