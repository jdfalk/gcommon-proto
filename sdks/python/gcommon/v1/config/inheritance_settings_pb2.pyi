...
from gcommon.v1.config import (
    inheritance_transformation_pb2 as _inheritance_transformation_pb2,
)
...
class InheritanceSettings(_message.Message):
    ...
    filters: _containers.RepeatedCompositeFieldContainer[
        _inheritance_filter_pb2.InheritanceFilter
    ]
    transformations: _containers.RepeatedCompositeFieldContainer[
        _inheritance_transformation_pb2.InheritanceTransformation
    ]
    merge_values: bool
    ...
    def __init__(
        ...
        strategy: _Optional[
            _Union[_inheritance_strategy_pb2.InheritanceStrategy, str]
        ] = ...,
        sources: _Optional[_Iterable[str]] = ...,
        filters: _Optional[
            _Iterable[_Union[_inheritance_filter_pb2.InheritanceFilter, _Mapping]]
        ] = ...,
        transformations: _Optional[
            _Iterable[
                _Union[
                    _inheritance_transformation_pb2.InheritanceTransformation, _Mapping
                ]
            ]
        ] = ...,
        merge_values: _Optional[bool] = ...,
        merge_strategy: _Optional[_Union[_merge_strategy_pb2.MergeStrategy, str]] = ...,
