...
class ConfigHealthStatus(_message.Message):
    ...
    class ComponentsEntry(_message.Message):
        ...
        def __init__(
            self,
            key: _Optional[str] = ...,
            value: _Optional[_Union[_health_state_pb2.HealthState, str]] = ...,
        ) -> None: ...
    ...
    health_checks: _containers.RepeatedCompositeFieldContainer[
        _health_check_result_pb2.ConfigHealthCheckResult
    ]
    last_check: _timestamp_pb2.Timestamp
    metrics: _containers.ScalarMap[str, float]
    def __init__(
        self,
        overall: _Optional[_Union[_health_state_pb2.HealthState, str]] = ...,
        components: _Optional[_Mapping[str, _health_state_pb2.HealthState]] = ...,
        health_checks: _Optional[
            _Iterable[
                _Union[_health_check_result_pb2.ConfigHealthCheckResult, _Mapping]
            ]
        ] = ...,
