...
class WatchConfigResponse(_message.Message):
    ...
    change_type: _config_config_change_type_pb2.ConfigChangeType
    entry: _config_entry_pb2.ConfigEntry
    previous_entry: _config_entry_pb2.ConfigEntry
    timestamp: _timestamp_pb2.Timestamp
    def __init__(self, change_type: _Optional[_Union[_config_config_change_type_pb2.ConfigChangeType, str]] = ..., entry: _Optional[_Union[_config_entry_pb2.ConfigEntry, _Mapping]] = ..., previous_entry: _Optional[_Union[_config_entry_pb2.ConfigEntry, _Mapping]] = ..., timestamp: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
