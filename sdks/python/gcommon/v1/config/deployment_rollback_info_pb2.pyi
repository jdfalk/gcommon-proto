...
class DeploymentRollbackInfo(_message.Message):
    ...
    reason: str
    method: str
    def __init__(self, available: bool = ..., previous_version: _Optional[str] = ..., rollback_timestamp: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., reason: _Optional[str] = ..., method: _Optional[str] = ...) -> None: ...
