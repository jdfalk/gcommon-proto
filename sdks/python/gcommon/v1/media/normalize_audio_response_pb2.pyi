...
class NormalizeAudioResponse(_message.Message):
    ...
    def __init__(
        self,
        normalized_audio_file_id: _Optional[str] = ...,
        original_lufs: _Optional[float] = ...,
        normalized_lufs: _Optional[float] = ...,
        gain_applied_db: _Optional[float] = ...,
        limiting_applied: _Optional[bool] = ...,
    ) -> None: ...
