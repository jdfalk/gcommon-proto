...
class TranscodeOptions(_message.Message):
    ...
    def __init__(self, resolution: _Optional[str] = ..., bitrate: _Optional[int] = ..., framerate: _Optional[int] = ..., audio_codec: _Optional[str] = ..., audio_bitrate: _Optional[int] = ..., preserve_subtitles: bool = ..., preserve_chapters: bool = ...) -> None: ...
