...
class AnalyzeMediaRequest(_message.Message):
    ...
    def __init__(
        ...
        options: _Optional[_Union[AnalysisOptions, _Mapping]] = ...,
    ) -> None: ...
...
class AnalysisOptions(_message.Message):
    ...
    def __init__(
        self,
        extract_metadata: _Optional[bool] = ...,
        analyze_quality: _Optional[bool] = ...,
        detect_scenes: _Optional[bool] = ...,
        extract_thumbnails: _Optional[bool] = ...,
        analyze_audio: _Optional[bool] = ...,
    ) -> None: ...
