...
class MergeOptions(_message.Message):
    ...
    def __init__(self, output_format: _Optional[str] = ..., preserve_formatting: bool = ..., conflict_resolution: _Optional[_Union[_conflict_resolution_pb2.ConflictResolution, str]] = ..., sort_by_timestamp: bool = ...) -> None: ...
