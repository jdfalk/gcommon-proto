...
class MovieInfo(_message.Message):
    ...
    revenue: int
    runtime_minutes: int
    def __init__(self, release_date: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., budget: _Optional[int] = ..., revenue: _Optional[int] = ..., runtime_minutes: _Optional[int] = ...) -> None: ...
