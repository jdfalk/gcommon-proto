...
class DetectChaptersRequest(_message.Message):
    ...
    def __init__(
        ...
        options: _Optional[_Union[ChapterDetectionOptions, _Mapping]] = ...,
    ) -> None: ...

class ChapterDetectionOptions(_message.Message):
    __slots__ = (
        "silence_threshold_db",
        "min_chapter_length_seconds",
        "use_metadata",
        "use_ai_detection",
    )
    ...
    def __init__(
        self,
        silence_threshold_db: _Optional[float] = ...,
        min_chapter_length_seconds: _Optional[float] = ...,
        use_metadata: _Optional[bool] = ...,
        use_ai_detection: _Optional[bool] = ...,
    ) -> None: ...
