...
class AnalyzeAudioQualityResponse(_message.Message):
    ...
    def __init__(
        self,
        peak_level_db: _Optional[float] = ...,
        rms_level_db: _Optional[float] = ...,
        dynamic_range_db: _Optional[float] = ...,
        signal_to_noise_ratio: _Optional[float] = ...,
        clipping_detected: _Optional[bool] = ...,
    ) -> None: ...
