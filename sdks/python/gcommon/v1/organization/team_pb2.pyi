...
class Team(_message.Message):
    ...
    def __init__(
        ...
        lead_id: _Optional[str] = ...,
        team_type: _Optional[str] = ...,
        focus_area: _Optional[str] = ...,
        ...
        communication_channel: _Optional[str] = ...,
        max_members: _Optional[int] = ...,
        budget_allocation: _Optional[float] = ...,
        timezone: _Optional[str] = ...,
        member_ids: _Optional[_Iterable[str]] = ...,
        project_ids: _Optional[_Iterable[str]] = ...,
        objectives: _Optional[_Iterable[str]] = ...,
        kpis: _Optional[_Iterable[str]] = ...,
        cross_functional: _Optional[bool] = ...,
    ) -> None: ...
