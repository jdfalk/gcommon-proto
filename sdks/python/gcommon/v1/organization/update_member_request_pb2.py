...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_UPDATEMEMBERREQUEST']._serialized_start=243
  _globals['_UPDATEMEMBERREQUEST']._serialized_end=487
