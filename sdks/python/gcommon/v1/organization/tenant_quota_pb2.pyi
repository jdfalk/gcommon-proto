...
class TenantQuota(_message.Message):
    __slots__ = (
        ...
        "max_projects",
        "max_bandwidth_bytes_per_month",
        "can_create_sub_tenants",
        "custom_quotas",
    )
    ...
    def __init__(
        ...
        max_users: _Optional[int] = ...,
        max_storage_bytes: _Optional[int] = ...,
        max_api_requests_per_hour: _Optional[int] = ...,
        max_projects: _Optional[int] = ...,
        max_bandwidth_bytes_per_month: _Optional[int] = ...,
        can_create_sub_tenants: _Optional[bool] = ...,
        custom_quotas: _Optional[_Mapping[str, str]] = ...,
    ) -> None: ...
