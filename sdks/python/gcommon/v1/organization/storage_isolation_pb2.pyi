from gcommon.v1.organization import (
    storage_backup_config_pb2 as _storage_backup_config_pb2,
)
...
class StorageIsolation(_message.Message):
    ...
    policies: _containers.RepeatedCompositeFieldContainer[
        _storage_policy_pb2.StoragePolicy
    ]
    ...
    def __init__(
        ...
        path_prefix: _Optional[str] = ...,
        dedicated_storage: _Optional[bool] = ...,
        encryption: _Optional[
            _Union[_storage_encryption_pb2.StorageEncryption, _Mapping]
        ] = ...,
        policies: _Optional[
            _Iterable[_Union[_storage_policy_pb2.StoragePolicy, _Mapping]]
        ] = ...,
        backup: _Optional[
            _Union[_storage_backup_config_pb2.StorageBackupConfig, _Mapping]
        ] = ...,
        quota: _Optional[_Union[_storage_quota_pb2.StorageQuota, _Mapping]] = ...,
    ) -> None: ...
