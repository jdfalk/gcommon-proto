...
class CreateDepartmentResponse(_message.Message):
    ...
    def __init__(self, errors: _Optional[_Iterable[_Union[_error_pb2.Error, _Mapping]]] = ..., success: bool = ..., department: _Optional[_Union[_department_pb2.Department, _Mapping]] = ...) -> None: ...
