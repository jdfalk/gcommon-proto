...
class IntegrationSettings(_message.Message):
    ...
    enabled_integrations: _containers.RepeatedCompositeFieldContainer[
        _integration_pb2.Integration
    ]
    webhooks: _containers.RepeatedCompositeFieldContainer[
        _webhook_config_pb2.WebhookConfig
    ]
    api_keys: _containers.RepeatedCompositeFieldContainer[
        _metrics_api_key_config_pb2.MetricsAPIKeyConfig
    ]
    oauth_apps: _containers.RepeatedCompositeFieldContainer[
        _o_auth_app_config_pb2.OAuthAppConfig
    ]
    def __init__(
        self,
        enabled_integrations: _Optional[
            _Iterable[_Union[_integration_pb2.Integration, _Mapping]]
        ] = ...,
        webhooks: _Optional[
            _Iterable[_Union[_webhook_config_pb2.WebhookConfig, _Mapping]]
        ] = ...,
        api_keys: _Optional[
            _Iterable[_Union[_metrics_api_key_config_pb2.MetricsAPIKeyConfig, _Mapping]]
        ] = ...,
        oauth_apps: _Optional[
            _Iterable[_Union[_o_auth_app_config_pb2.OAuthAppConfig, _Mapping]]
        ] = ...,
    ) -> None: ...
