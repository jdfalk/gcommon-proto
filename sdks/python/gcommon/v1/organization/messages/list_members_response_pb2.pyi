...
from gcommon.v1.organization.messages import organization_member_pb2 as _organization_member_pb2
...
class ListMembersResponse(_message.Message):
    ...
    def __init__(self, errors: _Optional[_Iterable[_Union[_error_pb2.Error, _Mapping]]] = ..., success: bool = ..., members: _Optional[_Iterable[_Union[_organization_member_pb2.OrganizationMember, _Mapping]]] = ..., pagination: _Optional[_Union[_paginated_response_pb2.PaginatedResponse, _Mapping]] = ...) -> None: ...
