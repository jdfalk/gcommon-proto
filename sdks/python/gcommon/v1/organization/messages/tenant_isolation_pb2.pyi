...
from gcommon.v1.organization.enums import isolation_level_pb2 as _isolation_level_pb2
from gcommon.v1.organization.messages import access_control_pb2 as _access_control_pb2
from gcommon.v1.organization.messages import audit_config_pb2 as _audit_config_pb2
from gcommon.v1.organization.messages import compute_isolation_pb2 as _compute_isolation_pb2
from gcommon.v1.organization.messages import database_isolation_pb2 as _database_isolation_pb2
from gcommon.v1.organization.messages import encryption_config_pb2 as _encryption_config_pb2
from gcommon.v1.organization.messages import network_isolation_pb2 as _network_isolation_pb2
from gcommon.v1.organization.messages import storage_isolation_pb2 as _storage_isolation_pb2
...
class TenantIsolation(_message.Message):
    __slots__ = ("tenant_id", "level", "database", "network", "storage", "compute", "encryption", "access_control", "audit", "metadata", "created_at", "updated_at", "configured_by")
    ...
    access_control: _access_control_pb2.OrganizationAccessControl
