...
class CreateDepartmentRequest(_message.Message):
    ...
    validate_only: bool
    def __init__(self, metadata: _Optional[_Union[_request_metadata_pb2.RequestMetadata, _Mapping]] = ..., department: _Optional[_Union[_department_pb2.Department, _Mapping]] = ..., validate_only: bool = ...) -> None: ...
