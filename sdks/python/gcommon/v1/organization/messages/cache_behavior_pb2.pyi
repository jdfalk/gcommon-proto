from gcommon.v1.organization.messages import cache_key_policy_pb2 as _cache_key_policy_pb2
...
class CacheBehavior(_message.Message):
    ...
    def __init__(self, path_pattern: _Optional[str] = ..., ttl_seconds: _Optional[int] = ..., compress: bool = ..., allowed_methods: _Optional[_Iterable[str]] = ..., cache_key: _Optional[_Union[_cache_key_policy_pb2.CacheKeyPolicy, _Mapping]] = ...) -> None: ...
