...
from gcommon.v1.organization import (
    load_balancer_config_pb2 as _load_balancer_config_pb2,
)
...
class NetworkIsolation(_message.Message):
    ...
    acl_rules: _containers.RepeatedCompositeFieldContainer[
        _network_acl_rule_pb2.NetworkACLRule
    ]
    ...
    def __init__(
        ...
        subnet_id: _Optional[str] = ...,
        security_group_ids: _Optional[_Iterable[str]] = ...,
        acl_rules: _Optional[
            _Iterable[_Union[_network_acl_rule_pb2.NetworkACLRule, _Mapping]]
        ] = ...,
        dedicated_network: _Optional[bool] = ...,
        load_balancer: _Optional[
            _Union[_load_balancer_config_pb2.OrganizationLoadBalancerConfig, _Mapping]
        ] = ...,
        cdn: _Optional[_Union[_cdn_config_pb2.CDNConfig, _Mapping]] = ...,
        domain: _Optional[_Union[_domain_config_pb2.DomainConfig, _Mapping]] = ...,
    ) -> None: ...
