...
class CommonSubscriptionInfo(_message.Message):
    ...
    def __init__(
        ...
        subscriber: _Optional[_Union[_client_info_pb2.ClientInfo, _Mapping]] = ...,
        options: _Optional[
            _Union[_subscription_options_pb2.SubscriptionOptions, _Mapping]
        ] = ...,
        status: _Optional[
            _Union[_subscription_status_pb2.SubscriptionStatus, str]
        ] = ...,
    ) -> None: ...
