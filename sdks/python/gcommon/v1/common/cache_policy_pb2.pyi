...
from gcommon.v1.common import expiration_policy_pb2 as _expiration_policy_pb2
...
class CachePolicy(_message.Message):
    ...
    refresh_ahead: bool
    enable_stats: bool
    def __init__(self, expiration: _Optional[_Union[_expiration_policy_pb2.ExpirationPolicy, str]] = ..., eviction: _Optional[_Union[_eviction_policy_pb2.EvictionPolicy, str]] = ..., max_size_bytes: _Optional[int] = ..., max_entries: _Optional[int] = ..., default_ttl: _Optional[_Union[datetime.timedelta, _duration_pb2.Duration, _Mapping]] = ..., refresh_ahead: _Optional[bool] = ..., enable_stats: _Optional[bool] = ...) -> None: ...
