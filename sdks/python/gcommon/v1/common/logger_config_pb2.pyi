...
class LoggerConfig(_message.Message):
    ...
    appenders: _containers.RepeatedCompositeFieldContainer[
        _appender_config_pb2.AppenderConfig
    ]
    ...
    def __init__(
        ...
        appenders: _Optional[
            _Iterable[_Union[_appender_config_pb2.AppenderConfig, _Mapping]]
        ] = ...,
        inherit_appenders: _Optional[bool] = ...,
        propagate: _Optional[bool] = ...,
