...
class ResponseMetadata(_message.Message):
    ...
    def __init__(
        ...
        rate_limit: _Optional[
            _Union[_rate_limit_info_pb2.RateLimitInfo, _Mapping]
        ] = ...,
        pagination: _Optional[
            _Union[_pagination_info_pb2.CommonPaginationInfo, _Mapping]
        ] = ...,
    ) -> None: ...
