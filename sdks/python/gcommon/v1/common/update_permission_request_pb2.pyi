...
class UpdatePermissionRequest(_message.Message):
    ...
    reason: str
    def __init__(self, permission_id: _Optional[str] = ..., name: _Optional[str] = ..., description: _Optional[str] = ..., resource: _Optional[str] = ..., action: _Optional[str] = ..., conditions: _Optional[_Iterable[str]] = ..., active: bool = ..., update_mask: _Optional[_Iterable[str]] = ..., metadata: _Optional[_Union[_request_metadata_pb2.RequestMetadata, _Mapping]] = ..., reason: _Optional[str] = ...) -> None: ...
