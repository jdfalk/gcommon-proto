...
class AppenderConfig(_message.Message):
    ...
    def __init__(
        self,
        name: _Optional[str] = ...,
        type: _Optional[_Union[_appender_type_pb2.AppenderType, str]] = ...,
        output: _Optional[_Union[AppenderConfig.OutputConfig, _Mapping]] = ...,
        formatter: _Optional[_Union[AppenderConfig.LogFormatterConfig, _Mapping]] = ...,
