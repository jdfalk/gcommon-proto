...
class CommonRetryPolicy(_message.Message):
    ...
    enable_jitter: bool
    retryable_errors: _containers.RepeatedScalarFieldContainer[
        _error_code_pb2.ErrorCode
    ]
    ...
    def __init__(
        ...
        retryable_errors: _Optional[
            _Iterable[_Union[_error_code_pb2.ErrorCode, str]]
        ] = ...,
