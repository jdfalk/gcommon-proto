...
class OrganizationNotificationSettings(_message.Message):
    ...
    sms_enabled: bool
    in_app_enabled: bool
    email_templates: _containers.RepeatedCompositeFieldContainer[
        _email_template_pb2.EmailTemplate
    ]
    frequency: _notification_frequency_pb2.NotificationFrequency
    def __init__(
        self,
        sender_email: _Optional[str] = ...,
        sender_name: _Optional[str] = ...,
        email_enabled: _Optional[bool] = ...,
        sms_enabled: _Optional[bool] = ...,
        in_app_enabled: _Optional[bool] = ...,
        email_templates: _Optional[
            _Iterable[_Union[_email_template_pb2.EmailTemplate, _Mapping]]
        ] = ...,
        frequency: _Optional[
            _Union[_notification_frequency_pb2.NotificationFrequency, _Mapping]
        ] = ...,
    ) -> None: ...
