...
class HealthCheckAllResponse(_message.Message):
    ...
    results: _containers.RepeatedCompositeFieldContainer[
        _health_check_result_pb2.HealthHealthCheckResult
    ]
    total_services: int
    ...
    def __init__(
        self,
        overall_status: _Optional[_Union[_serving_status_pb2.ServingStatus, str]] = ...,
        results: _Optional[
            _Iterable[
                _Union[_health_check_result_pb2.HealthHealthCheckResult, _Mapping]
            ]
        ] = ...,
        total_services: _Optional[int] = ...,
        healthy_services: _Optional[int] = ...,
        unhealthy_services: _Optional[int] = ...,
