...
class CompletePasswordResetResponse(_message.Message):
    ...
    message: str
    def __init__(self, user_id: _Optional[str] = ..., username: _Optional[str] = ..., reset_completed_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., sessions_terminated: bool = ..., terminated_session_count: _Optional[int] = ..., tokens_revoked: bool = ..., revoked_token_count: _Optional[int] = ..., requires_additional_verification: bool = ..., message: _Optional[str] = ...) -> None: ...
