...
class AuthAuthConfig(_message.Message):
    ...
    require_mfa: bool
    def __init__(self, access_token_ttl: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., refresh_token_ttl: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., require_mfa: bool = ...) -> None: ...
