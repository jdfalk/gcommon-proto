...
class QueueAlertSeverity(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    QUEUE_ALERT_SEVERITY_UNSPECIFIED: _ClassVar[QueueAlertSeverity]
    QUEUE_ALERT_SEVERITY_INFO: _ClassVar[QueueAlertSeverity]
...
QUEUE_ALERT_SEVERITY_ERROR: QueueAlertSeverity
QUEUE_ALERT_SEVERITY_CRITICAL: QueueAlertSeverity
