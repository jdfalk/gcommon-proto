...
class RateLimitInfo(_message.Message):
    ...
    def __init__(self, remaining: _Optional[int] = ..., limit: _Optional[int] = ..., reset_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., retry_after: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ...) -> None: ...
