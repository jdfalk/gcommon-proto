...
class FilterOptions(_message.Message):
    ...
    class FiltersEntry(_message.Message):
        ...
        def __init__(
            self,
            key: _Optional[str] = ...,
            value: _Optional[_Union[_filter_value_pb2.FilterValue, _Mapping]] = ...,
        ) -> None: ...
    ...
    def __init__(
        self,
        filters: _Optional[_Mapping[str, _filter_value_pb2.FilterValue]] = ...,
        search_query: _Optional[str] = ...,
        time_range: _Optional[
            _Union[_metrics_time_range_pb2.CommonTimeRange, _Mapping]
        ] = ...,
    ) -> None: ...
