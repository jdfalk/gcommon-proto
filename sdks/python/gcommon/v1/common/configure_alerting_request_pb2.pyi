...
class ConfigureAlertingRequest(_message.Message):
    ...
    def __init__(self, target: _Optional[str] = ..., enabled: bool = ..., failure_threshold: _Optional[int] = ..., channels: _Optional[_Iterable[str]] = ..., metadata: _Optional[_Union[_request_metadata_pb2.RequestMetadata, _Mapping]] = ...) -> None: ...
