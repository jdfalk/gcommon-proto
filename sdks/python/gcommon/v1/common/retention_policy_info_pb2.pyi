...
class RetentionPolicyInfo(_message.Message):
    ...
    def __init__(self, policy: _Optional[_Union[_retention_policy_pb2.MetricsRetentionPolicy, str]] = ..., config: _Optional[_Union[_metrics_retention_policy_config_pb2.MetricsRetentionPolicyConfig, _Mapping]] = ...) -> None: ...
