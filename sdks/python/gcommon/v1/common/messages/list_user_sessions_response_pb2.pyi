...
from gcommon.v1.common.messages import session_info_pb2 as _session_info_pb2
...
class ListUserSessionsResponse(_message.Message):
    __slots__ = ("sessions", "total_count", "pagination", "request_metadata", "includes_current_session", "active_session_count", "user_id", "error", "generated_at", "data_refreshed_at")
