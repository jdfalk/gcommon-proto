from gcommon.v1.common.messages import role_pb2 as _role_pb2
...
class RemoveRoleResponse(_message.Message):
    ...
    message: str
    def __init__(self, user_id: _Optional[str] = ..., username: _Optional[str] = ..., role: _Optional[_Union[_role_pb2.Role, _Mapping]] = ..., removed_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., removed_by_user_id: _Optional[str] = ..., removed_by_username: _Optional[str] = ..., effective_immediately: bool = ..., has_remaining_roles: bool = ..., remaining_role_count: _Optional[int] = ..., message: _Optional[str] = ...) -> None: ...
