...
class JWTConfig(_message.Message):
    ...
    def __init__(self, signing_algorithm: _Optional[str] = ..., access_token_ttl: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ..., refresh_token_ttl: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ...) -> None: ...
