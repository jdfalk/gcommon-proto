...
from gcommon.v1.common.messages import check_result_pb2 as _check_result_pb2
from gcommon.v1.common.messages import error_pb2 as _error_pb2
from gcommon.v1.common.messages import health_metrics_pb2 as _health_metrics_pb2
...
class WatchResponse(_message.Message):
    ...
    def __init__(self, status: _Optional[_Union[_health_status_pb2.CommonHealthStatus, str]] = ..., service: _Optional[str] = ..., timestamp: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., response_time: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ..., check_results: _Optional[_Iterable[_Union[_check_result_pb2.CheckResult, _Mapping]]] = ..., message: _Optional[str] = ..., error: _Optional[_Union[_error_pb2.Error, _Mapping]] = ..., metrics: _Optional[_Union[_health_metrics_pb2.HealthMetrics, _Mapping]] = ...) -> None: ...
