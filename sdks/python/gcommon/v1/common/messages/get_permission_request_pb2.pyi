...
class GetPermissionRequest(_message.Message):
    __slots__ = ("permission_id", "metadata")
    PERMISSION_ID_FIELD_NUMBER: _ClassVar[int]
    METADATA_FIELD_NUMBER: _ClassVar[int]
    permission_id: str
    metadata: _request_metadata_pb2.RequestMetadata
    def __init__(self, permission_id: _Optional[str] = ..., metadata: _Optional[_Union[_request_metadata_pb2.RequestMetadata, _Mapping]] = ...) -> None: ...
