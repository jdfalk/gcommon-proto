from gcommon.v1.common.enums import ack_mode_pb2 as _ack_mode_pb2
...
class SubscriptionOptions(_message.Message):
    ...
    def __init__(self, include_history: bool = ..., max_batch_size: _Optional[int] = ..., ack_mode: _Optional[_Union[_ack_mode_pb2.AckMode, str]] = ..., keep_alive: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ...) -> None: ...
