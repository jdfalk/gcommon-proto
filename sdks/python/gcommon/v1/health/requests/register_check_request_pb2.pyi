...
class RegisterCheckRequest(_message.Message):
    ...
    def __init__(self, health_check: _Optional[_Union[_health_check_pb2.HealthCheck, _Mapping]] = ..., metadata: _Optional[_Union[_request_metadata_pb2.RequestMetadata, _Mapping]] = ..., replace_existing: _Optional[bool] = ...) -> None: ...
