...
class HealthCheckRequest(_message.Message):
    ...
    def __init__(self, service_name: _Optional[str] = ..., component_name: _Optional[str] = ..., check_id: _Optional[str] = ..., metadata: _Optional[_Union[_request_metadata_pb2.RequestMetadata, _Mapping]] = ..., timeout: _Optional[_Union[datetime.timedelta, _duration_pb2.Duration, _Mapping]] = ..., include_details: _Optional[bool] = ..., force_refresh: _Optional[bool] = ..., tags: _Optional[_Iterable[str]] = ...) -> None: ...
