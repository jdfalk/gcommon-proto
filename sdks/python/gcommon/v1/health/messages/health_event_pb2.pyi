...
class HealthEvent(_message.Message):
    ...
    source: str
    def __init__(self, event_id: _Optional[str] = ..., event_type: _Optional[str] = ..., service_name: _Optional[str] = ..., check_id: _Optional[str] = ..., timestamp: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., previous_status: _Optional[_Union[_health_status_pb2.HealthStatus, str]] = ..., current_status: _Optional[_Union[_health_status_pb2.HealthStatus, str]] = ..., message: _Optional[str] = ..., severity: _Optional[str] = ..., metadata: _Optional[_Mapping[str, str]] = ..., source: _Optional[str] = ...) -> None: ...
