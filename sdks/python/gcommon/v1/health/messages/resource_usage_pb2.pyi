...
class ResourceUsage(_message.Message):
    ...
    def __init__(self, collected_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., component_name: _Optional[str] = ..., cpu: _Optional[_Union[CpuUsage, _Mapping]] = ..., memory: _Optional[_Union[MemoryUsage, _Mapping]] = ..., disk: _Optional[_Union[DiskUsage, _Mapping]] = ..., network: _Optional[_Union[NetworkUsage, _Mapping]] = ...) -> None: ...
