...
class DependencyCheck(_message.Message):
    ...
    def __init__(self, id: _Optional[str] = ..., dependency_name: _Optional[str] = ..., dependency_type: _Optional[str] = ..., endpoint: _Optional[str] = ..., status: _Optional[_Union[_health_status_pb2.HealthStatus, str]] = ..., criticality: _Optional[int] = ..., timeout: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ..., check_interval: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ..., last_checked: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., configured_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., metadata: _Optional[_Mapping[str, str]] = ...) -> None: ...
