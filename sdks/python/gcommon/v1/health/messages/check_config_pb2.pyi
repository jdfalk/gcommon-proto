...
class CheckConfig(_message.Message):
    ...
    auto_retry: bool
    def __init__(self, default_interval: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ..., default_timeout: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ..., default_failure_threshold: _Optional[int] = ..., default_success_threshold: _Optional[int] = ..., enable_metrics: bool = ..., enable_logging: bool = ..., max_concurrent_checks: _Optional[int] = ..., global_tags: _Optional[_Iterable[str]] = ..., retention_period: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ..., auto_retry: bool = ...) -> None: ...
