...
class LivenessCheckResponse(_message.Message):
    ...
    details: str
    def __init__(self, status: _Optional[_Union[_health_status_pb2.HealthStatus, str]] = ..., alive: _Optional[bool] = ..., started_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., metadata: _Optional[_Union[_response_metadata_pb2.ResponseMetadata, _Mapping]] = ..., details: _Optional[str] = ...) -> None: ...
