...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    3,
    '',
    'gcommon/v1/metrics/record_histogram_request.proto'
)
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_RECORDHISTOGRAMREQUEST'].fields_by_name['name']._loaded_options = None
  _globals['_RECORDHISTOGRAMREQUEST'].fields_by_name['name']._serialized_options = b'\272H\006r\004\020\001\030d'
  _globals['_RECORDHISTOGRAMREQUEST']._serialized_start=213
  _globals['_RECORDHISTOGRAMREQUEST']._serialized_end=698
  _globals['_RECORDHISTOGRAMREQUEST_LABELSENTRY']._serialized_start=641
  _globals['_RECORDHISTOGRAMREQUEST_LABELSENTRY']._serialized_end=698
