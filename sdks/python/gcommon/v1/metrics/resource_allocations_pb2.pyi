...
class ResourceAllocations(_message.Message):
    __slots__ = ("allocated_memory_bytes", "allocated_cpu_percent", "allocated_disk_bytes", "allocated_ports")
    ...
    def __init__(self, allocated_memory_bytes: _Optional[int] = ..., allocated_cpu_percent: _Optional[float] = ..., allocated_disk_bytes: _Optional[int] = ..., allocated_ports: _Optional[_Iterable[int]] = ...) -> None: ...
