...
class UpdateProviderResponse(_message.Message):
    ...
    validation_results: _containers.RepeatedCompositeFieldContainer[
        _metrics_validation_result_pb2.MetricsValidationResult
    ]
    ...
    def __init__(
        ...
        applied_changes: _Optional[_Iterable[str]] = ...,
