...
class QueryMetricsRequest(_message.Message):
    ...
    def __init__(
        ...
        query: _Optional[_Union[_metric_query_pb2.MetricQuery, _Mapping]] = ...,
        timeout_seconds: _Optional[int] = ...,
        include_query_plan: _Optional[bool] = ...,
        metadata_only: _Optional[bool] = ...,
        output_options: _Optional[
            _Union[_query_output_options_pb2.QueryOutputOptions, _Mapping]
        ] = ...,
    ) -> None: ...
