...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_METRICSCONFIGCHANGE']._serialized_start=136
  _globals['_METRICSCONFIGCHANGE']._serialized_end=356
