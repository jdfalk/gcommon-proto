...
class MetricsBackupInfo(_message.Message):
    ...
    def __init__(self, backup_id: _Optional[str] = ..., backup_location: _Optional[str] = ..., backup_size_bytes: _Optional[int] = ..., backup_created_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., backup_retention: _Optional[str] = ...) -> None: ...
