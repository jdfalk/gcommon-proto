...
class UpdateOptions(_message.Message):
    ...
    def __init__(self, validate_config: _Optional[bool] = ..., dry_run: _Optional[bool] = ..., restart_if_needed: _Optional[bool] = ..., backup_config: _Optional[bool] = ..., strategy: _Optional[_Union[_update_strategy_pb2.UpdateStrategy, str]] = ...) -> None: ...
