...
from gcommon.v1.metrics.messages import bucket_info_pb2 as _bucket_info_pb2
from gcommon.v1.metrics.messages import histogram_metric_pb2 as _histogram_metric_pb2
from gcommon.v1.metrics.messages import histogram_stats_pb2 as _histogram_stats_pb2
...
class RecordHistogramResponse(_message.Message):
    __slots__ = ("success", "error", "metric", "current_stats", "recorded_at", "is_new_metric", "affected_bucket", "recording_stats")
