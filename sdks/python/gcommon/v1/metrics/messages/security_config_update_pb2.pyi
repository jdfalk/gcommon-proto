from gcommon.v1.metrics.messages import api_key_config_update_pb2 as _api_key_config_update_pb2
from gcommon.v1.metrics.messages import tls_config_update_pb2 as _tls_config_update_pb2
...
class SecurityConfigUpdate(_message.Message):
    ...
    def __init__(self, require_auth: bool = ..., auth_methods: _Optional[_Iterable[str]] = ..., require_tls: bool = ..., tls_config_update: _Optional[_Union[_tls_config_update_pb2.TLSConfigUpdate, _Mapping]] = ..., api_key_config_update: _Optional[_Union[_api_key_config_update_pb2.APIKeyConfigUpdate, _Mapping]] = ...) -> None: ...
