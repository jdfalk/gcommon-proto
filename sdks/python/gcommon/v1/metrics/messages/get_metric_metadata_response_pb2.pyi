...
from gcommon.v1.metrics.messages import metric_metadata_pb2 as _metric_metadata_pb2
...
class GetMetricMetadataResponse(_message.Message):
    ...
    def __init__(self, success: bool = ..., error: _Optional[_Union[_error_pb2.Error, _Mapping]] = ..., provider_id: _Optional[str] = ..., metadata: _Optional[_Iterable[_Union[_metric_metadata_pb2.MetricMetadata, _Mapping]]] = ..., pagination: _Optional[_Union[_pagination_info_pb2.MetricsPaginationInfo, _Mapping]] = ..., total_count: _Optional[int] = ..., generated_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., warnings: _Optional[_Iterable[str]] = ..., execution_time_ms: _Optional[int] = ...) -> None: ...
