...
from gcommon.v1.metrics.messages import export_status_pb2 as _export_status_pb2
from gcommon.v1.metrics.messages import metric_type_counts_pb2 as _metric_type_counts_pb2
...
class MetricsSummary(_message.Message):
    ...
    def __init__(self, total_metrics: _Optional[int] = ..., total_data_points: _Optional[int] = ..., total_data_volume_bytes: _Optional[int] = ..., type_counts: _Optional[_Union[_metric_type_counts_pb2.MetricTypeCounts, _Mapping]] = ..., performance: _Optional[_Union[_performance_stats_pb2.MetricsPerformanceStats, _Mapping]] = ..., errors: _Optional[_Union[_error_stats_pb2.MetricsErrorStats, _Mapping]] = ..., top_metrics: _Optional[_Union[_top_metrics_pb2.TopMetrics, _Mapping]] = ..., retention: _Optional[_Union[_retention_info_pb2.MetricsRetentionInfo, _Mapping]] = ..., export_status: _Optional[_Union[_export_status_pb2.ExportStatus, _Mapping]] = ...) -> None: ...
