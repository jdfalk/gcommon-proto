...
class MetricInfo(_message.Message):
    ...
    def __init__(self, name: _Optional[str] = ..., metric_type: _Optional[str] = ..., data_points: _Optional[int] = ..., data_volume_bytes: _Optional[int] = ..., error_rate: _Optional[float] = ..., last_updated: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
