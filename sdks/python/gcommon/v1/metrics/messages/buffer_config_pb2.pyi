from gcommon.v1.metrics.enums import buffer_overflow_strategy_pb2 as _buffer_overflow_strategy_pb2
...
class BufferConfig(_message.Message):
    ...
    def __init__(self, max_buffer_size: _Optional[int] = ..., overflow_strategy: _Optional[_Union[_buffer_overflow_strategy_pb2.BufferOverflowStrategy, str]] = ..., persist_buffer: bool = ..., max_memory_bytes: _Optional[int] = ...) -> None: ...
