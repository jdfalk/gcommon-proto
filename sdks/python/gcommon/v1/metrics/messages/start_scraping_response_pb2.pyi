...
class StartScrapingResponse(_message.Message):
    ...
    def __init__(self, success: bool = ..., error: _Optional[_Union[_error_pb2.Error, _Mapping]] = ..., job: _Optional[_Union[_scrape_job_pb2.ScrapeJob, _Mapping]] = ..., started_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
