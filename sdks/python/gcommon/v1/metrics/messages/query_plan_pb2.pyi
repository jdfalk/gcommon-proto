from gcommon.v1.metrics.messages import query_step_pb2 as _query_step_pb2
...
class QueryPlan(_message.Message):
    ...
    def __init__(self, query_id: _Optional[str] = ..., estimated_duration: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ..., estimated_data_points: _Optional[int] = ..., steps: _Optional[_Iterable[_Union[_query_step_pb2.QueryStep, _Mapping]]] = ..., storage_backends: _Optional[_Iterable[str]] = ...) -> None: ...
