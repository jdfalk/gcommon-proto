...
class MetricQuery(_message.Message):
    ...
    time_filter: _time_range_metrics_pb2.TimeRangeMetrics
    aggregations: _containers.RepeatedCompositeFieldContainer[
        _aggregation_spec_pb2.AggregationSpec
    ]
    group_by: _containers.RepeatedCompositeFieldContainer[
        _group_by_spec_pb2.GroupBySpec
    ]
    sort_criteria: _containers.RepeatedCompositeFieldContainer[
        _sort_options_pb2.SortOptions
    ]
    limit: int
    offset: int
    def __init__(
        ...
        time_filter: _Optional[
            _Union[_time_range_metrics_pb2.TimeRangeMetrics, _Mapping]
        ] = ...,
        aggregations: _Optional[
            _Iterable[_Union[_aggregation_spec_pb2.AggregationSpec, _Mapping]]
        ] = ...,
        group_by: _Optional[
            _Iterable[_Union[_group_by_spec_pb2.GroupBySpec, _Mapping]]
        ] = ...,
        sort_criteria: _Optional[
            _Iterable[_Union[_sort_options_pb2.SortOptions, _Mapping]]
        ] = ...,
        limit: _Optional[int] = ...,
