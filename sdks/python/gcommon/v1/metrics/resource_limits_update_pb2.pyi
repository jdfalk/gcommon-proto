...
class ResourceLimitsUpdate(_message.Message):
    __slots__ = (
        "max_memory_bytes",
        "max_cpu_percent",
        "max_disk_bytes",
    ...
    def __init__(
        ...
        max_cpu_percent: _Optional[float] = ...,
        max_disk_bytes: _Optional[int] = ...,
        max_metrics: _Optional[int] = ...,
        max_data_points_per_metric: _Optional[int] = ...,
    ) -> None: ...
