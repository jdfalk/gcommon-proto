...
class MetricsSummary(_message.Message):
    ...
    def __init__(
        ...
        total_data_volume_bytes: _Optional[int] = ...,
        type_counts: _Optional[
            _Union[_metric_type_counts_pb2.MetricTypeCounts, _Mapping]
        ] = ...,
        ...
        export_status: _Optional[
            _Union[_export_status_pb2.ExportStatus, _Mapping]
        ] = ...,
    ) -> None: ...
