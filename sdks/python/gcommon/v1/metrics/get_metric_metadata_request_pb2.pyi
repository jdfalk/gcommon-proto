...
class GetMetricMetadataRequest(_message.Message):
    ...
    def __init__(
        ...
        include_inactive: _Optional[bool] = ...,
        page_size: _Optional[int] = ...,
        page_token: _Optional[str] = ...,
        metric_type: _Optional[str] = ...,
        label_filters: _Optional[_Mapping[str, str]] = ...,
        include_retention_info: _Optional[bool] = ...,
        include_usage_stats: _Optional[bool] = ...,
    ) -> None: ...
