...
class MetricsSecurityConfig(_message.Message):
    ...
    def __init__(self, require_auth: _Optional[bool] = ..., auth_methods: _Optional[_Iterable[str]] = ..., require_tls: _Optional[bool] = ..., tls_config: _Optional[_Union[_tls_config_pb2.MetricsTLSConfig, _Mapping]] = ..., api_key_config: _Optional[_Union[_metrics_api_key_config_pb2.MetricsAPIKeyConfig, _Mapping]] = ...) -> None: ...
