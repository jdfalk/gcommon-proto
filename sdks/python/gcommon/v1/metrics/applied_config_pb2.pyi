...
class AppliedConfig(_message.Message):
    ...
    def __init__(
        self,
        config_summary: _Optional[str] = ...,
        applied_defaults: _Optional[_Mapping[str, str]] = ...,
        applied_overrides: _Optional[_Mapping[str, str]] = ...,
        resource_allocations: _Optional[
            _Union[_resource_allocations_pb2.ResourceAllocations, _Mapping]
        ] = ...,
    ) -> None: ...
