...
class ExportConfig(_message.Message):
    ...
    def __init__(
        ...
        frequency_seconds: _Optional[int] = ...,
        compress: _Optional[bool] = ...,
        batch_size: _Optional[int] = ...,
        timeout_seconds: _Optional[int] = ...,
        headers: _Optional[_Mapping[str, str]] = ...,
        auth_config: _Optional[_Mapping[str, str]] = ...,
        retry_config: _Optional[_Union[MetricsRetryConfig, _Mapping]] = ...,
...
class MetricsRetryConfig(_message.Message):
    ...
    def __init__(
        ...
        initial_delay_seconds: _Optional[int] = ...,
        max_delay_seconds: _Optional[int] = ...,
