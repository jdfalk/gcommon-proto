...
class UpdateResult(_message.Message):
    ...
    config_changes: _containers.RepeatedCompositeFieldContainer[
    ...
    def __init__(
        self,
        action: _Optional[_Union[_update_action_pb2.UpdateAction, str]] = ...,
        config_changes: _Optional[
            _Iterable[_Union[_metrics_config_change_pb2.MetricsConfigChange, _Mapping]]
        ] = ...,
        updated_settings: _Optional[_Iterable[str]] = ...,
        removed_settings: _Optional[_Iterable[str]] = ...,
        restarted: _Optional[bool] = ...,
        strategy_used: _Optional[str] = ...,
        update_duration: _Optional[str] = ...,
    ) -> None: ...
