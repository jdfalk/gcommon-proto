...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_METRICSBATCHOPTIONS']._serialized_start=139
  _globals['_METRICSBATCHOPTIONS']._serialized_end=482
