...
class RegistrationResult(_message.Message):
    ...
    schema_changes: _containers.RepeatedCompositeFieldContainer[
        _schema_change_pb2.SchemaChange
    ]
    def __init__(
        self,
        action: _Optional[
            _Union[_registration_action_pb2.RegistrationAction, str]
        ] = ...,
        created_indices: _Optional[_Iterable[str]] = ...,
        created_alerts: _Optional[_Iterable[str]] = ...,
        configured_exports: _Optional[_Iterable[str]] = ...,
        applied_retention_policies: _Optional[_Iterable[str]] = ...,
        schema_changes: _Optional[
            _Iterable[_Union[_schema_change_pb2.SchemaChange, _Mapping]]
        ] = ...,
    ) -> None: ...
