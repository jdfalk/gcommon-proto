...
class OpenTelemetrySettingsUpdate(_message.Message):
    ...
    timeout: str
    def __init__(self, endpoint: _Optional[str] = ..., use_tls: bool = ..., header_updates: _Optional[_Mapping[str, str]] = ..., header_removes: _Optional[_Iterable[str]] = ..., resource_attribute_updates: _Optional[_Mapping[str, str]] = ..., resource_attribute_removes: _Optional[_Iterable[str]] = ..., timeout: _Optional[str] = ...) -> None: ...
