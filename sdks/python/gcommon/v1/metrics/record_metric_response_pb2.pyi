...
class RecordMetricResponse(_message.Message):
    ...
    def __init__(self, success: bool = ..., error: _Optional[_Union[_error_pb2.Error, _Mapping]] = ..., metric_id: _Optional[str] = ..., recorded_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., provider_id: _Optional[str] = ..., validation: _Optional[_Union[_metrics_validation_result_pb2.MetricsValidationResult, _Mapping]] = ..., stats: _Optional[_Union[_recording_stats_pb2.RecordingStats, _Mapping]] = ..., warnings: _Optional[_Iterable[str]] = ...) -> None: ...
