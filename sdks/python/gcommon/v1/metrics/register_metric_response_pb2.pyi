...
from gcommon.v1.metrics import (
    registration_validation_pb2 as _registration_validation_pb2,
)
...
class RegisterMetricResponse(_message.Message):
    ...
    def __init__(
        ...
        validation: _Optional[
            _Union[_registration_validation_pb2.RegistrationValidation, _Mapping]
        ] = ...,
        result: _Optional[
            _Union[_registration_result_pb2.RegistrationResult, _Mapping]
        ] = ...,
        warnings: _Optional[_Iterable[str]] = ...,
        replaced_existing: _Optional[bool] = ...,
    ) -> None: ...
