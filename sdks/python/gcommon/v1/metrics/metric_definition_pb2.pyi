...
class MetricDefinition(_message.Message):
    ...
    description: str
    unit: str
    labels: _containers.RepeatedCompositeFieldContainer[
        _label_definition_pb2.LabelDefinition
    ]
    ...
    def __init__(
        ...
        unit: _Optional[str] = ...,
        labels: _Optional[
            _Iterable[_Union[_label_definition_pb2.LabelDefinition, _Mapping]]
        ] = ...,
        config: _Optional[
            _Union[_metric_type_config_pb2.MetricTypeConfig, _Mapping]
        ] = ...,
        retention: _Optional[
            _Union[
        ...
        validation: _Optional[
            _Union[_validation_rules_pb2.ValidationRules, _Mapping]
        ] = ...,
