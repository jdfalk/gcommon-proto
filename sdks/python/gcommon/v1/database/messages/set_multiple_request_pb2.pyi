...
class SetMultipleRequest(_message.Message):
    ...
    def __init__(self, values: _Optional[_Mapping[str, bytes]] = ..., ttl: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ..., metadata: _Optional[_Union[_request_metadata_pb2.RequestMetadata, _Mapping]] = ...) -> None: ...
