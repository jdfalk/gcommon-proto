...
class DatabaseQueryStats(_message.Message):
    ...
    query_plan: str
    cost_estimate: float
    def __init__(self, execution_time: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ..., row_count: _Optional[int] = ..., column_count: _Optional[int] = ..., query_plan: _Optional[str] = ..., cost_estimate: _Optional[float] = ...) -> None: ...
