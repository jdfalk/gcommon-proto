...
from gcommon.v1.database import query_options_pb2 as _query_options_pb2
...
class QueryRequest(_message.Message):
    __slots__ = ("query", "parameters", "database", "options", "metadata", "transaction_id")
