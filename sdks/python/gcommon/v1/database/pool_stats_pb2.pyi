...
class PoolStats(_message.Message):
    ...
    def __init__(self, total_created: _Optional[int] = ..., total_closed: _Optional[int] = ..., acquisition_failures: _Optional[int] = ..., avg_acquisition_time: _Optional[_Union[datetime.timedelta, _duration_pb2.Duration, _Mapping]] = ...) -> None: ...
