...
class CreateNamespaceResponse(_message.Message):
    ...
    def __init__(self, namespace_id: _Optional[str] = ..., name: _Optional[str] = ..., description: _Optional[str] = ..., created_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., max_keys: _Optional[int] = ..., max_memory_bytes: _Optional[int] = ..., default_ttl_seconds: _Optional[int] = ..., config: _Optional[_Mapping[str, str]] = ...) -> None: ...
