...
class ExecuteOptions(_message.Message):
    ...
    def __init__(self, timeout: _Optional[_Union[datetime.timedelta, _duration_pb2.Duration, _Mapping]] = ..., return_generated_keys: _Optional[bool] = ..., isolation: _Optional[_Union[_database_isolation_level_pb2.DatabaseIsolationLevel, str]] = ...) -> None: ...
