...
class NamespaceStats(_message.Message):
    ...
    def __init__(
        self,
        total_keys: _Optional[int] = ...,
        memory_usage_bytes: _Optional[int] = ...,
        hit_rate_percent: _Optional[float] = ...,
        cache_hits: _Optional[int] = ...,
        cache_misses: _Optional[int] = ...,
        evictions: _Optional[int] = ...,
        avg_key_size_bytes: _Optional[float] = ...,
        avg_value_size_bytes: _Optional[float] = ...,
        last_access_time: _Optional[
