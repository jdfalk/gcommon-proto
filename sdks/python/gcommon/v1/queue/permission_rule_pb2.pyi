...
class PermissionRule(_message.Message):
    ...
    allow: bool
    priority: int
    def __init__(self, resource_pattern: _Optional[str] = ..., operation: _Optional[str] = ..., required_roles: _Optional[_Iterable[str]] = ..., allow: bool = ..., priority: _Optional[int] = ...) -> None: ...
