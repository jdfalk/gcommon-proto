...
class ResetDetails(_message.Message):
    ...
    reset_reason: str
    initiated_by: str
    def __init__(self, metrics_reset_count: _Optional[int] = ..., counters_reset_count: _Optional[int] = ..., histograms_reset_count: _Optional[int] = ..., partitions_affected: _Optional[int] = ..., reset_duration_ms: _Optional[int] = ..., partial_reset: bool = ..., reset_reason: _Optional[str] = ..., initiated_by: _Optional[str] = ...) -> None: ...
