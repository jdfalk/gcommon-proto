...
class QueueUnsubscribeRequest(_message.Message):
    ...
    CLOSE_CONNECTIONS_FIELD_NUMBER: _ClassVar[int]
    ...
    timeout_ms: int
    def __init__(self, subscription_id: _Optional[str] = ..., consumer_group_id: _Optional[str] = ..., force: bool = ..., close_connections: bool = ..., timeout_ms: _Optional[int] = ...) -> None: ...
