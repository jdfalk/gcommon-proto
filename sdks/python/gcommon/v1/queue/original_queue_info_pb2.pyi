...
class OriginalQueueInfo(_message.Message):
    ...
    def __init__(self, queue_id: _Optional[str] = ..., queue_name: _Optional[str] = ..., partition_count: _Optional[int] = ..., config_snapshot: _Optional[_Mapping[str, str]] = ..., backup_point: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
