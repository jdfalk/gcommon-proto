...
class QueueCircuitBreakerConfig(_message.Message):
    ...
    def __init__(self, enabled: bool = ..., failure_threshold: _Optional[int] = ..., success_threshold: _Optional[int] = ..., timeout: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ..., max_requests: _Optional[int] = ..., interval: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ...) -> None: ...
