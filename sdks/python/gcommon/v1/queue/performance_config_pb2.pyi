...
class PerformanceConfig(_message.Message):
    __slots__ = ("buffer_size", "max_batch_size", "flush_interval", "worker_threads", "queue_capacity", "async_processing", "connection_pool_size", "max_idle_time", "enable_multiplexing", "read_timeout", "write_timeout")
