...
class BackupSource(_message.Message):
    ...
    def __init__(
        ...
        backup_timestamp: _Optional[
            _Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]
        ] = ...,
        original_queue: _Optional[
            _Union[_original_queue_info_pb2.OriginalQueueInfo, _Mapping]
        ] = ...,
        backup_version: _Optional[str] = ...,
        compression_format: _Optional[str] = ...,
        encryption: _Optional[
            _Union[_encryption_info_pb2.EncryptionInfo, _Mapping]
        ] = ...,
    ) -> None: ...
