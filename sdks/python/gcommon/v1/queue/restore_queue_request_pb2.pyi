...
class RestoreQueueRequest(_message.Message):
    ...
    def __init__(
        self,
        target_queue_id: _Optional[str] = ...,
        backup_source: _Optional[
            _Union[_backup_source_pb2.BackupSource, _Mapping]
        ] = ...,
        restore_config: _Optional[
            _Union[_restore_config_pb2.RestoreConfig, _Mapping]
        ] = ...,
        restore_point: _Optional[
            _Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]
        ] = ...,
        overwrite_existing: _Optional[bool] = ...,
        validate_backup: _Optional[bool] = ...,
        partition_ids: _Optional[_Iterable[int]] = ...,
        options: _Optional[_Union[_restore_options_pb2.RestoreOptions, _Mapping]] = ...,
