...
class ConsumerGroupStats(_message.Message):
    ...
    def __init__(
        ...
        assigned_partitions: _Optional[int] = ...,
        total_messages_consumed: _Optional[int] = ...,
        total_bytes_consumed: _Optional[int] = ...,
        group_consumption_rate: _Optional[float] = ...,
        total_lag: _Optional[int] = ...,
        rebalance_stats: _Optional[
            _Union[_rebalance_stats_pb2.RebalanceStats, _Mapping]
        ] = ...,
        error_stats: _Optional[
            _Union[_consumer_error_stats_pb2.ConsumerErrorStats, _Mapping]
        ] = ...,
    ) -> None: ...
