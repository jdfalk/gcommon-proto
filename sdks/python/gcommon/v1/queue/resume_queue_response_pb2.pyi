...
class ResumeQueueResponse(_message.Message):
    ...
    def __init__(
        ...
        previous_state: _Optional[_Union[_queue_state_pb2.QueueState, str]] = ...,
        current_state: _Optional[_Union[_queue_state_pb2.QueueState, str]] = ...,
        resumed_at: _Optional[
            _Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]
        ] = ...,
        pause_duration_ms: _Optional[int] = ...,
        messages_queued_during_pause: _Optional[int] = ...,
        affected_consumer_groups: _Optional[_Iterable[str]] = ...,
        error_message: _Optional[str] = ...,
        error_code: _Optional[str] = ...,
        warnings: _Optional[_Iterable[str]] = ...,
        resume_stats: _Optional[_Union[_resume_stats_pb2.ResumeStats, _Mapping]] = ...,
