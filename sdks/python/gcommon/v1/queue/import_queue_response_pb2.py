...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_IMPORTQUEUERESPONSE']._serialized_start=135
  _globals['_IMPORTQUEUERESPONSE']._serialized_end=545
