...
class PushResponse(_message.Message):
    ...
    def __init__(self, message_id: _Optional[str] = ..., accepted_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., message_offset: _Optional[int] = ..., queue_depth: _Optional[int] = ..., persisted: _Optional[bool] = ..., estimated_delivery_time: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
