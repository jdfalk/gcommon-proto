...
class SubscriptionConfigUpdate(_message.Message):
    ...
    def __init__(
        self,
        name: _Optional[str] = ...,
        delivery_settings: _Optional[
            _Union[_delivery_settings_pb2.DeliverySettings, _Mapping]
        ] = ...,
        retry_settings: _Optional[
            _Union[_config_retry_settings_pb2.ConfigRetrySettings, _Mapping]
        ] = ...,
        filter_settings: _Optional[
            _Union[_filter_settings_pb2.FilterSettings, _Mapping]
        ] = ...,
        routing_settings: _Optional[
            _Union[_routing_settings_pb2.RoutingSettings, _Mapping]
        ] = ...,
        max_inflight_messages: _Optional[int] = ...,
