...
class QueueTimeoutConfig(_message.Message):
    ...
    def __init__(self, publish_timeout: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ..., consume_timeout: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ..., ack_timeout: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ..., connect_timeout: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ..., processing_timeout: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ..., management_timeout: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ..., health_check_timeout: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ..., subscription_timeout: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ...) -> None: ...
