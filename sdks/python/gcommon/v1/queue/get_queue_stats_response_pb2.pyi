...
class GetQueueStatsResponse(_message.Message):
    ...
    queue_stats: _containers.RepeatedCompositeFieldContainer[
        _queue_stats_pb2.QueueStats
    ]
    consumer_stats: _containers.RepeatedCompositeFieldContainer[
        _consumer_stats_pb2.ConsumerStats
    ]
    ...
    def __init__(
        ...
        summary: _Optional[
            _Union[_queue_stats_summary_pb2.QueueStatsSummary, _Mapping]
        ] = ...,
        queue_stats: _Optional[
            _Iterable[_Union[_queue_stats_pb2.QueueStats, _Mapping]]
        ] = ...,
        consumer_stats: _Optional[
            _Iterable[_Union[_consumer_stats_pb2.ConsumerStats, _Mapping]]
        ] = ...,
        historical_stats: _Optional[
            _Union[_historical_stats_pb2.HistoricalStats, _Mapping]
        ] = ...,
        error_stats: _Optional[
            _Union[_metrics_error_stats_pb2.MetricsErrorStats, _Mapping]
        ] = ...,
        performance_metrics: _Optional[
            _Union[_performance_metrics_pb2.PerformanceMetrics, _Mapping]
        ] = ...,
