...
from gcommon.v1.queue import (
    message_update_properties_pb2 as _message_update_properties_pb2,
)
...
class UpdateMessageRequest(_message.Message):
    ...
    def __init__(
        ...
        properties: _Optional[
            _Union[_message_update_properties_pb2.MessageUpdateProperties, _Mapping]
        ] = ...,
        visibility_update: _Optional[
            _Union[_visibility_update_pb2.VisibilityUpdate, _Mapping]
        ] = ...,
        priority_update: _Optional[
            _Union[_priority_update_pb2.PriorityUpdate, _Mapping]
        ] = ...,
        metadata_update: _Optional[
            _Union[_metadata_update_pb2.MetadataUpdate, _Mapping]
        ] = ...,
        content_update: _Optional[
            _Union[_content_update_pb2.ContentUpdate, _Mapping]
        ] = ...,
        update_fields: _Optional[_Iterable[str]] = ...,
        condition: _Optional[
            _Union[_update_condition_pb2.UpdateCondition, _Mapping]
        ] = ...,
        operation_metadata: _Optional[_Mapping[str, str]] = ...,
    ) -> None: ...
