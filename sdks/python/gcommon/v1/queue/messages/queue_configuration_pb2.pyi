...
class QueueConfiguration(_message.Message):
    ...
    def __init__(self, max_messages: _Optional[int] = ..., visibility_timeout: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ..., message_retention_period: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ..., max_retry_attempts: _Optional[int] = ..., dead_letter_queue_enabled: bool = ...) -> None: ...
