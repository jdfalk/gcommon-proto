from gcommon.v1.queue.messages import partition_commit_result_pb2 as _partition_commit_result_pb2
...
class CommitOffsetResponse(_message.Message):
    ...
    def __init__(self, success: bool = ..., error_message: _Optional[str] = ..., error_code: _Optional[str] = ..., partition_results: _Optional[_Iterable[_Union[_partition_commit_result_pb2.PartitionCommitResult, _Mapping]]] = ..., committed_count: _Optional[int] = ..., failed_count: _Optional[int] = ..., commit_timestamp: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., consumer_generation: _Optional[int] = ..., metadata: _Optional[_Mapping[str, str]] = ...) -> None: ...
