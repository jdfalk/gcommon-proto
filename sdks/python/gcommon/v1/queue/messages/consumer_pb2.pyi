from gcommon.v1.queue.enums import consumer_state_pb2 as _consumer_state_pb2
from gcommon.v1.queue.messages import consumer_client_pb2 as _consumer_client_pb2
from gcommon.v1.queue.messages import consumer_config_pb2 as _consumer_config_pb2
...
class Consumer(_message.Message):
    ...
    def __init__(self, consumer_id: _Optional[str] = ..., client_info: _Optional[_Union[_consumer_client_pb2.ConsumerClient, _Mapping]] = ..., state: _Optional[_Union[_consumer_state_pb2.ConsumerState, str]] = ..., assigned_partitions: _Optional[_Iterable[int]] = ..., config: _Optional[_Union[_consumer_config_pb2.ConsumerConfig, _Mapping]] = ..., stats: _Optional[_Union[_consumer_stats_pb2.ConsumerStats, _Mapping]] = ..., last_heartbeat: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., joined_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
