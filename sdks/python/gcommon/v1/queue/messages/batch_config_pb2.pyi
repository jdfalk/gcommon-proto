...
class BatchConfig(_message.Message):
    ...
    worker_count: int
    buffer_size: int
    def __init__(self, max_batch_size: _Optional[int] = ..., max_wait_time: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ..., max_batch_bytes: _Optional[int] = ..., enable_compression: bool = ..., worker_count: _Optional[int] = ..., buffer_size: _Optional[int] = ...) -> None: ...
