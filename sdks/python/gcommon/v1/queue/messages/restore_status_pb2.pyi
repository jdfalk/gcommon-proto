...
class RestoreStatus(_message.Message):
    ...
    def __init__(self, status_code: _Optional[str] = ..., status_message: _Optional[str] = ..., progress_percentage: _Optional[int] = ..., current_phase: _Optional[str] = ..., estimated_remaining: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ..., last_update: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
