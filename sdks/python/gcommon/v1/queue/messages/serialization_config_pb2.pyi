from gcommon.v1.queue.enums import compression_algorithm_pb2 as _compression_algorithm_pb2
from gcommon.v1.queue.enums import serialization_format_pb2 as _serialization_format_pb2
from gcommon.v1.queue.messages import format_options_pb2 as _format_options_pb2
...
class SerializationConfig(_message.Message):
    __slots__ = ("default_format", "supported_formats", "auto_detect_format", "default_compression", "supported_compressions", "auto_detect_compression", "format_options", "validate_on_deserialize", "max_message_size", "backwards_compatible")
    class FormatOptionsEntry(_message.Message):
        ...
        def __init__(self, key: _Optional[str] = ..., value: _Optional[_Union[_format_options_pb2.FormatOptions, _Mapping]] = ...) -> None: ...
    ...
    supported_compressions: _containers.RepeatedScalarFieldContainer[_compression_algorithm_pb2.CompressionAlgorithm]
