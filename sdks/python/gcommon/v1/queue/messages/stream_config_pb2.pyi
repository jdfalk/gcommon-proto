from gcommon.v1.queue.enums import stream_restart_policy_pb2 as _stream_restart_policy_pb2
...
class StreamConfig(_message.Message):
    __slots__ = ("buffer_size", "read_timeout", "flow_control_enabled", "max_outstanding_messages", "max_outstanding_bytes", "auto_ack", "ack_deadline", "enable_message_ordering", "restart_policy")
