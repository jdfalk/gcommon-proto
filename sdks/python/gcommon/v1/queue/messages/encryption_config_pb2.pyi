...
class QueueEncryptionConfig(_message.Message):
    ...
    def __init__(self, enabled: bool = ..., algorithm: _Optional[str] = ..., key_derivation: _Optional[str] = ..., key_id: _Optional[str] = ..., encrypt_headers: bool = ..., encrypt_routing_keys: bool = ..., rotation_interval_hours: _Optional[int] = ...) -> None: ...
