...
class QueueHealth(_message.Message):
    ...
    def __init__(self, queue_name: _Optional[str] = ..., status: _Optional[_Union[_health_status_pb2.CommonHealthStatus, str]] = ..., health_score: _Optional[int] = ..., issues: _Optional[_Iterable[str]] = ..., last_check: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
