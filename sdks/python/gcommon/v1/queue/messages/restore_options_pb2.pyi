...
from gcommon.v1.queue.messages import filter_criteria_pb2 as _filter_criteria_pb2
from gcommon.v1.queue.messages import offset_range_pb2 as _offset_range_pb2
from gcommon.v1.queue.messages import performance_options_pb2 as _performance_options_pb2
...
class RestoreOptions(_message.Message):
    ...
    def __init__(self, skip_message_content: bool = ..., metadata_only: bool = ..., max_messages: _Optional[int] = ..., offset_range: _Optional[_Union[_offset_range_pb2.OffsetRange, _Mapping]] = ..., time_range: _Optional[_Union[_time_range_pb2.MetricsTimeRange, _Mapping]] = ..., priority_levels: _Optional[_Iterable[int]] = ..., filter_criteria: _Optional[_Union[_filter_criteria_pb2.FilterCriteria, _Mapping]] = ..., performance: _Optional[_Union[_performance_options_pb2.PerformanceOptions, _Mapping]] = ...) -> None: ...
