from gcommon.v1.queue.enums import ordering_level_pb2 as _ordering_level_pb2
...
class OrderingConfig(_message.Message):
    ...
    def __init__(self, global_ordering: _Optional[_Union[_ordering_level_pb2.OrderingLevel, str]] = ..., partition_ordering: _Optional[_Union[_ordering_level_pb2.OrderingLevel, str]] = ..., producer_ordering: _Optional[_Union[_ordering_level_pb2.OrderingLevel, str]] = ..., causal_ordering: bool = ..., ordering_timeout_ms: _Optional[int] = ...) -> None: ...
