...
class PartitionConfig(_message.Message):
    ...
    def __init__(
        ...
        partition_strategy: _Optional[str] = ...,
        partition_key: _Optional[str] = ...,
        custom_partition_function: _Optional[str] = ...,
        auto_scale: _Optional[bool] = ...,
        min_partitions: _Optional[int] = ...,
        max_partitions: _Optional[int] = ...,
        scale_threshold_mb: _Optional[int] = ...,
    ) -> None: ...
