...
class PartitionCommitResult(_message.Message):
    ...
    def __init__(self, partition_id: _Optional[int] = ..., success: bool = ..., committed_offset: _Optional[int] = ..., previous_offset: _Optional[int] = ..., error_message: _Optional[str] = ..., error_code: _Optional[str] = ..., commit_timestamp: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., partition_metadata: _Optional[_Mapping[str, str]] = ...) -> None: ...
