...
class ResumeStats(_message.Message):
    __slots__ = (
        "partitions_resumed",
        "subscriptions_reactivated",
        "consumers_reconnected",
        "resume_time_ms",
        "immediate_messages_processed",
        "post_resume_throughput",
    )
    ...
    def __init__(
        self,
        partitions_resumed: _Optional[int] = ...,
        subscriptions_reactivated: _Optional[int] = ...,
        consumers_reconnected: _Optional[int] = ...,
        resume_time_ms: _Optional[int] = ...,
        immediate_messages_processed: _Optional[int] = ...,
        post_resume_throughput: _Optional[float] = ...,
    ) -> None: ...
