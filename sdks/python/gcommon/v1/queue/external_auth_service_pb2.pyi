...
class ExternalAuthService(_message.Message):
    ...
    def __init__(
        ...
        retry_config: _Optional[
            _Union[_retry_config_pb2.QueueRetryConfig, _Mapping]
        ] = ...,
        cache_config: _Optional[
            _Union[_auth_cache_config_pb2.AuthCacheConfig, _Mapping]
        ] = ...,
        request_headers: _Optional[_Mapping[str, str]] = ...,
    ) -> None: ...
