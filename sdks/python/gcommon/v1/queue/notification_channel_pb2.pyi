...
from gcommon.v1.common import (
    notification_channel_type_pb2 as _notification_channel_type_pb2,
)
...
class QueueNotificationChannel(_message.Message):
    ...
    def __init__(
        ...
        id: _Optional[str] = ...,
        type: _Optional[
            _Union[_notification_channel_type_pb2.NotificationChannelType, str]
        ] = ...,
        config: _Optional[_Mapping[str, str]] = ...,
        enabled: _Optional[bool] = ...,
        min_severity: _Optional[
