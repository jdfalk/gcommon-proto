...
class ConnectionDetails(_message.Message):
    ...
    def __init__(
        self,
        delivery_endpoint: _Optional[str] = ...,
        auth_token: _Optional[str] = ...,
        heartbeat_interval_ms: _Optional[int] = ...,
        keep_alive_timeout_ms: _Optional[int] = ...,
        ssl_enabled: _Optional[bool] = ...,
        connection_metadata: _Optional[_Mapping[str, str]] = ...,
    ) -> None: ...
