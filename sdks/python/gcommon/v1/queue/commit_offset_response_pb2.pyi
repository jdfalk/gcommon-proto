...
class CommitOffsetResponse(_message.Message):
    ...
    partition_results: _containers.RepeatedCompositeFieldContainer[
        _partition_commit_result_pb2.PartitionCommitResult
    ]
    committed_count: int
    failed_count: int
    ...
    def __init__(
        ...
        partition_results: _Optional[
            _Iterable[
                _Union[_partition_commit_result_pb2.PartitionCommitResult, _Mapping]
            ]
        ] = ...,
        committed_count: _Optional[int] = ...,
        failed_count: _Optional[int] = ...,
        commit_timestamp: _Optional[
            _Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]
        ] = ...,
        consumer_generation: _Optional[int] = ...,
