...
from gcommon.v1.queue import (
    subscription_configuration_pb2 as _subscription_configuration_pb2,
)
...
class QueueSubscribeRequest(_message.Message):
    ...
    def __init__(
        ...
        config: _Optional[
            _Union[_subscription_configuration_pb2.SubscriptionConfiguration, _Mapping]
        ] = ...,
        filter_config: _Optional[
            _Union[_message_filter_config_pb2.MessageFilterConfig, _Mapping]
        ] = ...,
        delivery_config: _Optional[
            _Union[_delivery_configuration_pb2.DeliveryConfiguration, _Mapping]
        ] = ...,
        error_handling: _Optional[
            _Union[_error_handling_config_pb2.ErrorHandlingConfig, _Mapping]
        ] = ...,
