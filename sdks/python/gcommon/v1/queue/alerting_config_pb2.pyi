...
class AlertingConfig(_message.Message):
    ...
    channels: _containers.RepeatedCompositeFieldContainer[
        _notification_channel_pb2.QueueNotificationChannel
    ]
    ...
    def __init__(
        ...
        rules: _Optional[_Iterable[_Union[_alert_rule_pb2.AlertRule, _Mapping]]] = ...,
        channels: _Optional[
            _Iterable[
                _Union[_notification_channel_pb2.QueueNotificationChannel, _Mapping]
            ]
        ] = ...,
        default_severity: _Optional[
            _Union[_alert_severity_pb2.CommonAlertSeverity, str]
        ] = ...,
        aggregation_window: _Optional[
