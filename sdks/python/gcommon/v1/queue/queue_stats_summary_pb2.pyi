...
class QueueStatsSummary(_message.Message):
    ...
    def __init__(self, total_queues: _Optional[int] = ..., total_messages: _Optional[int] = ..., messages_processed_last_hour: _Optional[int] = ..., average_processing_time: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ..., health_score: _Optional[int] = ..., active_consumers: _Optional[int] = ..., total_storage_bytes: _Optional[int] = ...) -> None: ...
