from gcommon.v1.common import (
    load_balancing_strategy_pb2 as _load_balancing_strategy_pb2,
)
...
from gcommon.v1.queue import (
    dead_letter_queue_config_pb2 as _dead_letter_queue_config_pb2,
)
...
class ConsumerGroupConfig(_message.Message):
    ...
    def __init__(
        self,
        load_balancing_strategy: _Optional[
            _Union[_load_balancing_strategy_pb2.LoadBalancingStrategy, str]
        ] = ...,
        rebalance_strategy: _Optional[
            _Union[_rebalance_strategy_pb2.RebalanceStrategy, str]
        ] = ...,
        session_timeout_ms: _Optional[int] = ...,
        heartbeat_interval_ms: _Optional[int] = ...,
        max_poll_interval_ms: _Optional[int] = ...,
        auto_commit: _Optional[
            _Union[_auto_commit_config_pb2.AutoCommitConfig, _Mapping]
        ] = ...,
        offset_reset_strategy: _Optional[
            _Union[_offset_reset_strategy_pb2.OffsetResetStrategy, str]
        ] = ...,
        max_consumers: _Optional[int] = ...,
        exactly_once_enabled: _Optional[bool] = ...,
        dlq_config: _Optional[
            _Union[_dead_letter_queue_config_pb2.DeadLetterQueueConfig, _Mapping]
        ] = ...,
    ) -> None: ...
