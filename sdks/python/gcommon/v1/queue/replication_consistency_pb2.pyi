...
class ReplicationConsistency(_message.Message):
    ...
    def __init__(
        self,
        min_write_replicas: _Optional[int] = ...,
        min_read_replicas: _Optional[int] = ...,
        replication_factor: _Optional[int] = ...,
        replication_level: _Optional[
            _Union[_replication_level_pb2.ReplicationLevel, str]
        ] = ...,
        anti_entropy_enabled: _Optional[bool] = ...,
        repair_interval_seconds: _Optional[int] = ...,
    ) -> None: ...
