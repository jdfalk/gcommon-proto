...
class QueueEncryptionConfig(_message.Message):
    ...
    def __init__(
        ...
        key_derivation: _Optional[str] = ...,
        key_id: _Optional[str] = ...,
        encrypt_headers: _Optional[bool] = ...,
        encrypt_routing_keys: _Optional[bool] = ...,
        rotation_interval_hours: _Optional[int] = ...,
    ) -> None: ...
