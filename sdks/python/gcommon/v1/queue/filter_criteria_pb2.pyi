...
class FilterCriteria(_message.Message):
    __slots__ = ("include_patterns", "exclude_patterns", "header_filters", "content_types")
    ...
    def __init__(self, include_patterns: _Optional[_Iterable[str]] = ..., exclude_patterns: _Optional[_Iterable[str]] = ..., header_filters: _Optional[_Mapping[str, str]] = ..., content_types: _Optional[_Iterable[str]] = ...) -> None: ...
