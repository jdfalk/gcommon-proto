...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_STREAMMESSAGESREQUEST']._serialized_start=254
  _globals['_STREAMMESSAGESREQUEST']._serialized_end=900
