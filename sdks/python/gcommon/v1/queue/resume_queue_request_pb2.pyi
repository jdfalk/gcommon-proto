...
class ResumeQueueRequest(_message.Message):
    ...
    def __init__(self, queue_name: _Optional[str] = ..., reason: _Optional[str] = ..., metadata: _Optional[_Union[_request_metadata_pb2.RequestMetadata, _Mapping]] = ..., partition_ids: _Optional[_Iterable[int]] = ..., resume_from_last_position: bool = ...) -> None: ...
