...
from gcommon.v1.queue import (
    role_based_access_control_pb2 as _role_based_access_control_pb2,
)
...
class AuthorizationConfig(_message.Message):
    ...
    rules: _containers.RepeatedCompositeFieldContainer[
        _permission_rule_pb2.PermissionRule
    ]
    ...
    def __init__(
        ...
        rules: _Optional[
            _Iterable[_Union[_permission_rule_pb2.PermissionRule, _Mapping]]
        ] = ...,
        rbac: _Optional[
            _Union[_role_based_access_control_pb2.RoleBasedAccessControl, _Mapping]
        ] = ...,
        api_key_auth: _Optional[_Union[_api_key_auth_pb2.APIKeyAuth, _Mapping]] = ...,
        jwt_auth: _Optional[_Union[_jwt_auth_pb2.JwtAuth, _Mapping]] = ...,
        external_auth: _Optional[
            _Union[_external_auth_service_pb2.ExternalAuthService, _Mapping]
        ] = ...,
    ) -> None: ...
