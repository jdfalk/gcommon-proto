...
class RebalanceStats(_message.Message):
    ...
    def __init__(self, total_rebalances: _Optional[int] = ..., last_rebalance: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., avg_rebalance_duration_ms: _Optional[int] = ..., failed_rebalances: _Optional[int] = ...) -> None: ...
