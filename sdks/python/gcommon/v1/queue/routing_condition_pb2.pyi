...
class RoutingCondition(_message.Message):
    ...
    def __init__(
        self,
        header_matches: _Optional[_Mapping[str, str]] = ...,
        content_pattern: _Optional[str] = ...,
        routing_key_pattern: _Optional[str] = ...,
        message_type: _Optional[str] = ...,
        priority_range: _Optional[
            _Union[_priority_range_pb2.PriorityRange, _Mapping]
        ] = ...,
        size_range: _Optional[_Union[_size_range_pb2.SizeRange, _Mapping]] = ...,
    ) -> None: ...
