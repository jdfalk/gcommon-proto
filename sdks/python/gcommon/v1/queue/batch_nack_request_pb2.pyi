...
class BatchNackRequest(_message.Message):
    ...
    consumer_id: str
    message_nacks: _containers.RepeatedCompositeFieldContainer[
        _message_nack_pb2.MessageNack
    ]
    ...
    def __init__(
        ...
        message_nacks: _Optional[
            _Iterable[_Union[_message_nack_pb2.MessageNack, _Mapping]]
        ] = ...,
        requeue_messages: _Optional[bool] = ...,
        requeue_delay_ms: _Optional[int] = ...,
        max_requeue_attempts: _Optional[int] = ...,
        send_to_dlq: _Optional[bool] = ...,
