...
class WebServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.HealthCheck = channel.unary_unary(
                ...
                request_serializer=pkg_dot_web_dot_proto_dot_health__check__request__pb2.HealthCheckRequest.SerializeToString,
                response_deserializer=pkg_dot_web_dot_proto_dot_health__check__response__pb2.HealthCheckResponse.FromString,
                _registered_method=True)
...
def add_WebServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'HealthCheck': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=pkg_dot_web_dot_proto_dot_health__check__request__pb2.HealthCheckRequest.FromString,
                    response_serializer=pkg_dot_web_dot_proto_dot_health__check__response__pb2.HealthCheckResponse.SerializeToString,
            ),
    }
...
class WebService(object):
    ...
    def HealthCheck(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/gcommon.v1.web.WebService/HealthCheck',
            pkg_dot_web_dot_proto_dot_health__check__request__pb2.HealthCheckRequest.SerializeToString,
            pkg_dot_web_dot_proto_dot_health__check__response__pb2.HealthCheckResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
