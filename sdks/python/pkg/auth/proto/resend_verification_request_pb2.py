...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    3,
    '',
    'pkg/auth/proto/resend_verification_request.proto'
)
...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'pkg.auth.proto.resend_verification_request_pb2', _globals)
