...
from pkg.config.proto import compliance_audit_pb2 as pkg_dot_config_dot_proto_dot_compliance__audit__pb2
...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'pkg.config.proto.compliance_settings_pb2', _globals)
