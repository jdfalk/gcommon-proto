...
func (x *MetricQuery) Reset() {
	*x = MetricQuery{}
	mi := &file_gcommon_v1_metrics_metric_query_proto_msgTypes[0]
...
var File_gcommon_v1_metrics_metric_query_proto protoreflect.FileDescriptor

const file_gcommon_v1_metrics_metric_query_proto_rawDesc = "" +
	"\n" +
	"%gcommon/v1/metrics/metric_query.proto\x12\x12gcommon.v1.metrics\x1a$gcommon/v1/common/sort_options.proto\x1a)gcommon/v1/metrics/aggregation_spec.proto\x1a&gcommon/v1/metrics/group_by_spec.proto\x1a&gcommon/v1/metrics/metric_filter.proto\x1a#gcommon/v1/metrics/time_range.proto\x1a!google/protobuf/go_features.proto\"\xd8\x03\n" +
	...
	"\x06offset\x18\n" +
	" \x01(\x05R\x06offsetB6Z,github.com/jdfalk/gcommon/sdks/go/v1/metrics\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_metrics_metric_query_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_metrics_metric_query_proto_goTypes = []any{
...
func init() { file_gcommon_v1_metrics_metric_query_proto_init() }
func file_gcommon_v1_metrics_metric_query_proto_init() {
	if File_gcommon_v1_metrics_metric_query_proto != nil {
		return
	}
	file_gcommon_v1_metrics_aggregation_spec_proto_init()
	file_gcommon_v1_metrics_group_by_spec_proto_init()
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_metrics_metric_query_proto_rawDesc), len(file_gcommon_v1_metrics_metric_query_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_metrics_metric_query_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_metrics_metric_query_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_metrics_metric_query_proto_msgTypes,
	}.Build()
	File_gcommon_v1_metrics_metric_query_proto = out.File
	file_gcommon_v1_metrics_metric_query_proto_goTypes = nil
	file_gcommon_v1_metrics_metric_query_proto_depIdxs = nil
}
