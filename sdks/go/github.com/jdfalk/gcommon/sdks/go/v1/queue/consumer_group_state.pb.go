...
// 	protoc        (unknown)
// source: gcommon/v1/queue/consumer_group_state.proto
...
func (ConsumerGroupState) Descriptor() protoreflect.EnumDescriptor {
	return file_gcommon_v1_queue_consumer_group_state_proto_enumTypes[0].Descriptor()
}

func (ConsumerGroupState) Type() protoreflect.EnumType {
	return &file_gcommon_v1_queue_consumer_group_state_proto_enumTypes[0]
}
...
var File_gcommon_v1_queue_consumer_group_state_proto protoreflect.FileDescriptor

const file_gcommon_v1_queue_consumer_group_state_proto_rawDesc = "" +
	"\n" +
	"+gcommon/v1/queue/consumer_group_state.proto\x12\x10gcommon.v1.queue\x1a!google/protobuf/go_features.proto*\xf7\x01\n" +
	...
	"\x1aCONSUMER_GROUP_STATE_EMPTY\x10\x05B4Z*github.com/jdfalk/gcommon/sdks/go/v1/queue\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_queue_consumer_group_state_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_gcommon_v1_queue_consumer_group_state_proto_goTypes = []any{
	(ConsumerGroupState)(0), // 0: gcommon.v1.queue.ConsumerGroupState
}
var file_gcommon_v1_queue_consumer_group_state_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_queue_consumer_group_state_proto_init() }
func file_gcommon_v1_queue_consumer_group_state_proto_init() {
	if File_gcommon_v1_queue_consumer_group_state_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_queue_consumer_group_state_proto_rawDesc), len(file_gcommon_v1_queue_consumer_group_state_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_queue_consumer_group_state_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_queue_consumer_group_state_proto_depIdxs,
		EnumInfos:         file_gcommon_v1_queue_consumer_group_state_proto_enumTypes,
	}.Build()
	File_gcommon_v1_queue_consumer_group_state_proto = out.File
	file_gcommon_v1_queue_consumer_group_state_proto_goTypes = nil
	file_gcommon_v1_queue_consumer_group_state_proto_depIdxs = nil
}
