...
func (x *ComputeIsolation) Reset() {
	*x = ComputeIsolation{}
	mi := &file_gcommon_v1_organization_compute_isolation_proto_msgTypes[0]
...
var File_gcommon_v1_organization_compute_isolation_proto protoreflect.FileDescriptor

const file_gcommon_v1_organization_compute_isolation_proto_rawDesc = "" +
	"\n" +
	"/gcommon/v1/organization/compute_isolation.proto\x12\x17gcommon.v1.organization\x1a1gcommon/v1/organization/auto_scaling_config.proto\x1a,gcommon/v1/organization/cpu_allocation.proto\x1a/gcommon/v1/organization/memory_allocation.proto\x1a-gcommon/v1/organization/resource_limits.proto\x1a!google/protobuf/go_features.proto\"\xa1\x03\n" +
	...
	"\fauto_scaling\x18\a \x01(\v2*.gcommon.v1.organization.AutoScalingConfigR\vautoScalingB;Z1github.com/jdfalk/gcommon/sdks/go/v1/organization\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_organization_compute_isolation_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_organization_compute_isolation_proto_goTypes = []any{
...
var file_gcommon_v1_organization_compute_isolation_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_organization_compute_isolation_proto_init() }
func file_gcommon_v1_organization_compute_isolation_proto_init() {
	if File_gcommon_v1_organization_compute_isolation_proto != nil {
		return
	}
	file_gcommon_v1_organization_auto_scaling_config_proto_init()
	file_gcommon_v1_organization_cpu_allocation_proto_init()
	file_gcommon_v1_organization_memory_allocation_proto_init()
	file_gcommon_v1_organization_resource_limits_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_organization_compute_isolation_proto_rawDesc), len(file_gcommon_v1_organization_compute_isolation_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_organization_compute_isolation_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_organization_compute_isolation_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_organization_compute_isolation_proto_msgTypes,
	}.Build()
	File_gcommon_v1_organization_compute_isolation_proto = out.File
	file_gcommon_v1_organization_compute_isolation_proto_goTypes = nil
	file_gcommon_v1_organization_compute_isolation_proto_depIdxs = nil
}
