...
// 	protoc        (unknown)
// source: gcommon/v1/organization/access_control.proto
...
func (x *OrganizationAccessControl) Reset() {
	*x = OrganizationAccessControl{}
	mi := &file_gcommon_v1_organization_access_control_proto_msgTypes[0]
...
var File_gcommon_v1_organization_access_control_proto protoreflect.FileDescriptor

const file_gcommon_v1_organization_access_control_proto_rawDesc = "" +
	"\n" +
	",gcommon/v1/organization/access_control.proto\x12\x17gcommon.v1.organization\x1a.gcommon/v1/organization/time_restriction.proto\x1a!google/protobuf/go_features.proto\"\xc6\x02\n" +
	...
	"\x11time_restrictions\x18\x06 \x03(\v2(.gcommon.v1.organization.TimeRestrictionR\x10timeRestrictionsB;Z1github.com/jdfalk/gcommon/sdks/go/v1/organization\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_organization_access_control_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_organization_access_control_proto_goTypes = []any{
...
var file_gcommon_v1_organization_access_control_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_organization_access_control_proto_init() }
func file_gcommon_v1_organization_access_control_proto_init() {
	if File_gcommon_v1_organization_access_control_proto != nil {
		return
	}
	file_gcommon_v1_organization_time_restriction_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_organization_access_control_proto_rawDesc), len(file_gcommon_v1_organization_access_control_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_organization_access_control_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_organization_access_control_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_organization_access_control_proto_msgTypes,
	}.Build()
	File_gcommon_v1_organization_access_control_proto = out.File
	file_gcommon_v1_organization_access_control_proto_goTypes = nil
	file_gcommon_v1_organization_access_control_proto_depIdxs = nil
}
