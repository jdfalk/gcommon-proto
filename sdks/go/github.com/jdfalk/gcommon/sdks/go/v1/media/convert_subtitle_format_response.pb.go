...
func (x *ConvertSubtitleFormatResponse) Reset() {
	*x = ConvertSubtitleFormatResponse{}
	mi := &file_gcommon_v1_media_convert_subtitle_format_response_proto_msgTypes[0]
...
func init() { file_gcommon_v1_media_convert_subtitle_format_response_proto_init() }
func file_gcommon_v1_media_convert_subtitle_format_response_proto_init() {
	if File_gcommon_v1_media_convert_subtitle_format_response_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_media_convert_subtitle_format_response_proto_rawDesc), len(file_gcommon_v1_media_convert_subtitle_format_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_media_convert_subtitle_format_response_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_media_convert_subtitle_format_response_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_media_convert_subtitle_format_response_proto_msgTypes,
	}.Build()
	File_gcommon_v1_media_convert_subtitle_format_response_proto = out.File
	file_gcommon_v1_media_convert_subtitle_format_response_proto_goTypes = nil
	file_gcommon_v1_media_convert_subtitle_format_response_proto_depIdxs = nil
}
