...
// 	protoc        (unknown)
// source: gcommon/v1/metrics/record_metric_response.proto
...
func (x *RecordMetricResponse) Reset() {
	*x = RecordMetricResponse{}
	mi := &file_gcommon_v1_metrics_record_metric_response_proto_msgTypes[0]
...
var File_gcommon_v1_metrics_record_metric_response_proto protoreflect.FileDescriptor

const file_gcommon_v1_metrics_record_metric_response_proto_rawDesc = "" +
	"\n" +
	"/gcommon/v1/metrics/record_metric_response.proto\x12\x12gcommon.v1.metrics\x1a\x1dgcommon/v1/common/error.proto\x1a(gcommon/v1/metrics/recording_stats.proto\x1a*gcommon/v1/metrics/validation_result.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xfe\x02\n" +
...
func init() { file_gcommon_v1_metrics_record_metric_response_proto_init() }
func file_gcommon_v1_metrics_record_metric_response_proto_init() {
	if File_gcommon_v1_metrics_record_metric_response_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_metrics_record_metric_response_proto_rawDesc), len(file_gcommon_v1_metrics_record_metric_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_metrics_record_metric_response_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_metrics_record_metric_response_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_metrics_record_metric_response_proto_msgTypes,
	}.Build()
	File_gcommon_v1_metrics_record_metric_response_proto = out.File
	file_gcommon_v1_metrics_record_metric_response_proto_goTypes = nil
	file_gcommon_v1_metrics_record_metric_response_proto_depIdxs = nil
}
