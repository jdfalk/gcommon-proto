...
func (SampleRate) Descriptor() protoreflect.EnumDescriptor {
	return file_gcommon_v1_common_sample_rate_proto_enumTypes[0].Descriptor()
}

func (SampleRate) Type() protoreflect.EnumType {
	return &file_gcommon_v1_common_sample_rate_proto_enumTypes[0]
}
...
var File_gcommon_v1_common_sample_rate_proto protoreflect.FileDescriptor

const file_gcommon_v1_common_sample_rate_proto_rawDesc = "" +
	"\n" +
	...
	"\x12SAMPLE_RATE_CUSTOM\x10\tB5Z+github.com/jdfalk/gcommon/sdks/go/v1/common\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_common_sample_rate_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_gcommon_v1_common_sample_rate_proto_goTypes = []any{
	(SampleRate)(0), // 0: gcommon.v1.common.SampleRate
}
var file_gcommon_v1_common_sample_rate_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_common_sample_rate_proto_init() }
func file_gcommon_v1_common_sample_rate_proto_init() {
	if File_gcommon_v1_common_sample_rate_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_common_sample_rate_proto_rawDesc), len(file_gcommon_v1_common_sample_rate_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_common_sample_rate_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_common_sample_rate_proto_depIdxs,
		EnumInfos:         file_gcommon_v1_common_sample_rate_proto_enumTypes,
	}.Build()
	File_gcommon_v1_common_sample_rate_proto = out.File
	file_gcommon_v1_common_sample_rate_proto_goTypes = nil
	file_gcommon_v1_common_sample_rate_proto_depIdxs = nil
}
