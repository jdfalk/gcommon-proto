...
// 	protoc        (unknown)
// source: gcommon/v1/config/notification_trigger.proto
...
func (NotificationTrigger) Descriptor() protoreflect.EnumDescriptor {
	return file_gcommon_v1_config_notification_trigger_proto_enumTypes[0].Descriptor()
}

func (NotificationTrigger) Type() protoreflect.EnumType {
	return &file_gcommon_v1_config_notification_trigger_proto_enumTypes[0]
}
...
var File_gcommon_v1_config_notification_trigger_proto protoreflect.FileDescriptor

const file_gcommon_v1_config_notification_trigger_proto_rawDesc = "" +
	"\n" +
	",gcommon/v1/config/notification_trigger.proto\x12\x11gcommon.v1.config\x1a!google/protobuf/go_features.proto*\xab\x02\n" +
	...
	"\x1dNOTIFICATION_TRIGGER_SCHEDULE\x10\aB5Z+github.com/jdfalk/gcommon/sdks/go/v1/config\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_config_notification_trigger_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_gcommon_v1_config_notification_trigger_proto_goTypes = []any{
	(NotificationTrigger)(0), // 0: gcommon.v1.config.NotificationTrigger
}
var file_gcommon_v1_config_notification_trigger_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_config_notification_trigger_proto_init() }
func file_gcommon_v1_config_notification_trigger_proto_init() {
	if File_gcommon_v1_config_notification_trigger_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_config_notification_trigger_proto_rawDesc), len(file_gcommon_v1_config_notification_trigger_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_config_notification_trigger_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_config_notification_trigger_proto_depIdxs,
		EnumInfos:         file_gcommon_v1_config_notification_trigger_proto_enumTypes,
	}.Build()
	File_gcommon_v1_config_notification_trigger_proto = out.File
	file_gcommon_v1_config_notification_trigger_proto_goTypes = nil
	file_gcommon_v1_config_notification_trigger_proto_depIdxs = nil
}
