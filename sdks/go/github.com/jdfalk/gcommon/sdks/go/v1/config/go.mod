module github.com/jdfalk/gcommon/sdks/go/v1/config
...
replace (
	...
	github.com/jdfalk/gcommon/sdks/go/v1/organization => ../organization
)
...
require (
	...
	github.com/jdfalk/gcommon/sdks/go/v1/organization v0.0.0-00010101000000-000000000000
