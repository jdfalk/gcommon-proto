...
func (x *TopicPermissions) Reset() {
	*x = TopicPermissions{}
	mi := &file_gcommon_v1_queue_topic_permissions_proto_msgTypes[0]
...
var File_gcommon_v1_queue_topic_permissions_proto protoreflect.FileDescriptor

const file_gcommon_v1_queue_topic_permissions_proto_rawDesc = "" +
	"\n" +
	...
	"\x0ecan_view_stats\x18\x06 \x01(\bR\fcanViewStatsB4Z*github.com/jdfalk/gcommon/sdks/go/v1/queue\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_queue_topic_permissions_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_queue_topic_permissions_proto_goTypes = []any{
	(*TopicPermissions)(nil), // 0: gcommon.v1.queue.TopicPermissions
}
var file_gcommon_v1_queue_topic_permissions_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_queue_topic_permissions_proto_init() }
func file_gcommon_v1_queue_topic_permissions_proto_init() {
	if File_gcommon_v1_queue_topic_permissions_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_queue_topic_permissions_proto_rawDesc), len(file_gcommon_v1_queue_topic_permissions_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_queue_topic_permissions_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_queue_topic_permissions_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_queue_topic_permissions_proto_msgTypes,
	}.Build()
	File_gcommon_v1_queue_topic_permissions_proto = out.File
	file_gcommon_v1_queue_topic_permissions_proto_goTypes = nil
	file_gcommon_v1_queue_topic_permissions_proto_depIdxs = nil
}
