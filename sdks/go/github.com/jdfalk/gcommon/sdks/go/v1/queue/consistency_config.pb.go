...
func (x *ConsistencyConfig) Reset() {
	*x = ConsistencyConfig{}
	mi := &file_gcommon_v1_queue_consistency_config_proto_msgTypes[0]
...
var File_gcommon_v1_queue_consistency_config_proto protoreflect.FileDescriptor

const file_gcommon_v1_queue_consistency_config_proto_rawDesc = "" +
	"\n" +
	...
	"validationB4Z*github.com/jdfalk/gcommon/sdks/go/v1/queue\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_queue_consistency_config_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_queue_consistency_config_proto_goTypes = []any{
...
var file_gcommon_v1_queue_consistency_config_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_queue_consistency_config_proto_init() }
func file_gcommon_v1_queue_consistency_config_proto_init() {
	if File_gcommon_v1_queue_consistency_config_proto != nil {
		return
	}
	file_gcommon_v1_queue_ack_level_proto_init()
	file_gcommon_v1_queue_durability_level_proto_init()
	file_gcommon_v1_queue_consistency_validation_proto_init()
	file_gcommon_v1_queue_ordering_config_proto_init()
	file_gcommon_v1_queue_read_consistency_proto_init()
	file_gcommon_v1_queue_replication_consistency_proto_init()
	file_gcommon_v1_queue_write_consistency_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_queue_consistency_config_proto_rawDesc), len(file_gcommon_v1_queue_consistency_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_queue_consistency_config_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_queue_consistency_config_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_queue_consistency_config_proto_msgTypes,
	}.Build()
	File_gcommon_v1_queue_consistency_config_proto = out.File
	file_gcommon_v1_queue_consistency_config_proto_goTypes = nil
	file_gcommon_v1_queue_consistency_config_proto_depIdxs = nil
}
