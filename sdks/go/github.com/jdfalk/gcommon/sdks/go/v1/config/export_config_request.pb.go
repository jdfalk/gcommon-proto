...
const file_gcommon_v1_config_export_config_request_proto_rawDesc = "" +
	"\n" +
	"-gcommon/v1/config/export_config_request.proto\x12\x11gcommon.v1.config\x1a(gcommon/v1/common/request_metadata.proto\x1a!google/protobuf/go_features.proto\"\x8b\x01\n" +
