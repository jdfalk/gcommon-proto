...
// 	protoc        (unknown)
// source: gcommon/v1/metrics/comparison_operator.proto
...
func (ComparisonOperator) Descriptor() protoreflect.EnumDescriptor {
	return file_gcommon_v1_metrics_comparison_operator_proto_enumTypes[0].Descriptor()
}

func (ComparisonOperator) Type() protoreflect.EnumType {
	return &file_gcommon_v1_metrics_comparison_operator_proto_enumTypes[0]
}
...
var File_gcommon_v1_metrics_comparison_operator_proto protoreflect.FileDescriptor

const file_gcommon_v1_metrics_comparison_operator_proto_rawDesc = "" +
	"\n" +
	",gcommon/v1/metrics/comparison_operator.proto\x12\x12gcommon.v1.metrics\x1a!google/protobuf/go_features.proto*\x9f\x02\n" +
	...
	"&COMPARISON_OPERATOR_LESS_THAN_OR_EQUAL\x10\x06B6Z,github.com/jdfalk/gcommon/sdks/go/v1/metrics\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_metrics_comparison_operator_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_gcommon_v1_metrics_comparison_operator_proto_goTypes = []any{
	(ComparisonOperator)(0), // 0: gcommon.v1.metrics.ComparisonOperator
}
var file_gcommon_v1_metrics_comparison_operator_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_metrics_comparison_operator_proto_init() }
func file_gcommon_v1_metrics_comparison_operator_proto_init() {
	if File_gcommon_v1_metrics_comparison_operator_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_metrics_comparison_operator_proto_rawDesc), len(file_gcommon_v1_metrics_comparison_operator_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_metrics_comparison_operator_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_metrics_comparison_operator_proto_depIdxs,
		EnumInfos:         file_gcommon_v1_metrics_comparison_operator_proto_enumTypes,
	}.Build()
	File_gcommon_v1_metrics_comparison_operator_proto = out.File
	file_gcommon_v1_metrics_comparison_operator_proto_goTypes = nil
	file_gcommon_v1_metrics_comparison_operator_proto_depIdxs = nil
}
