...
func (x *GetMetricsSummaryRequest) Reset() {
	*x = GetMetricsSummaryRequest{}
	mi := &file_gcommon_v1_metrics_get_metrics_summary_request_proto_msgTypes[0]
...
var File_gcommon_v1_metrics_get_metrics_summary_request_proto protoreflect.FileDescriptor

const file_gcommon_v1_metrics_get_metrics_summary_request_proto_rawDesc = "" +
	"\n" +
	"4gcommon/v1/metrics/get_metrics_summary_request.proto\x12\x12gcommon.v1.metrics\x1a(gcommon/v1/common/request_metadata.proto\x1a&gcommon/v1/metrics/metric_filter.proto\x1a(gcommon/v1/metrics/summary_options.proto\x1a#gcommon/v1/metrics/time_range.proto\x1a!google/protobuf/go_features.proto\"\xa2\x03\n" +
	...
	"\x15include_health_status\x18\a \x01(\bR\x13includeHealthStatusB6Z,github.com/jdfalk/gcommon/sdks/go/v1/metrics\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_metrics_get_metrics_summary_request_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_metrics_get_metrics_summary_request_proto_goTypes = []any{
...
func init() { file_gcommon_v1_metrics_get_metrics_summary_request_proto_init() }
func file_gcommon_v1_metrics_get_metrics_summary_request_proto_init() {
	if File_gcommon_v1_metrics_get_metrics_summary_request_proto != nil {
		return
	}
	file_gcommon_v1_metrics_metric_filter_proto_init()
	file_gcommon_v1_metrics_summary_options_proto_init()
	file_gcommon_v1_metrics_time_range_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_metrics_get_metrics_summary_request_proto_rawDesc), len(file_gcommon_v1_metrics_get_metrics_summary_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_metrics_get_metrics_summary_request_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_metrics_get_metrics_summary_request_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_metrics_get_metrics_summary_request_proto_msgTypes,
	}.Build()
	File_gcommon_v1_metrics_get_metrics_summary_request_proto = out.File
	file_gcommon_v1_metrics_get_metrics_summary_request_proto_goTypes = nil
	file_gcommon_v1_metrics_get_metrics_summary_request_proto_depIdxs = nil
}
