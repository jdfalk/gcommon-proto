...
func (x *RecordMetricsResponse) Reset() {
	*x = RecordMetricsResponse{}
	mi := &file_gcommon_v1_metrics_messages_record_metrics_response_proto_msgTypes[0]
...
var File_gcommon_v1_metrics_messages_record_metrics_response_proto protoreflect.FileDescriptor

const file_gcommon_v1_metrics_messages_record_metrics_response_proto_rawDesc = "" +
	"\n" +
	"9gcommon/v1/metrics/messages/record_metrics_response.proto\x12\x12gcommon.v1.metrics\x1a&gcommon/v1/common/messages/error.proto\x1a-gcommon/v1/metrics/messages/batch_stats.proto\x1a/gcommon/v1/metrics/messages/metric_result.proto\x1a4gcommon/v1/metrics/messages/validation_summary.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x97\x04\n" +
	...
	"\x12validation_summary\x18\v \x01(\v2%.gcommon.v1.metrics.ValidationSummaryR\x11validationSummaryB\xdc\x01\n" +
...
var file_gcommon_v1_metrics_messages_record_metrics_response_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_metrics_messages_record_metrics_response_proto_goTypes = []any{
...
var file_gcommon_v1_metrics_messages_record_metrics_response_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_metrics_messages_record_metrics_response_proto_init() }
func file_gcommon_v1_metrics_messages_record_metrics_response_proto_init() {
	if File_gcommon_v1_metrics_messages_record_metrics_response_proto != nil {
		return
	}
	file_gcommon_v1_metrics_messages_batch_stats_proto_init()
	file_gcommon_v1_metrics_messages_metric_result_proto_init()
	file_gcommon_v1_metrics_messages_validation_summary_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_metrics_messages_record_metrics_response_proto_rawDesc), len(file_gcommon_v1_metrics_messages_record_metrics_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_metrics_messages_record_metrics_response_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_metrics_messages_record_metrics_response_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_metrics_messages_record_metrics_response_proto_msgTypes,
	}.Build()
	File_gcommon_v1_metrics_messages_record_metrics_response_proto = out.File
	file_gcommon_v1_metrics_messages_record_metrics_response_proto_goTypes = nil
	file_gcommon_v1_metrics_messages_record_metrics_response_proto_depIdxs = nil
}
