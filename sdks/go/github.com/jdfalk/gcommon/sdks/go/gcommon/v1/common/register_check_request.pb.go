...
func (x *RegisterCheckRequest) Reset() {
	*x = RegisterCheckRequest{}
	mi := &file_gcommon_v1_common_messages_register_check_request_proto_msgTypes[0]
...
var File_gcommon_v1_common_messages_register_check_request_proto protoreflect.FileDescriptor

const file_gcommon_v1_common_messages_register_check_request_proto_rawDesc = "" +
	"\n" +
	"7gcommon/v1/common/messages/register_check_request.proto\x12\x11gcommon.v1.common\x1a5gcommon/v1/common/messages/health_check_request.proto\x1a1gcommon/v1/common/messages/request_metadata.proto\x1a!google/protobuf/go_features.proto\"\xb7\x01\n" +
...
func init() { file_gcommon_v1_common_messages_register_check_request_proto_init() }
func file_gcommon_v1_common_messages_register_check_request_proto_init() {
	if File_gcommon_v1_common_messages_register_check_request_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_common_messages_register_check_request_proto_rawDesc), len(file_gcommon_v1_common_messages_register_check_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_common_messages_register_check_request_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_common_messages_register_check_request_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_common_messages_register_check_request_proto_msgTypes,
	}.Build()
	File_gcommon_v1_common_messages_register_check_request_proto = out.File
	file_gcommon_v1_common_messages_register_check_request_proto_goTypes = nil
	file_gcommon_v1_common_messages_register_check_request_proto_depIdxs = nil
}
