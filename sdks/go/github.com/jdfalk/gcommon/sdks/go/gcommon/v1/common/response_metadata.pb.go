...
func (x *ResponseMetadata) Reset() {
	*x = ResponseMetadata{}
	mi := &file_gcommon_v1_common_messages_response_metadata_proto_msgTypes[0]
...
var File_gcommon_v1_common_messages_response_metadata_proto protoreflect.FileDescriptor

const file_gcommon_v1_common_messages_response_metadata_proto_rawDesc = "" +
	"\n" +
	"2gcommon/v1/common/messages/response_metadata.proto\x12\x11gcommon.v1.common\x1a&gcommon/v1/common/messages/error.proto\x1a0gcommon/v1/common/messages/pagination_info.proto\x1a0gcommon/v1/common/messages/rate_limit_info.proto\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xd3\x04\n" +
	...
	"\x15com.gcommon.v1.commonB\x15ResponseMetadataProtoP\x01Z3github.com/jdfalk/gcommon/sdks/go/gcommon/v1/common\xa2\x02\x03GVC\xaa\x02\x11Gcommon.V1.Common\xca\x02\x11Gcommon\\V1\\Common\xe2\x02\x1dGcommon\\V1\\Common\\GPBMetadata\xea\x02\x13Gcommon::V1::Common\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
func init() { file_gcommon_v1_common_messages_response_metadata_proto_init() }
func file_gcommon_v1_common_messages_response_metadata_proto_init() {
	if File_gcommon_v1_common_messages_response_metadata_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_common_messages_response_metadata_proto_rawDesc), len(file_gcommon_v1_common_messages_response_metadata_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_common_messages_response_metadata_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_common_messages_response_metadata_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_common_messages_response_metadata_proto_msgTypes,
	}.Build()
	File_gcommon_v1_common_messages_response_metadata_proto = out.File
	file_gcommon_v1_common_messages_response_metadata_proto_goTypes = nil
	file_gcommon_v1_common_messages_response_metadata_proto_depIdxs = nil
}
