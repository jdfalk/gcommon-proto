...
type StreamConfig struct {
	...
	xxx_hidden_RestartPolicy          StreamRestartPolicy    `protobuf:"varint,9,opt,name=restart_policy,json=restartPolicy,enum=gcommon.v1.queue.StreamRestartPolicy"`
...
func (x *StreamConfig) SetRestartPolicy(v StreamRestartPolicy) {
...
func (x *StreamConfig) ClearRestartPolicy() {
	...
	x.xxx_hidden_RestartPolicy = StreamRestartPolicy_STREAM_RESTART_POLICY_UNSPECIFIED
}
...
type StreamConfig_builder struct {
	...
	RestartPolicy *StreamRestartPolicy
}
...
const file_gcommon_v1_queue_messages_stream_config_proto_rawDesc = "" +
	...
	"\x0erestart_policy\x18\t \x01(\x0e2%.gcommon.v1.queue.StreamRestartPolicyR\rrestartPolicyB\xc7\x01\n" +
	"\x14com.gcommon.v1.queueB\x11StreamConfigProtoP\x01Z2github.com/jdfalk/gcommon/sdks/go/gcommon/v1/queue\xa2\x02\x03GVQ\xaa\x02\x10Gcommon.V1.Queue\xca\x02\x10Gcommon\\V1\\Queue\xe2\x02\x1cGcommon\\V1\\Queue\\GPBMetadata\xea\x02\x12Gcommon::V1::Queue\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
func file_gcommon_v1_queue_messages_stream_config_proto_init() {
	...
	file_gcommon_v1_queue_enums_stream_restart_policy_proto_init()
	type x struct{}
