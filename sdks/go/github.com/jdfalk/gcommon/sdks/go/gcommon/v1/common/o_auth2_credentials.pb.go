...
// 	protoc        (unknown)
// source: gcommon/v1/common/messages/o_auth2_credentials.proto
...
func (x *OAuth2Credentials) Reset() {
	*x = OAuth2Credentials{}
	mi := &file_gcommon_v1_common_messages_o_auth2_credentials_proto_msgTypes[0]
...
var File_gcommon_v1_common_messages_o_auth2_credentials_proto protoreflect.FileDescriptor

const file_gcommon_v1_common_messages_o_auth2_credentials_proto_rawDesc = "" +
	"\n" +
	"4gcommon/v1/common/messages/o_auth2_credentials.proto\x12\x11gcommon.v1.common\x1a!google/protobuf/go_features.proto\"\x8c\x01\n" +
	"\x11OAuth2Credentials\x12\x12\n" +
	"\x04code\x18\x01 \x01(\tR\x04code\x12!\n" +
	"\fredirect_uri\x18\x02 \x01(\tR\vredirectUri\x12\x1b\n" +
	"\tclient_id\x18\x03 \x01(\tR\bclientId\x12#\n" +
	"\rclient_secret\x18\x04 \x01(\tR\fclientSecretB\xd2\x01\n" +
	"\x15com.gcommon.v1.commonB\x16OAuth2CredentialsProtoP\x01Z3github.com/jdfalk/gcommon/sdks/go/gcommon/v1/common\xa2\x02\x03GVC\xaa\x02\x11Gcommon.V1.Common\xca\x02\x11Gcommon\\V1\\Common\xe2\x02\x1dGcommon\\V1\\Common\\GPBMetadata\xea\x02\x13Gcommon::V1::Common\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
var file_gcommon_v1_common_messages_o_auth2_credentials_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_common_messages_o_auth2_credentials_proto_init() }
func file_gcommon_v1_common_messages_o_auth2_credentials_proto_init() {
	if File_gcommon_v1_common_messages_o_auth2_credentials_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_common_messages_o_auth2_credentials_proto_rawDesc), len(file_gcommon_v1_common_messages_o_auth2_credentials_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_common_messages_o_auth2_credentials_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_common_messages_o_auth2_credentials_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_common_messages_o_auth2_credentials_proto_msgTypes,
	}.Build()
	File_gcommon_v1_common_messages_o_auth2_credentials_proto = out.File
	file_gcommon_v1_common_messages_o_auth2_credentials_proto_goTypes = nil
	file_gcommon_v1_common_messages_o_auth2_credentials_proto_depIdxs = nil
}
