...
func (x *DatabaseIsolation) Reset() {
	*x = DatabaseIsolation{}
	mi := &file_gcommon_v1_organization_messages_database_isolation_proto_msgTypes[0]
...
var File_gcommon_v1_organization_messages_database_isolation_proto protoreflect.FileDescriptor

const file_gcommon_v1_organization_messages_database_isolation_proto_rawDesc = "" +
	"\n" +
	"9gcommon/v1/organization/messages/database_isolation.proto\x12\x17gcommon.v1.organization\x1a*gcommon/v1/common/messages/key_value.proto\x1a4gcommon/v1/organization/messages/backup_config.proto\x1a!google/protobuf/go_features.proto\"\xb5\x03\n" +
	...
	"\x15query_timeout_seconds\x18\b \x01(\x05R\x13queryTimeoutSecondsB\xf6\x01\n" +
...
func init() { file_gcommon_v1_organization_messages_database_isolation_proto_init() }
func file_gcommon_v1_organization_messages_database_isolation_proto_init() {
	if File_gcommon_v1_organization_messages_database_isolation_proto != nil {
		return
	}
	file_gcommon_v1_organization_messages_backup_config_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_organization_messages_database_isolation_proto_rawDesc), len(file_gcommon_v1_organization_messages_database_isolation_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_organization_messages_database_isolation_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_organization_messages_database_isolation_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_organization_messages_database_isolation_proto_msgTypes,
	}.Build()
	File_gcommon_v1_organization_messages_database_isolation_proto = out.File
	file_gcommon_v1_organization_messages_database_isolation_proto_goTypes = nil
	file_gcommon_v1_organization_messages_database_isolation_proto_depIdxs = nil
}
