...
func (HierarchyType) Descriptor() protoreflect.EnumDescriptor {
	return file_gcommon_v1_organization_enums_hierarchy_type_proto_enumTypes[0].Descriptor()
}

func (HierarchyType) Type() protoreflect.EnumType {
	return &file_gcommon_v1_organization_enums_hierarchy_type_proto_enumTypes[0]
}
...
var File_gcommon_v1_organization_enums_hierarchy_type_proto protoreflect.FileDescriptor

const file_gcommon_v1_organization_enums_hierarchy_type_proto_rawDesc = "" +
	"\n" +
	"2gcommon/v1/organization/enums/hierarchy_type.proto\x12\x17gcommon.v1.organization\x1a!google/protobuf/go_features.proto*\xf5\x01\n" +
	...
	"\x13HIERARCHY_TYPE_FLAT\x10\aB\xf2\x01\n" +
	"\x1bcom.gcommon.v1.organizationB\x12HierarchyTypeProtoP\x01Z9github.com/jdfalk/gcommon/sdks/go/gcommon/v1/organization\xa2\x02\x03GVO\xaa\x02\x17Gcommon.V1.Organization\xca\x02\x17Gcommon\\V1\\Organization\xe2\x02#Gcommon\\V1\\Organization\\GPBMetadata\xea\x02\x19Gcommon::V1::Organization\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
var file_gcommon_v1_organization_enums_hierarchy_type_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_organization_enums_hierarchy_type_proto_init() }
func file_gcommon_v1_organization_enums_hierarchy_type_proto_init() {
	if File_gcommon_v1_organization_enums_hierarchy_type_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_organization_enums_hierarchy_type_proto_rawDesc), len(file_gcommon_v1_organization_enums_hierarchy_type_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_organization_enums_hierarchy_type_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_organization_enums_hierarchy_type_proto_depIdxs,
		EnumInfos:         file_gcommon_v1_organization_enums_hierarchy_type_proto_enumTypes,
	}.Build()
	File_gcommon_v1_organization_enums_hierarchy_type_proto = out.File
	file_gcommon_v1_organization_enums_hierarchy_type_proto_goTypes = nil
	file_gcommon_v1_organization_enums_hierarchy_type_proto_depIdxs = nil
}
