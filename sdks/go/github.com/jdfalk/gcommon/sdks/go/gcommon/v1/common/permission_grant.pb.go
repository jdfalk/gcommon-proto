...
type PermissionGrant struct {
	...
	xxx_hidden_Scope           PermissionScope        `protobuf:"varint,5,opt,name=scope,enum=gcommon.v1.common.PermissionScope"`
...
func (x *PermissionGrant) Reset() {
	*x = PermissionGrant{}
	mi := &file_gcommon_v1_common_messages_permission_grant_proto_msgTypes[0]
...
var File_gcommon_v1_common_messages_permission_grant_proto protoreflect.FileDescriptor

const file_gcommon_v1_common_messages_permission_grant_proto_rawDesc = "" +
	"\n" +
	...
	"\x05scope\x18\x05 \x01(\x0e2\".gcommon.v1.common.PermissionScopeR\x05scope\x12=\n" +
	"\n" +
	...
	"\x12granted_by_user_id\x18\b \x01(\tR\x0fgrantedByUserId\x12P\n" +
	"\bmetadata\x18\t \x03(\v20.gcommon.v1.common.PermissionGrant.MetadataEntryB\x02(\x01R\bmetadata\x12\x16\n" +
	"\x06active\x18\n" +
	" \x01(\bR\x06active\x1a;\n" +
	"\rMetadataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\xd0\x01\n" +
	"\x15com.gcommon.v1.commonB\x14PermissionGrantProtoP\x01Z3github.com/jdfalk/gcommon/sdks/go/gcommon/v1/common\xa2\x02\x03GVC\xaa\x02\x11Gcommon.V1.Common\xca\x02\x11Gcommon\\V1\\Common\xe2\x02\x1dGcommon\\V1\\Common\\GPBMetadata\xea\x02\x13Gcommon::V1::Common\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_common_messages_permission_grant_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_gcommon_v1_common_messages_permission_grant_proto_goTypes = []any{
	(*PermissionGrant)(nil),       // 0: gcommon.v1.common.PermissionGrant
	nil,                           // 1: gcommon.v1.common.PermissionGrant.MetadataEntry
	(PermissionScope)(0),          // 2: gcommon.v1.common.PermissionScope
	(*timestamppb.Timestamp)(nil), // 3: google.protobuf.Timestamp
}
var file_gcommon_v1_common_messages_permission_grant_proto_depIdxs = []int32{
	2, // 0: gcommon.v1.common.PermissionGrant.scope:type_name -> gcommon.v1.common.PermissionScope
	3, // 1: gcommon.v1.common.PermissionGrant.created_at:type_name -> google.protobuf.Timestamp
	3, // 2: gcommon.v1.common.PermissionGrant.expires_at:type_name -> google.protobuf.Timestamp
	1, // 3: gcommon.v1.common.PermissionGrant.metadata:type_name -> gcommon.v1.common.PermissionGrant.MetadataEntry
...
func init() { file_gcommon_v1_common_messages_permission_grant_proto_init() }
func file_gcommon_v1_common_messages_permission_grant_proto_init() {
	if File_gcommon_v1_common_messages_permission_grant_proto != nil {
		return
	}
	file_gcommon_v1_common_enums_permission_scope_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_common_messages_permission_grant_proto_rawDesc), len(file_gcommon_v1_common_messages_permission_grant_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_common_messages_permission_grant_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_common_messages_permission_grant_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_common_messages_permission_grant_proto_msgTypes,
	}.Build()
	File_gcommon_v1_common_messages_permission_grant_proto = out.File
	file_gcommon_v1_common_messages_permission_grant_proto_goTypes = nil
	file_gcommon_v1_common_messages_permission_grant_proto_depIdxs = nil
}
