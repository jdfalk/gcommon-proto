...
// 	protoc        (unknown)
// source: gcommon/v1/metrics/messages/record_summary_response.proto
...
func (x *RecordSummaryResponse) Reset() {
	*x = RecordSummaryResponse{}
	mi := &file_gcommon_v1_metrics_messages_record_summary_response_proto_msgTypes[0]
...
var File_gcommon_v1_metrics_messages_record_summary_response_proto protoreflect.FileDescriptor

const file_gcommon_v1_metrics_messages_record_summary_response_proto_rawDesc = "" +
	"\n" +
	"9gcommon/v1/metrics/messages/record_summary_response.proto\x12\x12gcommon.v1.metrics\x1a&gcommon/v1/common/messages/error.proto\x1a1gcommon/v1/metrics/messages/recording_stats.proto\x1a0gcommon/v1/metrics/messages/summary_metric.proto\x1a!google/protobuf/go_features.proto\"\xbc\x01\n" +
...
var file_gcommon_v1_metrics_messages_record_summary_response_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_metrics_messages_record_summary_response_proto_goTypes = []any{
...
func init() { file_gcommon_v1_metrics_messages_record_summary_response_proto_init() }
func file_gcommon_v1_metrics_messages_record_summary_response_proto_init() {
	if File_gcommon_v1_metrics_messages_record_summary_response_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_metrics_messages_record_summary_response_proto_rawDesc), len(file_gcommon_v1_metrics_messages_record_summary_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_metrics_messages_record_summary_response_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_metrics_messages_record_summary_response_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_metrics_messages_record_summary_response_proto_msgTypes,
	}.Build()
	File_gcommon_v1_metrics_messages_record_summary_response_proto = out.File
	file_gcommon_v1_metrics_messages_record_summary_response_proto_goTypes = nil
	file_gcommon_v1_metrics_messages_record_summary_response_proto_depIdxs = nil
}
