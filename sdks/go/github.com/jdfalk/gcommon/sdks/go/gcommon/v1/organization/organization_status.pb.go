...
func (OrganizationStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_gcommon_v1_organization_enums_organization_status_proto_enumTypes[0].Descriptor()
}

func (OrganizationStatus) Type() protoreflect.EnumType {
	return &file_gcommon_v1_organization_enums_organization_status_proto_enumTypes[0]
}
...
var File_gcommon_v1_organization_enums_organization_status_proto protoreflect.FileDescriptor

const file_gcommon_v1_organization_enums_organization_status_proto_rawDesc = "" +
	"\n" +
	"7gcommon/v1/organization/enums/organization_status.proto\x12\x17gcommon.v1.organization\x1a!google/protobuf/go_features.proto*\x82\x02\n" +
...
var file_gcommon_v1_organization_enums_organization_status_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_organization_enums_organization_status_proto_init() }
func file_gcommon_v1_organization_enums_organization_status_proto_init() {
	if File_gcommon_v1_organization_enums_organization_status_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_organization_enums_organization_status_proto_rawDesc), len(file_gcommon_v1_organization_enums_organization_status_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_organization_enums_organization_status_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_organization_enums_organization_status_proto_depIdxs,
		EnumInfos:         file_gcommon_v1_organization_enums_organization_status_proto_enumTypes,
	}.Build()
	File_gcommon_v1_organization_enums_organization_status_proto = out.File
	file_gcommon_v1_organization_enums_organization_status_proto_goTypes = nil
	file_gcommon_v1_organization_enums_organization_status_proto_depIdxs = nil
}
