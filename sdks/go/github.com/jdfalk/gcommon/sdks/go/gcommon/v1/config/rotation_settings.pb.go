...
type RotationSettings struct {
	...
	xxx_hidden_Frequency              RotationFrequency      `protobuf:"varint,2,opt,name=frequency,enum=gcommon.v1.config.RotationFrequency"`
...
func (x *RotationSettings) Reset() {
	*x = RotationSettings{}
	mi := &file_gcommon_v1_config_messages_rotation_settings_proto_msgTypes[0]
...
func (x *RotationSettings) SetFrequency(v RotationFrequency) {
...
func (x *RotationSettings) ClearFrequency() {
	...
	x.xxx_hidden_Frequency = RotationFrequency_ROTATION_FREQUENCY_UNSPECIFIED
}
...
var File_gcommon_v1_config_messages_rotation_settings_proto protoreflect.FileDescriptor

const file_gcommon_v1_config_messages_rotation_settings_proto_rawDesc = "" +
	"\n" +
	"2gcommon/v1/config/messages/rotation_settings.proto\x12\x11gcommon.v1.config\x1a0gcommon/v1/config/enums/rotation_frequency.proto\x1a/gcommon/v1/config/messages/rotation_event.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x85\x04\n" +
	...
	" \x03(\v2 .gcommon.v1.config.RotationEventR\x0frotationHistoryB\xd1\x01\n" +
	"\x15com.gcommon.v1.configB\x15RotationSettingsProtoP\x01Z3github.com/jdfalk/gcommon/sdks/go/gcommon/v1/config\xa2\x02\x03GVC\xaa\x02\x11Gcommon.V1.Config\xca\x02\x11Gcommon\\V1\\Config\xe2\x02\x1dGcommon\\V1\\Config\\GPBMetadata\xea\x02\x13Gcommon::V1::Config\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_config_messages_rotation_settings_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_config_messages_rotation_settings_proto_goTypes = []any{
...
var file_gcommon_v1_config_messages_rotation_settings_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_config_messages_rotation_settings_proto_init() }
func file_gcommon_v1_config_messages_rotation_settings_proto_init() {
	if File_gcommon_v1_config_messages_rotation_settings_proto != nil {
		return
	}
	file_gcommon_v1_config_enums_rotation_frequency_proto_init()
	file_gcommon_v1_config_messages_rotation_event_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_config_messages_rotation_settings_proto_rawDesc), len(file_gcommon_v1_config_messages_rotation_settings_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_config_messages_rotation_settings_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_config_messages_rotation_settings_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_config_messages_rotation_settings_proto_msgTypes,
	}.Build()
	File_gcommon_v1_config_messages_rotation_settings_proto = out.File
	file_gcommon_v1_config_messages_rotation_settings_proto_goTypes = nil
	file_gcommon_v1_config_messages_rotation_settings_proto_depIdxs = nil
}
