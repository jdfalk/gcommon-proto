...
// 	protoc        (unknown)
// source: gcommon/v1/config/messages/batching_settings.proto
...
func (x *BatchingSettings) Reset() {
	*x = BatchingSettings{}
	mi := &file_gcommon_v1_config_messages_batching_settings_proto_msgTypes[0]
...
var File_gcommon_v1_config_messages_batching_settings_proto protoreflect.FileDescriptor

const file_gcommon_v1_config_messages_batching_settings_proto_rawDesc = "" +
	"\n" +
	"2gcommon/v1/config/messages/batching_settings.proto\x12\x11gcommon.v1.config\x1a!google/protobuf/go_features.proto\"\x97\x01\n" +
	...
	"\fgrouping_key\x18\x04 \x01(\tR\vgroupingKeyB\xd1\x01\n" +
	"\x15com.gcommon.v1.configB\x15BatchingSettingsProtoP\x01Z3github.com/jdfalk/gcommon/sdks/go/gcommon/v1/config\xa2\x02\x03GVC\xaa\x02\x11Gcommon.V1.Config\xca\x02\x11Gcommon\\V1\\Config\xe2\x02\x1dGcommon\\V1\\Config\\GPBMetadata\xea\x02\x13Gcommon::V1::Config\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
var file_gcommon_v1_config_messages_batching_settings_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_config_messages_batching_settings_proto_init() }
func file_gcommon_v1_config_messages_batching_settings_proto_init() {
	if File_gcommon_v1_config_messages_batching_settings_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_config_messages_batching_settings_proto_rawDesc), len(file_gcommon_v1_config_messages_batching_settings_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_config_messages_batching_settings_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_config_messages_batching_settings_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_config_messages_batching_settings_proto_msgTypes,
	}.Build()
	File_gcommon_v1_config_messages_batching_settings_proto = out.File
	file_gcommon_v1_config_messages_batching_settings_proto_goTypes = nil
	file_gcommon_v1_config_messages_batching_settings_proto_depIdxs = nil
}
