...
func (x *GetProviderStatsResponse) Reset() {
	*x = GetProviderStatsResponse{}
	mi := &file_gcommon_v1_metrics_messages_get_provider_stats_response_proto_msgTypes[0]
...
var File_gcommon_v1_metrics_messages_get_provider_stats_response_proto protoreflect.FileDescriptor

const file_gcommon_v1_metrics_messages_get_provider_stats_response_proto_rawDesc = "" +
	"\n" +
	"=gcommon/v1/metrics/messages/get_provider_stats_response.proto\x12\x12gcommon.v1.metrics\x1a&gcommon/v1/common/messages/error.proto\x1a5gcommon/v1/metrics/messages/provider_statistics.proto\x1a,gcommon/v1/metrics/messages/time_range.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xed\x02\n" +
	...
	"\bwarnings\x18\a \x03(\tR\bwarningsB\xdf\x01\n" +
	"\x16com.gcommon.v1.metricsB\x1dGetProviderStatsResponseProtoP\x01Z4github.com/jdfalk/gcommon/sdks/go/gcommon/v1/metrics\xa2\x02\x03GVM\xaa\x02\x12Gcommon.V1.Metrics\xca\x02\x12Gcommon\\V1\\Metrics\xe2\x02\x1eGcommon\\V1\\Metrics\\GPBMetadata\xea\x02\x14Gcommon::V1::Metrics\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
var file_gcommon_v1_metrics_messages_get_provider_stats_response_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_metrics_messages_get_provider_stats_response_proto_init() }
func file_gcommon_v1_metrics_messages_get_provider_stats_response_proto_init() {
	if File_gcommon_v1_metrics_messages_get_provider_stats_response_proto != nil {
		return
	}
	file_gcommon_v1_metrics_messages_provider_statistics_proto_init()
	file_gcommon_v1_metrics_messages_time_range_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_metrics_messages_get_provider_stats_response_proto_rawDesc), len(file_gcommon_v1_metrics_messages_get_provider_stats_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_metrics_messages_get_provider_stats_response_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_metrics_messages_get_provider_stats_response_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_metrics_messages_get_provider_stats_response_proto_msgTypes,
	}.Build()
	File_gcommon_v1_metrics_messages_get_provider_stats_response_proto = out.File
	file_gcommon_v1_metrics_messages_get_provider_stats_response_proto_goTypes = nil
	file_gcommon_v1_metrics_messages_get_provider_stats_response_proto_depIdxs = nil
}
