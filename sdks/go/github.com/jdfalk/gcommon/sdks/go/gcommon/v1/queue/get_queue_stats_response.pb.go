...
type GetQueueStatsResponse struct {
	...
	xxx_hidden_ErrorStats         *metrics.MetricsErrorStats `protobuf:"bytes,6,opt,name=error_stats,json=errorStats"`
...
func (x *GetQueueStatsResponse) Reset() {
	*x = GetQueueStatsResponse{}
	mi := &file_gcommon_v1_queue_messages_get_queue_stats_response_proto_msgTypes[0]
...
func (x *GetQueueStatsResponse) GetErrorStats() *metrics.MetricsErrorStats {
	if x != nil {
...
func (x *GetQueueStatsResponse) SetErrorStats(v *metrics.MetricsErrorStats) {
...
type GetQueueStatsResponse_builder struct {
	...
	ErrorStats *metrics.MetricsErrorStats
	// Performance metrics
...
var File_gcommon_v1_queue_messages_get_queue_stats_response_proto protoreflect.FileDescriptor

const file_gcommon_v1_queue_messages_get_queue_stats_response_proto_rawDesc = "" +
	"\n" +
	"8gcommon/v1/queue/messages/get_queue_stats_response.proto\x12\x10gcommon.v1.queue\x1a2gcommon/v1/common/messages/response_metadata.proto\x1a-gcommon/v1/metrics/messages/error_stats.proto\x1a.gcommon/v1/queue/messages/consumer_stats.proto\x1a0gcommon/v1/queue/messages/historical_stats.proto\x1a3gcommon/v1/queue/messages/performance_metrics.proto\x1a+gcommon/v1/queue/messages/queue_stats.proto\x1a3gcommon/v1/queue/messages/queue_stats_summary.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xca\x04\n" +
	...
	"\x10historical_stats\x18\x05 \x01(\v2!.gcommon.v1.queue.HistoricalStatsR\x0fhistoricalStats\x12F\n" +
	...
	"\fgenerated_at\x18\b \x01(\v2\x1a.google.protobuf.TimestampR\vgeneratedAtB\xd0\x01\n" +
	"\x14com.gcommon.v1.queueB\x1aGetQueueStatsResponseProtoP\x01Z2github.com/jdfalk/gcommon/sdks/go/gcommon/v1/queue\xa2\x02\x03GVQ\xaa\x02\x10Gcommon.V1.Queue\xca\x02\x10Gcommon\\V1\\Queue\xe2\x02\x1cGcommon\\V1\\Queue\\GPBMetadata\xea\x02\x12Gcommon::V1::Queue\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
var file_gcommon_v1_queue_messages_get_queue_stats_response_proto_goTypes = []any{
	...
	(*metrics.MetricsErrorStats)(nil), // 6: gcommon.v1.metrics.MetricsErrorStats
	(*PerformanceMetrics)(nil),        // 7: gcommon.v1.queue.PerformanceMetrics
	(*timestamppb.Timestamp)(nil),     // 8: google.protobuf.Timestamp
}
var file_gcommon_v1_queue_messages_get_queue_stats_response_proto_depIdxs = []int32{
	...
	6, // 5: gcommon.v1.queue.GetQueueStatsResponse.error_stats:type_name -> gcommon.v1.metrics.MetricsErrorStats
...
func init() { file_gcommon_v1_queue_messages_get_queue_stats_response_proto_init() }
func file_gcommon_v1_queue_messages_get_queue_stats_response_proto_init() {
	if File_gcommon_v1_queue_messages_get_queue_stats_response_proto != nil {
		return
	}
	file_gcommon_v1_queue_messages_consumer_stats_proto_init()
	file_gcommon_v1_queue_messages_historical_stats_proto_init()
	file_gcommon_v1_queue_messages_performance_metrics_proto_init()
	file_gcommon_v1_queue_messages_queue_stats_proto_init()
	file_gcommon_v1_queue_messages_queue_stats_summary_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_queue_messages_get_queue_stats_response_proto_rawDesc), len(file_gcommon_v1_queue_messages_get_queue_stats_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_queue_messages_get_queue_stats_response_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_queue_messages_get_queue_stats_response_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_queue_messages_get_queue_stats_response_proto_msgTypes,
	}.Build()
	File_gcommon_v1_queue_messages_get_queue_stats_response_proto = out.File
	file_gcommon_v1_queue_messages_get_queue_stats_response_proto_goTypes = nil
	file_gcommon_v1_queue_messages_get_queue_stats_response_proto_depIdxs = nil
}
