...
func (x *ExecuteBatchResponse) GetStats() *metrics.MetricsBatchStats {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 1) {
			if protoimpl.X.AtomicCheckPointerIsNil(&x.xxx_hidden_Stats) {
				protoimpl.X.UnmarshalField(x, 2)
			}
			var rv *metrics.MetricsBatchStats
...
func (x *ExecuteBatchResponse) SetStats(v *metrics.MetricsBatchStats) {
...
func (x *ExecuteBatchResponse) ClearStats() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 1)
	protoimpl.X.AtomicSetPointer(&x.xxx_hidden_Stats, (*metrics.MetricsBatchStats)(nil))
}
...
const file_gcommon_v1_database_messages_execute_batch_response_proto_rawDesc = "" +
	...
	"\x05error\x18\x03 \x01(\v2\x18.gcommon.v1.common.ErrorB\x02(\x01R\x05errorB\xe1\x01\n" +
	"\x17com.gcommon.v1.databaseB\x19ExecuteBatchResponseProtoP\x01Z5github.com/jdfalk/gcommon/sdks/go/gcommon/v1/database\xa2\x02\x03GVD\xaa\x02\x13Gcommon.V1.Database\xca\x02\x13Gcommon\\V1\\Database\xe2\x02\x1fGcommon\\V1\\Database\\GPBMetadata\xea\x02\x15Gcommon::V1::Database\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
