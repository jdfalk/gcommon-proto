...
func (NotificationType) Descriptor() protoreflect.EnumDescriptor {
	return file_gcommon_v1_metrics_enums_notification_type_proto_enumTypes[0].Descriptor()
}

func (NotificationType) Type() protoreflect.EnumType {
	return &file_gcommon_v1_metrics_enums_notification_type_proto_enumTypes[0]
}
...
var File_gcommon_v1_metrics_enums_notification_type_proto protoreflect.FileDescriptor

const file_gcommon_v1_metrics_enums_notification_type_proto_rawDesc = "" +
	"\n" +
	...
	"\x17NOTIFICATION_TYPE_VOICE\x10\rB\xd7\x01\n" +
	"\x16com.gcommon.v1.metricsB\x15NotificationTypeProtoP\x01Z4github.com/jdfalk/gcommon/sdks/go/gcommon/v1/metrics\xa2\x02\x03GVM\xaa\x02\x12Gcommon.V1.Metrics\xca\x02\x12Gcommon\\V1\\Metrics\xe2\x02\x1eGcommon\\V1\\Metrics\\GPBMetadata\xea\x02\x14Gcommon::V1::Metrics\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
var file_gcommon_v1_metrics_enums_notification_type_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_metrics_enums_notification_type_proto_init() }
func file_gcommon_v1_metrics_enums_notification_type_proto_init() {
	if File_gcommon_v1_metrics_enums_notification_type_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_metrics_enums_notification_type_proto_rawDesc), len(file_gcommon_v1_metrics_enums_notification_type_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_metrics_enums_notification_type_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_metrics_enums_notification_type_proto_depIdxs,
		EnumInfos:         file_gcommon_v1_metrics_enums_notification_type_proto_enumTypes,
	}.Build()
	File_gcommon_v1_metrics_enums_notification_type_proto = out.File
	file_gcommon_v1_metrics_enums_notification_type_proto_goTypes = nil
	file_gcommon_v1_metrics_enums_notification_type_proto_depIdxs = nil
}
