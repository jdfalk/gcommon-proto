...
// 	protoc        (unknown)
// source: gcommon/v1/queue/messages/update_topic_config_request.proto
...
func (x *UpdateTopicConfigRequest) Reset() {
	*x = UpdateTopicConfigRequest{}
	mi := &file_gcommon_v1_queue_messages_update_topic_config_request_proto_msgTypes[0]
...
var File_gcommon_v1_queue_messages_update_topic_config_request_proto protoreflect.FileDescriptor

const file_gcommon_v1_queue_messages_update_topic_config_request_proto_rawDesc = "" +
	"\n" +
	";gcommon/v1/queue/messages/update_topic_config_request.proto\x12\x10gcommon.v1.queue\x1a,gcommon/v1/queue/messages/topic_config.proto\x1a!google/protobuf/go_features.proto\"\xe3\x01\n" +
	...
	"\x14com.gcommon.v1.queueB\x1dUpdateTopicConfigRequestProtoP\x01Z2github.com/jdfalk/gcommon/sdks/go/gcommon/v1/queue\xa2\x02\x03GVQ\xaa\x02\x10Gcommon.V1.Queue\xca\x02\x10Gcommon\\V1\\Queue\xe2\x02\x1cGcommon\\V1\\Queue\\GPBMetadata\xea\x02\x12Gcommon::V1::Queue\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_queue_messages_update_topic_config_request_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_queue_messages_update_topic_config_request_proto_goTypes = []any{
	(*UpdateTopicConfigRequest)(nil), // 0: gcommon.v1.queue.UpdateTopicConfigRequest
	(*TopicConfig)(nil),              // 1: gcommon.v1.queue.TopicConfig
}
var file_gcommon_v1_queue_messages_update_topic_config_request_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_queue_messages_update_topic_config_request_proto_init() }
func file_gcommon_v1_queue_messages_update_topic_config_request_proto_init() {
	if File_gcommon_v1_queue_messages_update_topic_config_request_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_queue_messages_update_topic_config_request_proto_rawDesc), len(file_gcommon_v1_queue_messages_update_topic_config_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_queue_messages_update_topic_config_request_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_queue_messages_update_topic_config_request_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_queue_messages_update_topic_config_request_proto_msgTypes,
	}.Build()
	File_gcommon_v1_queue_messages_update_topic_config_request_proto = out.File
	file_gcommon_v1_queue_messages_update_topic_config_request_proto_goTypes = nil
	file_gcommon_v1_queue_messages_update_topic_config_request_proto_depIdxs = nil
}
