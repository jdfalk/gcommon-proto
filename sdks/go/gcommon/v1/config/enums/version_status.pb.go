...
func (VersionStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_gcommon_v1_config_enums_version_status_proto_enumTypes[0].Descriptor()
}

func (VersionStatus) Type() protoreflect.EnumType {
	return &file_gcommon_v1_config_enums_version_status_proto_enumTypes[0]
}
...
var File_gcommon_v1_config_enums_version_status_proto protoreflect.FileDescriptor

const file_gcommon_v1_config_enums_version_status_proto_rawDesc = "" +
	"\n" +
	...
	"\x18VERSION_STATUS_CANCELLED\x10\bB\xd4\x01\n" +
	"\x15com.gcommon.v1.configB\x12VersionStatusProtoP\x01Z9github.com/jdfalk/gcommon/sdks/go/gcommon/v1/config/enums\xa2\x02\x03GVC\xaa\x02\x11Gcommon.V1.Config\xca\x02\x11Gcommon\\V1\\Config\xe2\x02\x1dGcommon\\V1\\Config\\GPBMetadata\xea\x02\x13Gcommon::V1::Config\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_config_enums_version_status_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_gcommon_v1_config_enums_version_status_proto_goTypes = []any{
	(VersionStatus)(0), // 0: gcommon.v1.config.VersionStatus
}
var file_gcommon_v1_config_enums_version_status_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_config_enums_version_status_proto_init() }
func file_gcommon_v1_config_enums_version_status_proto_init() {
	if File_gcommon_v1_config_enums_version_status_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_config_enums_version_status_proto_rawDesc), len(file_gcommon_v1_config_enums_version_status_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_config_enums_version_status_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_config_enums_version_status_proto_depIdxs,
		EnumInfos:         file_gcommon_v1_config_enums_version_status_proto_enumTypes,
	}.Build()
	File_gcommon_v1_config_enums_version_status_proto = out.File
	file_gcommon_v1_config_enums_version_status_proto_goTypes = nil
	file_gcommon_v1_config_enums_version_status_proto_depIdxs = nil
}
