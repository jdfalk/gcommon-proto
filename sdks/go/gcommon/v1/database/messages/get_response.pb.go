...
// 	protoc        (unknown)
// source: gcommon/v1/database/messages/get_response.proto
...
func (x *GetResponse) Reset() {
	*x = GetResponse{}
	mi := &file_gcommon_v1_database_messages_get_response_proto_msgTypes[0]
...
var File_gcommon_v1_database_messages_get_response_proto protoreflect.FileDescriptor

const file_gcommon_v1_database_messages_get_response_proto_rawDesc = "" +
	"\n" +
	...
	"\tcache_hit\x18\x03 \x01(\bR\bcacheHitB\xe1\x01\n" +
	"\x17com.gcommon.v1.databaseB\x10GetResponseProtoP\x01Z>github.com/jdfalk/gcommon/sdks/go/gcommon/v1/database/messages\xa2\x02\x03GVD\xaa\x02\x13Gcommon.V1.Database\xca\x02\x13Gcommon\\V1\\Database\xe2\x02\x1fGcommon\\V1\\Database\\GPBMetadata\xea\x02\x15Gcommon::V1::Database\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
var file_gcommon_v1_database_messages_get_response_proto_goTypes = []any{
	(*GetResponse)(nil), // 0: gcommon.v1.database.GetResponse
	(*CacheEntry)(nil),  // 1: gcommon.v1.database.CacheEntry
}
var file_gcommon_v1_database_messages_get_response_proto_depIdxs = []int32{
	1, // 0: gcommon.v1.database.GetResponse.entry:type_name -> gcommon.v1.database.CacheEntry
...
func init() { file_gcommon_v1_database_messages_get_response_proto_init() }
func file_gcommon_v1_database_messages_get_response_proto_init() {
	if File_gcommon_v1_database_messages_get_response_proto != nil {
		return
	}
	file_gcommon_v1_database_messages_cache_entry_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_database_messages_get_response_proto_rawDesc), len(file_gcommon_v1_database_messages_get_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_database_messages_get_response_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_database_messages_get_response_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_database_messages_get_response_proto_msgTypes,
	}.Build()
	File_gcommon_v1_database_messages_get_response_proto = out.File
	file_gcommon_v1_database_messages_get_response_proto_goTypes = nil
	file_gcommon_v1_database_messages_get_response_proto_depIdxs = nil
}
