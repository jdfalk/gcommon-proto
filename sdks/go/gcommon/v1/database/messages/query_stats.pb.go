...
// 	protoc        (unknown)
// source: gcommon/v1/database/messages/query_stats.proto
...
func (x *DatabaseQueryStats) Reset() {
	*x = DatabaseQueryStats{}
	mi := &file_gcommon_v1_database_messages_query_stats_proto_msgTypes[0]
...
var File_gcommon_v1_database_messages_query_stats_proto protoreflect.FileDescriptor

const file_gcommon_v1_database_messages_query_stats_proto_rawDesc = "" +
	"\n" +
	".gcommon/v1/database/messages/query_stats.proto\x12\x13gcommon.v1.database\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\"\xde\x01\n" +
	...
	"\rcost_estimate\x18\x05 \x01(\x01R\fcostEstimateB\xe0\x01\n" +
	"\x17com.gcommon.v1.databaseB\x0fQueryStatsProtoP\x01Z>github.com/jdfalk/gcommon/sdks/go/gcommon/v1/database/messages\xa2\x02\x03GVD\xaa\x02\x13Gcommon.V1.Database\xca\x02\x13Gcommon\\V1\\Database\xe2\x02\x1fGcommon\\V1\\Database\\GPBMetadata\xea\x02\x15Gcommon::V1::Database\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_database_messages_query_stats_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_database_messages_query_stats_proto_goTypes = []any{
	(*DatabaseQueryStats)(nil),  // 0: gcommon.v1.database.DatabaseQueryStats
	(*durationpb.Duration)(nil), // 1: google.protobuf.Duration
}
var file_gcommon_v1_database_messages_query_stats_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_database_messages_query_stats_proto_init() }
func file_gcommon_v1_database_messages_query_stats_proto_init() {
	if File_gcommon_v1_database_messages_query_stats_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_database_messages_query_stats_proto_rawDesc), len(file_gcommon_v1_database_messages_query_stats_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_database_messages_query_stats_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_database_messages_query_stats_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_database_messages_query_stats_proto_msgTypes,
	}.Build()
	File_gcommon_v1_database_messages_query_stats_proto = out.File
	file_gcommon_v1_database_messages_query_stats_proto_goTypes = nil
	file_gcommon_v1_database_messages_query_stats_proto_depIdxs = nil
}
