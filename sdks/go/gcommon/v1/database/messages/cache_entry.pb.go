...
func (x *CacheEntry) Reset() {
	*x = CacheEntry{}
	mi := &file_gcommon_v1_database_messages_cache_entry_proto_msgTypes[0]
...
var File_gcommon_v1_database_messages_cache_entry_proto protoreflect.FileDescriptor

const file_gcommon_v1_database_messages_cache_entry_proto_rawDesc = "" +
	"\n" +
	...
	"\n" +
	"size_bytes\x18\a \x01(\x03R\tsizeBytes\x12M\n" +
	"\bmetadata\x18\b \x03(\v2-.gcommon.v1.database.CacheEntry.MetadataEntryB\x02(\x01R\bmetadata\x12\x1c\n" +
	"\tnamespace\x18\t \x01(\tR\tnamespace\x1a;\n" +
	"\rMetadataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\xe0\x01\n" +
	"\x17com.gcommon.v1.databaseB\x0fCacheEntryProtoP\x01Z>github.com/jdfalk/gcommon/sdks/go/gcommon/v1/database/messages\xa2\x02\x03GVD\xaa\x02\x13Gcommon.V1.Database\xca\x02\x13Gcommon\\V1\\Database\xe2\x02\x1fGcommon\\V1\\Database\\GPBMetadata\xea\x02\x15Gcommon::V1::Database\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_database_messages_cache_entry_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_gcommon_v1_database_messages_cache_entry_proto_goTypes = []any{
	(*CacheEntry)(nil),            // 0: gcommon.v1.database.CacheEntry
	nil,                           // 1: gcommon.v1.database.CacheEntry.MetadataEntry
	(*anypb.Any)(nil),             // 2: google.protobuf.Any
	(*timestamppb.Timestamp)(nil), // 3: google.protobuf.Timestamp
}
var file_gcommon_v1_database_messages_cache_entry_proto_depIdxs = []int32{
	2, // 0: gcommon.v1.database.CacheEntry.value:type_name -> google.protobuf.Any
	3, // 1: gcommon.v1.database.CacheEntry.created_at:type_name -> google.protobuf.Timestamp
	3, // 2: gcommon.v1.database.CacheEntry.last_accessed_at:type_name -> google.protobuf.Timestamp
	3, // 3: gcommon.v1.database.CacheEntry.expires_at:type_name -> google.protobuf.Timestamp
	1, // 4: gcommon.v1.database.CacheEntry.metadata:type_name -> gcommon.v1.database.CacheEntry.MetadataEntry
...
func init() { file_gcommon_v1_database_messages_cache_entry_proto_init() }
func file_gcommon_v1_database_messages_cache_entry_proto_init() {
	if File_gcommon_v1_database_messages_cache_entry_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_database_messages_cache_entry_proto_rawDesc), len(file_gcommon_v1_database_messages_cache_entry_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_database_messages_cache_entry_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_database_messages_cache_entry_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_database_messages_cache_entry_proto_msgTypes,
	}.Build()
	File_gcommon_v1_database_messages_cache_entry_proto = out.File
	file_gcommon_v1_database_messages_cache_entry_proto_goTypes = nil
	file_gcommon_v1_database_messages_cache_entry_proto_depIdxs = nil
}
