...
// 	protoc        (unknown)
// source: gcommon/v1/database/messages/rollback_transaction_request.proto
...
func (x *RollbackTransactionRequest) Reset() {
	*x = RollbackTransactionRequest{}
	mi := &file_gcommon_v1_database_messages_rollback_transaction_request_proto_msgTypes[0]
...
var File_gcommon_v1_database_messages_rollback_transaction_request_proto protoreflect.FileDescriptor

const file_gcommon_v1_database_messages_rollback_transaction_request_proto_rawDesc = "" +
	"\n" +
	"?gcommon/v1/database/messages/rollback_transaction_request.proto\x12\x13gcommon.v1.database\x1a1gcommon/v1/common/messages/request_metadata.proto\x1a!google/protobuf/go_features.proto\"\x87\x01\n" +
	"\x1aRollbackTransactionRequest\x12%\n" +
	"\x0etransaction_id\x18\x01 \x01(\tR\rtransactionId\x12B\n" +
	"\bmetadata\x18\x02 \x01(\v2\".gcommon.v1.common.RequestMetadataB\x02(\x01R\bmetadataB\xf0\x01\n" +
	"\x17com.gcommon.v1.databaseB\x1fRollbackTransactionRequestProtoP\x01Z>github.com/jdfalk/gcommon/sdks/go/gcommon/v1/database/messages\xa2\x02\x03GVD\xaa\x02\x13Gcommon.V1.Database\xca\x02\x13Gcommon\\V1\\Database\xe2\x02\x1fGcommon\\V1\\Database\\GPBMetadata\xea\x02\x15Gcommon::V1::Database\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
func init() { file_gcommon_v1_database_messages_rollback_transaction_request_proto_init() }
func file_gcommon_v1_database_messages_rollback_transaction_request_proto_init() {
	if File_gcommon_v1_database_messages_rollback_transaction_request_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_database_messages_rollback_transaction_request_proto_rawDesc), len(file_gcommon_v1_database_messages_rollback_transaction_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_database_messages_rollback_transaction_request_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_database_messages_rollback_transaction_request_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_database_messages_rollback_transaction_request_proto_msgTypes,
	}.Build()
	File_gcommon_v1_database_messages_rollback_transaction_request_proto = out.File
	file_gcommon_v1_database_messages_rollback_transaction_request_proto_goTypes = nil
	file_gcommon_v1_database_messages_rollback_transaction_request_proto_depIdxs = nil
}
