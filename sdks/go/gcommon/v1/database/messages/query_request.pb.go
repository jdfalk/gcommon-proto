...
func (x *QueryRequest) GetMetadata() *messages.RequestMetadata {
	if x != nil {
...
func (x *QueryRequest) SetMetadata(v *messages.RequestMetadata) {
...
const file_gcommon_v1_database_messages_query_request_proto_rawDesc = "" +
	...
	"\x0etransaction_id\x18\x06 \x01(\tR\rtransactionIdB\xe2\x01\n" +
	"\x17com.gcommon.v1.databaseB\x11QueryRequestProtoP\x01Z>github.com/jdfalk/gcommon/sdks/go/gcommon/v1/database/messages\xa2\x02\x03GVD\xaa\x02\x13Gcommon.V1.Database\xca\x02\x13Gcommon\\V1\\Database\xe2\x02\x1fGcommon\\V1\\Database\\GPBMetadata\xea\x02\x15Gcommon::V1::Database\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
