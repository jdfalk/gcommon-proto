...
func (x *BackupSource) Reset() {
	*x = BackupSource{}
	mi := &file_gcommon_v1_queue_messages_backup_source_proto_msgTypes[0]
...
var File_gcommon_v1_queue_messages_backup_source_proto protoreflect.FileDescriptor

const file_gcommon_v1_queue_messages_backup_source_proto_rawDesc = "" +
	"\n" +
	"-gcommon/v1/queue/messages/backup_source.proto\x12\x10gcommon.v1.queue\x1a/gcommon/v1/queue/messages/encryption_info.proto\x1a3gcommon/v1/queue/messages/original_queue_info.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xad\x04\n" +
	...
	"\x14com.gcommon.v1.queueB\x11BackupSourceProtoP\x01Z;github.com/jdfalk/gcommon/sdks/go/gcommon/v1/queue/messages\xa2\x02\x03GVQ\xaa\x02\x10Gcommon.V1.Queue\xca\x02\x10Gcommon\\V1\\Queue\xe2\x02\x1cGcommon\\V1\\Queue\\GPBMetadata\xea\x02\x12Gcommon::V1::Queue\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_queue_messages_backup_source_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_gcommon_v1_queue_messages_backup_source_proto_goTypes = []any{
...
var file_gcommon_v1_queue_messages_backup_source_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_queue_messages_backup_source_proto_init() }
func file_gcommon_v1_queue_messages_backup_source_proto_init() {
	if File_gcommon_v1_queue_messages_backup_source_proto != nil {
		return
	}
	file_gcommon_v1_queue_messages_encryption_info_proto_init()
	file_gcommon_v1_queue_messages_original_queue_info_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_queue_messages_backup_source_proto_rawDesc), len(file_gcommon_v1_queue_messages_backup_source_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_queue_messages_backup_source_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_queue_messages_backup_source_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_queue_messages_backup_source_proto_msgTypes,
	}.Build()
	File_gcommon_v1_queue_messages_backup_source_proto = out.File
	file_gcommon_v1_queue_messages_backup_source_proto_goTypes = nil
	file_gcommon_v1_queue_messages_backup_source_proto_depIdxs = nil
}
