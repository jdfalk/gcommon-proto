...
// 	protoc        (unknown)
// source: gcommon/v1/queue/messages/schema_validation.proto
...
func (x *SchemaValidation) Reset() {
	*x = SchemaValidation{}
	mi := &file_gcommon_v1_queue_messages_schema_validation_proto_msgTypes[0]
...
var File_gcommon_v1_queue_messages_schema_validation_proto protoreflect.FileDescriptor

const file_gcommon_v1_queue_messages_schema_validation_proto_rawDesc = "" +
	"\n" +
	"1gcommon/v1/queue/messages/schema_validation.proto\x12\x10gcommon.v1.queue\x1a!google/protobuf/go_features.proto\"\xc7\x01\n" +
	...
	"\x14compatibility_status\x18\x04 \x01(\tR\x13compatibilityStatusB\xd4\x01\n" +
	"\x14com.gcommon.v1.queueB\x15SchemaValidationProtoP\x01Z;github.com/jdfalk/gcommon/sdks/go/gcommon/v1/queue/messages\xa2\x02\x03GVQ\xaa\x02\x10Gcommon.V1.Queue\xca\x02\x10Gcommon\\V1\\Queue\xe2\x02\x1cGcommon\\V1\\Queue\\GPBMetadata\xea\x02\x12Gcommon::V1::Queue\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_queue_messages_schema_validation_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_queue_messages_schema_validation_proto_goTypes = []any{
	(*SchemaValidation)(nil), // 0: gcommon.v1.queue.SchemaValidation
}
var file_gcommon_v1_queue_messages_schema_validation_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_queue_messages_schema_validation_proto_init() }
func file_gcommon_v1_queue_messages_schema_validation_proto_init() {
	if File_gcommon_v1_queue_messages_schema_validation_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_queue_messages_schema_validation_proto_rawDesc), len(file_gcommon_v1_queue_messages_schema_validation_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_queue_messages_schema_validation_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_queue_messages_schema_validation_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_queue_messages_schema_validation_proto_msgTypes,
	}.Build()
	File_gcommon_v1_queue_messages_schema_validation_proto = out.File
	file_gcommon_v1_queue_messages_schema_validation_proto_goTypes = nil
	file_gcommon_v1_queue_messages_schema_validation_proto_depIdxs = nil
}
