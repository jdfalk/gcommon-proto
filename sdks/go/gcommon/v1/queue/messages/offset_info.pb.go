...
func (x *OffsetInfo) Reset() {
	*x = OffsetInfo{}
	mi := &file_gcommon_v1_queue_messages_offset_info_proto_msgTypes[0]
...
var File_gcommon_v1_queue_messages_offset_info_proto protoreflect.FileDescriptor

const file_gcommon_v1_queue_messages_offset_info_proto_rawDesc = "" +
	"\n" +
	...
	"\x10committed_offset\x18\a \x01(\x04R\x0fcommittedOffsetB\xce\x01\n" +
	"\x14com.gcommon.v1.queueB\x0fOffsetInfoProtoP\x01Z;github.com/jdfalk/gcommon/sdks/go/gcommon/v1/queue/messages\xa2\x02\x03GVQ\xaa\x02\x10Gcommon.V1.Queue\xca\x02\x10Gcommon\\V1\\Queue\xe2\x02\x1cGcommon\\V1\\Queue\\GPBMetadata\xea\x02\x12Gcommon::V1::Queue\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
var file_gcommon_v1_queue_messages_offset_info_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_queue_messages_offset_info_proto_init() }
func file_gcommon_v1_queue_messages_offset_info_proto_init() {
	if File_gcommon_v1_queue_messages_offset_info_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_queue_messages_offset_info_proto_rawDesc), len(file_gcommon_v1_queue_messages_offset_info_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_queue_messages_offset_info_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_queue_messages_offset_info_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_queue_messages_offset_info_proto_msgTypes,
	}.Build()
	File_gcommon_v1_queue_messages_offset_info_proto = out.File
	file_gcommon_v1_queue_messages_offset_info_proto_goTypes = nil
	file_gcommon_v1_queue_messages_offset_info_proto_depIdxs = nil
}
