...
const file_gcommon_v1_queue_message_filter_config_proto_rawDesc = "" +
	"\n" +
	",gcommon/v1/queue/message_filter_config.proto\x12\x10gcommon.v1.queue\x1a%gcommon/v1/queue/content_filter.proto\x1a!google/protobuf/go_features.proto\"\xb3\x03\n" +
