...
type ExportQueueRequest struct {
	...
	xxx_hidden_TimeRange          *common1.TimeRangeMetrics `protobuf:"bytes,5,opt,name=time_range,json=timeRange"`
...
func (x *ExportQueueRequest) Reset() {
	*x = ExportQueueRequest{}
	mi := &file_gcommon_v1_queue_export_queue_request_proto_msgTypes[0]
...
func (x *ExportQueueRequest) GetTimeRange() *common1.TimeRangeMetrics {
	if x != nil {
...
func (x *ExportQueueRequest) SetTimeRange(v *common1.TimeRangeMetrics) {
...
var File_gcommon_v1_queue_export_queue_request_proto protoreflect.FileDescriptor

const file_gcommon_v1_queue_export_queue_request_proto_rawDesc = "" +
	"\n" +
	"+gcommon/v1/queue/export_queue_request.proto\x12\x10gcommon.v1.queue\x1a+gcommon/v1/common/queue_export_format.proto\x1a*gcommon/v1/common/time_range_metrics.proto\x1a!google/protobuf/go_features.proto\"\xd1\x03\n" +
	...
	"\x14include_message_data\x18\x04 \x01(\bR\x12includeMessageData\x12B\n" +
	"\n" +
	"time_range\x18\x05 \x01(\v2#.gcommon.v1.common.TimeRangeMetricsR\ttimeRange\x12\x1a\n" +
...
var file_gcommon_v1_queue_export_queue_request_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
...
var file_gcommon_v1_queue_export_queue_request_proto_depIdxs = []int32{
	...
	3, // 1: gcommon.v1.queue.ExportQueueRequest.time_range:type_name -> gcommon.v1.common.TimeRangeMetrics
...
func init() { file_gcommon_v1_queue_export_queue_request_proto_init() }
func file_gcommon_v1_queue_export_queue_request_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_queue_export_queue_request_proto_rawDesc), len(file_gcommon_v1_queue_export_queue_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_queue_export_queue_request_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_queue_export_queue_request_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_queue_export_queue_request_proto_msgTypes,
	}.Build()
	File_gcommon_v1_queue_export_queue_request_proto = out.File
	file_gcommon_v1_queue_export_queue_request_proto_goTypes = nil
	file_gcommon_v1_queue_export_queue_request_proto_depIdxs = nil
}
