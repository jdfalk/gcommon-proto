...
// 	protoc        (unknown)
// source: gcommon/v1/media/extract_subtitles_request.proto
...
func (x *ExtractSubtitlesRequest) Reset() {
	*x = ExtractSubtitlesRequest{}
	mi := &file_gcommon_v1_media_extract_subtitles_request_proto_msgTypes[0]
...
const file_gcommon_v1_media_extract_subtitles_request_proto_rawDesc = "" +
	"\n" +
	"0gcommon/v1/media/extract_subtitles_request.proto\x12\x10gcommon.v1.media\x1a!google/protobuf/go_features.proto\"\xa9\x01\n" +
...
func init() { file_gcommon_v1_media_extract_subtitles_request_proto_init() }
func file_gcommon_v1_media_extract_subtitles_request_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_gcommon_v1_media_extract_subtitles_request_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_media_extract_subtitles_request_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_media_extract_subtitles_request_proto_msgTypes,
	}.Build()
	File_gcommon_v1_media_extract_subtitles_request_proto = out.File
	file_gcommon_v1_media_extract_subtitles_request_proto_goTypes = nil
	file_gcommon_v1_media_extract_subtitles_request_proto_depIdxs = nil
}
