...
// 	protoc        (unknown)
// source: gcommon/v1/media/messages/audio_track.proto
...
func (x *AudioTrack) Reset() {
	*x = AudioTrack{}
	mi := &file_gcommon_v1_media_messages_audio_track_proto_msgTypes[0]
...
var File_gcommon_v1_media_messages_audio_track_proto protoreflect.FileDescriptor

const file_gcommon_v1_media_messages_audio_track_proto_rawDesc = "" +
	"\n" +
	"+gcommon/v1/media/messages/audio_track.proto\x12\x10gcommon.v1.media\x1a!google/protobuf/go_features.proto\"\xcc\x01\n" +
	"\n" +
	"AudioTrack\x12\x14\n" +
	...
	"sampleRate\x12#\n" +
	"\rdefault_track\x18\a \x01(\bR\fdefaultTrackB\xce\x01\n" +
	"\x14com.gcommon.v1.mediaB\x0fAudioTrackProtoP\x01Z;github.com/jdfalk/gcommon/sdks/go/gcommon/v1/media/messages\xa2\x02\x03GVM\xaa\x02\x10Gcommon.V1.Media\xca\x02\x10Gcommon\\V1\\Media\xe2\x02\x1cGcommon\\V1\\Media\\GPBMetadata\xea\x02\x12Gcommon::V1::Media\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
var file_gcommon_v1_media_messages_audio_track_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_media_messages_audio_track_proto_init() }
func file_gcommon_v1_media_messages_audio_track_proto_init() {
	if File_gcommon_v1_media_messages_audio_track_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_media_messages_audio_track_proto_rawDesc), len(file_gcommon_v1_media_messages_audio_track_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_media_messages_audio_track_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_media_messages_audio_track_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_media_messages_audio_track_proto_msgTypes,
	}.Build()
	File_gcommon_v1_media_messages_audio_track_proto = out.File
	file_gcommon_v1_media_messages_audio_track_proto_goTypes = nil
	file_gcommon_v1_media_messages_audio_track_proto_depIdxs = nil
}
