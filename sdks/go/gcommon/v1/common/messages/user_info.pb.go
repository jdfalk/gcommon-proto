...
// 	protoc        (unknown)
// source: gcommon/v1/common/messages/user_info.proto
...
func (x *UserInfo) Reset() {
	*x = UserInfo{}
	mi := &file_gcommon_v1_common_messages_user_info_proto_msgTypes[0]
...
var File_gcommon_v1_common_messages_user_info_proto protoreflect.FileDescriptor

const file_gcommon_v1_common_messages_user_info_proto_rawDesc = "" +
	"\n" +
	"*gcommon/v1/common/messages/user_info.proto\x12\x11gcommon.v1.common\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xe0\x04\n" +
	"\bUserInfo\x12\x17\n" +
	...
	"\bmetadata\x18\b \x03(\v2).gcommon.v1.common.UserInfo.MetadataEntryR\bmetadata\x129\n" +
	"\n" +
	...
	"\x15com.gcommon.v1.commonB\rUserInfoProtoP\x01Z<github.com/jdfalk/gcommon/sdks/go/gcommon/v1/common/messages\xa2\x02\x03GVC\xaa\x02\x11Gcommon.V1.Common\xca\x02\x11Gcommon\\V1\\Common\xe2\x02\x1dGcommon\\V1\\Common\\GPBMetadata\xea\x02\x13Gcommon::V1::Common\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_common_messages_user_info_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_gcommon_v1_common_messages_user_info_proto_goTypes = []any{
	(*UserInfo)(nil),              // 0: gcommon.v1.common.UserInfo
	nil,                           // 1: gcommon.v1.common.UserInfo.MetadataEntry
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
}
var file_gcommon_v1_common_messages_user_info_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_common_messages_user_info_proto_init() }
func file_gcommon_v1_common_messages_user_info_proto_init() {
	if File_gcommon_v1_common_messages_user_info_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_common_messages_user_info_proto_rawDesc), len(file_gcommon_v1_common_messages_user_info_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_common_messages_user_info_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_common_messages_user_info_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_common_messages_user_info_proto_msgTypes,
	}.Build()
	File_gcommon_v1_common_messages_user_info_proto = out.File
	file_gcommon_v1_common_messages_user_info_proto_goTypes = nil
	file_gcommon_v1_common_messages_user_info_proto_depIdxs = nil
}
