...
// 	protoc        (unknown)
// source: gcommon/v1/common/messages/validate_token_response.proto
...
func (x *ValidateTokenResponse) Reset() {
	*x = ValidateTokenResponse{}
	mi := &file_gcommon_v1_common_messages_validate_token_response_proto_msgTypes[0]
...
var File_gcommon_v1_common_messages_validate_token_response_proto protoreflect.FileDescriptor

const file_gcommon_v1_common_messages_validate_token_response_proto_rawDesc = "" +
	"\n" +
	"8gcommon/v1/common/messages/validate_token_response.proto\x12\x11gcommon.v1.common\x1a*gcommon/v1/common/messages/user_info.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x93\x02\n" +
	"\x15ValidateTokenResponse\x12\x14\n" +
	"\x05valid\x18\x01 \x01(\bR\x05valid\x12=\n" +
	"\n" +
	"expires_at\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampB\x02(\x01R\texpiresAt\x12<\n" +
	"\tuser_info\x18\x03 \x01(\v2\x1b.gcommon.v1.common.UserInfoB\x02(\x01R\buserInfo\x12\x16\n" +
	...
	"\n" +
	"expires_in\x18\a \x01(\x05R\texpiresInB\xdf\x01\n" +
	"\x15com.gcommon.v1.commonB\x1aValidateTokenResponseProtoP\x01Z<github.com/jdfalk/gcommon/sdks/go/gcommon/v1/common/messages\xa2\x02\x03GVC\xaa\x02\x11Gcommon.V1.Common\xca\x02\x11Gcommon\\V1\\Common\xe2\x02\x1dGcommon\\V1\\Common\\GPBMetadata\xea\x02\x13Gcommon::V1::Common\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_common_messages_validate_token_response_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_common_messages_validate_token_response_proto_goTypes = []any{
	(*ValidateTokenResponse)(nil), // 0: gcommon.v1.common.ValidateTokenResponse
	(*timestamppb.Timestamp)(nil), // 1: google.protobuf.Timestamp
	(*UserInfo)(nil),              // 2: gcommon.v1.common.UserInfo
}
var file_gcommon_v1_common_messages_validate_token_response_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_common_messages_validate_token_response_proto_init() }
func file_gcommon_v1_common_messages_validate_token_response_proto_init() {
	if File_gcommon_v1_common_messages_validate_token_response_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_common_messages_validate_token_response_proto_rawDesc), len(file_gcommon_v1_common_messages_validate_token_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_common_messages_validate_token_response_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_common_messages_validate_token_response_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_common_messages_validate_token_response_proto_msgTypes,
	}.Build()
	File_gcommon_v1_common_messages_validate_token_response_proto = out.File
	file_gcommon_v1_common_messages_validate_token_response_proto_goTypes = nil
	file_gcommon_v1_common_messages_validate_token_response_proto_depIdxs = nil
}
