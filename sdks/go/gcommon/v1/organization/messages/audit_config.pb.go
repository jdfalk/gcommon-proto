...
func (x *AuditConfig) Reset() {
	*x = AuditConfig{}
	mi := &file_gcommon_v1_organization_messages_audit_config_proto_msgTypes[0]
...
var File_gcommon_v1_organization_messages_audit_config_proto protoreflect.FileDescriptor

const file_gcommon_v1_organization_messages_audit_config_proto_rawDesc = "" +
	"\n" +
	"3gcommon/v1/organization/messages/audit_config.proto\x12\x17gcommon.v1.organization\x1a2gcommon/v1/organization/messages/audit_alert.proto\x1a!google/protobuf/go_features.proto\"\x9a\x02\n" +
	"\vAuditConfig\x12#\n" +
	...
	"\x06alerts\x18\x06 \x03(\v2#.gcommon.v1.organization.AuditAlertR\x06alertsB\xf9\x01\n" +
	"\x1bcom.gcommon.v1.organizationB\x10AuditConfigProtoP\x01ZBgithub.com/jdfalk/gcommon/sdks/go/gcommon/v1/organization/messages\xa2\x02\x03GVO\xaa\x02\x17Gcommon.V1.Organization\xca\x02\x17Gcommon\\V1\\Organization\xe2\x02#Gcommon\\V1\\Organization\\GPBMetadata\xea\x02\x19Gcommon::V1::Organization\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_organization_messages_audit_config_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_organization_messages_audit_config_proto_goTypes = []any{
	(*AuditConfig)(nil), // 0: gcommon.v1.organization.AuditConfig
	(*AuditAlert)(nil),  // 1: gcommon.v1.organization.AuditAlert
}
var file_gcommon_v1_organization_messages_audit_config_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_organization_messages_audit_config_proto_init() }
func file_gcommon_v1_organization_messages_audit_config_proto_init() {
	if File_gcommon_v1_organization_messages_audit_config_proto != nil {
		return
	}
	file_gcommon_v1_organization_messages_audit_alert_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_organization_messages_audit_config_proto_rawDesc), len(file_gcommon_v1_organization_messages_audit_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_organization_messages_audit_config_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_organization_messages_audit_config_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_organization_messages_audit_config_proto_msgTypes,
	}.Build()
	File_gcommon_v1_organization_messages_audit_config_proto = out.File
	file_gcommon_v1_organization_messages_audit_config_proto_goTypes = nil
	file_gcommon_v1_organization_messages_audit_config_proto_depIdxs = nil
}
