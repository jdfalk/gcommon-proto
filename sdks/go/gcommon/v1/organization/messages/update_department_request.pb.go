...
// 	protoc        (unknown)
// source: gcommon/v1/organization/messages/update_department_request.proto
...
func (x *UpdateDepartmentRequest) Reset() {
	*x = UpdateDepartmentRequest{}
	mi := &file_gcommon_v1_organization_messages_update_department_request_proto_msgTypes[0]
...
var File_gcommon_v1_organization_messages_update_department_request_proto protoreflect.FileDescriptor

const file_gcommon_v1_organization_messages_update_department_request_proto_rawDesc = "" +
	"\n" +
	"@gcommon/v1/organization/messages/update_department_request.proto\x12\x17gcommon.v1.organization\x1a1gcommon/v1/common/messages/request_metadata.proto\x1a1gcommon/v1/organization/messages/department.proto\x1a google/protobuf/field_mask.proto\x1a!google/protobuf/go_features.proto\"\xa5\x02\n" +
	...
	"updateMask\x12#\n" +
	"\rvalidate_only\x18\x05 \x01(\bR\fvalidateOnlyB\x85\x02\n" +
	"\x1bcom.gcommon.v1.organizationB\x1cUpdateDepartmentRequestProtoP\x01ZBgithub.com/jdfalk/gcommon/sdks/go/gcommon/v1/organization/messages\xa2\x02\x03GVO\xaa\x02\x17Gcommon.V1.Organization\xca\x02\x17Gcommon\\V1\\Organization\xe2\x02#Gcommon\\V1\\Organization\\GPBMetadata\xea\x02\x19Gcommon::V1::Organization\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
func init() { file_gcommon_v1_organization_messages_update_department_request_proto_init() }
func file_gcommon_v1_organization_messages_update_department_request_proto_init() {
	if File_gcommon_v1_organization_messages_update_department_request_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_organization_messages_update_department_request_proto_rawDesc), len(file_gcommon_v1_organization_messages_update_department_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_organization_messages_update_department_request_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_organization_messages_update_department_request_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_organization_messages_update_department_request_proto_msgTypes,
	}.Build()
	File_gcommon_v1_organization_messages_update_department_request_proto = out.File
	file_gcommon_v1_organization_messages_update_department_request_proto_goTypes = nil
	file_gcommon_v1_organization_messages_update_department_request_proto_depIdxs = nil
}
