...
func (x *ListTeamsRequest) GetMetadata() *messages.RequestMetadata {
	if x != nil {
...
func (x *ListTeamsRequest) SetMetadata(v *messages.RequestMetadata) {
...
const file_gcommon_v1_organization_messages_list_teams_request_proto_rawDesc = "" +
	...
	"\x06filter\x18\x06 \x01(\tR\x06filterB8Z.github.com/jdfalk/gcommon/sdks/go/organization\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
