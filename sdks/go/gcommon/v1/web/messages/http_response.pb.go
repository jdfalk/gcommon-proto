...
func (x *HttpResponse) Reset() {
	*x = HttpResponse{}
	mi := &file_gcommon_v1_web_messages_http_response_proto_msgTypes[0]
...
func (x *HttpResponse) GetRequestMetadata() *messages.RequestMetadata {
	if x != nil {
...
func (x *HttpResponse) GetError() *messages.Error {
	if x != nil {
...
func (x *HttpResponse) SetRequestMetadata(v *messages.RequestMetadata) {
...
func (x *HttpResponse) SetError(v *messages.Error) {
...
var File_gcommon_v1_web_messages_http_response_proto protoreflect.FileDescriptor

const file_gcommon_v1_web_messages_http_response_proto_rawDesc = "" +
	"\n" +
	"+gcommon/v1/web/messages/http_response.proto\x12\x0egcommon.v1.web\x1a&gcommon/v1/common/messages/error.proto\x1a1gcommon/v1/common/messages/request_metadata.proto\x1a\x19google/protobuf/any.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xe2\v\n" +
	...
	"\x12com.gcommon.v1.webB\x11HttpResponseProtoP\x01Z9github.com/jdfalk/gcommon/sdks/go/gcommon/v1/web/messages\xa2\x02\x03GVW\xaa\x02\x0eGcommon.V1.Web\xca\x02\x0eGcommon\\V1\\Web\xe2\x02\x1aGcommon\\V1\\Web\\GPBMetadata\xea\x02\x10Gcommon::V1::Web\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_web_messages_http_response_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_gcommon_v1_web_messages_http_response_proto_goTypes = []any{
...
var file_gcommon_v1_web_messages_http_response_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_web_messages_http_response_proto_init() }
func file_gcommon_v1_web_messages_http_response_proto_init() {
	if File_gcommon_v1_web_messages_http_response_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_web_messages_http_response_proto_rawDesc), len(file_gcommon_v1_web_messages_http_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_web_messages_http_response_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_web_messages_http_response_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_web_messages_http_response_proto_msgTypes,
	}.Build()
	File_gcommon_v1_web_messages_http_response_proto = out.File
	file_gcommon_v1_web_messages_http_response_proto_goTypes = nil
	file_gcommon_v1_web_messages_http_response_proto_depIdxs = nil
}
