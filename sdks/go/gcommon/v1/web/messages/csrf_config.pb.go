...
// 	protoc        (unknown)
// source: gcommon/v1/web/messages/csrf_config.proto
...
func (x *CsrfConfig) Reset() {
	*x = CsrfConfig{}
	mi := &file_gcommon_v1_web_messages_csrf_config_proto_msgTypes[0]
...
var File_gcommon_v1_web_messages_csrf_config_proto protoreflect.FileDescriptor

const file_gcommon_v1_web_messages_csrf_config_proto_rawDesc = "" +
	"\n" +
	...
	"\x06secure\x18\x05 \x01(\bR\x06secureB\xc2\x01\n" +
	"\x12com.gcommon.v1.webB\x0fCsrfConfigProtoP\x01Z9github.com/jdfalk/gcommon/sdks/go/gcommon/v1/web/messages\xa2\x02\x03GVW\xaa\x02\x0eGcommon.V1.Web\xca\x02\x0eGcommon\\V1\\Web\xe2\x02\x1aGcommon\\V1\\Web\\GPBMetadata\xea\x02\x10Gcommon::V1::Web\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_web_messages_csrf_config_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_web_messages_csrf_config_proto_goTypes = []any{
	(*CsrfConfig)(nil),          // 0: gcommon.v1.web.CsrfConfig
	(*durationpb.Duration)(nil), // 1: google.protobuf.Duration
}
var file_gcommon_v1_web_messages_csrf_config_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_web_messages_csrf_config_proto_init() }
func file_gcommon_v1_web_messages_csrf_config_proto_init() {
	if File_gcommon_v1_web_messages_csrf_config_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_web_messages_csrf_config_proto_rawDesc), len(file_gcommon_v1_web_messages_csrf_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_web_messages_csrf_config_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_web_messages_csrf_config_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_web_messages_csrf_config_proto_msgTypes,
	}.Build()
	File_gcommon_v1_web_messages_csrf_config_proto = out.File
	file_gcommon_v1_web_messages_csrf_config_proto_goTypes = nil
	file_gcommon_v1_web_messages_csrf_config_proto_depIdxs = nil
}
