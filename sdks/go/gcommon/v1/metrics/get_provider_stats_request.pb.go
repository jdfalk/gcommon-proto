...
func (x *GetProviderStatsRequest) Reset() {
	*x = GetProviderStatsRequest{}
	mi := &file_gcommon_v1_metrics_get_provider_stats_request_proto_msgTypes[0]
...
func (x *GetProviderStatsRequest) GetTimeRange() *common1.TimeRangeMetrics {
	if x != nil {
...
func (x *GetProviderStatsRequest) SetTimeRange(v *common1.TimeRangeMetrics) {
...
var File_gcommon_v1_metrics_get_provider_stats_request_proto protoreflect.FileDescriptor

const file_gcommon_v1_metrics_get_provider_stats_request_proto_rawDesc = "" +
	"\n" +
	"3gcommon/v1/metrics/get_provider_stats_request.proto\x12\x12gcommon.v1.metrics\x1a(gcommon/v1/common/request_metadata.proto\x1a*gcommon/v1/common/time_range_metrics.proto\x1a&gcommon/v1/metrics/stats_options.proto\x1a!google/protobuf/go_features.proto\"\xc7\x02\n" +
	...
	"\x10include_realtime\x18\x06 \x01(\bR\x0fincludeRealtimeB6Z,github.com/jdfalk/gcommon/sdks/go/v1/metrics\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_metrics_get_provider_stats_request_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_metrics_get_provider_stats_request_proto_goTypes = []any{
	...
	(*common1.TimeRangeMetrics)(nil), // 2: gcommon.v1.common.TimeRangeMetrics
	(*StatsOptions)(nil),             // 3: gcommon.v1.metrics.StatsOptions
}
var file_gcommon_v1_metrics_get_provider_stats_request_proto_depIdxs = []int32{
	1, // 0: gcommon.v1.metrics.GetProviderStatsRequest.metadata:type_name -> gcommon.v1.common.RequestMetadata
	2, // 1: gcommon.v1.metrics.GetProviderStatsRequest.time_range:type_name -> gcommon.v1.common.TimeRangeMetrics
...
func init() { file_gcommon_v1_metrics_get_provider_stats_request_proto_init() }
func file_gcommon_v1_metrics_get_provider_stats_request_proto_init() {
	if File_gcommon_v1_metrics_get_provider_stats_request_proto != nil {
		return
	}
	file_gcommon_v1_metrics_stats_options_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_metrics_get_provider_stats_request_proto_rawDesc), len(file_gcommon_v1_metrics_get_provider_stats_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_metrics_get_provider_stats_request_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_metrics_get_provider_stats_request_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_metrics_get_provider_stats_request_proto_msgTypes,
	}.Build()
	File_gcommon_v1_metrics_get_provider_stats_request_proto = out.File
	file_gcommon_v1_metrics_get_provider_stats_request_proto_goTypes = nil
	file_gcommon_v1_metrics_get_provider_stats_request_proto_depIdxs = nil
}
