...
// 	protoc        (unknown)
// source: gcommon/v1/metrics/create_provider_response.proto
...
func (x *CreateProviderResponse) Reset() {
	*x = CreateProviderResponse{}
	mi := &file_gcommon_v1_metrics_create_provider_response_proto_msgTypes[0]
...
func (x *CreateProviderResponse) GetValidation() *common1.MetricsValidationResult {
	if x != nil {
...
func (x *CreateProviderResponse) SetValidation(v *common1.MetricsValidationResult) {
...
var File_gcommon_v1_metrics_create_provider_response_proto protoreflect.FileDescriptor

const file_gcommon_v1_metrics_create_provider_response_proto_rawDesc = "" +
	"\n" +
	"1gcommon/v1/metrics/create_provider_response.proto\x12\x12gcommon.v1.metrics\x1a\x1dgcommon/v1/common/error.proto\x1a1gcommon/v1/common/metrics_validation_result.proto\x1a'gcommon/v1/metrics/applied_config.proto\x1a+gcommon/v1/metrics/provider_endpoints.proto\x1a(gcommon/v1/metrics/provider_status.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xf1\x03\n" +
	...
	"\x06status\x18\x05 \x01(\v2\".gcommon.v1.metrics.ProviderStatusR\x06status\x12J\n" +
	"\n" +
	"validation\x18\x06 \x01(\v2*.gcommon.v1.common.MetricsValidationResultR\n" +
	"validation\x12H\n" +
	...
	"\tendpoints\x18\t \x01(\v2%.gcommon.v1.metrics.ProviderEndpointsR\tendpointsB6Z,github.com/jdfalk/gcommon/sdks/go/v1/metrics\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_metrics_create_provider_response_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_metrics_create_provider_response_proto_goTypes = []any{
	...
	(*common1.MetricsValidationResult)(nil), // 4: gcommon.v1.common.MetricsValidationResult
	(*AppliedConfig)(nil),                   // 5: gcommon.v1.metrics.AppliedConfig
	(*ProviderEndpoints)(nil),               // 6: gcommon.v1.metrics.ProviderEndpoints
}
var file_gcommon_v1_metrics_create_provider_response_proto_depIdxs = []int32{
	...
	4, // 3: gcommon.v1.metrics.CreateProviderResponse.validation:type_name -> gcommon.v1.common.MetricsValidationResult
...
func init() { file_gcommon_v1_metrics_create_provider_response_proto_init() }
func file_gcommon_v1_metrics_create_provider_response_proto_init() {
	if File_gcommon_v1_metrics_create_provider_response_proto != nil {
		return
	}
	file_gcommon_v1_metrics_applied_config_proto_init()
	file_gcommon_v1_metrics_provider_endpoints_proto_init()
	file_gcommon_v1_metrics_provider_status_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_metrics_create_provider_response_proto_rawDesc), len(file_gcommon_v1_metrics_create_provider_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_metrics_create_provider_response_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_metrics_create_provider_response_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_metrics_create_provider_response_proto_msgTypes,
	}.Build()
	File_gcommon_v1_metrics_create_provider_response_proto = out.File
	file_gcommon_v1_metrics_create_provider_response_proto_goTypes = nil
	file_gcommon_v1_metrics_create_provider_response_proto_depIdxs = nil
}
