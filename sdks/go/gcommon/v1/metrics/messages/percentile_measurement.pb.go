...
// 	protoc        (unknown)
// source: gcommon/v1/metrics/messages/percentile_measurement.proto
...
func (x *PercentileMeasurement) Reset() {
	*x = PercentileMeasurement{}
	mi := &file_gcommon_v1_metrics_messages_percentile_measurement_proto_msgTypes[0]
...
var File_gcommon_v1_metrics_messages_percentile_measurement_proto protoreflect.FileDescriptor

const file_gcommon_v1_metrics_messages_percentile_measurement_proto_rawDesc = "" +
	"\n" +
	"8gcommon/v1/metrics/messages/percentile_measurement.proto\x12\x12gcommon.v1.metrics\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\"\x91\x01\n" +
	...
	"\fsample_count\x18\x03 \x01(\x03R\vsampleCountB\xe5\x01\n" +
	"\x16com.gcommon.v1.metricsB\x1aPercentileMeasurementProtoP\x01Z=github.com/jdfalk/gcommon/sdks/go/gcommon/v1/metrics/messages\xa2\x02\x03GVM\xaa\x02\x12Gcommon.V1.Metrics\xca\x02\x12Gcommon\\V1\\Metrics\xe2\x02\x1eGcommon\\V1\\Metrics\\GPBMetadata\xea\x02\x14Gcommon::V1::Metrics\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
var file_gcommon_v1_metrics_messages_percentile_measurement_proto_goTypes = []any{
	(*PercentileMeasurement)(nil), // 0: gcommon.v1.metrics.PercentileMeasurement
	(*durationpb.Duration)(nil),   // 1: google.protobuf.Duration
}
var file_gcommon_v1_metrics_messages_percentile_measurement_proto_depIdxs = []int32{
	1, // 0: gcommon.v1.metrics.PercentileMeasurement.duration:type_name -> google.protobuf.Duration
...
func init() { file_gcommon_v1_metrics_messages_percentile_measurement_proto_init() }
func file_gcommon_v1_metrics_messages_percentile_measurement_proto_init() {
	if File_gcommon_v1_metrics_messages_percentile_measurement_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_metrics_messages_percentile_measurement_proto_rawDesc), len(file_gcommon_v1_metrics_messages_percentile_measurement_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_metrics_messages_percentile_measurement_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_metrics_messages_percentile_measurement_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_metrics_messages_percentile_measurement_proto_msgTypes,
	}.Build()
	File_gcommon_v1_metrics_messages_percentile_measurement_proto = out.File
	file_gcommon_v1_metrics_messages_percentile_measurement_proto_goTypes = nil
	file_gcommon_v1_metrics_messages_percentile_measurement_proto_depIdxs = nil
}
