...
// 	protoc        (unknown)
// source: gcommon/v1/metrics/messages/batch_options.proto
...
func (x *MetricsBatchOptions) Reset() {
	*x = MetricsBatchOptions{}
	mi := &file_gcommon_v1_metrics_messages_batch_options_proto_msgTypes[0]
...
var File_gcommon_v1_metrics_messages_batch_options_proto protoreflect.FileDescriptor

const file_gcommon_v1_metrics_messages_batch_options_proto_rawDesc = "" +
	"\n" +
	"/gcommon/v1/metrics/messages/batch_options.proto\x12\x12gcommon.v1.metrics\x1a0gcommon/v1/metrics/messages/batch_priority.proto\x1a!google/protobuf/go_features.proto\"\xd7\x02\n" +
	...
	"\bpriority\x18\a \x01(\x0e2!.gcommon.v1.metrics.BatchPriorityR\bpriorityB\xdc\x01\n" +
	"\x16com.gcommon.v1.metricsB\x11BatchOptionsProtoP\x01Z=github.com/jdfalk/gcommon/sdks/go/gcommon/v1/metrics/messages\xa2\x02\x03GVM\xaa\x02\x12Gcommon.V1.Metrics\xca\x02\x12Gcommon\\V1\\Metrics\xe2\x02\x1eGcommon\\V1\\Metrics\\GPBMetadata\xea\x02\x14Gcommon::V1::Metrics\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
var file_gcommon_v1_metrics_messages_batch_options_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_metrics_messages_batch_options_proto_init() }
func file_gcommon_v1_metrics_messages_batch_options_proto_init() {
	if File_gcommon_v1_metrics_messages_batch_options_proto != nil {
		return
	}
	file_gcommon_v1_metrics_messages_batch_priority_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_metrics_messages_batch_options_proto_rawDesc), len(file_gcommon_v1_metrics_messages_batch_options_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_metrics_messages_batch_options_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_metrics_messages_batch_options_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_metrics_messages_batch_options_proto_msgTypes,
	}.Build()
	File_gcommon_v1_metrics_messages_batch_options_proto = out.File
	file_gcommon_v1_metrics_messages_batch_options_proto_goTypes = nil
	file_gcommon_v1_metrics_messages_batch_options_proto_depIdxs = nil
}
