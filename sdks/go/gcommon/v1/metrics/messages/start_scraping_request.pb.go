...
// 	protoc        (unknown)
// source: gcommon/v1/metrics/messages/start_scraping_request.proto
...
func (x *StartScrapingRequest) Reset() {
	*x = StartScrapingRequest{}
	mi := &file_gcommon_v1_metrics_messages_start_scraping_request_proto_msgTypes[0]
...
var File_gcommon_v1_metrics_messages_start_scraping_request_proto protoreflect.FileDescriptor

const file_gcommon_v1_metrics_messages_start_scraping_request_proto_rawDesc = "" +
	"\n" +
	"8gcommon/v1/metrics/messages/start_scraping_request.proto\x12\x12gcommon.v1.metrics\x1a1gcommon/v1/common/messages/request_metadata.proto\x1a/gcommon/v1/metrics/messages/scrape_config.proto\x1a!google/protobuf/go_features.proto\"\xb1\x01\n" +
	"\x14StartScrapingRequest\x12>\n" +
	"\bmetadata\x18\x01 \x01(\v2\".gcommon.v1.common.RequestMetadataR\bmetadata\x12\x1f\n" +
	"\vprovider_id\x18\x02 \x01(\tR\n" +
	"providerId\x128\n" +
	"\x06config\x18\x03 \x01(\v2 .gcommon.v1.metrics.ScrapeConfigR\x06configB\xe4\x01\n" +
	"\x16com.gcommon.v1.metricsB\x19StartScrapingRequestProtoP\x01Z=github.com/jdfalk/gcommon/sdks/go/gcommon/v1/metrics/messages\xa2\x02\x03GVM\xaa\x02\x12Gcommon.V1.Metrics\xca\x02\x12Gcommon\\V1\\Metrics\xe2\x02\x1eGcommon\\V1\\Metrics\\GPBMetadata\xea\x02\x14Gcommon::V1::Metrics\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
func init() { file_gcommon_v1_metrics_messages_start_scraping_request_proto_init() }
func file_gcommon_v1_metrics_messages_start_scraping_request_proto_init() {
	if File_gcommon_v1_metrics_messages_start_scraping_request_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_metrics_messages_start_scraping_request_proto_rawDesc), len(file_gcommon_v1_metrics_messages_start_scraping_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_metrics_messages_start_scraping_request_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_metrics_messages_start_scraping_request_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_metrics_messages_start_scraping_request_proto_msgTypes,
	}.Build()
	File_gcommon_v1_metrics_messages_start_scraping_request_proto = out.File
	file_gcommon_v1_metrics_messages_start_scraping_request_proto_goTypes = nil
	file_gcommon_v1_metrics_messages_start_scraping_request_proto_depIdxs = nil
}
