...
type MetricQuery struct {
	...
	xxx_hidden_SortCriteria *[]*messages.SortOptions `protobuf:"bytes,8,rep,name=sort_criteria,json=sortCriteria"`
...
func (x *MetricQuery) GetSortCriteria() []*messages.SortOptions {
	if x != nil {
...
func (x *MetricQuery) SetSortCriteria(v []*messages.SortOptions) {
...
type MetricQuery_builder struct {
	...
	GroupBy []*GroupBySpec
	// Sort criteria
	SortCriteria []*messages.SortOptions
...
const file_gcommon_v1_metrics_messages_metric_query_proto_rawDesc = "" +
	...
	"\x06offset\x18\n" +
	" \x01(\x05R\x06offsetB\xdb\x01\n" +
	"\x16com.gcommon.v1.metricsB\x10MetricQueryProtoP\x01Z=github.com/jdfalk/gcommon/sdks/go/gcommon/v1/metrics/messages\xa2\x02\x03GVM\xaa\x02\x12Gcommon.V1.Metrics\xca\x02\x12Gcommon\\V1\\Metrics\xe2\x02\x1eGcommon\\V1\\Metrics\\GPBMetadata\xea\x02\x14Gcommon::V1::Metrics\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
var file_gcommon_v1_metrics_messages_metric_query_proto_goTypes = []any{
	...
	(*messages.SortOptions)(nil), // 5: gcommon.v1.common.SortOptions
}
