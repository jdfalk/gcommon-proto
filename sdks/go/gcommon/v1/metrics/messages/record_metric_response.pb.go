...
// 	protoc        (unknown)
// source: gcommon/v1/metrics/messages/record_metric_response.proto
...
func (x *RecordMetricResponse) Reset() {
	*x = RecordMetricResponse{}
	mi := &file_gcommon_v1_metrics_messages_record_metric_response_proto_msgTypes[0]
...
func (x *RecordMetricResponse) GetValidation() *MetricsValidationResult {
	if x != nil {
...
func (x *RecordMetricResponse) SetValidation(v *MetricsValidationResult) {
...
var File_gcommon_v1_metrics_messages_record_metric_response_proto protoreflect.FileDescriptor

const file_gcommon_v1_metrics_messages_record_metric_response_proto_rawDesc = "" +
	"\n" +
	"8gcommon/v1/metrics/messages/record_metric_response.proto\x12\x12gcommon.v1.metrics\x1a&gcommon/v1/common/messages/error.proto\x1a1gcommon/v1/metrics/messages/recording_stats.proto\x1a3gcommon/v1/metrics/messages/validation_result.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xfe\x02\n" +
	...
	"\bwarnings\x18\b \x03(\tR\bwarningsB\xe4\x01\n" +
	"\x16com.gcommon.v1.metricsB\x19RecordMetricResponseProtoP\x01Z=github.com/jdfalk/gcommon/sdks/go/gcommon/v1/metrics/messages\xa2\x02\x03GVM\xaa\x02\x12Gcommon.V1.Metrics\xca\x02\x12Gcommon\\V1\\Metrics\xe2\x02\x1eGcommon\\V1\\Metrics\\GPBMetadata\xea\x02\x14Gcommon::V1::Metrics\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
var file_gcommon_v1_metrics_messages_record_metric_response_proto_depIdxs = []int32{
	...
	3, // 2: gcommon.v1.metrics.RecordMetricResponse.validation:type_name -> gcommon.v1.metrics.MetricsValidationResult
...
func init() { file_gcommon_v1_metrics_messages_record_metric_response_proto_init() }
func file_gcommon_v1_metrics_messages_record_metric_response_proto_init() {
	if File_gcommon_v1_metrics_messages_record_metric_response_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_metrics_messages_record_metric_response_proto_rawDesc), len(file_gcommon_v1_metrics_messages_record_metric_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_metrics_messages_record_metric_response_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_metrics_messages_record_metric_response_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_metrics_messages_record_metric_response_proto_msgTypes,
	}.Build()
	File_gcommon_v1_metrics_messages_record_metric_response_proto = out.File
	file_gcommon_v1_metrics_messages_record_metric_response_proto_goTypes = nil
	file_gcommon_v1_metrics_messages_record_metric_response_proto_depIdxs = nil
}
