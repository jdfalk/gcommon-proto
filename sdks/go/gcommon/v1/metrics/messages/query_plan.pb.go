...
func (x *QueryPlan) Reset() {
	*x = QueryPlan{}
	mi := &file_gcommon_v1_metrics_messages_query_plan_proto_msgTypes[0]
...
var File_gcommon_v1_metrics_messages_query_plan_proto protoreflect.FileDescriptor

const file_gcommon_v1_metrics_messages_query_plan_proto_rawDesc = "" +
	"\n" +
	...
	"\x10storage_backends\x18\x05 \x03(\tR\x0fstorageBackendsB\xd9\x01\n" +
	"\x16com.gcommon.v1.metricsB\x0eQueryPlanProtoP\x01Z=github.com/jdfalk/gcommon/sdks/go/gcommon/v1/metrics/messages\xa2\x02\x03GVM\xaa\x02\x12Gcommon.V1.Metrics\xca\x02\x12Gcommon\\V1\\Metrics\xe2\x02\x1eGcommon\\V1\\Metrics\\GPBMetadata\xea\x02\x14Gcommon::V1::Metrics\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_metrics_messages_query_plan_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_metrics_messages_query_plan_proto_goTypes = []any{
	(*QueryPlan)(nil),           // 0: gcommon.v1.metrics.QueryPlan
	(*durationpb.Duration)(nil), // 1: google.protobuf.Duration
	(*QueryStep)(nil),           // 2: gcommon.v1.metrics.QueryStep
}
var file_gcommon_v1_metrics_messages_query_plan_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_metrics_messages_query_plan_proto_init() }
func file_gcommon_v1_metrics_messages_query_plan_proto_init() {
	if File_gcommon_v1_metrics_messages_query_plan_proto != nil {
		return
	}
	file_gcommon_v1_metrics_messages_query_step_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_metrics_messages_query_plan_proto_rawDesc), len(file_gcommon_v1_metrics_messages_query_plan_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_metrics_messages_query_plan_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_metrics_messages_query_plan_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_metrics_messages_query_plan_proto_msgTypes,
	}.Build()
	File_gcommon_v1_metrics_messages_query_plan_proto = out.File
	file_gcommon_v1_metrics_messages_query_plan_proto_goTypes = nil
	file_gcommon_v1_metrics_messages_query_plan_proto_depIdxs = nil
}
