...
// 	protoc        (unknown)
// source: gcommon/v1/metrics/config_change.proto
...
func (x *MetricsConfigChange) Reset() {
	*x = MetricsConfigChange{}
	mi := &file_gcommon_v1_metrics_config_change_proto_msgTypes[0]
...
var File_gcommon_v1_metrics_config_change_proto protoreflect.FileDescriptor
...
const file_gcommon_v1_metrics_config_change_proto_rawDesc = "" +
	...
	"\vdescription\x18\x05 \x01(\tR\vdescriptionB6Z,github.com/jdfalk/gcommon/sdks/go/v1/metrics\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
func init() { file_gcommon_v1_metrics_config_change_proto_init() }
func file_gcommon_v1_metrics_config_change_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_metrics_config_change_proto_rawDesc), len(file_gcommon_v1_metrics_config_change_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_metrics_config_change_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_metrics_config_change_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_metrics_config_change_proto_msgTypes,
	}.Build()
	File_gcommon_v1_metrics_config_change_proto = out.File
	file_gcommon_v1_metrics_config_change_proto_goTypes = nil
	file_gcommon_v1_metrics_config_change_proto_depIdxs = nil
}
