...
func (x *ExportConfig) Reset() {
	*x = ExportConfig{}
	mi := &file_gcommon_v1_metrics_export_config_proto_msgTypes[0]
...
const file_gcommon_v1_metrics_export_config_proto_rawDesc = "" +
	"\n" +
	"&gcommon/v1/metrics/export_config.proto\x12\x12gcommon.v1.metrics\x1a!google/protobuf/go_features.proto\"\x91\x05\n" +
	"\fExportConfig\x12 \n" +
	...
	"\x12backoff_multiplier\x18\x04 \x01(\x01R\x11backoffMultiplierB6Z,github.com/jdfalk/gcommon/sdks/go/v1/metrics\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
func init() { file_gcommon_v1_metrics_export_config_proto_init() }
func file_gcommon_v1_metrics_export_config_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_gcommon_v1_metrics_export_config_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_metrics_export_config_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_metrics_export_config_proto_msgTypes,
	}.Build()
	File_gcommon_v1_metrics_export_config_proto = out.File
	file_gcommon_v1_metrics_export_config_proto_goTypes = nil
	file_gcommon_v1_metrics_export_config_proto_depIdxs = nil
}
