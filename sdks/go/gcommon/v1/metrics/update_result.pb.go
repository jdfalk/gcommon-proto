...
type UpdateResult struct {
	...
	xxx_hidden_ConfigChanges   *[]*common1.MetricsConfigChange `protobuf:"bytes,2,rep,name=config_changes,json=configChanges"`
...
func (x *UpdateResult) Reset() {
	*x = UpdateResult{}
	mi := &file_gcommon_v1_metrics_update_result_proto_msgTypes[0]
...
func (x *UpdateResult) GetConfigChanges() []*common1.MetricsConfigChange {
	if x != nil {
...
func (x *UpdateResult) SetConfigChanges(v []*common1.MetricsConfigChange) {
...
type UpdateResult_builder struct {
	...
	ConfigChanges []*common1.MetricsConfigChange
...
var File_gcommon_v1_metrics_update_result_proto protoreflect.FileDescriptor

const file_gcommon_v1_metrics_update_result_proto_rawDesc = "" +
	"\n" +
	"&gcommon/v1/metrics/update_result.proto\x12\x12gcommon.v1.metrics\x1a-gcommon/v1/common/metrics_config_change.proto\x1a%gcommon/v1/common/update_action.proto\x1a!google/protobuf/go_features.proto\"\xd8\x02\n" +
	"\fUpdateResult\x127\n" +
	"\x06action\x18\x01 \x01(\x0e2\x1f.gcommon.v1.common.UpdateActionR\x06action\x12M\n" +
	"\x0econfig_changes\x18\x02 \x03(\v2&.gcommon.v1.common.MetricsConfigChangeR\rconfigChanges\x12)\n" +
	...
	"\x0fupdate_duration\x18\a \x01(\tR\x0eupdateDurationB6Z,github.com/jdfalk/gcommon/sdks/go/v1/metrics\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
var file_gcommon_v1_metrics_update_result_proto_goTypes = []any{
	...
	(*common1.MetricsConfigChange)(nil), // 2: gcommon.v1.common.MetricsConfigChange
}
var file_gcommon_v1_metrics_update_result_proto_depIdxs = []int32{
	...
	2, // 1: gcommon.v1.metrics.UpdateResult.config_changes:type_name -> gcommon.v1.common.MetricsConfigChange
...
func init() { file_gcommon_v1_metrics_update_result_proto_init() }
func file_gcommon_v1_metrics_update_result_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_metrics_update_result_proto_rawDesc), len(file_gcommon_v1_metrics_update_result_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_metrics_update_result_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_metrics_update_result_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_metrics_update_result_proto_msgTypes,
	}.Build()
	File_gcommon_v1_metrics_update_result_proto = out.File
	file_gcommon_v1_metrics_update_result_proto_goTypes = nil
	file_gcommon_v1_metrics_update_result_proto_depIdxs = nil
}
