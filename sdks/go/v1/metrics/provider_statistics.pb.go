...
func (x *ProviderStatistics) Reset() {
	*x = ProviderStatistics{}
	mi := &file_gcommon_v1_metrics_provider_statistics_proto_msgTypes[0]
...
const file_gcommon_v1_metrics_provider_statistics_proto_rawDesc = "" +
	...
	"\x06errors\x18\x04 \x01(\v2$.gcommon.v1.common.MetricsErrorStatsR\x06errors\x12D\n" +
	"\vdata_volume\x18\x05 \x01(\v2#.gcommon.v1.metrics.DataVolumeStatsR\n" +
	"dataVolume\x129\n" +
	"\aexports\x18\x06 \x01(\v2\x1f.gcommon.v1.metrics.ExportStatsR\aexports\x12V\n" +
	"\x0ehealth_history\x18\a \x03(\v2%.gcommon.v1.metrics.HealthStatusEntryB\b\xbaH\x05\x92\x01\x02\b\x01R\rhealthHistory\x12@\n" +
	...
	"topMetrics\x129\n" +
	"\x06trends\x18\n" +
	" \x01(\v2!.gcommon.v1.metrics.TrendAnalysisR\x06trendsB6Z,github.com/jdfalk/gcommon/sdks/go/v1/metrics\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_metrics_provider_statistics_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_metrics_provider_statistics_proto_goTypes = []any{
	...
	(*common.MetricsErrorStats)(nil), // 4: gcommon.v1.common.MetricsErrorStats
...
var file_gcommon_v1_metrics_provider_statistics_proto_depIdxs = []int32{
	...
	4,  // 3: gcommon.v1.metrics.ProviderStatistics.errors:type_name -> gcommon.v1.common.MetricsErrorStats
...
func init() { file_gcommon_v1_metrics_provider_statistics_proto_init() }
func file_gcommon_v1_metrics_provider_statistics_proto_init() {
	if File_gcommon_v1_metrics_provider_statistics_proto != nil {
		return
	}
	file_gcommon_v1_metrics_configuration_summary_proto_init()
	file_gcommon_v1_metrics_data_volume_stats_proto_init()
	file_gcommon_v1_metrics_export_stats_proto_init()
	file_gcommon_v1_metrics_health_status_entry_proto_init()
	file_gcommon_v1_metrics_performance_stats_proto_init()
	file_gcommon_v1_metrics_provider_info_proto_init()
	file_gcommon_v1_metrics_resource_usage_stats_proto_init()
	file_gcommon_v1_metrics_top_metrics_proto_init()
	file_gcommon_v1_metrics_trend_analysis_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_metrics_provider_statistics_proto_rawDesc), len(file_gcommon_v1_metrics_provider_statistics_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_metrics_provider_statistics_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_metrics_provider_statistics_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_metrics_provider_statistics_proto_msgTypes,
	}.Build()
	File_gcommon_v1_metrics_provider_statistics_proto = out.File
	file_gcommon_v1_metrics_provider_statistics_proto_goTypes = nil
	file_gcommon_v1_metrics_provider_statistics_proto_depIdxs = nil
}
