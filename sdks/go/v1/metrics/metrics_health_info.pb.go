...
// 	protoc        (unknown)
// source: gcommon/v1/metrics/metrics_health_info.proto
...
func (x *MetricsHealthInfo) Reset() {
	*x = MetricsHealthInfo{}
	mi := &file_gcommon_v1_metrics_metrics_health_info_proto_msgTypes[0]
...
var File_gcommon_v1_metrics_metrics_health_info_proto protoreflect.FileDescriptor

const file_gcommon_v1_metrics_metrics_health_info_proto_rawDesc = "" +
	"\n" +
	",gcommon/v1/metrics/metrics_health_info.proto\x12\x12gcommon.v1.metrics\x1a%gcommon/v1/common/health_status.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xf1\x01\n" +
	...
	"\n" +
	"last_check\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\tlastCheckB6Z,github.com/jdfalk/gcommon/sdks/go/v1/metrics\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_metrics_metrics_health_info_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_metrics_metrics_health_info_proto_goTypes = []any{
...
var file_gcommon_v1_metrics_metrics_health_info_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_metrics_metrics_health_info_proto_init() }
func file_gcommon_v1_metrics_metrics_health_info_proto_init() {
	if File_gcommon_v1_metrics_metrics_health_info_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_metrics_metrics_health_info_proto_rawDesc), len(file_gcommon_v1_metrics_metrics_health_info_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_metrics_metrics_health_info_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_metrics_metrics_health_info_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_metrics_metrics_health_info_proto_msgTypes,
	}.Build()
	File_gcommon_v1_metrics_metrics_health_info_proto = out.File
	file_gcommon_v1_metrics_metrics_health_info_proto_goTypes = nil
	file_gcommon_v1_metrics_metrics_health_info_proto_depIdxs = nil
}
