...
func (x *ConfigurationSummary) Reset() {
	*x = ConfigurationSummary{}
	mi := &file_gcommon_v1_metrics_configuration_summary_proto_msgTypes[0]
...
var File_gcommon_v1_metrics_configuration_summary_proto protoreflect.FileDescriptor

const file_gcommon_v1_metrics_configuration_summary_proto_rawDesc = "" +
	"\n" +
	".gcommon/v1/metrics/configuration_summary.proto\x12\x12gcommon.v1.metrics\x1a0gcommon/v1/metrics/resource_limits_summary.proto\x1a)gcommon/v1/metrics/security_summary.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x9f\x02\n" +
	...
	"\x0econfig_version\x18\x04 \x01(\tB\x17\xbaH\x14r\x122\x10^v?\\d+\\.\\d+\\.\\d+R\rconfigVersionB6Z,github.com/jdfalk/gcommon/sdks/go/v1/metrics\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_metrics_configuration_summary_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_metrics_configuration_summary_proto_goTypes = []any{
...
var file_gcommon_v1_metrics_configuration_summary_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_metrics_configuration_summary_proto_init() }
func file_gcommon_v1_metrics_configuration_summary_proto_init() {
	if File_gcommon_v1_metrics_configuration_summary_proto != nil {
		return
	}
	file_gcommon_v1_metrics_resource_limits_summary_proto_init()
	file_gcommon_v1_metrics_security_summary_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_metrics_configuration_summary_proto_rawDesc), len(file_gcommon_v1_metrics_configuration_summary_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_metrics_configuration_summary_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_metrics_configuration_summary_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_metrics_configuration_summary_proto_msgTypes,
	}.Build()
	File_gcommon_v1_metrics_configuration_summary_proto = out.File
	file_gcommon_v1_metrics_configuration_summary_proto_goTypes = nil
	file_gcommon_v1_metrics_configuration_summary_proto_depIdxs = nil
}
