...
func (x *ExportDestinationStats) Reset() {
	*x = ExportDestinationStats{}
	mi := &file_gcommon_v1_metrics_export_destination_stats_proto_msgTypes[0]
...
var File_gcommon_v1_metrics_export_destination_stats_proto protoreflect.FileDescriptor

const file_gcommon_v1_metrics_export_destination_stats_proto_rawDesc = "" +
	"\n" +
	"1gcommon/v1/metrics/export_destination_stats.proto\x12\x12gcommon.v1.metrics\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xd0\x02\n" +
...
var file_gcommon_v1_metrics_export_destination_stats_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_metrics_export_destination_stats_proto_goTypes = []any{
	(*ExportDestinationStats)(nil), // 0: gcommon.v1.metrics.ExportDestinationStats
	(*timestamppb.Timestamp)(nil),  // 1: google.protobuf.Timestamp
}
var file_gcommon_v1_metrics_export_destination_stats_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_metrics_export_destination_stats_proto_init() }
func file_gcommon_v1_metrics_export_destination_stats_proto_init() {
	if File_gcommon_v1_metrics_export_destination_stats_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_metrics_export_destination_stats_proto_rawDesc), len(file_gcommon_v1_metrics_export_destination_stats_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_metrics_export_destination_stats_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_metrics_export_destination_stats_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_metrics_export_destination_stats_proto_msgTypes,
	}.Build()
	File_gcommon_v1_metrics_export_destination_stats_proto = out.File
	file_gcommon_v1_metrics_export_destination_stats_proto_goTypes = nil
	file_gcommon_v1_metrics_export_destination_stats_proto_depIdxs = nil
}
