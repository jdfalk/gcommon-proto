...
// 	protoc        (unknown)
// source: gcommon/v1/metrics/record_histogram_response.proto
...
func (x *RecordHistogramResponse) Reset() {
	*x = RecordHistogramResponse{}
	mi := &file_gcommon_v1_metrics_record_histogram_response_proto_msgTypes[0]
...
var File_gcommon_v1_metrics_record_histogram_response_proto protoreflect.FileDescriptor

const file_gcommon_v1_metrics_record_histogram_response_proto_rawDesc = "" +
	"\n" +
	"2gcommon/v1/metrics/record_histogram_response.proto\x12\x12gcommon.v1.metrics\x1a\x1dgcommon/v1/common/error.proto\x1a$gcommon/v1/metrics/bucket_info.proto\x1a)gcommon/v1/metrics/histogram_metric.proto\x1a(gcommon/v1/metrics/histogram_stats.proto\x1a(gcommon/v1/metrics/recording_stats.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xe0\x03\n" +
	...
	"\x0frecording_stats\x18\b \x01(\v2\".gcommon.v1.metrics.RecordingStatsR\x0erecordingStatsB6Z,github.com/jdfalk/gcommon/sdks/go/v1/metrics\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_metrics_record_histogram_response_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_metrics_record_histogram_response_proto_goTypes = []any{
...
var file_gcommon_v1_metrics_record_histogram_response_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_metrics_record_histogram_response_proto_init() }
func file_gcommon_v1_metrics_record_histogram_response_proto_init() {
	if File_gcommon_v1_metrics_record_histogram_response_proto != nil {
		return
	}
	file_gcommon_v1_metrics_bucket_info_proto_init()
	file_gcommon_v1_metrics_histogram_metric_proto_init()
	file_gcommon_v1_metrics_histogram_stats_proto_init()
	file_gcommon_v1_metrics_recording_stats_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_metrics_record_histogram_response_proto_rawDesc), len(file_gcommon_v1_metrics_record_histogram_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_metrics_record_histogram_response_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_metrics_record_histogram_response_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_metrics_record_histogram_response_proto_msgTypes,
	}.Build()
	File_gcommon_v1_metrics_record_histogram_response_proto = out.File
	file_gcommon_v1_metrics_record_histogram_response_proto_goTypes = nil
	file_gcommon_v1_metrics_record_histogram_response_proto_depIdxs = nil
}
