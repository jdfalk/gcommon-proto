...
const file_gcommon_v1_metrics_error_trend_proto_rawDesc = "" +
	"\n" +
	"$gcommon/v1/metrics/error_trend.proto\x12\x12gcommon.v1.metrics\x1a!google/protobuf/go_features.proto\"\x93\x01\n" +
	"\n" +
	"ErrorTrend\x12(\n" +
	"\x10error_rate_trend\x18\x01 \x01(\tR\x0eerrorRateTrend\x12)\n" +
	"\x10trend_confidence\x18\x02 \x01(\x01R\x0ftrendConfidence\x120\n" +
	"\x14emerging_error_types\x18\x03 \x03(\tR\x12emergingErrorTypesB6Z,github.com/jdfalk/gcommon/sdks/go/v1/metrics\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
