...
func (x *ErrorTrend) Reset() {
	*x = ErrorTrend{}
	mi := &file_gcommon_v1_metrics_error_trend_proto_msgTypes[0]
...
var File_gcommon_v1_metrics_error_trend_proto protoreflect.FileDescriptor

const file_gcommon_v1_metrics_error_trend_proto_rawDesc = "" +
	"\n" +
	"$gcommon/v1/metrics/error_trend.proto\x12\x12gcommon.v1.metrics\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xad\x01\n" +
	"\n" +
	"ErrorTrend\x12(\n" +
	...
	"\x14emerging_error_types\x18\x03 \x03(\tB\b\xbaH\x05\x92\x01\x02\b\x01R\x12emergingErrorTypesB6Z,github.com/jdfalk/gcommon/sdks/go/v1/metrics\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_metrics_error_trend_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_metrics_error_trend_proto_goTypes = []any{
	(*ErrorTrend)(nil), // 0: gcommon.v1.metrics.ErrorTrend
}
var file_gcommon_v1_metrics_error_trend_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_metrics_error_trend_proto_init() }
func file_gcommon_v1_metrics_error_trend_proto_init() {
	if File_gcommon_v1_metrics_error_trend_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_metrics_error_trend_proto_rawDesc), len(file_gcommon_v1_metrics_error_trend_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_metrics_error_trend_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_metrics_error_trend_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_metrics_error_trend_proto_msgTypes,
	}.Build()
	File_gcommon_v1_metrics_error_trend_proto = out.File
	file_gcommon_v1_metrics_error_trend_proto_goTypes = nil
	file_gcommon_v1_metrics_error_trend_proto_depIdxs = nil
}
