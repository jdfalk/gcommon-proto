...
const file_gcommon_v1_metrics_counter_config_proto_rawDesc = "" +
	"\n" +
	"'gcommon/v1/metrics/counter_config.proto\x12\x12gcommon.v1.metrics\x1a!google/protobuf/go_features.proto\"r\n" +
	"\rCounterConfig\x12#\n" +
	"\rinitial_value\x18\x01 \x01(\x01R\finitialValue\x12\x1f\n" +
	"\vallow_reset\x18\x02 \x01(\bR\n" +
	"allowReset\x12\x1b\n" +
	"\tmax_value\x18\x03 \x01(\x01R\bmaxValueB6Z,github.com/jdfalk/gcommon/sdks/go/v1/metrics\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
