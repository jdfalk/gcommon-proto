...
func (x *DataVolumeStats) Reset() {
	*x = DataVolumeStats{}
	mi := &file_gcommon_v1_metrics_data_volume_stats_proto_msgTypes[0]
...
var File_gcommon_v1_metrics_data_volume_stats_proto protoreflect.FileDescriptor

const file_gcommon_v1_metrics_data_volume_stats_proto_rawDesc = "" +
	"\n" +
	"*gcommon/v1/metrics/data_volume_stats.proto\x12\x12gcommon.v1.metrics\x1a/gcommon/v1/metrics/data_volume_data_point.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xe9\x03\n" +
	...
	"\x11compression_ratio\x18\x06 \x01(\x01B\x0e\xbaH\v\x12\t)\x00\x00\x00\x00\x00\x00\x00\x00R\x10compressionRatio\x12^\n" +
	"\x11volume_timeseries\x18\a \x03(\v2'.gcommon.v1.metrics.DataVolumeDataPointB\b\xbaH\x05\x92\x01\x02\b\x01R\x10volumeTimeseriesB6Z,github.com/jdfalk/gcommon/sdks/go/v1/metrics\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_metrics_data_volume_stats_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_metrics_data_volume_stats_proto_goTypes = []any{
	(*DataVolumeStats)(nil),     // 0: gcommon.v1.metrics.DataVolumeStats
	(*DataVolumeDataPoint)(nil), // 1: gcommon.v1.metrics.DataVolumeDataPoint
}
var file_gcommon_v1_metrics_data_volume_stats_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_metrics_data_volume_stats_proto_init() }
func file_gcommon_v1_metrics_data_volume_stats_proto_init() {
	if File_gcommon_v1_metrics_data_volume_stats_proto != nil {
		return
	}
	file_gcommon_v1_metrics_data_volume_data_point_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_metrics_data_volume_stats_proto_rawDesc), len(file_gcommon_v1_metrics_data_volume_stats_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_metrics_data_volume_stats_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_metrics_data_volume_stats_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_metrics_data_volume_stats_proto_msgTypes,
	}.Build()
	File_gcommon_v1_metrics_data_volume_stats_proto = out.File
	file_gcommon_v1_metrics_data_volume_stats_proto_goTypes = nil
	file_gcommon_v1_metrics_data_volume_stats_proto_depIdxs = nil
}
