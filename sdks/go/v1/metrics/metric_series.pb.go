...
// 	protoc        (unknown)
// source: gcommon/v1/metrics/metric_series.proto
...
func (x *MetricSeries) Reset() {
	*x = MetricSeries{}
	mi := &file_gcommon_v1_metrics_metric_series_proto_msgTypes[0]
...
var File_gcommon_v1_metrics_metric_series_proto protoreflect.FileDescriptor

const file_gcommon_v1_metrics_metric_series_proto_rawDesc = "" +
	"\n" +
	"&gcommon/v1/metrics/metric_series.proto\x12\x12gcommon.v1.metrics\x1a#gcommon/v1/common/metric_type.proto\x1a%gcommon/v1/metrics/metric_value.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xc4\x02\n" +
	"\fMetricSeries\x12\x1d\n" +
	"\x04name\x18\x01 \x01(\tB\t\xbaH\x06r\x04\x10\x01\x18dR\x04name\x128\n" +
	"\x04type\x18\x02 \x01(\x0e2$.gcommon.v1.common.MetricsMetricTypeR\x04type\x12D\n" +
...
var file_gcommon_v1_metrics_metric_series_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_gcommon_v1_metrics_metric_series_proto_goTypes = []any{
...
var file_gcommon_v1_metrics_metric_series_proto_depIdxs = []int32{
	2, // 0: gcommon.v1.metrics.MetricSeries.type:type_name -> gcommon.v1.common.MetricsMetricType
...
func init() { file_gcommon_v1_metrics_metric_series_proto_init() }
func file_gcommon_v1_metrics_metric_series_proto_init() {
	if File_gcommon_v1_metrics_metric_series_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_metrics_metric_series_proto_rawDesc), len(file_gcommon_v1_metrics_metric_series_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_metrics_metric_series_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_metrics_metric_series_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_metrics_metric_series_proto_msgTypes,
	}.Build()
	File_gcommon_v1_metrics_metric_series_proto = out.File
	file_gcommon_v1_metrics_metric_series_proto_goTypes = nil
	file_gcommon_v1_metrics_metric_series_proto_depIdxs = nil
}
