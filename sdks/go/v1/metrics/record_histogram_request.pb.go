...
// 	protoc        (unknown)
// source: gcommon/v1/metrics/record_histogram_request.proto
...
func (x *RecordHistogramRequest) Reset() {
	*x = RecordHistogramRequest{}
	mi := &file_gcommon_v1_metrics_record_histogram_request_proto_msgTypes[0]
...
var File_gcommon_v1_metrics_record_histogram_request_proto protoreflect.FileDescriptor

const file_gcommon_v1_metrics_record_histogram_request_proto_rawDesc = "" +
	"\n" +
	"1gcommon/v1/metrics/record_histogram_request.proto\x12\x12gcommon.v1.metrics\x1a(gcommon/v1/common/request_metadata.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xe5\x03\n" +
...
var file_gcommon_v1_metrics_record_histogram_request_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_gcommon_v1_metrics_record_histogram_request_proto_goTypes = []any{
...
var file_gcommon_v1_metrics_record_histogram_request_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_metrics_record_histogram_request_proto_init() }
func file_gcommon_v1_metrics_record_histogram_request_proto_init() {
	if File_gcommon_v1_metrics_record_histogram_request_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_metrics_record_histogram_request_proto_rawDesc), len(file_gcommon_v1_metrics_record_histogram_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_metrics_record_histogram_request_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_metrics_record_histogram_request_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_metrics_record_histogram_request_proto_msgTypes,
	}.Build()
	File_gcommon_v1_metrics_record_histogram_request_proto = out.File
	file_gcommon_v1_metrics_record_histogram_request_proto_goTypes = nil
	file_gcommon_v1_metrics_record_histogram_request_proto_depIdxs = nil
}
