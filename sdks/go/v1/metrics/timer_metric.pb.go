...
func (x *TimerMetric) Reset() {
	*x = TimerMetric{}
	mi := &file_gcommon_v1_metrics_timer_metric_proto_msgTypes[0]
...
var file_gcommon_v1_metrics_timer_metric_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_gcommon_v1_metrics_timer_metric_proto_goTypes = []any{
...
var file_gcommon_v1_metrics_timer_metric_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_metrics_timer_metric_proto_init() }
func file_gcommon_v1_metrics_timer_metric_proto_init() {
	if File_gcommon_v1_metrics_timer_metric_proto != nil {
		return
	}
	file_gcommon_v1_metrics_percentile_measurement_proto_init()
	file_gcommon_v1_metrics_timer_statistics_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_metrics_timer_metric_proto_rawDesc), len(file_gcommon_v1_metrics_timer_metric_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_metrics_timer_metric_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_metrics_timer_metric_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_metrics_timer_metric_proto_msgTypes,
	}.Build()
	File_gcommon_v1_metrics_timer_metric_proto = out.File
	file_gcommon_v1_metrics_timer_metric_proto_goTypes = nil
	file_gcommon_v1_metrics_timer_metric_proto_depIdxs = nil
}
