...
// 	protoc        (unknown)
// source: gcommon/v1/metrics/metric_metadata.proto
...
func (x *MetricMetadata) Reset() {
	*x = MetricMetadata{}
	mi := &file_gcommon_v1_metrics_metric_metadata_proto_msgTypes[0]
...
var File_gcommon_v1_metrics_metric_metadata_proto protoreflect.FileDescriptor

const file_gcommon_v1_metrics_metric_metadata_proto_rawDesc = "" +
	"\n" +
	"(gcommon/v1/metrics/metric_metadata.proto\x12\x12gcommon.v1.metrics\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xa3\x04\n" +
	...
	"\x06labels\x18\x06 \x03(\v2..gcommon.v1.metrics.MetricMetadata.LabelsEntryR\x06labels\x12A\n" +
	"\n" +
...
var file_gcommon_v1_metrics_metric_metadata_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_gcommon_v1_metrics_metric_metadata_proto_goTypes = []any{
	(*MetricMetadata)(nil),        // 0: gcommon.v1.metrics.MetricMetadata
	nil,                           // 1: gcommon.v1.metrics.MetricMetadata.LabelsEntry
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
}
var file_gcommon_v1_metrics_metric_metadata_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_metrics_metric_metadata_proto_init() }
func file_gcommon_v1_metrics_metric_metadata_proto_init() {
	if File_gcommon_v1_metrics_metric_metadata_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_metrics_metric_metadata_proto_rawDesc), len(file_gcommon_v1_metrics_metric_metadata_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_metrics_metric_metadata_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_metrics_metric_metadata_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_metrics_metric_metadata_proto_msgTypes,
	}.Build()
	File_gcommon_v1_metrics_metric_metadata_proto = out.File
	file_gcommon_v1_metrics_metric_metadata_proto_goTypes = nil
	file_gcommon_v1_metrics_metric_metadata_proto_depIdxs = nil
}
