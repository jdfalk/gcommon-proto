...
// 	protoc        (unknown)
// source: gcommon/v1/metrics/unregister_metric_request.proto
...
func (x *UnregisterMetricRequest) Reset() {
	*x = UnregisterMetricRequest{}
	mi := &file_gcommon_v1_metrics_unregister_metric_request_proto_msgTypes[0]
...
func (x case_UnregisterMetricRequest_MetricIdentifier) String() string {
	md := file_gcommon_v1_metrics_unregister_metric_request_proto_msgTypes[0].Descriptor()
	if x == 0 {
		return "not set"
	}
...
var File_gcommon_v1_metrics_unregister_metric_request_proto protoreflect.FileDescriptor

const file_gcommon_v1_metrics_unregister_metric_request_proto_rawDesc = "" +
	"\n" +
	"2gcommon/v1/metrics/unregister_metric_request.proto\x12\x12gcommon.v1.metrics\x1a(gcommon/v1/common/request_metadata.proto\x1a/gcommon/v1/metrics/unregistration_options.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xa1\x02\n" +
	...
	"\x11metric_identifierB6Z,github.com/jdfalk/gcommon/sdks/go/v1/metrics\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_metrics_unregister_metric_request_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_metrics_unregister_metric_request_proto_goTypes = []any{
...
var file_gcommon_v1_metrics_unregister_metric_request_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_metrics_unregister_metric_request_proto_init() }
func file_gcommon_v1_metrics_unregister_metric_request_proto_init() {
	if File_gcommon_v1_metrics_unregister_metric_request_proto != nil {
		return
	}
	file_gcommon_v1_metrics_unregistration_options_proto_init()
	file_gcommon_v1_metrics_unregister_metric_request_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_metrics_unregister_metric_request_proto_rawDesc), len(file_gcommon_v1_metrics_unregister_metric_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_metrics_unregister_metric_request_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_metrics_unregister_metric_request_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_metrics_unregister_metric_request_proto_msgTypes,
	}.Build()
	File_gcommon_v1_metrics_unregister_metric_request_proto = out.File
	file_gcommon_v1_metrics_unregister_metric_request_proto_goTypes = nil
	file_gcommon_v1_metrics_unregister_metric_request_proto_depIdxs = nil
}
