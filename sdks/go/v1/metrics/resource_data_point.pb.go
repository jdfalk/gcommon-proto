...
func (x *ResourceDataPoint) Reset() {
	*x = ResourceDataPoint{}
	mi := &file_gcommon_v1_metrics_resource_data_point_proto_msgTypes[0]
...
var File_gcommon_v1_metrics_resource_data_point_proto protoreflect.FileDescriptor

const file_gcommon_v1_metrics_resource_data_point_proto_rawDesc = "" +
	"\n" +
	",gcommon/v1/metrics/resource_data_point.proto\x12\x12gcommon.v1.metrics\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xe6\x02\n" +
	...
	"\x18network_bytes_per_second\x18\x05 \x01(\x03B\a\xbaH\x04\"\x02(\x00R\x15networkBytesPerSecondB6Z,github.com/jdfalk/gcommon/sdks/go/v1/metrics\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_metrics_resource_data_point_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_metrics_resource_data_point_proto_goTypes = []any{
	(*ResourceDataPoint)(nil),     // 0: gcommon.v1.metrics.ResourceDataPoint
	(*timestamppb.Timestamp)(nil), // 1: google.protobuf.Timestamp
}
var file_gcommon_v1_metrics_resource_data_point_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_metrics_resource_data_point_proto_init() }
func file_gcommon_v1_metrics_resource_data_point_proto_init() {
	if File_gcommon_v1_metrics_resource_data_point_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_metrics_resource_data_point_proto_rawDesc), len(file_gcommon_v1_metrics_resource_data_point_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_metrics_resource_data_point_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_metrics_resource_data_point_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_metrics_resource_data_point_proto_msgTypes,
	}.Build()
	File_gcommon_v1_metrics_resource_data_point_proto = out.File
	file_gcommon_v1_metrics_resource_data_point_proto_goTypes = nil
	file_gcommon_v1_metrics_resource_data_point_proto_depIdxs = nil
}
