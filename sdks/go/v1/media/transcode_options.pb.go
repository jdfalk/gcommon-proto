...
// 	protoc        (unknown)
// source: gcommon/v1/media/messages/transcode_options.proto
...
func (x *TranscodeOptions) Reset() {
	*x = TranscodeOptions{}
	mi := &file_gcommon_v1_media_messages_transcode_options_proto_msgTypes[0]
...
var File_gcommon_v1_media_messages_transcode_options_proto protoreflect.FileDescriptor

const file_gcommon_v1_media_messages_transcode_options_proto_rawDesc = "" +
	"\n" +
	"1gcommon/v1/media/messages/transcode_options.proto\x12\x10gcommon.v1.media\x1a!google/protobuf/go_features.proto\"\x8c\x02\n" +
	...
	"\x11preserve_chapters\x18\a \x01(\bR\x10preserveChaptersB\x12Z\bv1/media\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_media_messages_transcode_options_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_media_messages_transcode_options_proto_goTypes = []any{
	(*TranscodeOptions)(nil), // 0: gcommon.v1.media.TranscodeOptions
}
var file_gcommon_v1_media_messages_transcode_options_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_media_messages_transcode_options_proto_init() }
func file_gcommon_v1_media_messages_transcode_options_proto_init() {
	if File_gcommon_v1_media_messages_transcode_options_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_media_messages_transcode_options_proto_rawDesc), len(file_gcommon_v1_media_messages_transcode_options_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_media_messages_transcode_options_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_media_messages_transcode_options_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_media_messages_transcode_options_proto_msgTypes,
	}.Build()
	File_gcommon_v1_media_messages_transcode_options_proto = out.File
	file_gcommon_v1_media_messages_transcode_options_proto_goTypes = nil
	file_gcommon_v1_media_messages_transcode_options_proto_depIdxs = nil
}
