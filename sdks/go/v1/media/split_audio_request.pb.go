...
func (x *SplitAudioRequest) Reset() {
	*x = SplitAudioRequest{}
	mi := &file_gcommon_v1_media_messages_split_audio_request_proto_msgTypes[0]
...
func (x *SplitPoint) Reset() {
	*x = SplitPoint{}
	mi := &file_gcommon_v1_media_messages_split_audio_request_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_gcommon_v1_media_messages_split_audio_request_proto protoreflect.FileDescriptor

const file_gcommon_v1_media_messages_split_audio_request_proto_rawDesc = "" +
	"\n" +
	...
	"\fsplit_points\x18\x02 \x03(\v2\x1c.gcommon.v1.media.SplitPointR\vsplitPoints\"h\n" +
	"\n" +
	"SplitPoint\x127\n" +
	"\ttimestamp\x18\x01 \x01(\v2\x19.google.protobuf.DurationR\ttimestamp\x12!\n" +
	"\fsegment_name\x18\x02 \x01(\tR\vsegmentNameB\x12Z\bv1/media\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_media_messages_split_audio_request_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_gcommon_v1_media_messages_split_audio_request_proto_goTypes = []any{
	(*SplitAudioRequest)(nil),   // 0: gcommon.v1.media.SplitAudioRequest
	(*SplitPoint)(nil),          // 1: gcommon.v1.media.SplitPoint
	(*durationpb.Duration)(nil), // 2: google.protobuf.Duration
}
var file_gcommon_v1_media_messages_split_audio_request_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_media_messages_split_audio_request_proto_init() }
func file_gcommon_v1_media_messages_split_audio_request_proto_init() {
	if File_gcommon_v1_media_messages_split_audio_request_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_media_messages_split_audio_request_proto_rawDesc), len(file_gcommon_v1_media_messages_split_audio_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_media_messages_split_audio_request_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_media_messages_split_audio_request_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_media_messages_split_audio_request_proto_msgTypes,
	}.Build()
	File_gcommon_v1_media_messages_split_audio_request_proto = out.File
	file_gcommon_v1_media_messages_split_audio_request_proto_goTypes = nil
	file_gcommon_v1_media_messages_split_audio_request_proto_depIdxs = nil
}
