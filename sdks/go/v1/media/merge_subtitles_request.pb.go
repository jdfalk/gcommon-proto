...
// 	protoc        (unknown)
// source: gcommon/v1/media/messages/merge_subtitles_request.proto
...
func (ConflictResolution) Descriptor() protoreflect.EnumDescriptor {
	return file_gcommon_v1_media_messages_merge_subtitles_request_proto_enumTypes[0].Descriptor()
}

func (ConflictResolution) Type() protoreflect.EnumType {
	return &file_gcommon_v1_media_messages_merge_subtitles_request_proto_enumTypes[0]
}
...
func (x *MergeSubtitlesRequest) Reset() {
	*x = MergeSubtitlesRequest{}
	mi := &file_gcommon_v1_media_messages_merge_subtitles_request_proto_msgTypes[0]
...
func (x *MergeOptions) Reset() {
	*x = MergeOptions{}
	mi := &file_gcommon_v1_media_messages_merge_subtitles_request_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_gcommon_v1_media_messages_merge_subtitles_request_proto protoreflect.FileDescriptor

const file_gcommon_v1_media_messages_merge_subtitles_request_proto_rawDesc = "" +
	"\n" +
	"7gcommon/v1/media/messages/merge_subtitles_request.proto\x12\x10gcommon.v1.media\x1a!google/protobuf/go_features.proto\"}\n" +
	...
	"\x19CONFLICT_RESOLUTION_ERROR\x10\x04B\x12Z\bv1/media\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_media_messages_merge_subtitles_request_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_gcommon_v1_media_messages_merge_subtitles_request_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_gcommon_v1_media_messages_merge_subtitles_request_proto_goTypes = []any{
...
var file_gcommon_v1_media_messages_merge_subtitles_request_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_media_messages_merge_subtitles_request_proto_init() }
func file_gcommon_v1_media_messages_merge_subtitles_request_proto_init() {
	if File_gcommon_v1_media_messages_merge_subtitles_request_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_media_messages_merge_subtitles_request_proto_rawDesc), len(file_gcommon_v1_media_messages_merge_subtitles_request_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_media_messages_merge_subtitles_request_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_media_messages_merge_subtitles_request_proto_depIdxs,
		EnumInfos:         file_gcommon_v1_media_messages_merge_subtitles_request_proto_enumTypes,
		MessageInfos:      file_gcommon_v1_media_messages_merge_subtitles_request_proto_msgTypes,
	}.Build()
	File_gcommon_v1_media_messages_merge_subtitles_request_proto = out.File
	file_gcommon_v1_media_messages_merge_subtitles_request_proto_goTypes = nil
	file_gcommon_v1_media_messages_merge_subtitles_request_proto_depIdxs = nil
}
