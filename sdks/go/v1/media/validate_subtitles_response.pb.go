...
func (x *ValidateSubtitlesResponse) Reset() {
	*x = ValidateSubtitlesResponse{}
	mi := &file_gcommon_v1_media_messages_validate_subtitles_response_proto_msgTypes[0]
...
func (x *ValidationError) Reset() {
	*x = ValidationError{}
	mi := &file_gcommon_v1_media_messages_validate_subtitles_response_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *ValidationWarning) Reset() {
	*x = ValidationWarning{}
	mi := &file_gcommon_v1_media_messages_validate_subtitles_response_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *ValidationStatistics) Reset() {
	*x = ValidationStatistics{}
	mi := &file_gcommon_v1_media_messages_validate_subtitles_response_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_gcommon_v1_media_messages_validate_subtitles_response_proto protoreflect.FileDescriptor

const file_gcommon_v1_media_messages_validate_subtitles_response_proto_rawDesc = "" +
	"\n" +
	...
	"\x15max_reading_speed_wpm\x18\x04 \x01(\x01R\x12maxReadingSpeedWpmB\x12Z\bv1/media\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_media_messages_validate_subtitles_response_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_gcommon_v1_media_messages_validate_subtitles_response_proto_goTypes = []any{
...
var file_gcommon_v1_media_messages_validate_subtitles_response_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_media_messages_validate_subtitles_response_proto_init() }
func file_gcommon_v1_media_messages_validate_subtitles_response_proto_init() {
	if File_gcommon_v1_media_messages_validate_subtitles_response_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_media_messages_validate_subtitles_response_proto_rawDesc), len(file_gcommon_v1_media_messages_validate_subtitles_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_media_messages_validate_subtitles_response_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_media_messages_validate_subtitles_response_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_media_messages_validate_subtitles_response_proto_msgTypes,
	}.Build()
	File_gcommon_v1_media_messages_validate_subtitles_response_proto = out.File
	file_gcommon_v1_media_messages_validate_subtitles_response_proto_goTypes = nil
	file_gcommon_v1_media_messages_validate_subtitles_response_proto_depIdxs = nil
}
