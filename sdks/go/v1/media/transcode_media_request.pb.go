...
func (x *TranscodeMediaRequest) Reset() {
	*x = TranscodeMediaRequest{}
	mi := &file_gcommon_v1_media_transcode_media_request_proto_msgTypes[0]
...
const file_gcommon_v1_media_transcode_media_request_proto_rawDesc = "" +
	"\n" +
	".gcommon/v1/media/transcode_media_request.proto\x12\x10gcommon.v1.media\x1a(gcommon/v1/media/transcode_options.proto\x1a!google/protobuf/go_features.proto\"\xc1\x01\n" +
...
func init() { file_gcommon_v1_media_transcode_media_request_proto_init() }
func file_gcommon_v1_media_transcode_media_request_proto_init() {
	if File_gcommon_v1_media_transcode_media_request_proto != nil {
		return
	}
	file_gcommon_v1_media_transcode_options_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_media_transcode_media_request_proto_rawDesc), len(file_gcommon_v1_media_transcode_media_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_media_transcode_media_request_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_media_transcode_media_request_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_media_transcode_media_request_proto_msgTypes,
	}.Build()
	File_gcommon_v1_media_transcode_media_request_proto = out.File
	file_gcommon_v1_media_transcode_media_request_proto_goTypes = nil
	file_gcommon_v1_media_transcode_media_request_proto_depIdxs = nil
}
