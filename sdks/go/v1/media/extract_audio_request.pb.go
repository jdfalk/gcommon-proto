...
func (x *ExtractAudioRequest) Reset() {
	*x = ExtractAudioRequest{}
	mi := &file_gcommon_v1_media_extract_audio_request_proto_msgTypes[0]
...
func (x *AudioExtractionOptions) Reset() {
	*x = AudioExtractionOptions{}
	mi := &file_gcommon_v1_media_extract_audio_request_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
const file_gcommon_v1_media_extract_audio_request_proto_rawDesc = "" +
	"\n" +
	",gcommon/v1/media/extract_audio_request.proto\x12\x10gcommon.v1.media\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xab\x01\n" +
...
var file_gcommon_v1_media_extract_audio_request_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
...
func init() { file_gcommon_v1_media_extract_audio_request_proto_init() }
func file_gcommon_v1_media_extract_audio_request_proto_init() {
	if File_gcommon_v1_media_extract_audio_request_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_media_extract_audio_request_proto_rawDesc), len(file_gcommon_v1_media_extract_audio_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_media_extract_audio_request_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_media_extract_audio_request_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_media_extract_audio_request_proto_msgTypes,
	}.Build()
	File_gcommon_v1_media_extract_audio_request_proto = out.File
	file_gcommon_v1_media_extract_audio_request_proto_goTypes = nil
	file_gcommon_v1_media_extract_audio_request_proto_depIdxs = nil
}
