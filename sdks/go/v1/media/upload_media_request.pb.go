...
func (x *UploadMediaRequest) Reset() {
	*x = UploadMediaRequest{}
	mi := &file_gcommon_v1_media_messages_upload_media_request_proto_msgTypes[0]
...
func (x case_UploadMediaRequest_Data) String() string {
	md := file_gcommon_v1_media_messages_upload_media_request_proto_msgTypes[0].Descriptor()
	if x == 0 {
		return "not set"
	}
...
func (x *UploadMetadata) Reset() {
	*x = UploadMetadata{}
	mi := &file_gcommon_v1_media_messages_upload_media_request_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_gcommon_v1_media_messages_upload_media_request_proto protoreflect.FileDescriptor

const file_gcommon_v1_media_messages_upload_media_request_proto_rawDesc = "" +
	"\n" +
	...
	"\x0emedia_metadata\x18\x04 \x01(\v2\x1f.gcommon.v1.media.MediaMetadataR\rmediaMetadataB\x12Z\bv1/media\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_media_messages_upload_media_request_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_gcommon_v1_media_messages_upload_media_request_proto_goTypes = []any{
...
var file_gcommon_v1_media_messages_upload_media_request_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_media_messages_upload_media_request_proto_init() }
func file_gcommon_v1_media_messages_upload_media_request_proto_init() {
	if File_gcommon_v1_media_messages_upload_media_request_proto != nil {
		return
	}
	file_gcommon_v1_media_messages_media_metadata_proto_init()
	file_gcommon_v1_media_messages_upload_media_request_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_media_messages_upload_media_request_proto_rawDesc), len(file_gcommon_v1_media_messages_upload_media_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_media_messages_upload_media_request_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_media_messages_upload_media_request_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_media_messages_upload_media_request_proto_msgTypes,
	}.Build()
	File_gcommon_v1_media_messages_upload_media_request_proto = out.File
	file_gcommon_v1_media_messages_upload_media_request_proto_goTypes = nil
	file_gcommon_v1_media_messages_upload_media_request_proto_depIdxs = nil
}
