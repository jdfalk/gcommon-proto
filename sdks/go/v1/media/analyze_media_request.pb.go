...
// 	protoc        (unknown)
// source: gcommon/v1/media/messages/analyze_media_request.proto
...
func (x *AnalyzeMediaRequest) Reset() {
	*x = AnalyzeMediaRequest{}
	mi := &file_gcommon_v1_media_messages_analyze_media_request_proto_msgTypes[0]
...
func (x *AnalysisOptions) Reset() {
	*x = AnalysisOptions{}
	mi := &file_gcommon_v1_media_messages_analyze_media_request_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_gcommon_v1_media_messages_analyze_media_request_proto protoreflect.FileDescriptor

const file_gcommon_v1_media_messages_analyze_media_request_proto_rawDesc = "" +
	"\n" +
	"5gcommon/v1/media/messages/analyze_media_request.proto\x12\x10gcommon.v1.media\x1a!google/protobuf/go_features.proto\"v\n" +
	...
	"\ranalyze_audio\x18\x05 \x01(\bR\fanalyzeAudioB\x12Z\bv1/media\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_media_messages_analyze_media_request_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_gcommon_v1_media_messages_analyze_media_request_proto_goTypes = []any{
	(*AnalyzeMediaRequest)(nil), // 0: gcommon.v1.media.AnalyzeMediaRequest
	(*AnalysisOptions)(nil),     // 1: gcommon.v1.media.AnalysisOptions
}
var file_gcommon_v1_media_messages_analyze_media_request_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_media_messages_analyze_media_request_proto_init() }
func file_gcommon_v1_media_messages_analyze_media_request_proto_init() {
	if File_gcommon_v1_media_messages_analyze_media_request_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_media_messages_analyze_media_request_proto_rawDesc), len(file_gcommon_v1_media_messages_analyze_media_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_media_messages_analyze_media_request_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_media_messages_analyze_media_request_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_media_messages_analyze_media_request_proto_msgTypes,
	}.Build()
	File_gcommon_v1_media_messages_analyze_media_request_proto = out.File
	file_gcommon_v1_media_messages_analyze_media_request_proto_goTypes = nil
	file_gcommon_v1_media_messages_analyze_media_request_proto_depIdxs = nil
}
