...
func (x *WebCacheConfig) Reset() {
	*x = WebCacheConfig{}
	mi := &file_gcommon_v1_web_cache_config_proto_msgTypes[0]
...
var File_gcommon_v1_web_cache_config_proto protoreflect.FileDescriptor

const file_gcommon_v1_web_cache_config_proto_rawDesc = "" +
	"\n" +
	"!gcommon/v1/web/cache_config.proto\x12\x0egcommon.v1.web\x1a$gcommon/v1/common/cache_policy.proto\x1a&gcommon/v1/common/cache_strategy.proto\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xfb\x01\n" +
	...
	"\n" +
	"cache_name\x18\x05 \x01(\tB\t\xbaH\x06r\x04\x10\x01\x18dR\tcacheNameB2Z(github.com/jdfalk/gcommon/sdks/go/v1/web\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
func init() { file_gcommon_v1_web_cache_config_proto_init() }
func file_gcommon_v1_web_cache_config_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_web_cache_config_proto_rawDesc), len(file_gcommon_v1_web_cache_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_web_cache_config_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_web_cache_config_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_web_cache_config_proto_msgTypes,
	}.Build()
	File_gcommon_v1_web_cache_config_proto = out.File
	file_gcommon_v1_web_cache_config_proto_goTypes = nil
	file_gcommon_v1_web_cache_config_proto_depIdxs = nil
}
