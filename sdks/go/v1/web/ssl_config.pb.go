...
func (x *SslConfig) Reset() {
	*x = SslConfig{}
	mi := &file_gcommon_v1_web_ssl_config_proto_msgTypes[0]
...
var File_gcommon_v1_web_ssl_config_proto protoreflect.FileDescriptor

const file_gcommon_v1_web_ssl_config_proto_rawDesc = "" +
	"\n" +
	"\x1fgcommon/v1/web/ssl_config.proto\x12\x0egcommon.v1.web\x1a$gcommon/v1/common/ssl_protocol.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xe3\x01\n" +
	"\tSslConfig\x12:\n" +
	"\bprotocol\x18\x01 \x01(\x0e2\x1e.gcommon.v1.common.SSLProtocolR\bprotocol\x12$\n" +
	...
	"\x13require_client_auth\x18\x05 \x01(\bR\x11requireClientAuthB2Z(github.com/jdfalk/gcommon/sdks/go/v1/web\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
func init() { file_gcommon_v1_web_ssl_config_proto_init() }
func file_gcommon_v1_web_ssl_config_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_web_ssl_config_proto_rawDesc), len(file_gcommon_v1_web_ssl_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_web_ssl_config_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_web_ssl_config_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_web_ssl_config_proto_msgTypes,
	}.Build()
	File_gcommon_v1_web_ssl_config_proto = out.File
	file_gcommon_v1_web_ssl_config_proto_goTypes = nil
	file_gcommon_v1_web_ssl_config_proto_depIdxs = nil
}
