...
func (x *StartServerResponse) Reset() {
	*x = StartServerResponse{}
	mi := &file_gcommon_v1_web_start_server_response_proto_msgTypes[0]
...
var File_gcommon_v1_web_start_server_response_proto protoreflect.FileDescriptor

const file_gcommon_v1_web_start_server_response_proto_rawDesc = "" +
	"\n" +
	"*gcommon/v1/web/start_server_response.proto\x12\x0egcommon.v1.web\x1a\x1dgcommon/v1/common/error.proto\x1a%gcommon/v1/common/server_status.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xc8\x01\n" +
...
func init() { file_gcommon_v1_web_start_server_response_proto_init() }
func file_gcommon_v1_web_start_server_response_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_web_start_server_response_proto_rawDesc), len(file_gcommon_v1_web_start_server_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_web_start_server_response_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_web_start_server_response_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_web_start_server_response_proto_msgTypes,
	}.Build()
	File_gcommon_v1_web_start_server_response_proto = out.File
	file_gcommon_v1_web_start_server_response_proto_goTypes = nil
	file_gcommon_v1_web_start_server_response_proto_depIdxs = nil
}
