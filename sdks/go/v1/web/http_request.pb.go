...
// 	protoc        (unknown)
// source: gcommon/v1/web/http_request.proto
...
func (x *HttpRequest) Reset() {
	*x = HttpRequest{}
	mi := &file_gcommon_v1_web_http_request_proto_msgTypes[0]
...
var File_gcommon_v1_web_http_request_proto protoreflect.FileDescriptor

const file_gcommon_v1_web_http_request_proto_rawDesc = "" +
	"\n" +
	"!gcommon/v1/web/http_request.proto\x12\x0egcommon.v1.web\x1a(gcommon/v1/common/request_metadata.proto\x1a\x19google/protobuf/any.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xfc\n" +
	"\n" +
...
var file_gcommon_v1_web_http_request_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_gcommon_v1_web_http_request_proto_goTypes = []any{
...
var file_gcommon_v1_web_http_request_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_web_http_request_proto_init() }
func file_gcommon_v1_web_http_request_proto_init() {
	if File_gcommon_v1_web_http_request_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_web_http_request_proto_rawDesc), len(file_gcommon_v1_web_http_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_web_http_request_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_web_http_request_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_web_http_request_proto_msgTypes,
	}.Build()
	File_gcommon_v1_web_http_request_proto = out.File
	file_gcommon_v1_web_http_request_proto_goTypes = nil
	file_gcommon_v1_web_http_request_proto_depIdxs = nil
}
