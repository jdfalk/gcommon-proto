...
// 	protoc        (unknown)
// source: gcommon/v1/web/list_middleware_request.proto
...
func (x *ListMiddlewareRequest) Reset() {
	*x = ListMiddlewareRequest{}
	mi := &file_gcommon_v1_web_list_middleware_request_proto_msgTypes[0]
...
var File_gcommon_v1_web_list_middleware_request_proto protoreflect.FileDescriptor

const file_gcommon_v1_web_list_middleware_request_proto_rawDesc = "" +
	"\n" +
	",gcommon/v1/web/list_middleware_request.proto\x12\x0egcommon.v1.web\x1a'gcommon/v1/common/middleware_type.proto\x1a\"gcommon/v1/common/pagination.proto\x1a(gcommon/v1/common/request_metadata.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x8d\x02\n" +
	"\x15ListMiddlewareRequest\x12$\n" +
	"\tserver_id\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\bserverId\x125\n" +
	...
	"pagination\x12>\n" +
	"\bmetadata\x18\x05 \x01(\v2\".gcommon.v1.common.RequestMetadataR\bmetadataB2Z(github.com/jdfalk/gcommon/sdks/go/v1/web\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
func init() { file_gcommon_v1_web_list_middleware_request_proto_init() }
func file_gcommon_v1_web_list_middleware_request_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_web_list_middleware_request_proto_rawDesc), len(file_gcommon_v1_web_list_middleware_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_web_list_middleware_request_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_web_list_middleware_request_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_web_list_middleware_request_proto_msgTypes,
	}.Build()
	File_gcommon_v1_web_list_middleware_request_proto = out.File
	file_gcommon_v1_web_list_middleware_request_proto_goTypes = nil
	file_gcommon_v1_web_list_middleware_request_proto_depIdxs = nil
}
