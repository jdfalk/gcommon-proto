...
// 	protoc        (unknown)
// source: gcommon/v1/web/middleware_config.proto
...
func (x *MiddlewareConfig) Reset() {
	*x = MiddlewareConfig{}
	mi := &file_gcommon_v1_web_middleware_config_proto_msgTypes[0]
...
var File_gcommon_v1_web_middleware_config_proto protoreflect.FileDescriptor

const file_gcommon_v1_web_middleware_config_proto_rawDesc = "" +
	"\n" +
	"&gcommon/v1/web/middleware_config.proto\x12\x0egcommon.v1.web\x1a'gcommon/v1/common/middleware_type.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x8d\x02\n" +
	"\x10MiddlewareConfig\x125\n" +
	"\x04type\x18\x01 \x01(\x0e2!.gcommon.v1.common.MiddlewareTypeR\x04type\x12\x18\n" +
	"\aenabled\x18\x02 \x01(\bR\aenabled\x12#\n" +
	"\bpriority\x18\x03 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\bpriority\x12G\n" +
...
func init() { file_gcommon_v1_web_middleware_config_proto_init() }
func file_gcommon_v1_web_middleware_config_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_web_middleware_config_proto_rawDesc), len(file_gcommon_v1_web_middleware_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_web_middleware_config_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_web_middleware_config_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_web_middleware_config_proto_msgTypes,
	}.Build()
	File_gcommon_v1_web_middleware_config_proto = out.File
	file_gcommon_v1_web_middleware_config_proto_goTypes = nil
	file_gcommon_v1_web_middleware_config_proto_depIdxs = nil
}
