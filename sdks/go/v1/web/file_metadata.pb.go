...
// 	protoc        (unknown)
// source: gcommon/v1/web/file_metadata.proto
...
func (x *FileMetadata) Reset() {
	*x = FileMetadata{}
	mi := &file_gcommon_v1_web_file_metadata_proto_msgTypes[0]
...
var File_gcommon_v1_web_file_metadata_proto protoreflect.FileDescriptor

const file_gcommon_v1_web_file_metadata_proto_rawDesc = "" +
	"\n" +
	"\"gcommon/v1/web/file_metadata.proto\x12\x0egcommon.v1.web\x1a\x1egcommon/v1/web/mime_type.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xdc\x01\n" +
	...
	"modifiedAtB2Z(github.com/jdfalk/gcommon/sdks/go/v1/web\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_web_file_metadata_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_web_file_metadata_proto_goTypes = []any{
	(*FileMetadata)(nil),          // 0: gcommon.v1.web.FileMetadata
	(*MimeType)(nil),              // 1: gcommon.v1.web.MimeType
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
}
var file_gcommon_v1_web_file_metadata_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_web_file_metadata_proto_init() }
func file_gcommon_v1_web_file_metadata_proto_init() {
	if File_gcommon_v1_web_file_metadata_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_web_file_metadata_proto_rawDesc), len(file_gcommon_v1_web_file_metadata_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_web_file_metadata_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_web_file_metadata_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_web_file_metadata_proto_msgTypes,
	}.Build()
	File_gcommon_v1_web_file_metadata_proto = out.File
	file_gcommon_v1_web_file_metadata_proto_goTypes = nil
	file_gcommon_v1_web_file_metadata_proto_depIdxs = nil
}
