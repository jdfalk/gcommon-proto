...
func (x *CookieData) Reset() {
	*x = CookieData{}
	mi := &file_gcommon_v1_web_cookie_data_proto_msgTypes[0]
...
var File_gcommon_v1_web_cookie_data_proto protoreflect.FileDescriptor

const file_gcommon_v1_web_cookie_data_proto_rawDesc = "" +
	"\n" +
	" gcommon/v1/web/cookie_data.proto\x12\x0egcommon.v1.web\x1a(gcommon/v1/common/cookie_same_site.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\x9d\x02\n" +
	"\n" +
	"CookieData\x12\x1d\n" +
...
func init() { file_gcommon_v1_web_cookie_data_proto_init() }
func file_gcommon_v1_web_cookie_data_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_web_cookie_data_proto_rawDesc), len(file_gcommon_v1_web_cookie_data_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_web_cookie_data_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_web_cookie_data_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_web_cookie_data_proto_msgTypes,
	}.Build()
	File_gcommon_v1_web_cookie_data_proto = out.File
	file_gcommon_v1_web_cookie_data_proto_goTypes = nil
	file_gcommon_v1_web_cookie_data_proto_depIdxs = nil
}
