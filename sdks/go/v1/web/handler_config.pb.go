...
func (x *HandlerConfig) Reset() {
	*x = HandlerConfig{}
	mi := &file_gcommon_v1_web_handler_config_proto_msgTypes[0]
...
var File_gcommon_v1_web_handler_config_proto protoreflect.FileDescriptor

const file_gcommon_v1_web_handler_config_proto_rawDesc = "" +
	"\n" +
	"#gcommon/v1/web/handler_config.proto\x12\x0egcommon.v1.web\x1a$gcommon/v1/common/handler_type.proto\x1a\x19google/protobuf/any.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x94\x02\n" +
	"\rHandlerConfig\x122\n" +
	...
	"\x06target\x18\x03 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x06target\x12D\n" +
...
func init() { file_gcommon_v1_web_handler_config_proto_init() }
func file_gcommon_v1_web_handler_config_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_web_handler_config_proto_rawDesc), len(file_gcommon_v1_web_handler_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_web_handler_config_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_web_handler_config_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_web_handler_config_proto_msgTypes,
	}.Build()
	File_gcommon_v1_web_handler_config_proto = out.File
	file_gcommon_v1_web_handler_config_proto_goTypes = nil
	file_gcommon_v1_web_handler_config_proto_depIdxs = nil
}
