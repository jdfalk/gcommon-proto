...
func (x *FilterOptions) Reset() {
	*x = FilterOptions{}
	mi := &file_gcommon_v1_common_filter_options_proto_msgTypes[0]
...
var File_gcommon_v1_common_filter_options_proto protoreflect.FileDescriptor

const file_gcommon_v1_common_filter_options_proto_rawDesc = "" +
	"\n" +
	"&gcommon/v1/common/filter_options.proto\x12\x11gcommon.v1.common\x1a$gcommon/v1/common/filter_value.proto\x1a*gcommon/v1/common/metrics_time_range.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xa3\x02\n" +
	"\rFilterOptions\x12G\n" +
	"\afilters\x18\x01 \x03(\v2-.gcommon.v1.common.FilterOptions.FiltersEntryR\afilters\x12*\n" +
	"\fsearch_query\x18\x02 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\vsearchQuery\x12A\n" +
	"\n" +
	"time_range\x18\x03 \x01(\v2\".gcommon.v1.common.CommonTimeRangeR\ttimeRange\x1aZ\n" +
	"\fFiltersEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x124\n" +
	"\x05value\x18\x02 \x01(\v2\x1e.gcommon.v1.common.FilterValueR\x05value:\x028\x01B5Z+github.com/jdfalk/gcommon/sdks/go/v1/common\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_common_filter_options_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_gcommon_v1_common_filter_options_proto_goTypes = []any{
...
var file_gcommon_v1_common_filter_options_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_common_filter_options_proto_init() }
func file_gcommon_v1_common_filter_options_proto_init() {
	if File_gcommon_v1_common_filter_options_proto != nil {
		return
	}
	file_gcommon_v1_common_filter_value_proto_init()
	file_gcommon_v1_common_metrics_time_range_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_common_filter_options_proto_rawDesc), len(file_gcommon_v1_common_filter_options_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_common_filter_options_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_common_filter_options_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_common_filter_options_proto_msgTypes,
	}.Build()
	File_gcommon_v1_common_filter_options_proto = out.File
	file_gcommon_v1_common_filter_options_proto_goTypes = nil
	file_gcommon_v1_common_filter_options_proto_depIdxs = nil
}
