...
// 	protoc        (unknown)
// source: gcommon/v1/common/set_health_response.proto
...
func (x *SetHealthResponse) Reset() {
	*x = SetHealthResponse{}
	mi := &file_gcommon_v1_common_set_health_response_proto_msgTypes[0]
...
var File_gcommon_v1_common_set_health_response_proto protoreflect.FileDescriptor

const file_gcommon_v1_common_set_health_response_proto_rawDesc = "" +
	"\n" +
	"+gcommon/v1/common/set_health_response.proto\x12\x11gcommon.v1.common\x1a\x1dgcommon/v1/common/error.proto\x1a%gcommon/v1/common/health_status.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xcf\x02\n" +
	...
	"\x05error\x18\x05 \x01(\v2\x18.gcommon.v1.common.ErrorR\x05error\x12\x1f\n" +
	"\x06reason\x18\x06 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x06reasonB5Z+github.com/jdfalk/gcommon/sdks/go/v1/common\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_common_set_health_response_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_common_set_health_response_proto_goTypes = []any{
...
var file_gcommon_v1_common_set_health_response_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_common_set_health_response_proto_init() }
func file_gcommon_v1_common_set_health_response_proto_init() {
	if File_gcommon_v1_common_set_health_response_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_common_set_health_response_proto_rawDesc), len(file_gcommon_v1_common_set_health_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_common_set_health_response_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_common_set_health_response_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_common_set_health_response_proto_msgTypes,
	}.Build()
	File_gcommon_v1_common_set_health_response_proto = out.File
	file_gcommon_v1_common_set_health_response_proto_goTypes = nil
	file_gcommon_v1_common_set_health_response_proto_depIdxs = nil
}
