...
// 	protoc        (unknown)
// source: gcommon/v1/common/error.proto
...
func (x *Error) Reset() {
	*x = Error{}
	mi := &file_gcommon_v1_common_error_proto_msgTypes[0]
...
var File_gcommon_v1_common_error_proto protoreflect.FileDescriptor

const file_gcommon_v1_common_error_proto_rawDesc = "" +
	"\n" +
	"\x1dgcommon/v1/common/error.proto\x12\x11gcommon.v1.common\x1a\"gcommon/v1/common/error_code.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xd8\x02\n" +
	"\x05Error\x120\n" +
	"\x04code\x18\x01 \x01(\x0e2\x1c.gcommon.v1.common.ErrorCodeR\x04code\x12!\n" +
	"\amessage\x18\x02 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\amessage\x12?\n" +
	"\adetails\x18\x03 \x03(\v2%.gcommon.v1.common.Error.DetailsEntryR\adetails\x12\"\n" +
...
var file_gcommon_v1_common_error_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_gcommon_v1_common_error_proto_goTypes = []any{
...
var file_gcommon_v1_common_error_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_common_error_proto_init() }
func file_gcommon_v1_common_error_proto_init() {
	if File_gcommon_v1_common_error_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_common_error_proto_rawDesc), len(file_gcommon_v1_common_error_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_common_error_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_common_error_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_common_error_proto_msgTypes,
	}.Build()
	File_gcommon_v1_common_error_proto = out.File
	file_gcommon_v1_common_error_proto_goTypes = nil
	file_gcommon_v1_common_error_proto_depIdxs = nil
}
