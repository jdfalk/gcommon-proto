...
// 	protoc        (unknown)
// source: gcommon/v1/common/service_version.proto
...
func (x *ServiceVersion) Reset() {
	*x = ServiceVersion{}
	mi := &file_gcommon_v1_common_service_version_proto_msgTypes[0]
...
var File_gcommon_v1_common_service_version_proto protoreflect.FileDescriptor

const file_gcommon_v1_common_service_version_proto_rawDesc = "" +
	"\n" +
	"'gcommon/v1/common/service_version.proto\x12\x11gcommon.v1.common\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xbb\x01\n" +
	...
	"\n" +
	"go_version\x18\x05 \x01(\tR\tgoVersionB5Z+github.com/jdfalk/gcommon/sdks/go/v1/common\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_common_service_version_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_common_service_version_proto_goTypes = []any{
	(*ServiceVersion)(nil),        // 0: gcommon.v1.common.ServiceVersion
	(*timestamppb.Timestamp)(nil), // 1: google.protobuf.Timestamp
}
var file_gcommon_v1_common_service_version_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_common_service_version_proto_init() }
func file_gcommon_v1_common_service_version_proto_init() {
	if File_gcommon_v1_common_service_version_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_common_service_version_proto_rawDesc), len(file_gcommon_v1_common_service_version_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_common_service_version_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_common_service_version_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_common_service_version_proto_msgTypes,
	}.Build()
	File_gcommon_v1_common_service_version_proto = out.File
	file_gcommon_v1_common_service_version_proto_goTypes = nil
	file_gcommon_v1_common_service_version_proto_depIdxs = nil
}
