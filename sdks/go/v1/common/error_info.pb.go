...
func (x *ErrorInfo) Reset() {
	*x = ErrorInfo{}
	mi := &file_gcommon_v1_common_error_info_proto_msgTypes[0]
...
var File_gcommon_v1_common_error_info_proto protoreflect.FileDescriptor

const file_gcommon_v1_common_error_info_proto_rawDesc = "" +
	"\n" +
	"\"gcommon/v1/common/error_info.proto\x12\x11gcommon.v1.common\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xd3\x02\n" +
	"\tErrorInfo\x12!\n" +
	...
	"stackTrace\x12\x1b\n" +
	"\x04code\x18\x04 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x04code\x12C\n" +
	"\acontext\x18\x05 \x03(\v2).gcommon.v1.common.ErrorInfo.ContextEntryR\acontext\x12>\n" +
	"\x06causes\x18\x06 \x03(\v2\x1c.gcommon.v1.common.ErrorInfoB\b\xbaH\x05\x92\x01\x02\b\x01R\x06causes\x1a:\n" +
...
var file_gcommon_v1_common_error_info_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_gcommon_v1_common_error_info_proto_goTypes = []any{
	(*ErrorInfo)(nil), // 0: gcommon.v1.common.ErrorInfo
	nil,               // 1: gcommon.v1.common.ErrorInfo.ContextEntry
}
var file_gcommon_v1_common_error_info_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_common_error_info_proto_init() }
func file_gcommon_v1_common_error_info_proto_init() {
	if File_gcommon_v1_common_error_info_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_common_error_info_proto_rawDesc), len(file_gcommon_v1_common_error_info_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_common_error_info_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_common_error_info_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_common_error_info_proto_msgTypes,
	}.Build()
	File_gcommon_v1_common_error_info_proto = out.File
	file_gcommon_v1_common_error_info_proto_goTypes = nil
	file_gcommon_v1_common_error_info_proto_depIdxs = nil
}
