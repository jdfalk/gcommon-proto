...
// 	protoc        (unknown)
// source: gcommon/v1/common/provider_type.proto
...
func (AuthProviderType) Descriptor() protoreflect.EnumDescriptor {
	return file_gcommon_v1_common_provider_type_proto_enumTypes[0].Descriptor()
}

func (AuthProviderType) Type() protoreflect.EnumType {
	return &file_gcommon_v1_common_provider_type_proto_enumTypes[0]
}
...
var File_gcommon_v1_common_provider_type_proto protoreflect.FileDescriptor
...
var file_gcommon_v1_common_provider_type_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_common_provider_type_proto_init() }
func file_gcommon_v1_common_provider_type_proto_init() {
	if File_gcommon_v1_common_provider_type_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_common_provider_type_proto_rawDesc), len(file_gcommon_v1_common_provider_type_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_common_provider_type_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_common_provider_type_proto_depIdxs,
		EnumInfos:         file_gcommon_v1_common_provider_type_proto_enumTypes,
	}.Build()
	File_gcommon_v1_common_provider_type_proto = out.File
	file_gcommon_v1_common_provider_type_proto_goTypes = nil
	file_gcommon_v1_common_provider_type_proto_depIdxs = nil
}
