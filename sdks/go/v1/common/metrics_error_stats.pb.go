...
const file_gcommon_v1_common_metrics_error_stats_proto_rawDesc = "" +
	"\n" +
	"+gcommon/v1/common/metrics_error_stats.proto\x12\x11gcommon.v1.common\x1a(gcommon/v1/common/error_type_count.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xe6\x01\n" +
	"\x11MetricsErrorStats\x12*\n" +
	"\ftotal_errors\x18\x01 \x01(\x03B\a\xbaH\x04\"\x02(\x00R\vtotalErrors\x12-\n" +
	"\n" +
	"error_rate\x18\x02 \x01(\x01B\x0e\xbaH\v\x12\t)\x00\x00\x00\x00\x00\x00\x00\x00R\terrorRate\x12L\n" +
	"\verror_types\x18\x03 \x03(\v2!.gcommon.v1.common.ErrorTypeCountB\b\xbaH\x05\x92\x01\x02\b\x01R\n" +
	"errorTypes\x12(\n" +
