...
// 	protoc        (unknown)
// source: gcommon/v1/common/user_metadata.proto
...
func (x *UserMetadata) Reset() {
	*x = UserMetadata{}
	mi := &file_gcommon_v1_common_user_metadata_proto_msgTypes[0]
...
var File_gcommon_v1_common_user_metadata_proto protoreflect.FileDescriptor

const file_gcommon_v1_common_user_metadata_proto_rawDesc = "" +
	"\n" +
	"%gcommon/v1/common/user_metadata.proto\x12\x11gcommon.v1.common\x1a(gcommon/v1/common/user_preferences.proto\x1a+gcommon/v1/common/verification_status.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xb4\x05\n" +
	"\fUserMetadata\x12,\n" +
...
var file_gcommon_v1_common_user_metadata_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_gcommon_v1_common_user_metadata_proto_goTypes = []any{
...
var file_gcommon_v1_common_user_metadata_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_common_user_metadata_proto_init() }
func file_gcommon_v1_common_user_metadata_proto_init() {
	if File_gcommon_v1_common_user_metadata_proto != nil {
		return
	}
	file_gcommon_v1_common_user_preferences_proto_init()
	file_gcommon_v1_common_verification_status_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_common_user_metadata_proto_rawDesc), len(file_gcommon_v1_common_user_metadata_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_common_user_metadata_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_common_user_metadata_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_common_user_metadata_proto_msgTypes,
	}.Build()
	File_gcommon_v1_common_user_metadata_proto = out.File
	file_gcommon_v1_common_user_metadata_proto_goTypes = nil
	file_gcommon_v1_common_user_metadata_proto_depIdxs = nil
}
