...
func (x *Claims) Reset() {
	*x = Claims{}
	mi := &file_gcommon_v1_common_claims_proto_msgTypes[0]
...
var File_gcommon_v1_common_claims_proto protoreflect.FileDescriptor

const file_gcommon_v1_common_claims_proto_rawDesc = "" +
	"\n" +
	"\x1egcommon/v1/common/claims.proto\x12\x11gcommon.v1.common\x1a!google/protobuf/go_features.proto\"\x97\x05\n" +
	"\x06Claims\x12\x16\n" +
...
var file_gcommon_v1_common_claims_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_gcommon_v1_common_claims_proto_goTypes = []any{
	(*Claims)(nil), // 0: gcommon.v1.common.Claims
	nil,            // 1: gcommon.v1.common.Claims.MetadataEntry
}
var file_gcommon_v1_common_claims_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_common_claims_proto_init() }
func file_gcommon_v1_common_claims_proto_init() {
	if File_gcommon_v1_common_claims_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_common_claims_proto_rawDesc), len(file_gcommon_v1_common_claims_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_common_claims_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_common_claims_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_common_claims_proto_msgTypes,
	}.Build()
	File_gcommon_v1_common_claims_proto = out.File
	file_gcommon_v1_common_claims_proto_goTypes = nil
	file_gcommon_v1_common_claims_proto_depIdxs = nil
}
