...
// 	protoc        (unknown)
// source: gcommon/v1/common/register_check_request.proto
...
func (x *RegisterCheckRequest) Reset() {
	*x = RegisterCheckRequest{}
	mi := &file_gcommon_v1_common_register_check_request_proto_msgTypes[0]
...
var File_gcommon_v1_common_register_check_request_proto protoreflect.FileDescriptor

const file_gcommon_v1_common_register_check_request_proto_rawDesc = "" +
	"\n" +
	".gcommon/v1/common/register_check_request.proto\x12\x11gcommon.v1.common\x1a,gcommon/v1/common/health_check_request.proto\x1a(gcommon/v1/common/request_metadata.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xc0\x01\n" +
	"\x14RegisterCheckRequest\x12!\n" +
	"\aservice\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\aservice\x12A\n" +
...
var file_gcommon_v1_common_register_check_request_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_common_register_check_request_proto_goTypes = []any{
...
var file_gcommon_v1_common_register_check_request_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_common_register_check_request_proto_init() }
func file_gcommon_v1_common_register_check_request_proto_init() {
	if File_gcommon_v1_common_register_check_request_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_common_register_check_request_proto_rawDesc), len(file_gcommon_v1_common_register_check_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_common_register_check_request_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_common_register_check_request_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_common_register_check_request_proto_msgTypes,
	}.Build()
	File_gcommon_v1_common_register_check_request_proto = out.File
	file_gcommon_v1_common_register_check_request_proto_goTypes = nil
	file_gcommon_v1_common_register_check_request_proto_depIdxs = nil
}
