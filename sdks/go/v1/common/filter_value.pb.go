...
func (x *FilterValue) Reset() {
	*x = FilterValue{}
	mi := &file_gcommon_v1_common_filter_value_proto_msgTypes[0]
...
func (x case_FilterValue_Value) String() string {
	md := file_gcommon_v1_common_filter_value_proto_msgTypes[0].Descriptor()
	if x == 0 {
		return "not set"
	}
...
var File_gcommon_v1_common_filter_value_proto protoreflect.FileDescriptor

const file_gcommon_v1_common_filter_value_proto_rawDesc = "" +
	"\n" +
	"$gcommon/v1/common/filter_value.proto\x12\x11gcommon.v1.common\x1a(gcommon/v1/common/filter_operation.proto\x1a#gcommon/v1/common/int64_array.proto\x1a$gcommon/v1/common/string_array.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x8f\x03\n" +
	"\vFilterValue\x12,\n" +
...
var file_gcommon_v1_common_filter_value_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_common_filter_value_proto_goTypes = []any{
...
var file_gcommon_v1_common_filter_value_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_common_filter_value_proto_init() }
func file_gcommon_v1_common_filter_value_proto_init() {
	if File_gcommon_v1_common_filter_value_proto != nil {
		return
	}
	file_gcommon_v1_common_filter_operation_proto_init()
	file_gcommon_v1_common_int64_array_proto_init()
	file_gcommon_v1_common_string_array_proto_init()
	file_gcommon_v1_common_filter_value_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_common_filter_value_proto_rawDesc), len(file_gcommon_v1_common_filter_value_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_common_filter_value_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_common_filter_value_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_common_filter_value_proto_msgTypes,
	}.Build()
	File_gcommon_v1_common_filter_value_proto = out.File
	file_gcommon_v1_common_filter_value_proto_goTypes = nil
	file_gcommon_v1_common_filter_value_proto_depIdxs = nil
}
