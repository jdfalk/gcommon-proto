...
// 	protoc        (unknown)
// source: gcommon/v1/common/logger_config.proto
...
func (x *LoggerConfig) Reset() {
	*x = LoggerConfig{}
	mi := &file_gcommon_v1_common_logger_config_proto_msgTypes[0]
...
var File_gcommon_v1_common_logger_config_proto protoreflect.FileDescriptor

const file_gcommon_v1_common_logger_config_proto_rawDesc = "" +
	"\n" +
	"%gcommon/v1/common/logger_config.proto\x12\x11gcommon.v1.common\x1a'gcommon/v1/common/appender_config.proto\x1a!gcommon/v1/common/log_level.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xe7\x02\n" +
	"\fLoggerConfig\x121\n" +
	"\x05level\x18\x01 \x01(\x0e2\x1b.gcommon.v1.common.LogLevelR\x05level\x12I\n" +
	"\tappenders\x18\x02 \x03(\v2!.gcommon.v1.common.AppenderConfigB\b\xbaH\x05\x92\x01\x02\b\x01R\tappenders\x12+\n" +
...
var file_gcommon_v1_common_logger_config_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_gcommon_v1_common_logger_config_proto_goTypes = []any{
...
var file_gcommon_v1_common_logger_config_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_common_logger_config_proto_init() }
func file_gcommon_v1_common_logger_config_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_common_logger_config_proto_rawDesc), len(file_gcommon_v1_common_logger_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_common_logger_config_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_common_logger_config_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_common_logger_config_proto_msgTypes,
	}.Build()
	File_gcommon_v1_common_logger_config_proto = out.File
	file_gcommon_v1_common_logger_config_proto_goTypes = nil
	file_gcommon_v1_common_logger_config_proto_depIdxs = nil
}
