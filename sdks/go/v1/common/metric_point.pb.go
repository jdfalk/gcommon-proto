...
// 	protoc        (unknown)
// source: gcommon/v1/common/metric_point.proto
...
func (x *MetricPoint) Reset() {
	*x = MetricPoint{}
	mi := &file_gcommon_v1_common_metric_point_proto_msgTypes[0]
...
var File_gcommon_v1_common_metric_point_proto protoreflect.FileDescriptor

const file_gcommon_v1_common_metric_point_proto_rawDesc = "" +
	"\n" +
	"$gcommon/v1/common/metric_point.proto\x12\x11gcommon.v1.common\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\x8f\x02\n" +
...
var file_gcommon_v1_common_metric_point_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_gcommon_v1_common_metric_point_proto_goTypes = []any{
	(*MetricPoint)(nil),           // 0: gcommon.v1.common.MetricPoint
	nil,                           // 1: gcommon.v1.common.MetricPoint.LabelsEntry
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
}
var file_gcommon_v1_common_metric_point_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_common_metric_point_proto_init() }
func file_gcommon_v1_common_metric_point_proto_init() {
	if File_gcommon_v1_common_metric_point_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_common_metric_point_proto_rawDesc), len(file_gcommon_v1_common_metric_point_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_common_metric_point_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_common_metric_point_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_common_metric_point_proto_msgTypes,
	}.Build()
	File_gcommon_v1_common_metric_point_proto = out.File
	file_gcommon_v1_common_metric_point_proto_goTypes = nil
	file_gcommon_v1_common_metric_point_proto_depIdxs = nil
}
