...
const file_gcommon_v1_common_auth_provider_proto_rawDesc = "" +
	"\n" +
	"%gcommon/v1/common/auth_provider.proto\x12\x11gcommon.v1.common\x1a%gcommon/v1/common/provider_type.proto\x1a!google/protobuf/go_features.proto\"\x83\x01\n" +
