...
// 	protoc        (unknown)
// source: gcommon/v1/common/subscription_options.proto
...
func (x *SubscriptionOptions) Reset() {
	*x = SubscriptionOptions{}
	mi := &file_gcommon_v1_common_subscription_options_proto_msgTypes[0]
...
var File_gcommon_v1_common_subscription_options_proto protoreflect.FileDescriptor

const file_gcommon_v1_common_subscription_options_proto_rawDesc = "" +
	"\n" +
	",gcommon/v1/common/subscription_options.proto\x12\x11gcommon.v1.common\x1a gcommon/v1/common/ack_mode.proto\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xde\x01\n" +
	"\x13SubscriptionOptions\x12'\n" +
	"\x0finclude_history\x18\x01 \x01(\bR\x0eincludeHistory\x12-\n" +
	"\x0emax_batch_size\x18\x02 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\fmaxBatchSize\x125\n" +
	"\back_mode\x18\x03 \x01(\x0e2\x1a.gcommon.v1.common.AckModeR\aackMode\x128\n" +
	"\n" +
	"keep_alive\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\tkeepAliveB5Z+github.com/jdfalk/gcommon/sdks/go/v1/common\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_common_subscription_options_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_common_subscription_options_proto_goTypes = []any{
	(*SubscriptionOptions)(nil), // 0: gcommon.v1.common.SubscriptionOptions
	(AckMode)(0),                // 1: gcommon.v1.common.AckMode
	(*durationpb.Duration)(nil), // 2: google.protobuf.Duration
}
var file_gcommon_v1_common_subscription_options_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_common_subscription_options_proto_init() }
func file_gcommon_v1_common_subscription_options_proto_init() {
	if File_gcommon_v1_common_subscription_options_proto != nil {
		return
	}
	file_gcommon_v1_common_ack_mode_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_common_subscription_options_proto_rawDesc), len(file_gcommon_v1_common_subscription_options_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_common_subscription_options_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_common_subscription_options_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_common_subscription_options_proto_msgTypes,
	}.Build()
	File_gcommon_v1_common_subscription_options_proto = out.File
	file_gcommon_v1_common_subscription_options_proto_goTypes = nil
	file_gcommon_v1_common_subscription_options_proto_depIdxs = nil
}
