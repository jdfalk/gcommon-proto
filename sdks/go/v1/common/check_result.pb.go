...
// 	protoc        (unknown)
// source: gcommon/v1/common/check_result.proto
...
func (x *CheckResult) Reset() {
	*x = CheckResult{}
	mi := &file_gcommon_v1_common_check_result_proto_msgTypes[0]
...
var File_gcommon_v1_common_check_result_proto protoreflect.FileDescriptor

const file_gcommon_v1_common_check_result_proto_rawDesc = "" +
	"\n" +
	"$gcommon/v1/common/check_result.proto\x12\x11gcommon.v1.common\x1a\x1dgcommon/v1/common/error.proto\x1a%gcommon/v1/common/health_status.proto\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xb8\x03\n" +
...
var file_gcommon_v1_common_check_result_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_gcommon_v1_common_check_result_proto_goTypes = []any{
...
var file_gcommon_v1_common_check_result_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_common_check_result_proto_init() }
func file_gcommon_v1_common_check_result_proto_init() {
	if File_gcommon_v1_common_check_result_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_common_check_result_proto_rawDesc), len(file_gcommon_v1_common_check_result_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_common_check_result_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_common_check_result_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_common_check_result_proto_msgTypes,
	}.Build()
	File_gcommon_v1_common_check_result_proto = out.File
	file_gcommon_v1_common_check_result_proto_goTypes = nil
	file_gcommon_v1_common_check_result_proto_depIdxs = nil
}
