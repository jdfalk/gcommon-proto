...
func (x *ConsumerGroup) Reset() {
	*x = ConsumerGroup{}
	mi := &file_gcommon_v1_queue_consumer_group_proto_msgTypes[0]
...
const file_gcommon_v1_queue_consumer_group_proto_rawDesc = "" +
	...
	"\bmetadata\x18\n" +
	" \x03(\v2-.gcommon.v1.queue.ConsumerGroup.MetadataEntryR\bmetadata\x12A\n" +
	"\n" +
...
func init() { file_gcommon_v1_queue_consumer_group_proto_init() }
func file_gcommon_v1_queue_consumer_group_proto_init() {
	...
	file_gcommon_v1_queue_group_coordinator_proto_init()
	file_gcommon_v1_queue_partition_assignment_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_queue_consumer_group_proto_rawDesc), len(file_gcommon_v1_queue_consumer_group_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_queue_consumer_group_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_queue_consumer_group_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_queue_consumer_group_proto_msgTypes,
	}.Build()
	File_gcommon_v1_queue_consumer_group_proto = out.File
	file_gcommon_v1_queue_consumer_group_proto_goTypes = nil
	file_gcommon_v1_queue_consumer_group_proto_depIdxs = nil
}
