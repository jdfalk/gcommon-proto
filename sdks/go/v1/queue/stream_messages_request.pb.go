...
func (x *StreamMessagesRequest) Reset() {
	*x = StreamMessagesRequest{}
	mi := &file_gcommon_v1_queue_stream_messages_request_proto_msgTypes[0]
...
const file_gcommon_v1_queue_stream_messages_request_proto_rawDesc = "" +
	...
	"\x11stream_timeout_ms\x18\x06 \x01(\x05B\a\xbaH\x04\x1a\x02 \x00R\x0fstreamTimeoutMs\x128\n" +
	"\tack_level\x18\a \x01(\x0e2\x1b.gcommon.v1.common.AckLevelR\backLevel\x12&\n" +
	"\n" +
	"batch_size\x18\b \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\tbatchSize\x127\n" +
	...
	"\rpartition_ids\x18\r \x03(\x05B\b\xbaH\x05\x92\x01\x02\b\x01R\fpartitionIds\x12C\n" +
	"\rstream_config\x18\x0e \x01(\v2\x1e.gcommon.v1.queue.StreamConfigR\fstreamConfigB4Z*github.com/jdfalk/gcommon/sdks/go/v1/queue\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_queue_stream_messages_request_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
...
func init() { file_gcommon_v1_queue_stream_messages_request_proto_init() }
func file_gcommon_v1_queue_stream_messages_request_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_queue_stream_messages_request_proto_rawDesc), len(file_gcommon_v1_queue_stream_messages_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_queue_stream_messages_request_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_queue_stream_messages_request_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_queue_stream_messages_request_proto_msgTypes,
	}.Build()
	File_gcommon_v1_queue_stream_messages_request_proto = out.File
	file_gcommon_v1_queue_stream_messages_request_proto_goTypes = nil
	file_gcommon_v1_queue_stream_messages_request_proto_depIdxs = nil
}
