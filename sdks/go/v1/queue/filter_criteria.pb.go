...
func (x *FilterCriteria) Reset() {
	*x = FilterCriteria{}
	mi := &file_gcommon_v1_queue_filter_criteria_proto_msgTypes[0]
...
var File_gcommon_v1_queue_filter_criteria_proto protoreflect.FileDescriptor

const file_gcommon_v1_queue_filter_criteria_proto_rawDesc = "" +
	"\n" +
	"&gcommon/v1/queue/filter_criteria.proto\x12\x10gcommon.v1.queue\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xc7\x02\n" +
	"\x0eFilterCriteria\x123\n" +
	"\x10include_patterns\x18\x01 \x03(\tB\b\xbaH\x05\x92\x01\x02\b\x01R\x0fincludePatterns\x123\n" +
	"\x10exclude_patterns\x18\x02 \x03(\tB\b\xbaH\x05\x92\x01\x02\b\x01R\x0fexcludePatterns\x12Z\n" +
...
var file_gcommon_v1_queue_filter_criteria_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_gcommon_v1_queue_filter_criteria_proto_goTypes = []any{
	(*FilterCriteria)(nil), // 0: gcommon.v1.queue.FilterCriteria
	nil,                    // 1: gcommon.v1.queue.FilterCriteria.HeaderFiltersEntry
}
var file_gcommon_v1_queue_filter_criteria_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_queue_filter_criteria_proto_init() }
func file_gcommon_v1_queue_filter_criteria_proto_init() {
	if File_gcommon_v1_queue_filter_criteria_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_queue_filter_criteria_proto_rawDesc), len(file_gcommon_v1_queue_filter_criteria_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_queue_filter_criteria_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_queue_filter_criteria_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_queue_filter_criteria_proto_msgTypes,
	}.Build()
	File_gcommon_v1_queue_filter_criteria_proto = out.File
	file_gcommon_v1_queue_filter_criteria_proto_goTypes = nil
	file_gcommon_v1_queue_filter_criteria_proto_depIdxs = nil
}
