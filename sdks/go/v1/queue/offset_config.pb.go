...
type OffsetConfig struct {
	...
	xxx_hidden_OffsetType      common.OffsetType      `protobuf:"varint,1,opt,name=offset_type,json=offsetType,enum=gcommon.v1.common.OffsetType"`
...
func (x *OffsetConfig) Reset() {
	*x = OffsetConfig{}
	mi := &file_gcommon_v1_queue_offset_config_proto_msgTypes[0]
...
var File_gcommon_v1_queue_offset_config_proto protoreflect.FileDescriptor

const file_gcommon_v1_queue_offset_config_proto_rawDesc = "" +
	"\n" +
	"$gcommon/v1/queue/offset_config.proto\x12\x10gcommon.v1.queue\x1a#gcommon/v1/common/offset_type.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xec\x01\n" +
	"\fOffsetConfig\x12>\n" +
	"\voffset_type\x18\x01 \x01(\x0e2\x1d.gcommon.v1.common.OffsetTypeR\n" +
	"offsetType\x12*\n" +
	...
	"\x12reset_on_not_found\x18\x04 \x01(\bR\x0fresetOnNotFoundB4Z*github.com/jdfalk/gcommon/sdks/go/v1/queue\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_queue_offset_config_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_queue_offset_config_proto_goTypes = []any{
	(*OffsetConfig)(nil),          // 0: gcommon.v1.queue.OffsetConfig
	(common.OffsetType)(0),        // 1: gcommon.v1.common.OffsetType
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
}
var file_gcommon_v1_queue_offset_config_proto_depIdxs = []int32{
	1, // 0: gcommon.v1.queue.OffsetConfig.offset_type:type_name -> gcommon.v1.common.OffsetType
...
func init() { file_gcommon_v1_queue_offset_config_proto_init() }
func file_gcommon_v1_queue_offset_config_proto_init() {
	if File_gcommon_v1_queue_offset_config_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_queue_offset_config_proto_rawDesc), len(file_gcommon_v1_queue_offset_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_queue_offset_config_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_queue_offset_config_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_queue_offset_config_proto_msgTypes,
	}.Build()
	File_gcommon_v1_queue_offset_config_proto = out.File
	file_gcommon_v1_queue_offset_config_proto_goTypes = nil
	file_gcommon_v1_queue_offset_config_proto_depIdxs = nil
}
