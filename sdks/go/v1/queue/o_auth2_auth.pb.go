...
func (x *OAuth2Auth) Reset() {
	*x = OAuth2Auth{}
	mi := &file_gcommon_v1_queue_o_auth2_auth_proto_msgTypes[0]
...
var File_gcommon_v1_queue_o_auth2_auth_proto protoreflect.FileDescriptor

const file_gcommon_v1_queue_o_auth2_auth_proto_rawDesc = "" +
	"\n" +
	"#gcommon/v1/queue/o_auth2_auth.proto\x12\x10gcommon.v1.queue\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xbf\x02\n" +
	"\n" +
	"OAuth2Auth\x12.\n" +
	...
	"\x06scopes\x18\x04 \x03(\tB\b\xbaH\x05\x92\x01\x02\b\x01R\x06scopes\x12L\n" +
	"\n" +
...
var file_gcommon_v1_queue_o_auth2_auth_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_gcommon_v1_queue_o_auth2_auth_proto_goTypes = []any{
	(*OAuth2Auth)(nil), // 0: gcommon.v1.queue.OAuth2Auth
	nil,                // 1: gcommon.v1.queue.OAuth2Auth.ParametersEntry
}
var file_gcommon_v1_queue_o_auth2_auth_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_queue_o_auth2_auth_proto_init() }
func file_gcommon_v1_queue_o_auth2_auth_proto_init() {
	if File_gcommon_v1_queue_o_auth2_auth_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_queue_o_auth2_auth_proto_rawDesc), len(file_gcommon_v1_queue_o_auth2_auth_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_queue_o_auth2_auth_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_queue_o_auth2_auth_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_queue_o_auth2_auth_proto_msgTypes,
	}.Build()
	File_gcommon_v1_queue_o_auth2_auth_proto = out.File
	file_gcommon_v1_queue_o_auth2_auth_proto_goTypes = nil
	file_gcommon_v1_queue_o_auth2_auth_proto_depIdxs = nil
}
