...
// 	protoc        (unknown)
// source: gcommon/v1/queue/anti_affinity_rule.proto
...
func (x *AntiAffinityRule) Reset() {
	*x = AntiAffinityRule{}
	mi := &file_gcommon_v1_queue_anti_affinity_rule_proto_msgTypes[0]
...
var File_gcommon_v1_queue_anti_affinity_rule_proto protoreflect.FileDescriptor

const file_gcommon_v1_queue_anti_affinity_rule_proto_rawDesc = "" +
	"\n" +
	")gcommon/v1/queue/anti_affinity_rule.proto\x12\x10gcommon.v1.queue\x1a+gcommon/v1/common/anti_affinity_scope.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xa1\x01\n" +
	"\x10AntiAffinityRule\x12$\n" +
	"\tlabel_key\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\blabelKey\x12+\n" +
	"\flabel_values\x18\x02 \x03(\tB\b\xbaH\x05\x92\x01\x02\b\x01R\vlabelValues\x12:\n" +
...
func init() { file_gcommon_v1_queue_anti_affinity_rule_proto_init() }
func file_gcommon_v1_queue_anti_affinity_rule_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_queue_anti_affinity_rule_proto_rawDesc), len(file_gcommon_v1_queue_anti_affinity_rule_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_queue_anti_affinity_rule_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_queue_anti_affinity_rule_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_queue_anti_affinity_rule_proto_msgTypes,
	}.Build()
	File_gcommon_v1_queue_anti_affinity_rule_proto = out.File
	file_gcommon_v1_queue_anti_affinity_rule_proto_goTypes = nil
	file_gcommon_v1_queue_anti_affinity_rule_proto_depIdxs = nil
}
