...
func (x *PushRequest) Reset() {
	*x = PushRequest{}
	mi := &file_gcommon_v1_queue_push_request_proto_msgTypes[0]
...
var File_gcommon_v1_queue_push_request_proto protoreflect.FileDescriptor

const file_gcommon_v1_queue_push_request_proto_rawDesc = "" +
	"\n" +
	"#gcommon/v1/queue/push_request.proto\x12\x10gcommon.v1.queue\x1a%gcommon/v1/queue/batch_settings.proto\x1a%gcommon/v1/queue/publish_config.proto\x1a$gcommon/v1/queue/queue_message.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xe2\x03\n" +
	"\vPushRequest\x12\x1d\n" +
	"\x05topic\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x05topic\x12D\n" +
	"\bmessages\x18\x02 \x03(\v2\x1e.gcommon.v1.queue.QueueMessageB\b\xbaH\x05\x92\x01\x02\b\x01R\bmessages\x12F\n" +
...
var file_gcommon_v1_queue_push_request_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_gcommon_v1_queue_push_request_proto_goTypes = []any{
...
var file_gcommon_v1_queue_push_request_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_queue_push_request_proto_init() }
func file_gcommon_v1_queue_push_request_proto_init() {
	if File_gcommon_v1_queue_push_request_proto != nil {
		return
	}
	file_gcommon_v1_queue_batch_settings_proto_init()
	file_gcommon_v1_queue_publish_config_proto_init()
	file_gcommon_v1_queue_queue_message_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_queue_push_request_proto_rawDesc), len(file_gcommon_v1_queue_push_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_queue_push_request_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_queue_push_request_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_queue_push_request_proto_msgTypes,
	}.Build()
	File_gcommon_v1_queue_push_request_proto = out.File
	file_gcommon_v1_queue_push_request_proto_goTypes = nil
	file_gcommon_v1_queue_push_request_proto_depIdxs = nil
}
