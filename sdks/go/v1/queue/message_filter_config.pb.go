...
func (x *MessageFilterConfig) Reset() {
	*x = MessageFilterConfig{}
	mi := &file_gcommon_v1_queue_message_filter_config_proto_msgTypes[0]
...
var File_gcommon_v1_queue_message_filter_config_proto protoreflect.FileDescriptor

const file_gcommon_v1_queue_message_filter_config_proto_rawDesc = "" +
	"\n" +
	",gcommon/v1/queue/message_filter_config.proto\x12\x10gcommon.v1.queue\x1a%gcommon/v1/queue/content_filter.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xdb\x03\n" +
	"\x13MessageFilterConfig\x12_\n" +
	"\x0eheader_filters\x18\x01 \x03(\v28.gcommon.v1.queue.MessageFilterConfig.HeaderFiltersEntryR\rheaderFilters\x12R\n" +
	"\x0fcontent_filters\x18\x02 \x03(\v2\x1f.gcommon.v1.queue.ContentFilterB\b\xbaH\x05\x92\x01\x02\b\x01R\x0econtentFilters\x12:\n" +
...
var file_gcommon_v1_queue_message_filter_config_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_gcommon_v1_queue_message_filter_config_proto_goTypes = []any{
...
var file_gcommon_v1_queue_message_filter_config_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_queue_message_filter_config_proto_init() }
func file_gcommon_v1_queue_message_filter_config_proto_init() {
	if File_gcommon_v1_queue_message_filter_config_proto != nil {
		return
	}
	file_gcommon_v1_queue_content_filter_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_queue_message_filter_config_proto_rawDesc), len(file_gcommon_v1_queue_message_filter_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_queue_message_filter_config_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_queue_message_filter_config_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_queue_message_filter_config_proto_msgTypes,
	}.Build()
	File_gcommon_v1_queue_message_filter_config_proto = out.File
	file_gcommon_v1_queue_message_filter_config_proto_goTypes = nil
	file_gcommon_v1_queue_message_filter_config_proto_depIdxs = nil
}
