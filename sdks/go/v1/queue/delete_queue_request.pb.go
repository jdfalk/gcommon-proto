...
// 	protoc        (unknown)
// source: gcommon/v1/queue/delete_queue_request.proto
...
func (x *DeleteQueueRequest) Reset() {
	*x = DeleteQueueRequest{}
	mi := &file_gcommon_v1_queue_delete_queue_request_proto_msgTypes[0]
...
var File_gcommon_v1_queue_delete_queue_request_proto protoreflect.FileDescriptor

const file_gcommon_v1_queue_delete_queue_request_proto_rawDesc = "" +
	"\n" +
	"+gcommon/v1/queue/delete_queue_request.proto\x12\x10gcommon.v1.queue\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"j\n" +
	...
	"purgeFirstB4Z*github.com/jdfalk/gcommon/sdks/go/v1/queue\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_queue_delete_queue_request_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_queue_delete_queue_request_proto_goTypes = []any{
	(*DeleteQueueRequest)(nil), // 0: gcommon.v1.queue.DeleteQueueRequest
}
var file_gcommon_v1_queue_delete_queue_request_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_queue_delete_queue_request_proto_init() }
func file_gcommon_v1_queue_delete_queue_request_proto_init() {
	if File_gcommon_v1_queue_delete_queue_request_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_queue_delete_queue_request_proto_rawDesc), len(file_gcommon_v1_queue_delete_queue_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_queue_delete_queue_request_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_queue_delete_queue_request_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_queue_delete_queue_request_proto_msgTypes,
	}.Build()
	File_gcommon_v1_queue_delete_queue_request_proto = out.File
	file_gcommon_v1_queue_delete_queue_request_proto_goTypes = nil
	file_gcommon_v1_queue_delete_queue_request_proto_depIdxs = nil
}
