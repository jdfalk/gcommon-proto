...
type MessageNack struct {
	...
	xxx_hidden_ErrorCategory   common.NackErrorCategory `protobuf:"varint,6,opt,name=error_category,json=errorCategory,enum=gcommon.v1.common.NackErrorCategory"`
...
func (x *MessageNack) Reset() {
	*x = MessageNack{}
	mi := &file_gcommon_v1_queue_message_nack_proto_msgTypes[0]
...
var File_gcommon_v1_queue_message_nack_proto protoreflect.FileDescriptor

const file_gcommon_v1_queue_message_nack_proto_rawDesc = "" +
	"\n" +
	"#gcommon/v1/queue/message_nack.proto\x12\x10gcommon.v1.queue\x1a+gcommon/v1/common/nack_error_category.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xd3\x04\n" +
	"\vMessageNack\x12&\n" +
	"\n" +
	...
	"nackReason\x12K\n" +
	"\x0eerror_category\x18\x06 \x01(\x0e2$.gcommon.v1.common.NackErrorCategoryR\rerrorCategory\x12&\n" +
	"\n" +
	"error_code\x18\a \x01(\tB\a\xbaH\x04r\x02\x10\x01R\terrorCode\x12#\n" +
	"\rretry_message\x18\b \x01(\bR\fretryMessage\x12-\n" +
	"\x0eretry_delay_ms\x18\t \x01(\x03B\a\xbaH\x04\"\x02(\x00R\fretryDelayMs\x12]\n" +
...
var file_gcommon_v1_queue_message_nack_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_gcommon_v1_queue_message_nack_proto_goTypes = []any{
	(*MessageNack)(nil),           // 0: gcommon.v1.queue.MessageNack
	nil,                           // 1: gcommon.v1.queue.MessageNack.MessageMetadataEntry
	(common.NackErrorCategory)(0), // 2: gcommon.v1.common.NackErrorCategory
}
var file_gcommon_v1_queue_message_nack_proto_depIdxs = []int32{
	2, // 0: gcommon.v1.queue.MessageNack.error_category:type_name -> gcommon.v1.common.NackErrorCategory
...
func init() { file_gcommon_v1_queue_message_nack_proto_init() }
func file_gcommon_v1_queue_message_nack_proto_init() {
	if File_gcommon_v1_queue_message_nack_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_queue_message_nack_proto_rawDesc), len(file_gcommon_v1_queue_message_nack_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_queue_message_nack_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_queue_message_nack_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_queue_message_nack_proto_msgTypes,
	}.Build()
	File_gcommon_v1_queue_message_nack_proto = out.File
	file_gcommon_v1_queue_message_nack_proto_goTypes = nil
	file_gcommon_v1_queue_message_nack_proto_depIdxs = nil
}
