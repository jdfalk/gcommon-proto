...
const file_gcommon_v1_queue_get_queue_stats_request_proto_rawDesc = "" +
	"\n" +
	".gcommon/v1/queue/get_queue_stats_request.proto\x12\x10gcommon.v1.queue\x1a)gcommon/v1/common/stats_granularity.proto\x1a*gcommon/v1/common/time_range_metrics.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xcb\x01\n" +
	"\x14GetQueueStatsRequest\x12(\n" +
	"\n" +
	"queue_name\x18\x01 \x01(\tB\t\xbaH\x06r\x04\x10\x01\x18dR\tqueueName\x12B\n" +
	"\n" +
