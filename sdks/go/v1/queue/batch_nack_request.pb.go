...
func (x *BatchNackRequest) Reset() {
	*x = BatchNackRequest{}
	mi := &file_gcommon_v1_queue_batch_nack_request_proto_msgTypes[0]
...
var File_gcommon_v1_queue_batch_nack_request_proto protoreflect.FileDescriptor

const file_gcommon_v1_queue_batch_nack_request_proto_rawDesc = "" +
	"\n" +
	")gcommon/v1/queue/batch_nack_request.proto\x12\x10gcommon.v1.queue\x1a#gcommon/v1/queue/message_nack.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xad\x04\n" +
	...
	"consumerId\x12L\n" +
	"\rmessage_nacks\x18\x03 \x03(\v2\x1d.gcommon.v1.queue.MessageNackB\b\xbaH\x05\x92\x01\x02\b\x01R\fmessageNacks\x12)\n" +
...
var file_gcommon_v1_queue_batch_nack_request_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_gcommon_v1_queue_batch_nack_request_proto_goTypes = []any{
...
var file_gcommon_v1_queue_batch_nack_request_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_queue_batch_nack_request_proto_init() }
func file_gcommon_v1_queue_batch_nack_request_proto_init() {
	if File_gcommon_v1_queue_batch_nack_request_proto != nil {
		return
	}
	file_gcommon_v1_queue_message_nack_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_queue_batch_nack_request_proto_rawDesc), len(file_gcommon_v1_queue_batch_nack_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_queue_batch_nack_request_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_queue_batch_nack_request_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_queue_batch_nack_request_proto_msgTypes,
	}.Build()
	File_gcommon_v1_queue_batch_nack_request_proto = out.File
	file_gcommon_v1_queue_batch_nack_request_proto_goTypes = nil
	file_gcommon_v1_queue_batch_nack_request_proto_depIdxs = nil
}
