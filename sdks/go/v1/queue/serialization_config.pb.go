...
// 	protoc        (unknown)
// source: gcommon/v1/queue/serialization_config.proto
...
func (x *SerializationConfig) Reset() {
	*x = SerializationConfig{}
	mi := &file_gcommon_v1_queue_serialization_config_proto_msgTypes[0]
...
var File_gcommon_v1_queue_serialization_config_proto protoreflect.FileDescriptor

const file_gcommon_v1_queue_serialization_config_proto_rawDesc = "" +
	"\n" +
	"+gcommon/v1/queue/serialization_config.proto\x12\x10gcommon.v1.queue\x1a-gcommon/v1/common/compression_algorithm.proto\x1a,gcommon/v1/common/serialization_format.proto\x1a%gcommon/v1/queue/format_options.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xcf\x06\n" +
	"\x13SerializationConfig\x12M\n" +
	"\x0edefault_format\x18\x01 \x01(\x0e2&.gcommon.v1.common.SerializationFormatR\rdefaultFormat\x12]\n" +
	"\x11supported_formats\x18\x02 \x03(\x0e2&.gcommon.v1.common.SerializationFormatB\b\xbaH\x05\x92\x01\x02\b\x01R\x10supportedFormats\x12,\n" +
	"\x12auto_detect_format\x18\x03 \x01(\bR\x10autoDetectFormat\x12X\n" +
	"\x13default_compression\x18\x04 \x01(\x0e2'.gcommon.v1.common.CompressionAlgorithmR\x12defaultCompression\x12h\n" +
	"\x16supported_compressions\x18\x05 \x03(\x0e2'.gcommon.v1.common.CompressionAlgorithmB\b\xbaH\x05\x92\x01\x02\b\x01R\x15supportedCompressions\x126\n" +
	...
	"\x05value\x18\x02 \x01(\v2\x1f.gcommon.v1.queue.FormatOptionsR\x05value:\x028\x01B4Z*github.com/jdfalk/gcommon/sdks/go/v1/queue\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
func init() { file_gcommon_v1_queue_serialization_config_proto_init() }
func file_gcommon_v1_queue_serialization_config_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_queue_serialization_config_proto_rawDesc), len(file_gcommon_v1_queue_serialization_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_queue_serialization_config_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_queue_serialization_config_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_queue_serialization_config_proto_msgTypes,
	}.Build()
	File_gcommon_v1_queue_serialization_config_proto = out.File
	file_gcommon_v1_queue_serialization_config_proto_goTypes = nil
	file_gcommon_v1_queue_serialization_config_proto_depIdxs = nil
}
