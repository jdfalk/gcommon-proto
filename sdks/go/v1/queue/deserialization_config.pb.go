...
func (x *DeserializationConfig) Reset() {
	*x = DeserializationConfig{}
	mi := &file_gcommon_v1_queue_deserialization_config_proto_msgTypes[0]
...
var File_gcommon_v1_queue_deserialization_config_proto protoreflect.FileDescriptor

const file_gcommon_v1_queue_deserialization_config_proto_rawDesc = "" +
	"\n" +
	"-gcommon/v1/queue/deserialization_config.proto\x12\x10gcommon.v1.queue\x1a,gcommon/v1/common/serialization_format.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x8d\x03\n" +
	"\x15DeserializationConfig\x12]\n" +
	"\x11supported_formats\x18\x01 \x03(\x0e2&.gcommon.v1.common.SerializationFormatB\b\xbaH\x05\x92\x01\x02\b\x01R\x10supportedFormats\x12M\n" +
	...
	"\x10max_message_size\x18\x06 \x01(\x04B\a\xbaH\x042\x02(\x00R\x0emaxMessageSizeB4Z*github.com/jdfalk/gcommon/sdks/go/v1/queue\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
func init() { file_gcommon_v1_queue_deserialization_config_proto_init() }
func file_gcommon_v1_queue_deserialization_config_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_queue_deserialization_config_proto_rawDesc), len(file_gcommon_v1_queue_deserialization_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_queue_deserialization_config_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_queue_deserialization_config_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_queue_deserialization_config_proto_msgTypes,
	}.Build()
	File_gcommon_v1_queue_deserialization_config_proto = out.File
	file_gcommon_v1_queue_deserialization_config_proto_goTypes = nil
	file_gcommon_v1_queue_deserialization_config_proto_depIdxs = nil
}
