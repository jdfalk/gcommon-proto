...
func (x *DeliveryConfiguration) Reset() {
	*x = DeliveryConfiguration{}
	mi := &file_gcommon_v1_queue_delivery_configuration_proto_msgTypes[0]
...
var File_gcommon_v1_queue_delivery_configuration_proto protoreflect.FileDescriptor

const file_gcommon_v1_queue_delivery_configuration_proto_rawDesc = "" +
	"\n" +
	"-gcommon/v1/queue/delivery_configuration.proto\x12\x10gcommon.v1.queue\x1a,gcommon/v1/queue/batch_delivery_config.proto\x1a,gcommon/v1/queue/delivery_retry_config.proto\x1a,gcommon/v1/queue/flow_control_settings.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xa8\x04\n" +
	"\x15DeliveryConfiguration\x12,\n" +
	"\rpush_endpoint\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\fpushEndpoint\x127\n" +
	"\x13delivery_timeout_ms\x18\x02 \x01(\x05B\a\xbaH\x04\x1a\x02 \x00R\x11deliveryTimeoutMs\x12H\n" +
...
var file_gcommon_v1_queue_delivery_configuration_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_gcommon_v1_queue_delivery_configuration_proto_goTypes = []any{
...
var file_gcommon_v1_queue_delivery_configuration_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_queue_delivery_configuration_proto_init() }
func file_gcommon_v1_queue_delivery_configuration_proto_init() {
	if File_gcommon_v1_queue_delivery_configuration_proto != nil {
		return
	}
	file_gcommon_v1_queue_batch_delivery_config_proto_init()
	file_gcommon_v1_queue_delivery_retry_config_proto_init()
	file_gcommon_v1_queue_flow_control_settings_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_queue_delivery_configuration_proto_rawDesc), len(file_gcommon_v1_queue_delivery_configuration_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_queue_delivery_configuration_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_queue_delivery_configuration_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_queue_delivery_configuration_proto_msgTypes,
	}.Build()
	File_gcommon_v1_queue_delivery_configuration_proto = out.File
	file_gcommon_v1_queue_delivery_configuration_proto_goTypes = nil
	file_gcommon_v1_queue_delivery_configuration_proto_depIdxs = nil
}
