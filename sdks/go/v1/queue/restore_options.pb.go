...
func (x *RestoreOptions) Reset() {
	*x = RestoreOptions{}
	mi := &file_gcommon_v1_queue_restore_options_proto_msgTypes[0]
...
const file_gcommon_v1_queue_restore_options_proto_rawDesc = "" +
	...
	"\fmax_messages\x18\x03 \x01(\x03B\a\xbaH\x04\"\x02(\x00R\vmaxMessages\x12@\n" +
	"\foffset_range\x18\x04 \x01(\v2\x1d.gcommon.v1.queue.OffsetRangeR\voffsetRange\x12B\n" +
	"\n" +
	"time_range\x18\x05 \x01(\v2#.gcommon.v1.common.TimeRangeMetricsR\ttimeRange\x121\n" +
	"\x0fpriority_levels\x18\x06 \x03(\x05B\b\xbaH\x05\x92\x01\x02\b\x01R\x0epriorityLevels\x12I\n" +
	"\x0ffilter_criteria\x18\a \x01(\v2 .gcommon.v1.queue.FilterCriteriaR\x0efilterCriteria\x12F\n" +
	"\vperformance\x18\b \x01(\v2$.gcommon.v1.queue.PerformanceOptionsR\vperformanceB4Z*github.com/jdfalk/gcommon/sdks/go/v1/queue\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_queue_restore_options_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_queue_restore_options_proto_goTypes = []any{
...
var file_gcommon_v1_queue_restore_options_proto_depIdxs = []int32{
	1, // 0: gcommon.v1.queue.RestoreOptions.offset_range:type_name -> gcommon.v1.queue.OffsetRange
	2, // 1: gcommon.v1.queue.RestoreOptions.time_range:type_name -> gcommon.v1.common.TimeRangeMetrics
...
func init() { file_gcommon_v1_queue_restore_options_proto_init() }
func file_gcommon_v1_queue_restore_options_proto_init() {
	if File_gcommon_v1_queue_restore_options_proto != nil {
		return
	}
	file_gcommon_v1_queue_filter_criteria_proto_init()
	file_gcommon_v1_queue_offset_range_proto_init()
	file_gcommon_v1_queue_performance_options_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_queue_restore_options_proto_rawDesc), len(file_gcommon_v1_queue_restore_options_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_queue_restore_options_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_queue_restore_options_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_queue_restore_options_proto_msgTypes,
	}.Build()
	File_gcommon_v1_queue_restore_options_proto = out.File
	file_gcommon_v1_queue_restore_options_proto_goTypes = nil
	file_gcommon_v1_queue_restore_options_proto_depIdxs = nil
}
