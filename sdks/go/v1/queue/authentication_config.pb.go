...
// 	protoc        (unknown)
// source: gcommon/v1/queue/authentication_config.proto
...
func (x *AuthenticationConfig) Reset() {
	*x = AuthenticationConfig{}
	mi := &file_gcommon_v1_queue_authentication_config_proto_msgTypes[0]
...
func (x case_AuthenticationConfig_AuthType) String() string {
	md := file_gcommon_v1_queue_authentication_config_proto_msgTypes[0].Descriptor()
	if x == 0 {
		return "not set"
	}
...
var File_gcommon_v1_queue_authentication_config_proto protoreflect.FileDescriptor

const file_gcommon_v1_queue_authentication_config_proto_rawDesc = "" +
	"\n" +
	",gcommon/v1/queue/authentication_config.proto\x12\x10gcommon.v1.queue\x1a#gcommon/v1/queue/api_key_auth.proto\x1a#gcommon/v1/queue/o_auth2_auth.proto\x1a gcommon/v1/queue/sasl_auth.proto\x1a\x1fgcommon/v1/queue/tls_auth.proto\x1a-gcommon/v1/queue/username_password_auth.proto\x1a!google/protobuf/go_features.proto\"\xe2\x02\n" +
	...
	"\tauth_typeB4Z*github.com/jdfalk/gcommon/sdks/go/v1/queue\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_queue_authentication_config_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_queue_authentication_config_proto_goTypes = []any{
...
var file_gcommon_v1_queue_authentication_config_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_queue_authentication_config_proto_init() }
func file_gcommon_v1_queue_authentication_config_proto_init() {
	if File_gcommon_v1_queue_authentication_config_proto != nil {
		return
	}
	file_gcommon_v1_queue_api_key_auth_proto_init()
	file_gcommon_v1_queue_o_auth2_auth_proto_init()
	file_gcommon_v1_queue_sasl_auth_proto_init()
	file_gcommon_v1_queue_tls_auth_proto_init()
	file_gcommon_v1_queue_username_password_auth_proto_init()
	file_gcommon_v1_queue_authentication_config_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_queue_authentication_config_proto_rawDesc), len(file_gcommon_v1_queue_authentication_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_queue_authentication_config_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_queue_authentication_config_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_queue_authentication_config_proto_msgTypes,
	}.Build()
	File_gcommon_v1_queue_authentication_config_proto = out.File
	file_gcommon_v1_queue_authentication_config_proto_goTypes = nil
	file_gcommon_v1_queue_authentication_config_proto_depIdxs = nil
}
