...
func (x *NackRequest) Reset() {
	*x = NackRequest{}
	mi := &file_gcommon_v1_queue_nack_request_proto_msgTypes[0]
...
var File_gcommon_v1_queue_nack_request_proto protoreflect.FileDescriptor

const file_gcommon_v1_queue_nack_request_proto_rawDesc = "" +
	"\n" +
	"#gcommon/v1/queue/nack_request.proto\x12\x10gcommon.v1.queue\x1a(gcommon/v1/common/request_metadata.proto\x1a!gcommon/v1/queue/nack_error.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xc8\x02\n" +
	"\vNackRequest\x12$\n" +
	"\tack_token\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\backToken\x12\x18\n" +
	"\arequeue\x18\x02 \x01(\bR\arequeue\x12\x1f\n" +
	"\x06reason\x18\x03 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x06reason\x121\n" +
	"\x05error\x18\x04 \x01(\v2\x1b.gcommon.v1.queue.NackErrorR\x05error\x12;\n" +
...
var file_gcommon_v1_queue_nack_request_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_queue_nack_request_proto_goTypes = []any{
...
var file_gcommon_v1_queue_nack_request_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_queue_nack_request_proto_init() }
func file_gcommon_v1_queue_nack_request_proto_init() {
	if File_gcommon_v1_queue_nack_request_proto != nil {
		return
	}
	file_gcommon_v1_queue_nack_error_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_queue_nack_request_proto_rawDesc), len(file_gcommon_v1_queue_nack_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_queue_nack_request_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_queue_nack_request_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_queue_nack_request_proto_msgTypes,
	}.Build()
	File_gcommon_v1_queue_nack_request_proto = out.File
	file_gcommon_v1_queue_nack_request_proto_goTypes = nil
	file_gcommon_v1_queue_nack_request_proto_depIdxs = nil
}
