...
const file_gcommon_v1_queue_acknowledge_response_proto_rawDesc = "" +
	"\n" +
	"+gcommon/v1/queue/acknowledge_response.proto\x12\x10gcommon.v1.queue\x1a\x1dgcommon/v1/common/error.proto\x1a(gcommon/v1/common/request_metadata.proto\x1a)gcommon/v1/queue/message_ack_result.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xea\x05\n" +
	...
	"\n" +
	"queue_name\x18\f \x01(\tB\t\xbaH\x06r\x04\x10\x01\x18dR\tqueueName\x12K\n" +
