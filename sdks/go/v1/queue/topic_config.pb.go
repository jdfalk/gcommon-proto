...
const file_gcommon_v1_queue_topic_config_proto_rawDesc = "" +
	"\n" +
	"#gcommon/v1/queue/topic_config.proto\x12\x10gcommon.v1.queue\x1a'gcommon/v1/queue/partition_config.proto\x1a'gcommon/v1/queue/retention_policy.proto\x1a!google/protobuf/go_features.proto\"\x93\x03\n" +
	"\vTopicConfig\x12!\n" +
