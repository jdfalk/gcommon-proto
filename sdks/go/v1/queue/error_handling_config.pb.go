...
const file_gcommon_v1_queue_error_handling_config_proto_rawDesc = "" +
	"\n" +
	",gcommon/v1/queue/error_handling_config.proto\x12\x10gcommon.v1.queue\x1a/gcommon/v1/queue/dead_letter_queue_config.proto\x1a*gcommon/v1/queue/error_action_config.proto\x1a0gcommon/v1/queue/error_notification_config.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xfc\x02\n" +
	"\x13ErrorHandlingConfig\x12F\n" +
	"\n" +
	"dlq_config\x18\x01 \x01(\v2'.gcommon.v1.queue.DeadLetterQueueConfigR\tdlqConfig\x12;\n" +
	"\x15max_delivery_attempts\x18\x02 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\x13maxDeliveryAttempts\x12R\n" +
	"\rerror_actions\x18\x03 \x03(\v2#.gcommon.v1.queue.ErrorActionConfigB\b\xbaH\x05\x92\x01\x02\b\x01R\ferrorActions\x120\n" +
