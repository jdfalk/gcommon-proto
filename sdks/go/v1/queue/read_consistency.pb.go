...
func (x *ReadConsistency) Reset() {
	*x = ReadConsistency{}
	mi := &file_gcommon_v1_queue_read_consistency_proto_msgTypes[0]
...
var File_gcommon_v1_queue_read_consistency_proto protoreflect.FileDescriptor

const file_gcommon_v1_queue_read_consistency_proto_rawDesc = "" +
	"\n" +
	"'gcommon/v1/queue/read_consistency.proto\x12\x10gcommon.v1.queue\x1a\"gcommon/v1/common/read_level.proto\x1a(gcommon/v1/queue/read_retry_config.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xb9\x02\n" +
	"\x0fReadConsistency\x122\n" +
	"\x05level\x18\x01 \x01(\x0e2\x1c.gcommon.v1.common.ReadLevelR\x05level\x121\n" +
	...
	"\n" +
	"timeout_ms\x18\x05 \x01(\x05B\a\xbaH\x04\x1a\x02 \x00R\ttimeoutMs\x12D\n" +
	"\fretry_config\x18\x06 \x01(\v2!.gcommon.v1.queue.ReadRetryConfigR\vretryConfigB4Z*github.com/jdfalk/gcommon/sdks/go/v1/queue\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
func init() { file_gcommon_v1_queue_read_consistency_proto_init() }
func file_gcommon_v1_queue_read_consistency_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_queue_read_consistency_proto_rawDesc), len(file_gcommon_v1_queue_read_consistency_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_queue_read_consistency_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_queue_read_consistency_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_queue_read_consistency_proto_msgTypes,
	}.Build()
	File_gcommon_v1_queue_read_consistency_proto = out.File
	file_gcommon_v1_queue_read_consistency_proto_goTypes = nil
	file_gcommon_v1_queue_read_consistency_proto_depIdxs = nil
}
