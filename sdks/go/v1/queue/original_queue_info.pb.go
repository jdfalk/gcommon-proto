...
func (x *OriginalQueueInfo) Reset() {
	*x = OriginalQueueInfo{}
	mi := &file_gcommon_v1_queue_original_queue_info_proto_msgTypes[0]
...
var File_gcommon_v1_queue_original_queue_info_proto protoreflect.FileDescriptor

const file_gcommon_v1_queue_original_queue_info_proto_rawDesc = "" +
	"\n" +
	"*gcommon/v1/queue/original_queue_info.proto\x12\x10gcommon.v1.queue\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xe5\x02\n" +
...
var file_gcommon_v1_queue_original_queue_info_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_gcommon_v1_queue_original_queue_info_proto_goTypes = []any{
...
var file_gcommon_v1_queue_original_queue_info_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_queue_original_queue_info_proto_init() }
func file_gcommon_v1_queue_original_queue_info_proto_init() {
	if File_gcommon_v1_queue_original_queue_info_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_queue_original_queue_info_proto_rawDesc), len(file_gcommon_v1_queue_original_queue_info_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_queue_original_queue_info_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_queue_original_queue_info_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_queue_original_queue_info_proto_msgTypes,
	}.Build()
	File_gcommon_v1_queue_original_queue_info_proto = out.File
	file_gcommon_v1_queue_original_queue_info_proto_goTypes = nil
	file_gcommon_v1_queue_original_queue_info_proto_depIdxs = nil
}
