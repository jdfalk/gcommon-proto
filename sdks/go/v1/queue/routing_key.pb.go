...
func (x *RoutingKey) Reset() {
	*x = RoutingKey{}
	mi := &file_gcommon_v1_queue_routing_key_proto_msgTypes[0]
...
var File_gcommon_v1_queue_routing_key_proto protoreflect.FileDescriptor

const file_gcommon_v1_queue_routing_key_proto_rawDesc = "" +
	"\n" +
	"\"gcommon/v1/queue/routing_key.proto\x12\x10gcommon.v1.queue\x1a'gcommon/v1/common/routing_pattern.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xc6\x02\n" +
	"\n" +
	"RoutingKey\x12\x19\n" +
	"\x03key\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x03key\x12D\n" +
	...
	"\bpriority\x18\x04 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\bpriority\x12L\n" +
	"\n" +
...
func init() { file_gcommon_v1_queue_routing_key_proto_init() }
func file_gcommon_v1_queue_routing_key_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_queue_routing_key_proto_rawDesc), len(file_gcommon_v1_queue_routing_key_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_queue_routing_key_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_queue_routing_key_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_queue_routing_key_proto_msgTypes,
	}.Build()
	File_gcommon_v1_queue_routing_key_proto = out.File
	file_gcommon_v1_queue_routing_key_proto_goTypes = nil
	file_gcommon_v1_queue_routing_key_proto_depIdxs = nil
}
