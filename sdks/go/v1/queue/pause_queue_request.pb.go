...
const file_gcommon_v1_queue_pause_queue_request_proto_rawDesc = "" +
	"\n" +
	"*gcommon/v1/queue/pause_queue_request.proto\x12\x10gcommon.v1.queue\x1a(gcommon/v1/common/request_metadata.proto\x1a!google/protobuf/go_features.proto\"\xea\x01\n" +
