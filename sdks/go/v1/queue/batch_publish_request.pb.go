...
func (x *BatchPublishRequest) Reset() {
	*x = BatchPublishRequest{}
	mi := &file_gcommon_v1_queue_batch_publish_request_proto_msgTypes[0]
...
var File_gcommon_v1_queue_batch_publish_request_proto protoreflect.FileDescriptor

const file_gcommon_v1_queue_batch_publish_request_proto_rawDesc = "" +
	"\n" +
	",gcommon/v1/queue/batch_publish_request.proto\x12\x10gcommon.v1.queue\x1a(gcommon/v1/common/request_metadata.proto\x1a$gcommon/v1/queue/queue_message.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xe1\x02\n" +
	...
	"maxRetries\x12\x19\n" +
	"\bbatch_id\x18\b \x01(\tR\abatchIdB4Z*github.com/jdfalk/gcommon/sdks/go/v1/queue\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_queue_batch_publish_request_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_queue_batch_publish_request_proto_goTypes = []any{
...
var file_gcommon_v1_queue_batch_publish_request_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_queue_batch_publish_request_proto_init() }
func file_gcommon_v1_queue_batch_publish_request_proto_init() {
	if File_gcommon_v1_queue_batch_publish_request_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_queue_batch_publish_request_proto_rawDesc), len(file_gcommon_v1_queue_batch_publish_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_queue_batch_publish_request_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_queue_batch_publish_request_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_queue_batch_publish_request_proto_msgTypes,
	}.Build()
	File_gcommon_v1_queue_batch_publish_request_proto = out.File
	file_gcommon_v1_queue_batch_publish_request_proto_goTypes = nil
	file_gcommon_v1_queue_batch_publish_request_proto_depIdxs = nil
}
