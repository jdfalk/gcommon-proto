...
// 	protoc        (unknown)
// source: gcommon/v1/queue/restore_queue_request.proto
...
func (x *RestoreQueueRequest) Reset() {
	*x = RestoreQueueRequest{}
	mi := &file_gcommon_v1_queue_restore_queue_request_proto_msgTypes[0]
...
var File_gcommon_v1_queue_restore_queue_request_proto protoreflect.FileDescriptor

const file_gcommon_v1_queue_restore_queue_request_proto_rawDesc = "" +
	"\n" +
	",gcommon/v1/queue/restore_queue_request.proto\x12\x10gcommon.v1.queue\x1a$gcommon/v1/queue/backup_source.proto\x1a%gcommon/v1/queue/restore_config.proto\x1a&gcommon/v1/queue/restore_options.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xe5\x04\n" +
	"\x13RestoreQueueRequest\x12/\n" +
	"\x0ftarget_queue_id\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\rtargetQueueId\x12C\n" +
	...
	"\rpartition_ids\x18\a \x03(\x05B\b\xbaH\x05\x92\x01\x02\b\x01R\fpartitionIds\x12:\n" +
...
var file_gcommon_v1_queue_restore_queue_request_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_gcommon_v1_queue_restore_queue_request_proto_goTypes = []any{
...
var file_gcommon_v1_queue_restore_queue_request_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_queue_restore_queue_request_proto_init() }
func file_gcommon_v1_queue_restore_queue_request_proto_init() {
	if File_gcommon_v1_queue_restore_queue_request_proto != nil {
		return
	}
	file_gcommon_v1_queue_backup_source_proto_init()
	file_gcommon_v1_queue_restore_config_proto_init()
	file_gcommon_v1_queue_restore_options_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_queue_restore_queue_request_proto_rawDesc), len(file_gcommon_v1_queue_restore_queue_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_queue_restore_queue_request_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_queue_restore_queue_request_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_queue_restore_queue_request_proto_msgTypes,
	}.Build()
	File_gcommon_v1_queue_restore_queue_request_proto = out.File
	file_gcommon_v1_queue_restore_queue_request_proto_goTypes = nil
	file_gcommon_v1_queue_restore_queue_request_proto_depIdxs = nil
}
