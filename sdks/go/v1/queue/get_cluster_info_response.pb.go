...
// 	protoc        (unknown)
// source: gcommon/v1/queue/get_cluster_info_response.proto
...
func (x *GetClusterInfoResponse) Reset() {
	*x = GetClusterInfoResponse{}
	mi := &file_gcommon_v1_queue_get_cluster_info_response_proto_msgTypes[0]
...
var File_gcommon_v1_queue_get_cluster_info_response_proto protoreflect.FileDescriptor

const file_gcommon_v1_queue_get_cluster_info_response_proto_rawDesc = "" +
	"\n" +
	"0gcommon/v1/queue/get_cluster_info_response.proto\x12\x10gcommon.v1.queue\x1a#gcommon/v1/queue/cluster_info.proto\x1a gcommon/v1/queue/node_info.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x89\x02\n" +
	"\x16GetClusterInfoResponse\x12@\n" +
	"\fcluster_info\x18\x01 \x01(\v2\x1d.gcommon.v1.queue.ClusterInfoR\vclusterInfo\x12:\n" +
	"\x05nodes\x18\x02 \x03(\v2\x1a.gcommon.v1.queue.NodeInfoB\b\xbaH\x05\x92\x01\x02\b\x01R\x05nodes\x12\x1d\n" +
	"\n" +
	"is_healthy\x18\x03 \x01(\bR\tisHealthy\x12$\n" +
	"\bwarnings\x18\x04 \x03(\tB\b\xbaH\x05\x92\x01\x02\b\x01R\bwarnings\x12,\n" +
	"\rerror_message\x18\x05 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\ferrorMessageB4Z*github.com/jdfalk/gcommon/sdks/go/v1/queue\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_queue_get_cluster_info_response_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_queue_get_cluster_info_response_proto_goTypes = []any{
...
var file_gcommon_v1_queue_get_cluster_info_response_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_queue_get_cluster_info_response_proto_init() }
func file_gcommon_v1_queue_get_cluster_info_response_proto_init() {
	if File_gcommon_v1_queue_get_cluster_info_response_proto != nil {
		return
	}
	file_gcommon_v1_queue_cluster_info_proto_init()
	file_gcommon_v1_queue_node_info_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_queue_get_cluster_info_response_proto_rawDesc), len(file_gcommon_v1_queue_get_cluster_info_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_queue_get_cluster_info_response_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_queue_get_cluster_info_response_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_queue_get_cluster_info_response_proto_msgTypes,
	}.Build()
	File_gcommon_v1_queue_get_cluster_info_response_proto = out.File
	file_gcommon_v1_queue_get_cluster_info_response_proto_goTypes = nil
	file_gcommon_v1_queue_get_cluster_info_response_proto_depIdxs = nil
}
