...
func (x *CommitOffsetResponse) Reset() {
	*x = CommitOffsetResponse{}
	mi := &file_gcommon_v1_queue_commit_offset_response_proto_msgTypes[0]
...
var File_gcommon_v1_queue_commit_offset_response_proto protoreflect.FileDescriptor

const file_gcommon_v1_queue_commit_offset_response_proto_rawDesc = "" +
	"\n" +
	"-gcommon/v1/queue/commit_offset_response.proto\x12\x10gcommon.v1.queue\x1a.gcommon/v1/queue/partition_commit_result.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xd4\x04\n" +
	"\x14CommitOffsetResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12,\n" +
	"\rerror_message\x18\x02 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\ferrorMessage\x12&\n" +
	"\n" +
	"error_code\x18\x03 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\terrorCode\x12^\n" +
	"\x11partition_results\x18\x04 \x03(\v2'.gcommon.v1.queue.PartitionCommitResultB\b\xbaH\x05\x92\x01\x02\b\x01R\x10partitionResults\x120\n" +
	...
	"\x13consumer_generation\x18\b \x01(\x03B\a\xbaH\x04\"\x02(\x00R\x12consumerGeneration\x12P\n" +
...
var file_gcommon_v1_queue_commit_offset_response_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_gcommon_v1_queue_commit_offset_response_proto_goTypes = []any{
...
var file_gcommon_v1_queue_commit_offset_response_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_queue_commit_offset_response_proto_init() }
func file_gcommon_v1_queue_commit_offset_response_proto_init() {
	if File_gcommon_v1_queue_commit_offset_response_proto != nil {
		return
	}
	file_gcommon_v1_queue_partition_commit_result_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_queue_commit_offset_response_proto_rawDesc), len(file_gcommon_v1_queue_commit_offset_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_queue_commit_offset_response_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_queue_commit_offset_response_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_queue_commit_offset_response_proto_msgTypes,
	}.Build()
	File_gcommon_v1_queue_commit_offset_response_proto = out.File
	file_gcommon_v1_queue_commit_offset_response_proto_goTypes = nil
	file_gcommon_v1_queue_commit_offset_response_proto_depIdxs = nil
}
