...
type SubscriptionConfiguration struct {
	...
	xxx_hidden_AckLevel             common.AckLevel        `protobuf:"varint,1,opt,name=ack_level,json=ackLevel,enum=gcommon.v1.common.AckLevel"`
...
func (x *SubscriptionConfiguration) Reset() {
	*x = SubscriptionConfiguration{}
	mi := &file_gcommon_v1_queue_subscription_configuration_proto_msgTypes[0]
...
var File_gcommon_v1_queue_subscription_configuration_proto protoreflect.FileDescriptor

const file_gcommon_v1_queue_subscription_configuration_proto_rawDesc = "" +
	"\n" +
	"1gcommon/v1/queue/subscription_configuration.proto\x12\x10gcommon.v1.queue\x1a!gcommon/v1/common/ack_level.proto\x1a%gcommon/v1/common/delivery_mode.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xb3\x04\n" +
	"\x19SubscriptionConfiguration\x128\n" +
	"\tack_level\x18\x01 \x01(\x0e2\x1b.gcommon.v1.common.AckLevelR\backLevel\x12D\n" +
	"\rdelivery_mode\x18\x02 \x01(\x0e2\x1f.gcommon.v1.common.DeliveryModeR\fdeliveryMode\x12<\n" +
	...
	" \x01(\x03B\a\xbaH\x04\"\x02(\x00R\x14maxMessageAgeSecondsB4Z*github.com/jdfalk/gcommon/sdks/go/v1/queue\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_queue_subscription_configuration_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_queue_subscription_configuration_proto_goTypes = []any{
	(*SubscriptionConfiguration)(nil), // 0: gcommon.v1.queue.SubscriptionConfiguration
	(common.AckLevel)(0),              // 1: gcommon.v1.common.AckLevel
	(common.DeliveryMode)(0),          // 2: gcommon.v1.common.DeliveryMode
}
var file_gcommon_v1_queue_subscription_configuration_proto_depIdxs = []int32{
	1, // 0: gcommon.v1.queue.SubscriptionConfiguration.ack_level:type_name -> gcommon.v1.common.AckLevel
	2, // 1: gcommon.v1.queue.SubscriptionConfiguration.delivery_mode:type_name -> gcommon.v1.common.DeliveryMode
...
func init() { file_gcommon_v1_queue_subscription_configuration_proto_init() }
func file_gcommon_v1_queue_subscription_configuration_proto_init() {
	if File_gcommon_v1_queue_subscription_configuration_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_queue_subscription_configuration_proto_rawDesc), len(file_gcommon_v1_queue_subscription_configuration_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_queue_subscription_configuration_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_queue_subscription_configuration_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_queue_subscription_configuration_proto_msgTypes,
	}.Build()
	File_gcommon_v1_queue_subscription_configuration_proto = out.File
	file_gcommon_v1_queue_subscription_configuration_proto_goTypes = nil
	file_gcommon_v1_queue_subscription_configuration_proto_depIdxs = nil
}
