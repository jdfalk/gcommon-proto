...
func (x *DomainConfig) Reset() {
	*x = DomainConfig{}
	mi := &file_gcommon_v1_organization_domain_config_proto_msgTypes[0]
...
var File_gcommon_v1_organization_domain_config_proto protoreflect.FileDescriptor

const file_gcommon_v1_organization_domain_config_proto_rawDesc = "" +
	"\n" +
	"+gcommon/v1/organization/domain_config.proto\x12\x17gcommon.v1.organization\x1a(gcommon/v1/organization/dns_config.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xc6\x01\n" +
	"\fDomainConfig\x12*\n" +
	...
	"\x11validation_status\x18\x04 \x01(\tR\x10validationStatusB;Z1github.com/jdfalk/gcommon/sdks/go/v1/organization\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_organization_domain_config_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_organization_domain_config_proto_goTypes = []any{
	(*DomainConfig)(nil), // 0: gcommon.v1.organization.DomainConfig
	(*DNSConfig)(nil),    // 1: gcommon.v1.organization.DNSConfig
}
var file_gcommon_v1_organization_domain_config_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_organization_domain_config_proto_init() }
func file_gcommon_v1_organization_domain_config_proto_init() {
	if File_gcommon_v1_organization_domain_config_proto != nil {
		return
	}
	file_gcommon_v1_organization_dns_config_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_organization_domain_config_proto_rawDesc), len(file_gcommon_v1_organization_domain_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_organization_domain_config_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_organization_domain_config_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_organization_domain_config_proto_msgTypes,
	}.Build()
	File_gcommon_v1_organization_domain_config_proto = out.File
	file_gcommon_v1_organization_domain_config_proto_goTypes = nil
	file_gcommon_v1_organization_domain_config_proto_depIdxs = nil
}
