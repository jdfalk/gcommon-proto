...
func (x *StoragePolicy) Reset() {
	*x = StoragePolicy{}
	mi := &file_gcommon_v1_organization_storage_policy_proto_msgTypes[0]
...
var File_gcommon_v1_organization_storage_policy_proto protoreflect.FileDescriptor

const file_gcommon_v1_organization_storage_policy_proto_rawDesc = "" +
	"\n" +
	",gcommon/v1/organization/storage_policy.proto\x12\x17gcommon.v1.organization\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x9c\x01\n" +
	...
	"\aactions\x18\x05 \x03(\tR\aactionsB;Z1github.com/jdfalk/gcommon/sdks/go/v1/organization\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_organization_storage_policy_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_organization_storage_policy_proto_goTypes = []any{
	(*StoragePolicy)(nil), // 0: gcommon.v1.organization.StoragePolicy
}
var file_gcommon_v1_organization_storage_policy_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_organization_storage_policy_proto_init() }
func file_gcommon_v1_organization_storage_policy_proto_init() {
	if File_gcommon_v1_organization_storage_policy_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_organization_storage_policy_proto_rawDesc), len(file_gcommon_v1_organization_storage_policy_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_organization_storage_policy_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_organization_storage_policy_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_organization_storage_policy_proto_msgTypes,
	}.Build()
	File_gcommon_v1_organization_storage_policy_proto = out.File
	file_gcommon_v1_organization_storage_policy_proto_goTypes = nil
	file_gcommon_v1_organization_storage_policy_proto_depIdxs = nil
}
