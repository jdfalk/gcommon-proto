...
// 	protoc        (unknown)
// source: gcommon/v1/organization/update_team_request.proto
...
func (x *UpdateTeamRequest) Reset() {
	*x = UpdateTeamRequest{}
	mi := &file_gcommon_v1_organization_update_team_request_proto_msgTypes[0]
...
var File_gcommon_v1_organization_update_team_request_proto protoreflect.FileDescriptor

const file_gcommon_v1_organization_update_team_request_proto_rawDesc = "" +
	"\n" +
	"1gcommon/v1/organization/update_team_request.proto\x12\x17gcommon.v1.organization\x1a(gcommon/v1/common/request_metadata.proto\x1a\"gcommon/v1/organization/team.proto\x1a google/protobuf/field_mask.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x8a\x02\n" +
	"\x11UpdateTeamRequest\x12>\n" +
	"\bmetadata\x18\x01 \x01(\v2\".gcommon.v1.common.RequestMetadataR\bmetadata\x12 \n" +
	"\ateam_id\x18\x02 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x06teamId\x121\n" +
...
var file_gcommon_v1_organization_update_team_request_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_organization_update_team_request_proto_goTypes = []any{
...
var file_gcommon_v1_organization_update_team_request_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_organization_update_team_request_proto_init() }
func file_gcommon_v1_organization_update_team_request_proto_init() {
	if File_gcommon_v1_organization_update_team_request_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_organization_update_team_request_proto_rawDesc), len(file_gcommon_v1_organization_update_team_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_organization_update_team_request_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_organization_update_team_request_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_organization_update_team_request_proto_msgTypes,
	}.Build()
	File_gcommon_v1_organization_update_team_request_proto = out.File
	file_gcommon_v1_organization_update_team_request_proto_goTypes = nil
	file_gcommon_v1_organization_update_team_request_proto_depIdxs = nil
}
