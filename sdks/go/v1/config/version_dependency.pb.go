...
// 	protoc        (unknown)
// source: gcommon/v1/config/version_dependency.proto
...
func (x *VersionDependency) Reset() {
	*x = VersionDependency{}
	mi := &file_gcommon_v1_config_version_dependency_proto_msgTypes[0]
...
var File_gcommon_v1_config_version_dependency_proto protoreflect.FileDescriptor

const file_gcommon_v1_config_version_dependency_proto_rawDesc = "" +
	"\n" +
	"*gcommon/v1/config/version_dependency.proto\x12\x11gcommon.v1.config\x1a/gcommon/v1/common/version_dependency_type.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xcf\x02\n" +
...
func init() { file_gcommon_v1_config_version_dependency_proto_init() }
func file_gcommon_v1_config_version_dependency_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_config_version_dependency_proto_rawDesc), len(file_gcommon_v1_config_version_dependency_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_config_version_dependency_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_config_version_dependency_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_config_version_dependency_proto_msgTypes,
	}.Build()
	File_gcommon_v1_config_version_dependency_proto = out.File
	file_gcommon_v1_config_version_dependency_proto_goTypes = nil
	file_gcommon_v1_config_version_dependency_proto_depIdxs = nil
}
