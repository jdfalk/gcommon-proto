...
// 	protoc        (unknown)
// source: gcommon/v1/config/template_hook.proto
...
func (x *TemplateHook) Reset() {
	*x = TemplateHook{}
	mi := &file_gcommon_v1_config_template_hook_proto_msgTypes[0]
...
var File_gcommon_v1_config_template_hook_proto protoreflect.FileDescriptor

const file_gcommon_v1_config_template_hook_proto_rawDesc = "" +
	"\n" +
	"%gcommon/v1/config/template_hook.proto\x12\x11gcommon.v1.config\x1a+gcommon/v1/common/hook_error_handling.proto\x1a!gcommon/v1/common/hook_type.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xbf\x04\n" +
...
func init() { file_gcommon_v1_config_template_hook_proto_init() }
func file_gcommon_v1_config_template_hook_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_config_template_hook_proto_rawDesc), len(file_gcommon_v1_config_template_hook_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_config_template_hook_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_config_template_hook_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_config_template_hook_proto_msgTypes,
	}.Build()
	File_gcommon_v1_config_template_hook_proto = out.File
	file_gcommon_v1_config_template_hook_proto_goTypes = nil
	file_gcommon_v1_config_template_hook_proto_depIdxs = nil
}
