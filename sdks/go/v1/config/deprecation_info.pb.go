...
// 	protoc        (unknown)
// source: gcommon/v1/config/deprecation_info.proto
...
func (x *DeprecationInfo) Reset() {
	*x = DeprecationInfo{}
	mi := &file_gcommon_v1_config_deprecation_info_proto_msgTypes[0]
...
var File_gcommon_v1_config_deprecation_info_proto protoreflect.FileDescriptor

const file_gcommon_v1_config_deprecation_info_proto_rawDesc = "" +
	"\n" +
	"(gcommon/v1/config/deprecation_info.proto\x12\x11gcommon.v1.config\x1a)gcommon/v1/common/deprecation_level.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xf1\x02\n" +
	...
	"\x0fmigration_guide\x18\x06 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x0emigrationGuide\x129\n" +
...
func init() { file_gcommon_v1_config_deprecation_info_proto_init() }
func file_gcommon_v1_config_deprecation_info_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_config_deprecation_info_proto_rawDesc), len(file_gcommon_v1_config_deprecation_info_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_config_deprecation_info_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_config_deprecation_info_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_config_deprecation_info_proto_msgTypes,
	}.Build()
	File_gcommon_v1_config_deprecation_info_proto = out.File
	file_gcommon_v1_config_deprecation_info_proto_goTypes = nil
	file_gcommon_v1_config_deprecation_info_proto_depIdxs = nil
}
