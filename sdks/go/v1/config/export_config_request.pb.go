...
// 	protoc        (unknown)
// source: gcommon/v1/config/export_config_request.proto
...
func (x *ExportConfigRequest) Reset() {
	*x = ExportConfigRequest{}
	mi := &file_gcommon_v1_config_export_config_request_proto_msgTypes[0]
...
var File_gcommon_v1_config_export_config_request_proto protoreflect.FileDescriptor

const file_gcommon_v1_config_export_config_request_proto_rawDesc = "" +
	"\n" +
	"-gcommon/v1/config/export_config_request.proto\x12\x11gcommon.v1.config\x1a(gcommon/v1/common/request_metadata.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x9d\x01\n" +
	"\x13ExportConfigRequest\x12%\n" +
	"\tnamespace\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\tnamespace\x12\x1f\n" +
	"\x06format\x18\x02 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x06format\x12>\n" +
...
var file_gcommon_v1_config_export_config_request_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_config_export_config_request_proto_goTypes = []any{
...
var file_gcommon_v1_config_export_config_request_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_config_export_config_request_proto_init() }
func file_gcommon_v1_config_export_config_request_proto_init() {
	if File_gcommon_v1_config_export_config_request_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_config_export_config_request_proto_rawDesc), len(file_gcommon_v1_config_export_config_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_config_export_config_request_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_config_export_config_request_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_config_export_config_request_proto_msgTypes,
	}.Build()
	File_gcommon_v1_config_export_config_request_proto = out.File
	file_gcommon_v1_config_export_config_request_proto_goTypes = nil
	file_gcommon_v1_config_export_config_request_proto_depIdxs = nil
}
