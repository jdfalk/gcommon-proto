...
// 	protoc        (unknown)
// source: gcommon/v1/config/watch_config_response.proto
...
func (x *WatchConfigResponse) Reset() {
	*x = WatchConfigResponse{}
	mi := &file_gcommon_v1_config_watch_config_response_proto_msgTypes[0]
...
var File_gcommon_v1_config_watch_config_response_proto protoreflect.FileDescriptor
...
const file_gcommon_v1_config_watch_config_response_proto_rawDesc = "" +
	...
	"\ttimestamp\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\ttimestampB5Z+github.com/jdfalk/gcommon/sdks/go/v1/config\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
func init() { file_gcommon_v1_config_watch_config_response_proto_init() }
func file_gcommon_v1_config_watch_config_response_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_config_watch_config_response_proto_rawDesc), len(file_gcommon_v1_config_watch_config_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_config_watch_config_response_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_config_watch_config_response_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_config_watch_config_response_proto_msgTypes,
	}.Build()
	File_gcommon_v1_config_watch_config_response_proto = out.File
	file_gcommon_v1_config_watch_config_response_proto_goTypes = nil
	file_gcommon_v1_config_watch_config_response_proto_depIdxs = nil
}
