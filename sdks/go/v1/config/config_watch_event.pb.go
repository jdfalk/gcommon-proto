...
// 	protoc        (unknown)
// source: gcommon/v1/config/config_watch_event.proto
...
func (x *ConfigWatchEvent) Reset() {
	*x = ConfigWatchEvent{}
	mi := &file_gcommon_v1_config_config_watch_event_proto_msgTypes[0]
...
var File_gcommon_v1_config_config_watch_event_proto protoreflect.FileDescriptor

const file_gcommon_v1_config_config_watch_event_proto_rawDesc = "" +
	"\n" +
	"*gcommon/v1/config/config_watch_event.proto\x12\x11gcommon.v1.config\x1a\x19google/protobuf/any.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xce\x03\n" +
	...
	"\tnamespace\x18\a \x01(\tB\a\xbaH\x04r\x02\x10\x01R\tnamespace\x12M\n" +
...
var file_gcommon_v1_config_config_watch_event_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_gcommon_v1_config_config_watch_event_proto_goTypes = []any{
...
var file_gcommon_v1_config_config_watch_event_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_config_config_watch_event_proto_init() }
func file_gcommon_v1_config_config_watch_event_proto_init() {
	if File_gcommon_v1_config_config_watch_event_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_config_config_watch_event_proto_rawDesc), len(file_gcommon_v1_config_config_watch_event_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_config_config_watch_event_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_config_config_watch_event_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_config_config_watch_event_proto_msgTypes,
	}.Build()
	File_gcommon_v1_config_config_watch_event_proto = out.File
	file_gcommon_v1_config_config_watch_event_proto_goTypes = nil
	file_gcommon_v1_config_config_watch_event_proto_depIdxs = nil
}
