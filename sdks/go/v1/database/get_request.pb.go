...
const file_gcommon_v1_database_get_request_proto_rawDesc = "" +
	"\n" +
	"%gcommon/v1/database/get_request.proto\x12\x13gcommon.v1.database\x1a(gcommon/v1/common/request_metadata.proto\x1a!google/protobuf/go_features.proto\"\xae\x01\n" +
	"\n" +
	"GetRequest\x12\x10\n" +
