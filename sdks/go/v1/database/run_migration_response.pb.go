...
func (x *RunMigrationResponse) Reset() {
	*x = RunMigrationResponse{}
	mi := &file_gcommon_v1_database_run_migration_response_proto_msgTypes[0]
...
const file_gcommon_v1_database_run_migration_response_proto_rawDesc = "" +
	"\n" +
	"0gcommon/v1/database/run_migration_response.proto\x12\x13gcommon.v1.database\x1a\x1dgcommon/v1/common/error.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x99\x01\n" +
	"\x14RunMigrationResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x123\n" +
	"\x10applied_versions\x18\x02 \x03(\tB\b\xbaH\x05\x92\x01\x02\b\x01R\x0fappliedVersions\x122\n" +
...
var file_gcommon_v1_database_run_migration_response_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_database_run_migration_response_proto_goTypes = []any{
	(*RunMigrationResponse)(nil), // 0: gcommon.v1.database.RunMigrationResponse
	(*common.Error)(nil),         // 1: gcommon.v1.common.Error
}
var file_gcommon_v1_database_run_migration_response_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_database_run_migration_response_proto_init() }
func file_gcommon_v1_database_run_migration_response_proto_init() {
	if File_gcommon_v1_database_run_migration_response_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_database_run_migration_response_proto_rawDesc), len(file_gcommon_v1_database_run_migration_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_database_run_migration_response_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_database_run_migration_response_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_database_run_migration_response_proto_msgTypes,
	}.Build()
	File_gcommon_v1_database_run_migration_response_proto = out.File
	file_gcommon_v1_database_run_migration_response_proto_goTypes = nil
	file_gcommon_v1_database_run_migration_response_proto_depIdxs = nil
}
