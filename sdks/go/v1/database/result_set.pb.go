...
func (x *ResultSet) Reset() {
	*x = ResultSet{}
	mi := &file_gcommon_v1_database_result_set_proto_msgTypes[0]
...
const file_gcommon_v1_database_result_set_proto_rawDesc = "" +
	"\n" +
	"$gcommon/v1/database/result_set.proto\x12\x13gcommon.v1.database\x1a)gcommon/v1/database/column_metadata.proto\x1a\x1dgcommon/v1/database/row.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xd5\x01\n" +
	"\tResultSet\x12I\n" +
	"\acolumns\x18\x01 \x03(\v2#.gcommon.v1.database.ColumnMetadataB\n" +
	"\xbaH\x05\x92\x01\x02\b\x01(\x01R\acolumns\x128\n" +
	"\x04rows\x18\x02 \x03(\v2\x18.gcommon.v1.database.RowB\n" +
	"\xbaH\x05\x92\x01\x02\b\x01(\x01R\x04rows\x12(\n" +
	"\vtotal_count\x18\x03 \x01(\x03B\a\xbaH\x04\"\x02(\x00R\n" +
	"totalCount\x12\x19\n" +
	"\bhas_more\x18\x04 \x01(\bR\ahasMoreB7Z-github.com/jdfalk/gcommon/sdks/go/v1/database\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_database_result_set_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_database_result_set_proto_goTypes = []any{
...
var file_gcommon_v1_database_result_set_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_database_result_set_proto_init() }
func file_gcommon_v1_database_result_set_proto_init() {
	if File_gcommon_v1_database_result_set_proto != nil {
		return
	}
	file_gcommon_v1_database_column_metadata_proto_init()
	file_gcommon_v1_database_row_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_database_result_set_proto_rawDesc), len(file_gcommon_v1_database_result_set_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_database_result_set_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_database_result_set_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_database_result_set_proto_msgTypes,
	}.Build()
	File_gcommon_v1_database_result_set_proto = out.File
	file_gcommon_v1_database_result_set_proto_goTypes = nil
	file_gcommon_v1_database_result_set_proto_depIdxs = nil
}
