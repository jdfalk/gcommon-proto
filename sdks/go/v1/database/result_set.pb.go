...
const file_gcommon_v1_database_result_set_proto_rawDesc = "" +
	"\n" +
	"$gcommon/v1/database/result_set.proto\x12\x13gcommon.v1.database\x1a)gcommon/v1/database/column_metadata.proto\x1a\x1dgcommon/v1/database/row.proto\x1a!google/protobuf/go_features.proto\"\xbc\x01\n" +
	"\tResultSet\x12A\n" +
