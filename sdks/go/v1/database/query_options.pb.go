...
type QueryOptions struct {
	...
	xxx_hidden_Consistency     common.DatabaseConsistencyLevel `protobuf:"varint,5,opt,name=consistency,enum=gcommon.v1.common.DatabaseConsistencyLevel"`
...
func (x *QueryOptions) Reset() {
	*x = QueryOptions{}
	mi := &file_gcommon_v1_database_query_options_proto_msgTypes[0]
...
const file_gcommon_v1_database_query_options_proto_rawDesc = "" +
	"\n" +
	"'gcommon/v1/database/query_options.proto\x12\x13gcommon.v1.database\x1a)gcommon/v1/common/consistency_level.proto\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x81\x02\n" +
	...
	"\x10include_metadata\x18\x04 \x01(\bR\x0fincludeMetadata\x12M\n" +
	"\vconsistency\x18\x05 \x01(\x0e2+.gcommon.v1.common.DatabaseConsistencyLevelR\vconsistencyB7Z-github.com/jdfalk/gcommon/sdks/go/v1/database\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_database_query_options_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_database_query_options_proto_goTypes = []any{
	(*QueryOptions)(nil),                 // 0: gcommon.v1.database.QueryOptions
	(*durationpb.Duration)(nil),          // 1: google.protobuf.Duration
	(common.DatabaseConsistencyLevel)(0), // 2: gcommon.v1.common.DatabaseConsistencyLevel
}
var file_gcommon_v1_database_query_options_proto_depIdxs = []int32{
	1, // 0: gcommon.v1.database.QueryOptions.timeout:type_name -> google.protobuf.Duration
	2, // 1: gcommon.v1.database.QueryOptions.consistency:type_name -> gcommon.v1.common.DatabaseConsistencyLevel
...
func init() { file_gcommon_v1_database_query_options_proto_init() }
func file_gcommon_v1_database_query_options_proto_init() {
	if File_gcommon_v1_database_query_options_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_database_query_options_proto_rawDesc), len(file_gcommon_v1_database_query_options_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_database_query_options_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_database_query_options_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_database_query_options_proto_msgTypes,
	}.Build()
	File_gcommon_v1_database_query_options_proto = out.File
	file_gcommon_v1_database_query_options_proto_goTypes = nil
	file_gcommon_v1_database_query_options_proto_depIdxs = nil
}
