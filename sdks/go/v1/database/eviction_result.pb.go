...
func (x *EvictionResult) Reset() {
	*x = EvictionResult{}
	mi := &file_gcommon_v1_database_eviction_result_proto_msgTypes[0]
...
const file_gcommon_v1_database_eviction_result_proto_rawDesc = "" +
	"\n" +
	")gcommon/v1/database/eviction_result.proto\x12\x13gcommon.v1.database\x1a'gcommon/v1/common/eviction_policy.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xe2\x02\n" +
	"\x0eEvictionResult\x12,\n" +
	"\revicted_count\x18\x01 \x01(\x03B\a\xbaH\x04\"\x02(\x00R\fevictedCount\x12+\n" +
	"\fevicted_keys\x18\x02 \x03(\tB\b\xbaH\x05\x92\x01\x02\b\x01R\vevictedKeys\x12B\n" +
	...
	"\asuccess\x18\a \x01(\bR\asuccessB7Z-github.com/jdfalk/gcommon/sdks/go/v1/database\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_database_eviction_result_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_database_eviction_result_proto_goTypes = []any{
...
var file_gcommon_v1_database_eviction_result_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_database_eviction_result_proto_init() }
func file_gcommon_v1_database_eviction_result_proto_init() {
	if File_gcommon_v1_database_eviction_result_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_database_eviction_result_proto_rawDesc), len(file_gcommon_v1_database_eviction_result_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_database_eviction_result_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_database_eviction_result_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_database_eviction_result_proto_msgTypes,
	}.Build()
	File_gcommon_v1_database_eviction_result_proto = out.File
	file_gcommon_v1_database_eviction_result_proto_goTypes = nil
	file_gcommon_v1_database_eviction_result_proto_depIdxs = nil
}
