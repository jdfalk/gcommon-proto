...
func (x *ExecuteBatchRequest) Reset() {
	*x = ExecuteBatchRequest{}
	mi := &file_gcommon_v1_database_execute_batch_request_proto_msgTypes[0]
...
const file_gcommon_v1_database_execute_batch_request_proto_rawDesc = "" +
	"\n" +
	"/gcommon/v1/database/execute_batch_request.proto\x12\x13gcommon.v1.database\x1a(gcommon/v1/common/request_metadata.proto\x1a/gcommon/v1/database/batch_execute_options.proto\x1a)gcommon/v1/database/batch_operation.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xcf\x02\n" +
	"\x13ExecuteBatchRequest\x12W\n" +
	"\n" +
	"operations\x18\x01 \x03(\v2+.gcommon.v1.database.DatabaseBatchOperationB\n" +
	"\xbaH\x05\x92\x01\x02\b\x01(\x01R\n" +
	"operations\x12#\n" +
	"\bdatabase\x18\x02 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\bdatabase\x12F\n" +
	...
	"\x0etransaction_id\x18\x05 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\rtransactionIdB7Z-github.com/jdfalk/gcommon/sdks/go/v1/database\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_database_execute_batch_request_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_database_execute_batch_request_proto_goTypes = []any{
...
var file_gcommon_v1_database_execute_batch_request_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_database_execute_batch_request_proto_init() }
func file_gcommon_v1_database_execute_batch_request_proto_init() {
	if File_gcommon_v1_database_execute_batch_request_proto != nil {
		return
	}
	file_gcommon_v1_database_batch_execute_options_proto_init()
	file_gcommon_v1_database_batch_operation_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_database_execute_batch_request_proto_rawDesc), len(file_gcommon_v1_database_execute_batch_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_database_execute_batch_request_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_database_execute_batch_request_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_database_execute_batch_request_proto_msgTypes,
	}.Build()
	File_gcommon_v1_database_execute_batch_request_proto = out.File
	file_gcommon_v1_database_execute_batch_request_proto_goTypes = nil
	file_gcommon_v1_database_execute_batch_request_proto_depIdxs = nil
}
