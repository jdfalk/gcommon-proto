...
// 	protoc        (unknown)
// source: gcommon/v1/database/query_row_response.proto
...
func (x *QueryRowResponse) Reset() {
	*x = QueryRowResponse{}
	mi := &file_gcommon_v1_database_query_row_response_proto_msgTypes[0]
...
const file_gcommon_v1_database_query_row_response_proto_rawDesc = "" +
	"\n" +
	",gcommon/v1/database/query_row_response.proto\x12\x13gcommon.v1.database\x1a\x1dgcommon/v1/common/error.proto\x1a%gcommon/v1/database/query_stats.proto\x1a\x19google/protobuf/any.proto\x1a!google/protobuf/go_features.proto\"\xeb\x01\n" +
	...
	"\x05error\x18\x05 \x01(\v2\x18.gcommon.v1.common.ErrorB\x02(\x01R\x05errorB7Z-github.com/jdfalk/gcommon/sdks/go/v1/database\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_database_query_row_response_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_database_query_row_response_proto_goTypes = []any{
...
var file_gcommon_v1_database_query_row_response_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_database_query_row_response_proto_init() }
func file_gcommon_v1_database_query_row_response_proto_init() {
	if File_gcommon_v1_database_query_row_response_proto != nil {
		return
	}
	file_gcommon_v1_database_query_stats_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_database_query_row_response_proto_rawDesc), len(file_gcommon_v1_database_query_row_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_database_query_row_response_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_database_query_row_response_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_database_query_row_response_proto_msgTypes,
	}.Build()
	File_gcommon_v1_database_query_row_response_proto = out.File
	file_gcommon_v1_database_query_row_response_proto_goTypes = nil
	file_gcommon_v1_database_query_row_response_proto_depIdxs = nil
}
