...
// 	protoc        (unknown)
// source: gcommon/v1/database/revert_migration_request.proto
...
func (x *RevertMigrationRequest) Reset() {
	*x = RevertMigrationRequest{}
	mi := &file_gcommon_v1_database_revert_migration_request_proto_msgTypes[0]
...
const file_gcommon_v1_database_revert_migration_request_proto_rawDesc = "" +
	"\n" +
	"2gcommon/v1/database/revert_migration_request.proto\x12\x13gcommon.v1.database\x1a(gcommon/v1/common/request_metadata.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xc1\x01\n" +
	"\x16RevertMigrationRequest\x12#\n" +
	"\bdatabase\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\bdatabase\x12>\n" +
	"\x0etarget_version\x18\x02 \x01(\tB\x17\xbaH\x14r\x122\x10^v?\\d+\\.\\d+\\.\\d+R\rtargetVersion\x12B\n" +
...
var file_gcommon_v1_database_revert_migration_request_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_database_revert_migration_request_proto_goTypes = []any{
...
var file_gcommon_v1_database_revert_migration_request_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_database_revert_migration_request_proto_init() }
func file_gcommon_v1_database_revert_migration_request_proto_init() {
	if File_gcommon_v1_database_revert_migration_request_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_database_revert_migration_request_proto_rawDesc), len(file_gcommon_v1_database_revert_migration_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_database_revert_migration_request_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_database_revert_migration_request_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_database_revert_migration_request_proto_msgTypes,
	}.Build()
	File_gcommon_v1_database_revert_migration_request_proto = out.File
	file_gcommon_v1_database_revert_migration_request_proto_goTypes = nil
	file_gcommon_v1_database_revert_migration_request_proto_depIdxs = nil
}
