...
// 	protoc        (unknown)
// source: gcommon/v1/database/revert_migration_response.proto
...
func (x *RevertMigrationResponse) Reset() {
	*x = RevertMigrationResponse{}
	mi := &file_gcommon_v1_database_revert_migration_response_proto_msgTypes[0]
...
const file_gcommon_v1_database_revert_migration_response_proto_rawDesc = "" +
	"\n" +
	"3gcommon/v1/database/revert_migration_response.proto\x12\x13gcommon.v1.database\x1a\x1dgcommon/v1/common/error.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x91\x01\n" +
...
var file_gcommon_v1_database_revert_migration_response_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_database_revert_migration_response_proto_goTypes = []any{
	(*RevertMigrationResponse)(nil), // 0: gcommon.v1.database.RevertMigrationResponse
	(*common.Error)(nil),            // 1: gcommon.v1.common.Error
}
var file_gcommon_v1_database_revert_migration_response_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_database_revert_migration_response_proto_init() }
func file_gcommon_v1_database_revert_migration_response_proto_init() {
	if File_gcommon_v1_database_revert_migration_response_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_database_revert_migration_response_proto_rawDesc), len(file_gcommon_v1_database_revert_migration_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_database_revert_migration_response_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_database_revert_migration_response_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_database_revert_migration_response_proto_msgTypes,
	}.Build()
	File_gcommon_v1_database_revert_migration_response_proto = out.File
	file_gcommon_v1_database_revert_migration_response_proto_goTypes = nil
	file_gcommon_v1_database_revert_migration_response_proto_depIdxs = nil
}
