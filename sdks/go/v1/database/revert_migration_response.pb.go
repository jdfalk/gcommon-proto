...
const file_gcommon_v1_database_revert_migration_response_proto_rawDesc = "" +
	"\n" +
	"3gcommon/v1/database/revert_migration_response.proto\x12\x13gcommon.v1.database\x1a\x1dgcommon/v1/common/error.proto\x1a!google/protobuf/go_features.proto\"\x88\x01\n" +
