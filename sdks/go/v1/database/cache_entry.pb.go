...
func (x *CacheEntry) Reset() {
	*x = CacheEntry{}
	mi := &file_gcommon_v1_database_cache_entry_proto_msgTypes[0]
...
const file_gcommon_v1_database_cache_entry_proto_rawDesc = "" +
	"\n" +
	"%gcommon/v1/database/cache_entry.proto\x12\x13gcommon.v1.database\x1a\x19google/protobuf/any.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\x88\x04\n" +
	"\n" +
	"CacheEntry\x12\x10\n" +
...
var file_gcommon_v1_database_cache_entry_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_gcommon_v1_database_cache_entry_proto_goTypes = []any{
	(*CacheEntry)(nil),            // 0: gcommon.v1.database.CacheEntry
	nil,                           // 1: gcommon.v1.database.CacheEntry.MetadataEntry
	(*anypb.Any)(nil),             // 2: google.protobuf.Any
	(*timestamppb.Timestamp)(nil), // 3: google.protobuf.Timestamp
}
var file_gcommon_v1_database_cache_entry_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_database_cache_entry_proto_init() }
func file_gcommon_v1_database_cache_entry_proto_init() {
	if File_gcommon_v1_database_cache_entry_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_database_cache_entry_proto_rawDesc), len(file_gcommon_v1_database_cache_entry_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_database_cache_entry_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_database_cache_entry_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_database_cache_entry_proto_msgTypes,
	}.Build()
	File_gcommon_v1_database_cache_entry_proto = out.File
	file_gcommon_v1_database_cache_entry_proto_goTypes = nil
	file_gcommon_v1_database_cache_entry_proto_depIdxs = nil
}
