...
def create_dependabot_file(repo_path: Path, repo_name: str) -> bool:
    ...
    try:
        ...
        print(f"  ✅ Created dependabot.yml with {len(config['updates'])} configurations")
        return True
...
def main():
    ...
    if success_count < total_count:
        print("⚠️  Some repositories could not be processed. Check the output above for details.")
