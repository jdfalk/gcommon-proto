...
func (x *WebCacheConfig) GetPolicy() *proto.CachePolicy {
	if x != nil {
...
func (x *WebCacheConfig) SetPolicy(v *proto.CachePolicy) {
...
const file_pkg_web_proto_cache_config_proto_rawDesc = "" +
	"\n" +
	" pkg/web/proto/cache_config.proto\x12\x0egcommon.v1.web\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a#pkg/common/proto/cache_policy.proto\x1a\"pkg/web/proto/cache_strategy.proto\"\xed\x01\n" +
