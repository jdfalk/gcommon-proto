...
// 	protoc        (unknown)
// source: pkg/web/proto/enums/middleware_type.proto
...
func init() { file_pkg_web_proto_enums_middleware_type_proto_init() }
func file_pkg_web_proto_enums_middleware_type_proto_init() {
	if File_pkg_web_proto_enums_middleware_type_proto != nil {
		return
	}
	type x struct{}
	...
	file_pkg_web_proto_enums_middleware_type_proto_depIdxs = nil
}
