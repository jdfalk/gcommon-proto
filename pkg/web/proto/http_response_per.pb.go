...
// 	protoc        (unknown)
// source: pkg/web/proto/http_response_per.proto
...
func (x *HttpResponse) Reset() {
	*x = HttpResponse{}
	mi := &file_pkg_web_proto_http_response_per_proto_msgTypes[0]
...
func (x *HttpResponse) SetRequestMetadata(v *proto.RequestMetadata) {
...
func (x *HttpResponse) SetError(v *proto.Error) {
...
var File_pkg_web_proto_http_response_per_proto protoreflect.FileDescriptor

const file_pkg_web_proto_http_response_per_proto_rawDesc = "" +
	"\n" +
	"%pkg/web/proto/http_response_per.proto\x12\x0egcommon.v1.web\x1a\x19google/protobuf/any.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1cpkg/common/proto/error.proto\x1a'pkg/common/proto/request_metadata.proto\"\xe2\v\n" +
	...
	"\x12com.gcommon.v1.webB\x14HttpResponsePerProtoP\x01Z'github.com/jdfalk/gcommon/pkg/web/proto\xa2\x02\x03GVW\xaa\x02\x0eGcommon.V1.Web\xca\x02\x0eGcommon\\V1\\Web\xe2\x02\x1aGcommon\\V1\\Web\\GPBMetadata\xea\x02\x10Gcommon::V1::Web\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_pkg_web_proto_http_response_per_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_pkg_web_proto_http_response_per_proto_goTypes = []any{
...
var file_pkg_web_proto_http_response_per_proto_depIdxs = []int32{
...
func init() { file_pkg_web_proto_http_response_per_proto_init() }
func file_pkg_web_proto_http_response_per_proto_init() {
	if File_pkg_web_proto_http_response_per_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_web_proto_http_response_per_proto_rawDesc), len(file_pkg_web_proto_http_response_per_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_web_proto_http_response_per_proto_goTypes,
		DependencyIndexes: file_pkg_web_proto_http_response_per_proto_depIdxs,
		MessageInfos:      file_pkg_web_proto_http_response_per_proto_msgTypes,
	}.Build()
	File_pkg_web_proto_http_response_per_proto = out.File
	file_pkg_web_proto_http_response_per_proto_goTypes = nil
	file_pkg_web_proto_http_response_per_proto_depIdxs = nil
}
