...
func (*HttpResponse) Descriptor() ([]byte, []int) {
	return file_pkg_web_proto_http_response_per_proto_rawDescGZIP(), []int{0}
}
...
const file_pkg_web_proto_http_response_per_proto_rawDesc = "" +
	"\n" +
	"%pkg/web/proto/http_response_per.proto\x12\x0egcommon.v1.web\x1a\x19google/protobuf/any.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1cpkg/common/proto/error.proto\x1a'pkg/common/proto/request_metadata.proto\"\xe2\v\n" +
	...
	"\x12com.gcommon.v1.webB\x14HttpResponsePerProtoP\x01Z'github.com/jdfalk/gcommon/pkg/web/proto\xa2\x02\x03GVW\xaa\x02\x0eGcommon.V1.Web\xca\x02\x0eGcommon\\V1\\Web\xe2\x02\x1aGcommon\\V1\\Web\\GPBMetadata\xea\x02\x10Gcommon::V1::Webb\beditionsp\xe8\a"

var (
	file_pkg_web_proto_http_response_per_proto_rawDescOnce sync.Once
	file_pkg_web_proto_http_response_per_proto_rawDescData []byte
)

func file_pkg_web_proto_http_response_per_proto_rawDescGZIP() []byte {
	file_pkg_web_proto_http_response_per_proto_rawDescOnce.Do(func() {
		file_pkg_web_proto_http_response_per_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_web_proto_http_response_per_proto_rawDesc), len(file_pkg_web_proto_http_response_per_proto_rawDesc)))
	})
	return file_pkg_web_proto_http_response_per_proto_rawDescData
}
