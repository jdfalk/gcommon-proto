...
// 	protoc        (unknown)
// source: pkg/web/proto/messages/handler_config.proto
...
func (x *HandlerConfig) Reset() {
	*x = HandlerConfig{}
	mi := &file_pkg_web_proto_messages_handler_config_proto_msgTypes[0]
...
var File_pkg_web_proto_messages_handler_config_proto protoreflect.FileDescriptor

const file_pkg_web_proto_messages_handler_config_proto_rawDesc = "" +
	"\n" +
	"+pkg/web/proto/messages/handler_config.proto\x12\x0egcommon.v1.web\x1a!google/protobuf/go_features.proto\x1a\x19google/protobuf/any.proto\x1a&pkg/web/proto/enums/handler_type.proto\"\x88\x02\n" +
	"\rHandlerConfig\x12/\n" +
	...
	"\x12com.gcommon.v1.webB\x12HandlerConfigProtoP\x01Z-github.com/jdfalk/gcommon/pkg/web/proto;webpb\xa2\x02\x03GVW\xaa\x02\x0eGcommon.V1.Web\xca\x02\x0eGcommon\\V1\\Web\xe2\x02\x1aGcommon\\V1\\Web\\GPBMetadata\xea\x02\x10Gcommon::V1::Web\x92\x03\x05\xd2>\x02\x10\x02b\beditionsp\xe8\a"

var file_pkg_web_proto_messages_handler_config_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_pkg_web_proto_messages_handler_config_proto_goTypes = []any{
...
var file_pkg_web_proto_messages_handler_config_proto_depIdxs = []int32{
...
func init() { file_pkg_web_proto_messages_handler_config_proto_init() }
func file_pkg_web_proto_messages_handler_config_proto_init() {
	if File_pkg_web_proto_messages_handler_config_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_web_proto_messages_handler_config_proto_rawDesc), len(file_pkg_web_proto_messages_handler_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_web_proto_messages_handler_config_proto_goTypes,
		DependencyIndexes: file_pkg_web_proto_messages_handler_config_proto_depIdxs,
		MessageInfos:      file_pkg_web_proto_messages_handler_config_proto_msgTypes,
	}.Build()
	File_pkg_web_proto_messages_handler_config_proto = out.File
	file_pkg_web_proto_messages_handler_config_proto_goTypes = nil
	file_pkg_web_proto_messages_handler_config_proto_depIdxs = nil
}
