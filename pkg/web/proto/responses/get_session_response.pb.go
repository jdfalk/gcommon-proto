...
// 	protoc        (unknown)
// source: pkg/web/proto/responses/get_session_response.proto
...
func (x *GetSessionResponse) Reset() {
	*x = GetSessionResponse{}
	mi := &file_pkg_web_proto_responses_get_session_response_proto_msgTypes[0]
...
var File_pkg_web_proto_responses_get_session_response_proto protoreflect.FileDescriptor
...
const file_pkg_web_proto_responses_get_session_response_proto_rawDesc = "" +
	...
	"\x12com.gcommon.v1.webB\x17GetSessionResponseProtoP\x01Z\x1f../../../../pkg/web/proto;webpb\xa2\x02\x03GVW\xaa\x02\x0eGcommon.V1.Web\xca\x02\x0eGcommon\\V1\\Web\xe2\x02\x1aGcommon\\V1\\Web\\GPBMetadata\xea\x02\x10Gcommon::V1::Web\x92\x03\x05\xd2>\x02\x10\x02b\beditionsp\xe8\a"
...
func file_pkg_web_proto_responses_get_session_response_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_web_proto_responses_get_session_response_proto_rawDesc), len(file_pkg_web_proto_responses_get_session_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_web_proto_responses_get_session_response_proto_goTypes,
		DependencyIndexes: file_pkg_web_proto_responses_get_session_response_proto_depIdxs,
		MessageInfos:      file_pkg_web_proto_responses_get_session_response_proto_msgTypes,
	}.Build()
	File_pkg_web_proto_responses_get_session_response_proto = out.File
	file_pkg_web_proto_responses_get_session_response_proto_goTypes = nil
	file_pkg_web_proto_responses_get_session_response_proto_depIdxs = nil
}
