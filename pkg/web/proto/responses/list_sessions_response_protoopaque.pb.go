...
func (x *ListSessionsResponse) Reset() {
	*x = ListSessionsResponse{}
	mi := &file_pkg_web_proto_responses_list_sessions_response_proto_msgTypes[0]
...
func file_pkg_web_proto_responses_list_sessions_response_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		MessageInfos:      file_pkg_web_proto_responses_list_sessions_response_proto_msgTypes,
	}.Build()
