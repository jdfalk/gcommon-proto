...
// 	protoc        (unknown)
// source: pkg/web/proto/responses/http_response.proto
...
func (x *HttpResponse) Reset() {
	*x = HttpResponse{}
	mi := &file_pkg_web_proto_responses_http_response_proto_msgTypes[0]
...
func (*HttpResponse) Descriptor() ([]byte, []int) {
	return file_pkg_web_proto_responses_http_response_proto_rawDescGZIP(), []int{0}
}
...
var File_pkg_web_proto_responses_http_response_proto protoreflect.FileDescriptor

const file_pkg_web_proto_responses_http_response_proto_rawDesc = "" +
	"\n" +
	"+pkg/web/proto/responses/http_response.proto\x12\x0egcommon.v1.web\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x19google/protobuf/any.proto\x1a\x1dpkg/common/proto/common.proto\"\xe2\v\n" +
	...
	"\x12com.gcommon.v1.webB\x11HttpResponseProtoP\x01Z1github.com/jdfalk/gcommon/pkg/web/proto/responses\xa2\x02\x03GVW\xaa\x02\x0eGcommon.V1.Web\xca\x02\x0eGcommon\\V1\\Web\xe2\x02\x1aGcommon\\V1\\Web\\GPBMetadata\xea\x02\x10Gcommon::V1::Webb\beditionsp\xe8\a"

var (
	file_pkg_web_proto_responses_http_response_proto_rawDescOnce sync.Once
	file_pkg_web_proto_responses_http_response_proto_rawDescData []byte
)

func file_pkg_web_proto_responses_http_response_proto_rawDescGZIP() []byte {
	file_pkg_web_proto_responses_http_response_proto_rawDescOnce.Do(func() {
		file_pkg_web_proto_responses_http_response_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_web_proto_responses_http_response_proto_rawDesc), len(file_pkg_web_proto_responses_http_response_proto_rawDesc)))
	})
	return file_pkg_web_proto_responses_http_response_proto_rawDescData
}

var file_pkg_web_proto_responses_http_response_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_pkg_web_proto_responses_http_response_proto_goTypes = []any{
...
var file_pkg_web_proto_responses_http_response_proto_depIdxs = []int32{
...
func init() { file_pkg_web_proto_responses_http_response_proto_init() }
func file_pkg_web_proto_responses_http_response_proto_init() {
	if File_pkg_web_proto_responses_http_response_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_web_proto_responses_http_response_proto_rawDesc), len(file_pkg_web_proto_responses_http_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_web_proto_responses_http_response_proto_goTypes,
		DependencyIndexes: file_pkg_web_proto_responses_http_response_proto_depIdxs,
		MessageInfos:      file_pkg_web_proto_responses_http_response_proto_msgTypes,
	}.Build()
	File_pkg_web_proto_responses_http_response_proto = out.File
	file_pkg_web_proto_responses_http_response_proto_goTypes = nil
	file_pkg_web_proto_responses_http_response_proto_depIdxs = nil
}
