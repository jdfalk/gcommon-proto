...
type CheckResult struct {
	...
	xxx_hidden_Error         *proto1.Error             `protobuf:"bytes,6,opt,name=error"`
...
func (x *CheckResult) GetStatus() proto.MetricsHealthStatus {
	if x != nil {
...
func (x *CheckResult) GetError() *proto1.Error {
	if x != nil {
...
func (x *CheckResult) SetStatus(v proto.MetricsHealthStatus) {
...
func (x *CheckResult) SetError(v *proto1.Error) {
...
const file_pkg_health_proto_check_result_proto_rawDesc = "" +
	...
	"\x06status\x18\x02 \x01(\x0e2'.gcommon.v1.metrics.MetricsHealthStatusR\x06status\x128\n" +
...
var file_pkg_health_proto_check_result_proto_goTypes = []any{
	...
	(proto.MetricsHealthStatus)(0), // 2: gcommon.v1.metrics.MetricsHealthStatus
	(*timestamppb.Timestamp)(nil),  // 3: google.protobuf.Timestamp
	(*durationpb.Duration)(nil),    // 4: google.protobuf.Duration
	(*proto1.Error)(nil),           // 5: gcommon.v1.common.Error
}
var file_pkg_health_proto_check_result_proto_depIdxs = []int32{
	2, // 0: gcommon.v1.health.CheckResult.status:type_name -> gcommon.v1.metrics.MetricsHealthStatus
