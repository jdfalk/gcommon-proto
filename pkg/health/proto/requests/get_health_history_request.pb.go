...
func (x *GetHealthHistoryRequest) GetMetadata() *pb.RequestMetadata {
	if x != nil {
		return x.Metadata
	}
	return nil
...
func (x *GetHealthHistoryRequest) SetMetadata(v *pb.RequestMetadata) {
	x.Metadata = v
}
...
const file_pkg_health_proto_requests_get_health_history_request_proto_rawDesc = "" +
	"\n" +
	":pkg/health/proto/requests/get_health_history_request.proto\x12\x11gcommon.v1.health\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a0pkg/common/proto/messages/request_metadata.proto\"\xe9\x01\n" +
	...
	"\x15com.gcommon.v1.healthB\x1cGetHealthHistoryRequestProtoP\x01Z\"../../../../pkg/health/pb;healthpb\xa2\x02\x03GVH\xaa\x02\x11Gcommon.V1.Health\xca\x02\x11Gcommon\\V1\\Health\xe2\x02\x1dGcommon\\V1\\Health\\GPBMetadata\xea\x02\x13Gcommon::V1::Health\x92\x03\x05\xd2>\x02\x10\x02b\beditionsp\xe8\a"
