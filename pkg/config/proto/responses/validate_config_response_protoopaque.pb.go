...
// 	protoc        (unknown)
// source: pkg/config/proto/responses/validate_config_response.proto
...
type ValidateConfigResponse struct {
	...
	xxx_hidden_Errors      *[]*messages.ConfigValidationError   `protobuf:"bytes,2,rep,name=errors"`
	xxx_hidden_Warnings    *[]*messages.ConfigValidationWarning `protobuf:"bytes,3,rep,name=warnings"`
...
func (x *ValidateConfigResponse) Reset() {
	*x = ValidateConfigResponse{}
	mi := &file_pkg_config_proto_responses_validate_config_response_proto_msgTypes[0]
...
var File_pkg_config_proto_responses_validate_config_response_proto protoreflect.FileDescriptor

const file_pkg_config_proto_responses_validate_config_response_proto_rawDesc = "" +
	"\n" +
	"9pkg/config/proto/responses/validate_config_response.proto\x12\x11gcommon.v1.config\x1a!google/protobuf/go_features.proto\x1a7pkg/config/proto/messages/config_validation_error.proto\x1a9pkg/config/proto/messages/config_validation_warning.proto\"\xb8\x01\n" +
...
func init() { file_pkg_config_proto_responses_validate_config_response_proto_init() }
func file_pkg_config_proto_responses_validate_config_response_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_config_proto_responses_validate_config_response_proto_rawDesc), len(file_pkg_config_proto_responses_validate_config_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_config_proto_responses_validate_config_response_proto_goTypes,
		DependencyIndexes: file_pkg_config_proto_responses_validate_config_response_proto_depIdxs,
		MessageInfos:      file_pkg_config_proto_responses_validate_config_response_proto_msgTypes,
	}.Build()
	File_pkg_config_proto_responses_validate_config_response_proto = out.File
	file_pkg_config_proto_responses_validate_config_response_proto_goTypes = nil
	file_pkg_config_proto_responses_validate_config_response_proto_depIdxs = nil
}
