...
// 	protoc        (unknown)
// source: pkg/config/proto/config_watch_event.proto
...
func (x *ConfigWatchEvent) Reset() {
	*x = ConfigWatchEvent{}
	mi := &file_pkg_config_proto_config_watch_event_proto_msgTypes[0]
...
var File_pkg_config_proto_config_watch_event_proto protoreflect.FileDescriptor

const file_pkg_config_proto_config_watch_event_proto_rawDesc = "" +
	"\n" +
	")pkg/config/proto/config_watch_event.proto\x12\x11gcommon.v1.config\x1a\x19google/protobuf/any.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xaa\x03\n" +
	...
	"\x15com.gcommon.v1.configB\x15ConfigWatchEventProtoP\x01Z*github.com/jdfalk/gcommon/pkg/config/proto\xa2\x02\x03GVC\xaa\x02\x11Gcommon.V1.Config\xca\x02\x11Gcommon\\V1\\Config\xe2\x02\x1dGcommon\\V1\\Config\\GPBMetadata\xea\x02\x13Gcommon::V1::Config\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_pkg_config_proto_config_watch_event_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_pkg_config_proto_config_watch_event_proto_goTypes = []any{
...
var file_pkg_config_proto_config_watch_event_proto_depIdxs = []int32{
...
func init() { file_pkg_config_proto_config_watch_event_proto_init() }
func file_pkg_config_proto_config_watch_event_proto_init() {
	if File_pkg_config_proto_config_watch_event_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_config_proto_config_watch_event_proto_rawDesc), len(file_pkg_config_proto_config_watch_event_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_config_proto_config_watch_event_proto_goTypes,
		DependencyIndexes: file_pkg_config_proto_config_watch_event_proto_depIdxs,
		MessageInfos:      file_pkg_config_proto_config_watch_event_proto_msgTypes,
	}.Build()
	File_pkg_config_proto_config_watch_event_proto = out.File
	file_pkg_config_proto_config_watch_event_proto_goTypes = nil
	file_pkg_config_proto_config_watch_event_proto_depIdxs = nil
}
