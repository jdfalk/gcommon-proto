...
const file_pkg_config_proto_messages_config_metadata_proto_rawDesc = "" +
	"\n" +
	"/pkg/config/proto/messages/config_metadata.proto\x12\x11gcommon.v1.config\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1dpkg/common/proto/common.proto\"\xc1\x0e\n" +
