...
// 	protoc        (unknown)
// source: pkg/config/proto/config_data_type.proto
...
func (ConfigDataType) Descriptor() protoreflect.EnumDescriptor {
	return file_pkg_config_proto_config_data_type_proto_enumTypes[0].Descriptor()
}

func (ConfigDataType) Type() protoreflect.EnumType {
	return &file_pkg_config_proto_config_data_type_proto_enumTypes[0]
}
...
func (ConfigDataType) EnumDescriptor() ([]byte, []int) {
	return file_pkg_config_proto_config_data_type_proto_rawDescGZIP(), []int{0}
}

var File_pkg_config_proto_config_data_type_proto protoreflect.FileDescriptor

const file_pkg_config_proto_config_data_type_proto_rawDesc = "" +
	"\n" +
	"'pkg/config/proto/config_data_type.proto\x12\x11gcommon.v1.config*\x80\x06\n" +
	...
	"\x14CONFIG_DATA_TYPE_HEX\x10\x19B\xbe\x01\n" +
	"\x15com.gcommon.v1.configB\x13ConfigDataTypeProtoP\x01Z*github.com/jdfalk/gcommon/pkg/config/proto\xa2\x02\x03GVC\xaa\x02\x11Gcommon.V1.Config\xca\x02\x11Gcommon\\V1\\Config\xe2\x02\x1dGcommon\\V1\\Config\\GPBMetadata\xea\x02\x13Gcommon::V1::Configb\beditionsp\xe8\a"

var (
	file_pkg_config_proto_config_data_type_proto_rawDescOnce sync.Once
	file_pkg_config_proto_config_data_type_proto_rawDescData []byte
)

func file_pkg_config_proto_config_data_type_proto_rawDescGZIP() []byte {
	file_pkg_config_proto_config_data_type_proto_rawDescOnce.Do(func() {
		file_pkg_config_proto_config_data_type_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_config_proto_config_data_type_proto_rawDesc), len(file_pkg_config_proto_config_data_type_proto_rawDesc)))
	})
	return file_pkg_config_proto_config_data_type_proto_rawDescData
}

var file_pkg_config_proto_config_data_type_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_pkg_config_proto_config_data_type_proto_goTypes = []any{
	(ConfigDataType)(0), // 0: gcommon.v1.config.ConfigDataType
}
var file_pkg_config_proto_config_data_type_proto_depIdxs = []int32{
...
func init() { file_pkg_config_proto_config_data_type_proto_init() }
func file_pkg_config_proto_config_data_type_proto_init() {
	if File_pkg_config_proto_config_data_type_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_config_proto_config_data_type_proto_rawDesc), len(file_pkg_config_proto_config_data_type_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_config_proto_config_data_type_proto_goTypes,
		DependencyIndexes: file_pkg_config_proto_config_data_type_proto_depIdxs,
		EnumInfos:         file_pkg_config_proto_config_data_type_proto_enumTypes,
	}.Build()
	File_pkg_config_proto_config_data_type_proto = out.File
	file_pkg_config_proto_config_data_type_proto_goTypes = nil
	file_pkg_config_proto_config_data_type_proto_depIdxs = nil
}
