...
const file_pkg_log_proto_appender_config_proto_rawDesc = "" +
	...
	"\x06output\x18\x03 \x01(\v2+.gcommon.v1.log.AppenderConfig.OutputConfigR\x06output\x12O\n" +
	"\tformatter\x18\x04 \x01(\v21.gcommon.v1.log.AppenderConfig.LogFormatterConfigR\tformatter\x12N\n" +
	"\n" +
...
var file_pkg_log_proto_appender_config_proto_goTypes = []any{
	...
	(*AppenderConfig_LogFormatterConfig)(nil), // 3: gcommon.v1.log.AppenderConfig.LogFormatterConfig
...
var file_pkg_log_proto_appender_config_proto_depIdxs = []int32{
	...
	3, // 2: gcommon.v1.log.AppenderConfig.formatter:type_name -> gcommon.v1.log.AppenderConfig.LogFormatterConfig
	...
	6, // 5: gcommon.v1.log.AppenderConfig.LogFormatterConfig.type:type_name -> gcommon.v1.log.FormatterType
