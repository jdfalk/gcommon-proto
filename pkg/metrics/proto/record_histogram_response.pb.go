...
const file_pkg_metrics_proto_record_histogram_response_proto_rawDesc = "" +
	...
	"\x0frecording_stats\x18\b \x01(\v2\".gcommon.v1.metrics.RecordingStatsR\x0erecordingStatsB\xd5\x01\n" +
...
var file_pkg_metrics_proto_record_histogram_response_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
...
func file_pkg_metrics_proto_record_histogram_response_proto_init() {
	...
	file_pkg_metrics_proto_bucket_info_proto_init()
	file_pkg_metrics_proto_histogram_metric_proto_init()
	file_pkg_metrics_proto_histogram_stats_proto_init()
