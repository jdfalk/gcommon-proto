...
type ProviderConfig struct {
	...
	xxx_hidden_ResourceLimits *proto.OrganizationResourceLimits `protobuf:"bytes,6,opt,name=resource_limits,json=resourceLimits"`
...
func (x *ProviderConfig) Reset() {
	*x = ProviderConfig{}
	mi := &file_pkg_metrics_proto_provider_config_proto_msgTypes[0]
...
func (x *ProviderConfig) GetResourceLimits() *proto.OrganizationResourceLimits {
	if x != nil {
...
func (x *ProviderConfig) SetResourceLimits(v *proto.OrganizationResourceLimits) {
...
var File_pkg_metrics_proto_provider_config_proto protoreflect.FileDescriptor

const file_pkg_metrics_proto_provider_config_proto_rawDesc = "" +
	"\n" +
	...
	"\x16com.gcommon.v1.metricsB\x13ProviderConfigProtoP\x01Z+github.com/jdfalk/gcommon/pkg/metrics/proto\xa2\x02\x03GVM\xaa\x02\x12Gcommon.V1.Metrics\xca\x02\x12Gcommon\\V1\\Metrics\xe2\x02\x1eGcommon\\V1\\Metrics\\GPBMetadata\xea\x02\x14Gcommon::V1::Metrics\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_pkg_metrics_proto_provider_config_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_pkg_metrics_proto_provider_config_proto_goTypes = []any{
	...
	(*proto.OrganizationResourceLimits)(nil), // 5: gcommon.v1.organization.OrganizationResourceLimits
	(*MetricsSecurityConfig)(nil),            // 6: gcommon.v1.metrics.MetricsSecurityConfig
}
var file_pkg_metrics_proto_provider_config_proto_depIdxs = []int32{
...
func init() { file_pkg_metrics_proto_provider_config_proto_init() }
func file_pkg_metrics_proto_provider_config_proto_init() {
	if File_pkg_metrics_proto_provider_config_proto != nil {
		return
	}
	file_pkg_metrics_proto_export_config_proto_init()
	file_pkg_metrics_proto_provider_settings_proto_init()
	file_pkg_metrics_proto_provider_type_proto_init()
	file_pkg_metrics_proto_security_config_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_metrics_proto_provider_config_proto_rawDesc), len(file_pkg_metrics_proto_provider_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_metrics_proto_provider_config_proto_goTypes,
		DependencyIndexes: file_pkg_metrics_proto_provider_config_proto_depIdxs,
		MessageInfos:      file_pkg_metrics_proto_provider_config_proto_msgTypes,
	}.Build()
	File_pkg_metrics_proto_provider_config_proto = out.File
	file_pkg_metrics_proto_provider_config_proto_goTypes = nil
	file_pkg_metrics_proto_provider_config_proto_depIdxs = nil
}
