...
const file_pkg_metrics_proto_get_provider_stats_request_proto_rawDesc = "" +
	"\n" +
	"2pkg/metrics/proto/get_provider_stats_request.proto\x12\x12gcommon.v1.metrics\x1a!google/protobuf/go_features.proto\x1a'pkg/common/proto/request_metadata.proto\x1a!pkg/common/proto/time_range.proto\x1a%pkg/metrics/proto/stats_options.proto\x1a\"pkg/metrics/proto/time_range.proto\"\xc8\x02\n" +
	...
	"\x10include_realtime\x18\x06 \x01(\bR\x0fincludeRealtimeB\xd5\x01\n" +
...
var file_pkg_metrics_proto_get_provider_stats_request_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
...
func file_pkg_metrics_proto_get_provider_stats_request_proto_init() {
	...
	file_pkg_metrics_proto_stats_options_proto_init()
