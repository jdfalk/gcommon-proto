...
const file_pkg_metrics_proto_query_metrics_request_proto_rawDesc = "" +
	"\n" +
	"-pkg/metrics/proto/query_metrics_request.proto\x12\x12gcommon.v1.metrics\x1a!google/protobuf/go_features.proto\x1a'pkg/common/proto/request_metadata.proto\x1a$pkg/metrics/proto/metric_query.proto\x1a,pkg/metrics/proto/query_output_options.proto\"\xd7\x02\n" +
	...
	"\x0eoutput_options\x18\x06 \x01(\v2&.gcommon.v1.metrics.QueryOutputOptionsR\routputOptionsB\xd1\x01\n" +
...
var file_pkg_metrics_proto_query_metrics_request_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
...
func file_pkg_metrics_proto_query_metrics_request_proto_init() {
	...
	file_pkg_metrics_proto_query_output_options_proto_init()
	type x struct{}
