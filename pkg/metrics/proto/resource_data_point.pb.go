...
// 	protoc        (unknown)
// source: pkg/metrics/proto/resource_data_point.proto
...
func (x *ResourceDataPoint) Reset() {
	*x = ResourceDataPoint{}
	mi := &file_pkg_metrics_proto_resource_data_point_proto_msgTypes[0]
...
var File_pkg_metrics_proto_resource_data_point_proto protoreflect.FileDescriptor

const file_pkg_metrics_proto_resource_data_point_proto_rawDesc = "" +
	"\n" +
	"+pkg/metrics/proto/resource_data_point.proto\x12\x12gcommon.v1.metrics\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1cpkg/common/proto/error.proto\x1a!pkg/common/proto/time_range.proto\x1a#pkg/metrics/proto/error_stats.proto\x1a)pkg/metrics/proto/performance_stats.proto\x1a%pkg/metrics/proto/provider_info.proto\x1a/pkg/metrics/proto/resource_limits_summary.proto\x1a\"pkg/metrics/proto/time_range.proto\x1a#pkg/metrics/proto/top_metrics.proto\"\x92\x02\n" +
	...
	"\x18network_bytes_per_second\x18\x05 \x01(\x03R\x15networkBytesPerSecondB\xcf\x01\n" +
	"\x16com.gcommon.v1.metricsB\x16ResourceDataPointProtoP\x01Z+github.com/jdfalk/gcommon/pkg/metrics/proto\xa2\x02\x03GVM\xaa\x02\x12Gcommon.V1.Metrics\xca\x02\x12Gcommon\\V1\\Metrics\xe2\x02\x1eGcommon\\V1\\Metrics\\GPBMetadata\xea\x02\x14Gcommon::V1::Metrics\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_pkg_metrics_proto_resource_data_point_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_pkg_metrics_proto_resource_data_point_proto_goTypes = []any{
	(*ResourceDataPoint)(nil),     // 0: gcommon.v1.metrics.ResourceDataPoint
	(*timestamppb.Timestamp)(nil), // 1: google.protobuf.Timestamp
}
var file_pkg_metrics_proto_resource_data_point_proto_depIdxs = []int32{
	1, // 0: gcommon.v1.metrics.ResourceDataPoint.timestamp:type_name -> google.protobuf.Timestamp
...
func init() { file_pkg_metrics_proto_resource_data_point_proto_init() }
func file_pkg_metrics_proto_resource_data_point_proto_init() {
	if File_pkg_metrics_proto_resource_data_point_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_metrics_proto_resource_data_point_proto_rawDesc), len(file_pkg_metrics_proto_resource_data_point_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_metrics_proto_resource_data_point_proto_goTypes,
		DependencyIndexes: file_pkg_metrics_proto_resource_data_point_proto_depIdxs,
		MessageInfos:      file_pkg_metrics_proto_resource_data_point_proto_msgTypes,
	}.Build()
	File_pkg_metrics_proto_resource_data_point_proto = out.File
	file_pkg_metrics_proto_resource_data_point_proto_goTypes = nil
	file_pkg_metrics_proto_resource_data_point_proto_depIdxs = nil
}
