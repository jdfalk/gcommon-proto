...
type RecordMetricsRequest struct {
	...
	FailOnError *bool `protobuf:"varint,7,opt,name=fail_on_error,json=failOnError" json:"fail_on_error,omitempty"`
	// Whether to validate all metrics before recording
	ValidateAll   *bool `protobuf:"varint,8,opt,name=validate_all,json=validateAll" json:"validate_all,omitempty"`
...
func (x *RecordMetricsRequest) GetMetadata() *pb.RequestMetadata {
	if x != nil {
		return x.Metadata
	}
	return nil
...
func (x *RecordMetricsRequest) GetValidateAll() bool {
	if x != nil && x.ValidateAll != nil {
		return *x.ValidateAll
	}
	return false
}

func (x *RecordMetricsRequest) SetMetadata(v *pb.RequestMetadata) {
	x.Metadata = v
}
...
func (b0 RecordMetricsRequest_builder) Build() *RecordMetricsRequest {
	...
	x.FailOnError = b.FailOnError
	x.ValidateAll = b.ValidateAll
	return m0
}
...
func (x *BatchOptions) HasParallelProcessing() bool {
	...
	return x.ParallelProcessing != nil
}
...
func (x *BatchOptions) HasReturnDetailedResults() bool {
	...
	return x.ReturnDetailedResults != nil
}
...
func (x *BatchOptions) ClearParallelProcessing() {
	x.ParallelProcessing = nil
}

func (x *BatchOptions) ClearMaxConcurrency() {
	x.MaxConcurrency = nil
}
...
func (b0 BatchOptions_builder) Build() *BatchOptions {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.ParallelProcessing = b.ParallelProcessing
	x.MaxConcurrency = b.MaxConcurrency
	x.Deduplicate = b.Deduplicate
	x.ReturnDetailedResults = b.ReturnDetailedResults
	x.TimeoutSeconds = b.TimeoutSeconds
	x.Transactional = b.Transactional
...
const file_pkg_metrics_proto_requests_record_metrics_request_proto_rawDesc = "" +
	...
	"\x16com.gcommon.v1.metricsB\x19RecordMetricsRequestProtoP\x01Z$../../../../pkg/metrics/pb;metricspb\xa2\x02\x03GVM\xaa\x02\x12Gcommon.V1.Metrics\xca\x02\x12Gcommon\\V1\\Metrics\xe2\x02\x1eGcommon\\V1\\Metrics\\GPBMetadata\xea\x02\x14Gcommon::V1::Metrics\x92\x03\x05\xd2>\x02\x10\x02b\beditionsp\xe8\a"
