...
func (x case_UnregisterMetricRequest_MetricIdentifier) String() string {
	md := file_pkg_metrics_proto_unregister_metric_request_proto_msgTypes[0].Descriptor()
	if x == 0 {
		return "not set"
	}
...
const file_pkg_metrics_proto_unregister_metric_request_proto_rawDesc = "" +
	"\n" +
	"1pkg/metrics/proto/unregister_metric_request.proto\x12\x12gcommon.v1.metrics\x1a!google/protobuf/go_features.proto\x1a'pkg/common/proto/request_metadata.proto\"\x96\x02\n" +
	...
	"\rcreate_backup\x18\b \x01(\bR\fcreateBackupB\xd5\x01\n" +
