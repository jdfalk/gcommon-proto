...
// 	protoc        (unknown)
// source: pkg/metrics/proto/metric_definition.proto
...
func (x *MetricDefinition) Reset() {
	*x = MetricDefinition{}
	mi := &file_pkg_metrics_proto_metric_definition_proto_msgTypes[0]
...
var File_pkg_metrics_proto_metric_definition_proto protoreflect.FileDescriptor

const file_pkg_metrics_proto_metric_definition_proto_rawDesc = "" +
	"\n" +
	")pkg/metrics/proto/metric_definition.proto\x12\x12gcommon.v1.metrics\x1a!google/protobuf/go_features.proto\x1a%pkg/metrics/proto/export_config.proto\x1a(pkg/metrics/proto/label_definition.proto\x1a#pkg/metrics/proto/metric_type.proto\x1a*pkg/metrics/proto/metric_type_config.proto\x1a/pkg/metrics/proto/retention_policy_config.proto\x1a(pkg/metrics/proto/validation_rules.proto\"\xe4\x04\n" +
	...
	"\x16com.gcommon.v1.metricsB\x15MetricDefinitionProtoP\x01Z+github.com/jdfalk/gcommon/pkg/metrics/proto\xa2\x02\x03GVM\xaa\x02\x12Gcommon.V1.Metrics\xca\x02\x12Gcommon\\V1\\Metrics\xe2\x02\x1eGcommon\\V1\\Metrics\\GPBMetadata\xea\x02\x14Gcommon::V1::Metrics\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_pkg_metrics_proto_metric_definition_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_pkg_metrics_proto_metric_definition_proto_goTypes = []any{
...
var file_pkg_metrics_proto_metric_definition_proto_depIdxs = []int32{
...
func init() { file_pkg_metrics_proto_metric_definition_proto_init() }
func file_pkg_metrics_proto_metric_definition_proto_init() {
	if File_pkg_metrics_proto_metric_definition_proto != nil {
		return
	}
	file_pkg_metrics_proto_export_config_proto_init()
	file_pkg_metrics_proto_label_definition_proto_init()
	file_pkg_metrics_proto_metric_type_proto_init()
	file_pkg_metrics_proto_metric_type_config_proto_init()
	file_pkg_metrics_proto_retention_policy_config_proto_init()
	file_pkg_metrics_proto_validation_rules_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_metrics_proto_metric_definition_proto_rawDesc), len(file_pkg_metrics_proto_metric_definition_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_metrics_proto_metric_definition_proto_goTypes,
		DependencyIndexes: file_pkg_metrics_proto_metric_definition_proto_depIdxs,
		MessageInfos:      file_pkg_metrics_proto_metric_definition_proto_msgTypes,
	}.Build()
	File_pkg_metrics_proto_metric_definition_proto = out.File
	file_pkg_metrics_proto_metric_definition_proto_goTypes = nil
	file_pkg_metrics_proto_metric_definition_proto_depIdxs = nil
}
