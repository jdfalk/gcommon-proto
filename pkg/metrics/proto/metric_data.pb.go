...
func (*MetricData) Descriptor() ([]byte, []int) {
	return file_pkg_metrics_proto_metric_data_proto_rawDescGZIP(), []int{0}
}
...
func (*MetricSeries) Descriptor() ([]byte, []int) {
	return file_pkg_metrics_proto_metric_data_proto_rawDescGZIP(), []int{1}
}
...
func (*MetricFamily) Descriptor() ([]byte, []int) {
	return file_pkg_metrics_proto_metric_data_proto_rawDescGZIP(), []int{2}
}
...
const file_pkg_metrics_proto_metric_data_proto_rawDesc = "" +
	"\n" +
	"#pkg/metrics/proto/metric_data.proto\x12\x12gcommon.v1.metrics\x1a#pkg/metrics/proto/metric_type.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a$pkg/metrics/proto/metric_value.proto\"\xf7\x03\n" +
	"\n" +
	"MetricData\x12\x1b\n" +
	...
	"\ametrics\x18\x05 \x03(\v2\x1e.gcommon.v1.metrics.MetricDataR\ametricsB\xc0\x01\n" +
	"\x16com.gcommon.v1.metricsB\x0fMetricDataProtoP\x01Z+github.com/jdfalk/gcommon/pkg/metrics/proto\xa2\x02\x03GVM\xaa\x02\x12Gcommon.V1.Metrics\xca\x02\x12Gcommon\\V1\\Metrics\xe2\x02\x1eGcommon\\V1\\Metrics\\GPBMetadata\xea\x02\x14Gcommon::V1::Metricsb\beditionsp\xe8\a"

var (
	file_pkg_metrics_proto_metric_data_proto_rawDescOnce sync.Once
	file_pkg_metrics_proto_metric_data_proto_rawDescData []byte
)

func file_pkg_metrics_proto_metric_data_proto_rawDescGZIP() []byte {
	file_pkg_metrics_proto_metric_data_proto_rawDescOnce.Do(func() {
		file_pkg_metrics_proto_metric_data_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_metrics_proto_metric_data_proto_rawDesc), len(file_pkg_metrics_proto_metric_data_proto_rawDesc)))
	})
	return file_pkg_metrics_proto_metric_data_proto_rawDescData
}
