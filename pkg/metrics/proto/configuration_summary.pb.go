...
// 	protoc        (unknown)
// source: pkg/metrics/proto/configuration_summary.proto
...
func (x *ConfigurationSummary) Reset() {
	*x = ConfigurationSummary{}
	mi := &file_pkg_metrics_proto_configuration_summary_proto_msgTypes[0]
...
var File_pkg_metrics_proto_configuration_summary_proto protoreflect.FileDescriptor

const file_pkg_metrics_proto_configuration_summary_proto_rawDesc = "" +
	"\n" +
	"-pkg/metrics/proto/configuration_summary.proto\x12\x12gcommon.v1.metrics\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a/pkg/metrics/proto/resource_limits_summary.proto\x1a(pkg/metrics/proto/security_summary.proto\"\xf9\x01\n" +
	...
	"\x0econfig_version\x18\x04 \x01(\tR\rconfigVersionB\xd2\x01\n" +
	"\x16com.gcommon.v1.metricsB\x19ConfigurationSummaryProtoP\x01Z+github.com/jdfalk/gcommon/pkg/metrics/proto\xa2\x02\x03GVM\xaa\x02\x12Gcommon.V1.Metrics\xca\x02\x12Gcommon\\V1\\Metrics\xe2\x02\x1eGcommon\\V1\\Metrics\\GPBMetadata\xea\x02\x14Gcommon::V1::Metrics\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_pkg_metrics_proto_configuration_summary_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_pkg_metrics_proto_configuration_summary_proto_goTypes = []any{
...
var file_pkg_metrics_proto_configuration_summary_proto_depIdxs = []int32{
...
func init() { file_pkg_metrics_proto_configuration_summary_proto_init() }
func file_pkg_metrics_proto_configuration_summary_proto_init() {
	if File_pkg_metrics_proto_configuration_summary_proto != nil {
		return
	}
	file_pkg_metrics_proto_resource_limits_summary_proto_init()
	file_pkg_metrics_proto_security_summary_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_metrics_proto_configuration_summary_proto_rawDesc), len(file_pkg_metrics_proto_configuration_summary_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_metrics_proto_configuration_summary_proto_goTypes,
		DependencyIndexes: file_pkg_metrics_proto_configuration_summary_proto_depIdxs,
		MessageInfos:      file_pkg_metrics_proto_configuration_summary_proto_msgTypes,
	}.Build()
	File_pkg_metrics_proto_configuration_summary_proto = out.File
	file_pkg_metrics_proto_configuration_summary_proto_goTypes = nil
	file_pkg_metrics_proto_configuration_summary_proto_depIdxs = nil
}
