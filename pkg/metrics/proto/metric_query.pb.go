...
type MetricQuery struct {
	...
	xxx_hidden_TimeFilter   *TimeRange             `protobuf:"bytes,5,opt,name=time_filter,json=timeFilter"`
...
func (x *MetricQuery) SetTimeFilter(v *TimeRange) {
...
const file_pkg_metrics_proto_metric_query_proto_rawDesc = "" +
	...
	"\x0einput_step_ids\x18\x05 \x03(\tR\finputStepIdsB\xc9\x01\n" +
