...
type MetricQuery struct {
	...
	xxx_hidden_SortCriteria *[]*proto.SortOptions  `protobuf:"bytes,8,rep,name=sort_criteria,json=sortCriteria"`
...
func (x *MetricQuery) SetSortCriteria(v []*proto.SortOptions) {
...
type MetricQuery_builder struct {
	...
	GroupBy []*GroupBySpec
	// Sort criteria
	SortCriteria []*proto.SortOptions
...
const file_pkg_metrics_proto_metric_query_proto_rawDesc = "" +
	...
	"\x16com.gcommon.v1.metricsB\x10MetricQueryProtoP\x01Z+github.com/jdfalk/gcommon/pkg/metrics/proto\xa2\x02\x03GVM\xaa\x02\x12Gcommon.V1.Metrics\xca\x02\x12Gcommon\\V1\\Metrics\xe2\x02\x1eGcommon\\V1\\Metrics\\GPBMetadata\xea\x02\x14Gcommon::V1::Metrics\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_pkg_metrics_proto_metric_query_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_pkg_metrics_proto_metric_query_proto_goTypes = []any{
	...
	(*proto.SortOptions)(nil), // 5: gcommon.v1.common.SortOptions
}
...
func file_pkg_metrics_proto_metric_query_proto_init() {
	...
	file_pkg_metrics_proto_aggregation_spec_proto_init()
	file_pkg_metrics_proto_aggregation_type_proto_init()
	file_pkg_metrics_proto_group_by_spec_proto_init()
