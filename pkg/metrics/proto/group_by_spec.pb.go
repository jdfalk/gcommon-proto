...
// 	protoc        (unknown)
// source: pkg/metrics/proto/group_by_spec.proto
...
func (x *GroupBySpec) Reset() {
	*x = GroupBySpec{}
	mi := &file_pkg_metrics_proto_group_by_spec_proto_msgTypes[0]
...
var File_pkg_metrics_proto_group_by_spec_proto protoreflect.FileDescriptor

const file_pkg_metrics_proto_group_by_spec_proto_rawDesc = "" +
	"\n" +
	"%pkg/metrics/proto/group_by_spec.proto\x12\x12gcommon.v1.metrics\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a(pkg/metrics/proto/aggregation_type.proto\x1a%pkg/metrics/proto/metric_filter.proto\x1a'pkg/metrics/proto/query_operation.proto\x1a\"pkg/metrics/proto/time_range.proto\x1a'pkg/metrics/proto/timestamp_range.proto\"\x85\x01\n" +
	...
	"\n" +
	"max_groups\x18\x03 \x01(\x05R\tmaxGroupsB\xc9\x01\n" +
	"\x16com.gcommon.v1.metricsB\x10GroupBySpecProtoP\x01Z+github.com/jdfalk/gcommon/pkg/metrics/proto\xa2\x02\x03GVM\xaa\x02\x12Gcommon.V1.Metrics\xca\x02\x12Gcommon\\V1\\Metrics\xe2\x02\x1eGcommon\\V1\\Metrics\\GPBMetadata\xea\x02\x14Gcommon::V1::Metrics\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_pkg_metrics_proto_group_by_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_pkg_metrics_proto_group_by_spec_proto_goTypes = []any{
	(*GroupBySpec)(nil),         // 0: gcommon.v1.metrics.GroupBySpec
	(*durationpb.Duration)(nil), // 1: google.protobuf.Duration
}
var file_pkg_metrics_proto_group_by_spec_proto_depIdxs = []int32{
...
func init() { file_pkg_metrics_proto_group_by_spec_proto_init() }
func file_pkg_metrics_proto_group_by_spec_proto_init() {
	if File_pkg_metrics_proto_group_by_spec_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_metrics_proto_group_by_spec_proto_rawDesc), len(file_pkg_metrics_proto_group_by_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_metrics_proto_group_by_spec_proto_goTypes,
		DependencyIndexes: file_pkg_metrics_proto_group_by_spec_proto_depIdxs,
		MessageInfos:      file_pkg_metrics_proto_group_by_spec_proto_msgTypes,
	}.Build()
	File_pkg_metrics_proto_group_by_spec_proto = out.File
	file_pkg_metrics_proto_group_by_spec_proto_goTypes = nil
	file_pkg_metrics_proto_group_by_spec_proto_depIdxs = nil
}
