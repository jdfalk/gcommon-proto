...
func (x *StreamStart) Reset() {
	*x = StreamStart{}
	mi := &file_pkg_metrics_proto_stream_start_proto_msgTypes[0]
...
var File_pkg_metrics_proto_stream_start_proto protoreflect.FileDescriptor

const file_pkg_metrics_proto_stream_start_proto_rawDesc = "" +
	"\n" +
	"$pkg/metrics/proto/stream_start.proto\x12\x12gcommon.v1.metrics\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a'pkg/common/proto/request_metadata.proto\x1a0pkg/metrics/proto/buffer_overflow_strategy.proto\x1a%pkg/metrics/proto/metric_filter.proto\x1a*pkg/metrics/proto/stream_compression.proto\x1a\"pkg/metrics/proto/stream_qos.proto\"\xb3\x01\n" +
	"\vStreamStart\x12A\n" +
	...
	"fromOffsetB\xc9\x01\n" +
	"\x16com.gcommon.v1.metricsB\x10StreamStartProtoP\x01Z+github.com/jdfalk/gcommon/pkg/metrics/proto\xa2\x02\x03GVM\xaa\x02\x12Gcommon.V1.Metrics\xca\x02\x12Gcommon\\V1\\Metrics\xe2\x02\x1eGcommon\\V1\\Metrics\\GPBMetadata\xea\x02\x14Gcommon::V1::Metrics\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_pkg_metrics_proto_stream_start_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_pkg_metrics_proto_stream_start_proto_goTypes = []any{
	(*StreamStart)(nil),           // 0: gcommon.v1.metrics.StreamStart
	(*timestamppb.Timestamp)(nil), // 1: google.protobuf.Timestamp
}
var file_pkg_metrics_proto_stream_start_proto_depIdxs = []int32{
...
func init() { file_pkg_metrics_proto_stream_start_proto_init() }
func file_pkg_metrics_proto_stream_start_proto_init() {
	if File_pkg_metrics_proto_stream_start_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_metrics_proto_stream_start_proto_rawDesc), len(file_pkg_metrics_proto_stream_start_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_metrics_proto_stream_start_proto_goTypes,
		DependencyIndexes: file_pkg_metrics_proto_stream_start_proto_depIdxs,
		MessageInfos:      file_pkg_metrics_proto_stream_start_proto_msgTypes,
	}.Build()
	File_pkg_metrics_proto_stream_start_proto = out.File
	file_pkg_metrics_proto_stream_start_proto_goTypes = nil
	file_pkg_metrics_proto_stream_start_proto_depIdxs = nil
}
