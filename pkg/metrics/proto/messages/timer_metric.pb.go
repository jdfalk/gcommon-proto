...
// 	protoc        (unknown)
// source: pkg/metrics/proto/messages/timer_metric.proto
...
func (x *TimerMetric) Reset() {
	*x = TimerMetric{}
	mi := &file_pkg_metrics_proto_messages_timer_metric_proto_msgTypes[0]
...
func (b0 TimerMetric_builder) Build() *TimerMetric {
	...
	x.IsRunning = b.IsRunning
	x.Count = b.Count
	x.TotalDuration = b.TotalDuration
	x.Percentiles = b.Percentiles
...
func (x *TimerStatistics) Reset() {
	*x = TimerStatistics{}
	mi := &file_pkg_metrics_proto_messages_timer_metric_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *TimerStatistics) HasStandardDeviationMs() bool {
	...
	return x.StandardDeviationMs != nil
}
...
func (b0 TimerStatistics_builder) Build() *TimerStatistics {
	...
	x.MeanDuration = b.MeanDuration
	x.StandardDeviationMs = b.StandardDeviationMs
	x.VarianceMs = b.VarianceMs
	x.SampleCount = b.SampleCount
	x.RatePerSecond = b.RatePerSecond
	x.LastDuration = b.LastDuration
	return m0
}
...
func (x *PercentileMeasurement) Reset() {
	*x = PercentileMeasurement{}
	mi := &file_pkg_metrics_proto_messages_timer_metric_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_pkg_metrics_proto_messages_timer_metric_proto protoreflect.FileDescriptor

const file_pkg_metrics_proto_messages_timer_metric_proto_rawDesc = "" +
	"\n" +
	"-pkg/metrics/proto/messages/timer_metric.proto\x12\x12gcommon.v1.metrics\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/duration.proto\"\xa3\x05\n" +
	...
	"\fsample_count\x18\x03 \x01(\x03R\vsampleCountB\xc5\x01\n" +
	"\x16com.gcommon.v1.metricsB\x10TimerMetricProtoP\x01Z'../../../../pkg/metrics/proto;metricspb\xa2\x02\x03GVM\xaa\x02\x12Gcommon.V1.Metrics\xca\x02\x12Gcommon\\V1\\Metrics\xe2\x02\x1eGcommon\\V1\\Metrics\\GPBMetadata\xea\x02\x14Gcommon::V1::Metrics\x92\x03\x05\xd2>\x02\x10\x02b\beditionsp\xe8\a"
...
var file_pkg_metrics_proto_messages_timer_metric_proto_depIdxs = []int32{
...
func init() { file_pkg_metrics_proto_messages_timer_metric_proto_init() }
func file_pkg_metrics_proto_messages_timer_metric_proto_init() {
	if File_pkg_metrics_proto_messages_timer_metric_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_metrics_proto_messages_timer_metric_proto_rawDesc), len(file_pkg_metrics_proto_messages_timer_metric_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_metrics_proto_messages_timer_metric_proto_goTypes,
		DependencyIndexes: file_pkg_metrics_proto_messages_timer_metric_proto_depIdxs,
		MessageInfos:      file_pkg_metrics_proto_messages_timer_metric_proto_msgTypes,
	}.Build()
	File_pkg_metrics_proto_messages_timer_metric_proto = out.File
	file_pkg_metrics_proto_messages_timer_metric_proto_goTypes = nil
	file_pkg_metrics_proto_messages_timer_metric_proto_depIdxs = nil
}
