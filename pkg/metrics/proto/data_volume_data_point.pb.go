...
// 	protoc        (unknown)
// source: pkg/metrics/proto/data_volume_data_point.proto
...
func (x *DataVolumeDataPoint) Reset() {
	*x = DataVolumeDataPoint{}
	mi := &file_pkg_metrics_proto_data_volume_data_point_proto_msgTypes[0]
...
const file_pkg_metrics_proto_data_volume_data_point_proto_rawDesc = "" +
	...
	"\x0eingestion_rate\x18\x05 \x01(\x01R\ringestionRateB\xd1\x01\n" +
	"\x16com.gcommon.v1.metricsB\x18DataVolumeDataPointProtoP\x01Z+github.com/jdfalk/gcommon/pkg/metrics/proto\xa2\x02\x03GVM\xaa\x02\x12Gcommon.V1.Metrics\xca\x02\x12Gcommon\\V1\\Metrics\xe2\x02\x1eGcommon\\V1\\Metrics\\GPBMetadata\xea\x02\x14Gcommon::V1::Metrics\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_pkg_metrics_proto_data_volume_data_point_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_pkg_metrics_proto_data_volume_data_point_proto_goTypes = []any{
	(*DataVolumeDataPoint)(nil),   // 0: gcommon.v1.metrics.DataVolumeDataPoint
	(*timestamppb.Timestamp)(nil), // 1: google.protobuf.Timestamp
}
var file_pkg_metrics_proto_data_volume_data_point_proto_depIdxs = []int32{
...
func init() { file_pkg_metrics_proto_data_volume_data_point_proto_init() }
func file_pkg_metrics_proto_data_volume_data_point_proto_init() {
	if File_pkg_metrics_proto_data_volume_data_point_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_metrics_proto_data_volume_data_point_proto_rawDesc), len(file_pkg_metrics_proto_data_volume_data_point_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_metrics_proto_data_volume_data_point_proto_goTypes,
		DependencyIndexes: file_pkg_metrics_proto_data_volume_data_point_proto_depIdxs,
		MessageInfos:      file_pkg_metrics_proto_data_volume_data_point_proto_msgTypes,
	}.Build()
	File_pkg_metrics_proto_data_volume_data_point_proto = out.File
	file_pkg_metrics_proto_data_volume_data_point_proto_goTypes = nil
	file_pkg_metrics_proto_data_volume_data_point_proto_depIdxs = nil
}
