...
func (*CreateProviderResponse) Descriptor() ([]byte, []int) {
	return file_pkg_metrics_proto_create_provider_response_proto_rawDescGZIP(), []int{0}
}
...
// Deprecated: Use AppliedConfig.ProtoReflect.Descriptor instead.
func (*AppliedConfig) Descriptor() ([]byte, []int) {
	return file_pkg_metrics_proto_create_provider_response_proto_rawDescGZIP(), []int{1}
}
...
func (*ResourceAllocations) Descriptor() ([]byte, []int) {
	return file_pkg_metrics_proto_create_provider_response_proto_rawDescGZIP(), []int{2}
}
...
func (*ProviderEndpoints) Descriptor() ([]byte, []int) {
	return file_pkg_metrics_proto_create_provider_response_proto_rawDescGZIP(), []int{3}
}
...
const file_pkg_metrics_proto_create_provider_response_proto_rawDesc = "" +
	"\n" +
	"0pkg/metrics/proto/create_provider_response.proto\x12\x12gcommon.v1.metrics\x1a\x1cpkg/common/proto/error.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a)pkg/metrics/proto/validation_result.proto\x1a'pkg/metrics/proto/provider_status.proto\"\xeb\x03\n" +
	...
	"\x16com.gcommon.v1.metricsB\x1bCreateProviderResponseProtoP\x01Z+github.com/jdfalk/gcommon/pkg/metrics/proto\xa2\x02\x03GVM\xaa\x02\x12Gcommon.V1.Metrics\xca\x02\x12Gcommon\\V1\\Metrics\xe2\x02\x1eGcommon\\V1\\Metrics\\GPBMetadata\xea\x02\x14Gcommon::V1::Metricsb\beditionsp\xe8\a"

var (
	file_pkg_metrics_proto_create_provider_response_proto_rawDescOnce sync.Once
	file_pkg_metrics_proto_create_provider_response_proto_rawDescData []byte
)

func file_pkg_metrics_proto_create_provider_response_proto_rawDescGZIP() []byte {
	file_pkg_metrics_proto_create_provider_response_proto_rawDescOnce.Do(func() {
		file_pkg_metrics_proto_create_provider_response_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_metrics_proto_create_provider_response_proto_rawDesc), len(file_pkg_metrics_proto_create_provider_response_proto_rawDesc)))
	})
	return file_pkg_metrics_proto_create_provider_response_proto_rawDescData
}
