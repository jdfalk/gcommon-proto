...
func (x *CreateProviderResponse) Reset() {
	*x = CreateProviderResponse{}
	mi := &file_pkg_metrics_proto_create_provider_response_proto_msgTypes[0]
...
func (x *AppliedConfig) Reset() {
	*x = AppliedConfig{}
	mi := &file_pkg_metrics_proto_create_provider_response_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *ResourceAllocations) Reset() {
	*x = ResourceAllocations{}
	mi := &file_pkg_metrics_proto_create_provider_response_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *ProviderEndpoints) Reset() {
	*x = ProviderEndpoints{}
	mi := &file_pkg_metrics_proto_create_provider_response_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_pkg_metrics_proto_create_provider_response_proto protoreflect.FileDescriptor

const file_pkg_metrics_proto_create_provider_response_proto_rawDesc = "" +
	"\n" +
	...
	"\x16com.gcommon.v1.metricsB\x1bCreateProviderResponseProtoP\x01Z+github.com/jdfalk/gcommon/pkg/metrics/proto\xa2\x02\x03GVM\xaa\x02\x12Gcommon.V1.Metrics\xca\x02\x12Gcommon\\V1\\Metrics\xe2\x02\x1eGcommon\\V1\\Metrics\\GPBMetadata\xea\x02\x14Gcommon::V1::Metrics\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_pkg_metrics_proto_create_provider_response_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_pkg_metrics_proto_create_provider_response_proto_goTypes = []any{
...
var file_pkg_metrics_proto_create_provider_response_proto_depIdxs = []int32{
...
func init() { file_pkg_metrics_proto_create_provider_response_proto_init() }
func file_pkg_metrics_proto_create_provider_response_proto_init() {
	if File_pkg_metrics_proto_create_provider_response_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_metrics_proto_create_provider_response_proto_rawDesc), len(file_pkg_metrics_proto_create_provider_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_metrics_proto_create_provider_response_proto_goTypes,
		DependencyIndexes: file_pkg_metrics_proto_create_provider_response_proto_depIdxs,
		MessageInfos:      file_pkg_metrics_proto_create_provider_response_proto_msgTypes,
	}.Build()
	File_pkg_metrics_proto_create_provider_response_proto = out.File
	file_pkg_metrics_proto_create_provider_response_proto_goTypes = nil
	file_pkg_metrics_proto_create_provider_response_proto_depIdxs = nil
}
