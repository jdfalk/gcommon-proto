...
const file_pkg_metrics_proto_create_provider_response_proto_rawDesc = "" +
	...
	"\tendpoints\x18\t \x01(\v2%.gcommon.v1.metrics.ProviderEndpointsR\tendpointsB\xd4\x01\n" +
...
var file_pkg_metrics_proto_create_provider_response_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
...
func file_pkg_metrics_proto_create_provider_response_proto_init() {
	...
	file_pkg_metrics_proto_applied_config_proto_init()
	file_pkg_metrics_proto_provider_endpoints_proto_init()
