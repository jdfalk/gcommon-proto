...
// 	protoc        (unknown)
// source: pkg/metrics/proto/record_histogram_request.proto
...
func (x *RecordHistogramRequest) Reset() {
	*x = RecordHistogramRequest{}
	mi := &file_pkg_metrics_proto_record_histogram_request_proto_msgTypes[0]
...
func (*RecordHistogramRequest) Descriptor() ([]byte, []int) {
	return file_pkg_metrics_proto_record_histogram_request_proto_rawDescGZIP(), []int{0}
}
...
var File_pkg_metrics_proto_record_histogram_request_proto protoreflect.FileDescriptor

const file_pkg_metrics_proto_record_histogram_request_proto_rawDesc = "" +
	"\n" +
	"0pkg/metrics/proto/record_histogram_request.proto\x12\x12gcommon.v1.metrics\x1a\x1fgoogle/protobuf/timestamp.proto\x1a'pkg/common/proto/request_metadata.proto\"\xda\x03\n" +
	...
	"\x16com.gcommon.v1.metricsB\x1bRecordHistogramRequestProtoP\x01Z+github.com/jdfalk/gcommon/pkg/metrics/proto\xa2\x02\x03GVM\xaa\x02\x12Gcommon.V1.Metrics\xca\x02\x12Gcommon\\V1\\Metrics\xe2\x02\x1eGcommon\\V1\\Metrics\\GPBMetadata\xea\x02\x14Gcommon::V1::Metricsb\beditionsp\xe8\a"

var (
	file_pkg_metrics_proto_record_histogram_request_proto_rawDescOnce sync.Once
	file_pkg_metrics_proto_record_histogram_request_proto_rawDescData []byte
)

func file_pkg_metrics_proto_record_histogram_request_proto_rawDescGZIP() []byte {
	file_pkg_metrics_proto_record_histogram_request_proto_rawDescOnce.Do(func() {
		file_pkg_metrics_proto_record_histogram_request_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_metrics_proto_record_histogram_request_proto_rawDesc), len(file_pkg_metrics_proto_record_histogram_request_proto_rawDesc)))
	})
	return file_pkg_metrics_proto_record_histogram_request_proto_rawDescData
}

var file_pkg_metrics_proto_record_histogram_request_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_pkg_metrics_proto_record_histogram_request_proto_goTypes = []any{
...
var file_pkg_metrics_proto_record_histogram_request_proto_depIdxs = []int32{
...
func init() { file_pkg_metrics_proto_record_histogram_request_proto_init() }
func file_pkg_metrics_proto_record_histogram_request_proto_init() {
	if File_pkg_metrics_proto_record_histogram_request_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_metrics_proto_record_histogram_request_proto_rawDesc), len(file_pkg_metrics_proto_record_histogram_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_metrics_proto_record_histogram_request_proto_goTypes,
		DependencyIndexes: file_pkg_metrics_proto_record_histogram_request_proto_depIdxs,
		MessageInfos:      file_pkg_metrics_proto_record_histogram_request_proto_msgTypes,
	}.Build()
	File_pkg_metrics_proto_record_histogram_request_proto = out.File
	file_pkg_metrics_proto_record_histogram_request_proto_goTypes = nil
	file_pkg_metrics_proto_record_histogram_request_proto_depIdxs = nil
}
