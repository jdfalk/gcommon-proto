...
// 	protoc        (unknown)
// source: pkg/metrics/proto/export_stats.proto
...
func (x *ExportStats) Reset() {
	*x = ExportStats{}
	mi := &file_pkg_metrics_proto_export_stats_proto_msgTypes[0]
...
var File_pkg_metrics_proto_export_stats_proto protoreflect.FileDescriptor

const file_pkg_metrics_proto_export_stats_proto_rawDesc = "" +
	"\n" +
	"$pkg/metrics/proto/export_stats.proto\x12\x12gcommon.v1.metrics\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1cpkg/common/proto/error.proto\x1a!pkg/common/proto/time_range.proto\x1a#pkg/metrics/proto/error_stats.proto\x1a0pkg/metrics/proto/export_destination_stats.proto\x1a)pkg/metrics/proto/performance_stats.proto\x1a%pkg/metrics/proto/provider_info.proto\x1a/pkg/metrics/proto/resource_limits_summary.proto\x1a\"pkg/metrics/proto/time_range.proto\x1a#pkg/metrics/proto/top_metrics.proto\"\xca\x03\n" +
	"\vExportStats\x124\n" +
	...
	"\x16last_successful_export\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\x14lastSuccessfulExportB\xc9\x01\n" +
	"\x16com.gcommon.v1.metricsB\x10ExportStatsProtoP\x01Z+github.com/jdfalk/gcommon/pkg/metrics/proto\xa2\x02\x03GVM\xaa\x02\x12Gcommon.V1.Metrics\xca\x02\x12Gcommon\\V1\\Metrics\xe2\x02\x1eGcommon\\V1\\Metrics\\GPBMetadata\xea\x02\x14Gcommon::V1::Metrics\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_pkg_metrics_proto_export_stats_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_pkg_metrics_proto_export_stats_proto_goTypes = []any{
...
var file_pkg_metrics_proto_export_stats_proto_depIdxs = []int32{
...
func init() { file_pkg_metrics_proto_export_stats_proto_init() }
func file_pkg_metrics_proto_export_stats_proto_init() {
	if File_pkg_metrics_proto_export_stats_proto != nil {
		return
	}
	file_pkg_metrics_proto_error_stats_proto_init()
	file_pkg_metrics_proto_export_destination_stats_proto_init()
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_metrics_proto_export_stats_proto_rawDesc), len(file_pkg_metrics_proto_export_stats_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_metrics_proto_export_stats_proto_goTypes,
		DependencyIndexes: file_pkg_metrics_proto_export_stats_proto_depIdxs,
		MessageInfos:      file_pkg_metrics_proto_export_stats_proto_msgTypes,
	}.Build()
	File_pkg_metrics_proto_export_stats_proto = out.File
	file_pkg_metrics_proto_export_stats_proto_goTypes = nil
	file_pkg_metrics_proto_export_stats_proto_depIdxs = nil
}
