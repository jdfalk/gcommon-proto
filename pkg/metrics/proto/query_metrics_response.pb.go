...
const file_pkg_metrics_proto_query_metrics_response_proto_rawDesc = "" +
	...
	"\rtotal_results\x18\b \x01(\x03R\ftotalResultsB\xd2\x01\n" +
...
var file_pkg_metrics_proto_query_metrics_response_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
...
func file_pkg_metrics_proto_query_metrics_response_proto_init() {
	...
	file_pkg_metrics_proto_metric_series_proto_init()
	file_pkg_metrics_proto_query_plan_proto_init()
	file_pkg_metrics_proto_query_statistics_proto_init()
	type x struct{}
