...
func (NotificationType) EnumDescriptor() ([]byte, []int) {
	return file_pkg_metrics_proto_notification_type_proto_rawDescGZIP(), []int{0}
}
...
const file_pkg_metrics_proto_notification_type_proto_rawDesc = "" +
	"\n" +
	")pkg/metrics/proto/notification_type.proto\x12\x12gcommon.v1.metrics*\xb7\x03\n" +
	...
	"\x17NOTIFICATION_TYPE_VOICE\x10\rB\xc6\x01\n" +
	"\x16com.gcommon.v1.metricsB\x15NotificationTypeProtoP\x01Z+github.com/jdfalk/gcommon/pkg/metrics/proto\xa2\x02\x03GVM\xaa\x02\x12Gcommon.V1.Metrics\xca\x02\x12Gcommon\\V1\\Metrics\xe2\x02\x1eGcommon\\V1\\Metrics\\GPBMetadata\xea\x02\x14Gcommon::V1::Metricsb\beditionsp\xe8\a"

var (
	file_pkg_metrics_proto_notification_type_proto_rawDescOnce sync.Once
	file_pkg_metrics_proto_notification_type_proto_rawDescData []byte
)

func file_pkg_metrics_proto_notification_type_proto_rawDescGZIP() []byte {
	file_pkg_metrics_proto_notification_type_proto_rawDescOnce.Do(func() {
		file_pkg_metrics_proto_notification_type_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_metrics_proto_notification_type_proto_rawDesc), len(file_pkg_metrics_proto_notification_type_proto_rawDesc)))
	})
	return file_pkg_metrics_proto_notification_type_proto_rawDescData
}
