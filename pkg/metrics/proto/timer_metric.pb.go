...
var file_pkg_metrics_proto_timer_metric_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
...
func file_pkg_metrics_proto_timer_metric_proto_init() {
	...
	file_pkg_metrics_proto_percentile_measurement_proto_init()
	file_pkg_metrics_proto_timer_statistics_proto_init()
	type x struct{}
