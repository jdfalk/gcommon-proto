...
// 	protoc        (unknown)
// source: pkg/metrics/proto/stats_d_settings.proto
...
func (x *StatsDSettings) Reset() {
	*x = StatsDSettings{}
	mi := &file_pkg_metrics_proto_stats_d_settings_proto_msgTypes[0]
...
var File_pkg_metrics_proto_stats_d_settings_proto protoreflect.FileDescriptor

const file_pkg_metrics_proto_stats_d_settings_proto_rawDesc = "" +
	"\n" +
	"(pkg/metrics/proto/stats_d_settings.proto\x12\x12gcommon.v1.metrics\x1a!google/protobuf/go_features.proto\x1a'pkg/common/proto/request_metadata.proto\x1a%pkg/metrics/proto/export_config.proto\x1a%pkg/metrics/proto/provider_type.proto\"\xa0\x01\n" +
	...
	"bufferSizeB\xcc\x01\n" +
	"\x16com.gcommon.v1.metricsB\x13StatsDSettingsProtoP\x01Z+github.com/jdfalk/gcommon/pkg/metrics/proto\xa2\x02\x03GVM\xaa\x02\x12Gcommon.V1.Metrics\xca\x02\x12Gcommon\\V1\\Metrics\xe2\x02\x1eGcommon\\V1\\Metrics\\GPBMetadata\xea\x02\x14Gcommon::V1::Metrics\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_pkg_metrics_proto_stats_d_settings_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_pkg_metrics_proto_stats_d_settings_proto_goTypes = []any{
	(*StatsDSettings)(nil), // 0: gcommon.v1.metrics.StatsDSettings
}
var file_pkg_metrics_proto_stats_d_settings_proto_depIdxs = []int32{
...
func init() { file_pkg_metrics_proto_stats_d_settings_proto_init() }
func file_pkg_metrics_proto_stats_d_settings_proto_init() {
	if File_pkg_metrics_proto_stats_d_settings_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_metrics_proto_stats_d_settings_proto_rawDesc), len(file_pkg_metrics_proto_stats_d_settings_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_metrics_proto_stats_d_settings_proto_goTypes,
		DependencyIndexes: file_pkg_metrics_proto_stats_d_settings_proto_depIdxs,
		MessageInfos:      file_pkg_metrics_proto_stats_d_settings_proto_msgTypes,
	}.Build()
	File_pkg_metrics_proto_stats_d_settings_proto = out.File
	file_pkg_metrics_proto_stats_d_settings_proto_goTypes = nil
	file_pkg_metrics_proto_stats_d_settings_proto_depIdxs = nil
}
