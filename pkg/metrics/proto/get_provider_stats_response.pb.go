...
type GetProviderStatsResponse struct {
	...
	xxx_hidden_TimeRange   *TimeRange             `protobuf:"bytes,6,opt,name=time_range,json=timeRange"`
...
type ProviderStatistics struct {
	...
	xxx_hidden_Performance   *PerformanceStats      `protobuf:"bytes,2,opt,name=performance"`
	xxx_hidden_ResourceUsage *ResourceUsageStats    `protobuf:"bytes,3,opt,name=resource_usage,json=resourceUsage"`
	xxx_hidden_Errors        *ErrorStats            `protobuf:"bytes,4,opt,name=errors"`
...
const file_pkg_metrics_proto_get_provider_stats_response_proto_rawDesc = "" +
	...
	"\x16com.gcommon.v1.metricsB\x1dGetProviderStatsResponseProtoP\x01Z+github.com/jdfalk/gcommon/pkg/metrics/proto\xa2\x02\x03GVM\xaa\x02\x12Gcommon.V1.Metrics\xca\x02\x12Gcommon\\V1\\Metrics\xe2\x02\x1eGcommon\\V1\\Metrics\\GPBMetadata\xea\x02\x14Gcommon::V1::Metrics\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
