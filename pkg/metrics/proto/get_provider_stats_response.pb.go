...
type GetProviderStatsResponse struct {
	...
	xxx_hidden_TimeRange   *MetricsTimeRange      `protobuf:"bytes,6,opt,name=time_range,json=timeRange"`
...
func (x *GetProviderStatsResponse) GetTimeRange() *MetricsTimeRange {
	if x != nil {
...
func (x *GetProviderStatsResponse) SetTimeRange(v *MetricsTimeRange) {
...
const file_pkg_metrics_proto_get_provider_stats_response_proto_rawDesc = "" +
	"\n" +
	"3pkg/metrics/proto/get_provider_stats_response.proto\x12\x12gcommon.v1.metrics\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1cpkg/common/proto/error.proto\x1a!pkg/common/proto/time_range.proto\x1a#pkg/metrics/proto/error_stats.proto\x1a)pkg/metrics/proto/performance_stats.proto\x1a%pkg/metrics/proto/provider_info.proto\x1a+pkg/metrics/proto/provider_statistics.proto\x1a/pkg/metrics/proto/resource_limits_summary.proto\x1a\"pkg/metrics/proto/time_range.proto\x1a#pkg/metrics/proto/top_metrics.proto\"\xed\x02\n" +
	...
	"\bwarnings\x18\a \x03(\tR\bwarningsB\xd6\x01\n" +
...
var file_pkg_metrics_proto_get_provider_stats_response_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_pkg_metrics_proto_get_provider_stats_response_proto_goTypes = []any{
	...
	(*MetricsTimeRange)(nil),         // 4: gcommon.v1.metrics.MetricsTimeRange
}
var file_pkg_metrics_proto_get_provider_stats_response_proto_depIdxs = []int32{
	...
	4, // 3: gcommon.v1.metrics.GetProviderStatsResponse.time_range:type_name -> gcommon.v1.metrics.MetricsTimeRange
...
func file_pkg_metrics_proto_get_provider_stats_response_proto_init() {
	...
	file_pkg_metrics_proto_provider_statistics_proto_init()
