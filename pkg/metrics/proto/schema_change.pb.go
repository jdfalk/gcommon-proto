...
// 	protoc        (unknown)
// source: pkg/metrics/proto/schema_change.proto
...
func (x *SchemaChange) Reset() {
	*x = SchemaChange{}
	mi := &file_pkg_metrics_proto_schema_change_proto_msgTypes[0]
...
var File_pkg_metrics_proto_schema_change_proto protoreflect.FileDescriptor

const file_pkg_metrics_proto_schema_change_proto_rawDesc = "" +
	"\n" +
	"%pkg/metrics/proto/schema_change.proto\x12\x12gcommon.v1.metrics\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xab\x01\n" +
	"\fSchemaChange\x12\x1f\n" +
	"\vchange_type\x18\x01 \x01(\tR\n" +
	"changeType\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescription\x12/\n" +
	"\x13backward_compatible\x18\x03 \x01(\bR\x12backwardCompatible\x12'\n" +
	"\x0fmigration_steps\x18\x04 \x03(\tR\x0emigrationStepsB\xca\x01\n" +
	"\x16com.gcommon.v1.metricsB\x11SchemaChangeProtoP\x01Z+github.com/jdfalk/gcommon/pkg/metrics/proto\xa2\x02\x03GVM\xaa\x02\x12Gcommon.V1.Metrics\xca\x02\x12Gcommon\\V1\\Metrics\xe2\x02\x1eGcommon\\V1\\Metrics\\GPBMetadata\xea\x02\x14Gcommon::V1::Metrics\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_pkg_metrics_proto_schema_change_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_pkg_metrics_proto_schema_change_proto_goTypes = []any{
	(*SchemaChange)(nil), // 0: gcommon.v1.metrics.SchemaChange
}
var file_pkg_metrics_proto_schema_change_proto_depIdxs = []int32{
...
func init() { file_pkg_metrics_proto_schema_change_proto_init() }
func file_pkg_metrics_proto_schema_change_proto_init() {
	if File_pkg_metrics_proto_schema_change_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_metrics_proto_schema_change_proto_rawDesc), len(file_pkg_metrics_proto_schema_change_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_metrics_proto_schema_change_proto_goTypes,
		DependencyIndexes: file_pkg_metrics_proto_schema_change_proto_depIdxs,
		MessageInfos:      file_pkg_metrics_proto_schema_change_proto_msgTypes,
	}.Build()
	File_pkg_metrics_proto_schema_change_proto = out.File
	file_pkg_metrics_proto_schema_change_proto_goTypes = nil
	file_pkg_metrics_proto_schema_change_proto_depIdxs = nil
}
