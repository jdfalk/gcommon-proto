...
func (x *MetricsRetryConfig) Reset() {
	*x = MetricsRetryConfig{}
	mi := &file_pkg_metrics_proto_export_config_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
const file_pkg_metrics_proto_export_config_proto_rawDesc = "" +
	...
	"\x12backoff_multiplier\x18\x04 \x01(\x01R\x11backoffMultiplierB\xca\x01\n" +
...
var file_pkg_metrics_proto_export_config_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
