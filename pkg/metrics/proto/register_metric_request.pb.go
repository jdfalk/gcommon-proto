...
const file_pkg_metrics_proto_register_metric_request_proto_rawDesc = "" +
	...
	"\aoptions\x18\x05 \x01(\v2'.gcommon.v1.metrics.RegistrationOptionsR\aoptionsB\xd3\x01\n" +
...
var file_pkg_metrics_proto_register_metric_request_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
...
func file_pkg_metrics_proto_register_metric_request_proto_init() {
	...
	file_pkg_metrics_proto_metric_definition_proto_init()
	file_pkg_metrics_proto_registration_options_proto_init()
	type x struct{}
