...
type StreamOptions struct {
	...
	xxx_hidden_Compression              enums.StreamCompression `protobuf:"varint,5,opt,name=compression,enum=gcommon.v1.metrics.StreamCompression"`
	...
	xxx_hidden_Qos                      enums.StreamQOS         `protobuf:"varint,9,opt,name=qos,enum=gcommon.v1.metrics.StreamQOS"`
...
func (x *StreamOptions) Reset() {
	*x = StreamOptions{}
	mi := &file_gcommon_v1_metrics_messages_stream_options_proto_msgTypes[0]
...
func (x *StreamOptions) GetCompression() enums.StreamCompression {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 4) {
			return x.xxx_hidden_Compression
		}
	}
	return enums.StreamCompression(0)
}
...
func (x *StreamOptions) GetQos() enums.StreamQOS {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 8) {
			return x.xxx_hidden_Qos
		}
	}
	return enums.StreamQOS(0)
}
...
func (x *StreamOptions) SetCompression(v enums.StreamCompression) {
...
func (x *StreamOptions) SetQos(v enums.StreamQOS) {
	x.xxx_hidden_Qos = v
...
func (x *StreamOptions) ClearCompression() {
	...
	x.xxx_hidden_Compression = enums.StreamCompression_STREAM_COMPRESSION_UNSPECIFIED
}
...
func (x *StreamOptions) ClearQos() {
	...
	x.xxx_hidden_Qos = enums.StreamQOS_STREAM_QOS_UNSPECIFIED
}
...
type StreamOptions_builder struct {
	...
	Compression *enums.StreamCompression
...
var File_gcommon_v1_metrics_messages_stream_options_proto protoreflect.FileDescriptor

const file_gcommon_v1_metrics_messages_stream_options_proto_rawDesc = "" +
	"\n" +
	"0gcommon/v1/metrics/messages/stream_options.proto\x12\x12gcommon.v1.metrics\x1a1gcommon/v1/metrics/enums/stream_compression.proto\x1a)gcommon/v1/metrics/enums/stream_qos.proto\x1a!google/protobuf/go_features.proto\"\xb2\x03\n" +
	"\rStreamOptions\x12-\n" +
	...
	"\x03qos\x18\t \x01(\x0e2\x1d.gcommon.v1.metrics.StreamQOSR\x03qosB\xd9\x01\n" +
	"\x16com.gcommon.v1.metricsB\x12StreamOptionsProtoP\x01Z9github.com/jdfalk/gcommon/pkg/gcommon/v1/metrics/messages\xa2\x02\x03GVM\xaa\x02\x12Gcommon.V1.Metrics\xca\x02\x12Gcommon\\V1\\Metrics\xe2\x02\x1eGcommon\\V1\\Metrics\\GPBMetadata\xea\x02\x14Gcommon::V1::Metrics\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
var file_gcommon_v1_metrics_messages_stream_options_proto_goTypes = []any{
	...
	(enums.StreamCompression)(0), // 1: gcommon.v1.metrics.StreamCompression
	(enums.StreamQOS)(0),         // 2: gcommon.v1.metrics.StreamQOS
}
var file_gcommon_v1_metrics_messages_stream_options_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_metrics_messages_stream_options_proto_init() }
func file_gcommon_v1_metrics_messages_stream_options_proto_init() {
	if File_gcommon_v1_metrics_messages_stream_options_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_metrics_messages_stream_options_proto_rawDesc), len(file_gcommon_v1_metrics_messages_stream_options_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_metrics_messages_stream_options_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_metrics_messages_stream_options_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_metrics_messages_stream_options_proto_msgTypes,
	}.Build()
	File_gcommon_v1_metrics_messages_stream_options_proto = out.File
	file_gcommon_v1_metrics_messages_stream_options_proto_goTypes = nil
	file_gcommon_v1_metrics_messages_stream_options_proto_depIdxs = nil
}
