...
func (x *MetricDefinition) Reset() {
	*x = MetricDefinition{}
	mi := &file_gcommon_v1_metrics_messages_metric_definition_proto_msgTypes[0]
...
var File_gcommon_v1_metrics_messages_metric_definition_proto protoreflect.FileDescriptor

const file_gcommon_v1_metrics_messages_metric_definition_proto_rawDesc = "" +
	"\n" +
	"3gcommon/v1/metrics/messages/metric_definition.proto\x12\x12gcommon.v1.metrics\x1a*gcommon/v1/metrics/enums/metric_type.proto\x1a/gcommon/v1/metrics/messages/export_config.proto\x1a2gcommon/v1/metrics/messages/label_definition.proto\x1a4gcommon/v1/metrics/messages/metric_type_config.proto\x1a9gcommon/v1/metrics/messages/retention_policy_config.proto\x1a2gcommon/v1/metrics/messages/validation_rules.proto\x1a!google/protobuf/go_features.proto\"\xe4\x04\n" +
	...
	"\x16com.gcommon.v1.metricsB\x15MetricDefinitionProtoP\x01Z9github.com/jdfalk/gcommon/pkg/gcommon/v1/metrics/messages\xa2\x02\x03GVM\xaa\x02\x12Gcommon.V1.Metrics\xca\x02\x12Gcommon\\V1\\Metrics\xe2\x02\x1eGcommon\\V1\\Metrics\\GPBMetadata\xea\x02\x14Gcommon::V1::Metrics\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
var file_gcommon_v1_metrics_messages_metric_definition_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_metrics_messages_metric_definition_proto_init() }
func file_gcommon_v1_metrics_messages_metric_definition_proto_init() {
	...
	file_gcommon_v1_metrics_messages_validation_rules_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_metrics_messages_metric_definition_proto_rawDesc), len(file_gcommon_v1_metrics_messages_metric_definition_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_metrics_messages_metric_definition_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_metrics_messages_metric_definition_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_metrics_messages_metric_definition_proto_msgTypes,
	}.Build()
	File_gcommon_v1_metrics_messages_metric_definition_proto = out.File
	file_gcommon_v1_metrics_messages_metric_definition_proto_goTypes = nil
	file_gcommon_v1_metrics_messages_metric_definition_proto_depIdxs = nil
}
