...
func (x *BufferConfig) Reset() {
	*x = BufferConfig{}
	mi := &file_gcommon_v1_metrics_messages_buffer_config_proto_msgTypes[0]
...
var File_gcommon_v1_metrics_messages_buffer_config_proto protoreflect.FileDescriptor

const file_gcommon_v1_metrics_messages_buffer_config_proto_rawDesc = "" +
	"\n" +
	"/gcommon/v1/metrics/messages/buffer_config.proto\x12\x12gcommon.v1.metrics\x1a7gcommon/v1/metrics/enums/buffer_overflow_strategy.proto\x1a!google/protobuf/go_features.proto\"\xe0\x01\n" +
	"\fBufferConfig\x12&\n" +
	...
	"\x10max_memory_bytes\x18\x04 \x01(\x03R\x0emaxMemoryBytesB\xd8\x01\n" +
...
func init() { file_gcommon_v1_metrics_messages_buffer_config_proto_init() }
func file_gcommon_v1_metrics_messages_buffer_config_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_metrics_messages_buffer_config_proto_rawDesc), len(file_gcommon_v1_metrics_messages_buffer_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_metrics_messages_buffer_config_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_metrics_messages_buffer_config_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_metrics_messages_buffer_config_proto_msgTypes,
	}.Build()
	File_gcommon_v1_metrics_messages_buffer_config_proto = out.File
	file_gcommon_v1_metrics_messages_buffer_config_proto_goTypes = nil
	file_gcommon_v1_metrics_messages_buffer_config_proto_depIdxs = nil
}
