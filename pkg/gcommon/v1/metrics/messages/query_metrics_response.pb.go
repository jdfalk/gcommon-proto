...
// 	protoc        (unknown)
// source: gcommon/v1/metrics/messages/query_metrics_response.proto
...
func (x *QueryMetricsResponse) Reset() {
	*x = QueryMetricsResponse{}
	mi := &file_gcommon_v1_metrics_messages_query_metrics_response_proto_msgTypes[0]
...
var File_gcommon_v1_metrics_messages_query_metrics_response_proto protoreflect.FileDescriptor

const file_gcommon_v1_metrics_messages_query_metrics_response_proto_rawDesc = "" +
	"\n" +
	"8gcommon/v1/metrics/messages/query_metrics_response.proto\x12\x12gcommon.v1.metrics\x1a&gcommon/v1/common/messages/error.proto\x1a/gcommon/v1/metrics/messages/metric_series.proto\x1a,gcommon/v1/metrics/messages/query_plan.proto\x1a2gcommon/v1/metrics/messages/query_statistics.proto\x1a!google/protobuf/go_features.proto\"\x86\x03\n" +
	...
	"\rtotal_results\x18\b \x01(\x03R\ftotalResultsB\xe0\x01\n" +
...
var file_gcommon_v1_metrics_messages_query_metrics_response_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_metrics_messages_query_metrics_response_proto_init() }
func file_gcommon_v1_metrics_messages_query_metrics_response_proto_init() {
	if File_gcommon_v1_metrics_messages_query_metrics_response_proto != nil {
		return
	}
	file_gcommon_v1_metrics_messages_metric_series_proto_init()
	file_gcommon_v1_metrics_messages_query_plan_proto_init()
	file_gcommon_v1_metrics_messages_query_statistics_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_metrics_messages_query_metrics_response_proto_rawDesc), len(file_gcommon_v1_metrics_messages_query_metrics_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_metrics_messages_query_metrics_response_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_metrics_messages_query_metrics_response_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_metrics_messages_query_metrics_response_proto_msgTypes,
	}.Build()
	File_gcommon_v1_metrics_messages_query_metrics_response_proto = out.File
	file_gcommon_v1_metrics_messages_query_metrics_response_proto_goTypes = nil
	file_gcommon_v1_metrics_messages_query_metrics_response_proto_depIdxs = nil
}
