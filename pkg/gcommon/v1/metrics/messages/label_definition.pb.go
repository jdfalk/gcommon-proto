...
func (x *LabelDefinition) Reset() {
	*x = LabelDefinition{}
	mi := &file_gcommon_v1_metrics_messages_label_definition_proto_msgTypes[0]
...
var File_gcommon_v1_metrics_messages_label_definition_proto protoreflect.FileDescriptor

const file_gcommon_v1_metrics_messages_label_definition_proto_rawDesc = "" +
	"\n" +
	"2gcommon/v1/metrics/messages/label_definition.proto\x12\x12gcommon.v1.metrics\x1a!google/protobuf/go_features.proto\"\xde\x01\n" +
	...
	"\rdefault_value\x18\x06 \x01(\tR\fdefaultValueB\xdb\x01\n" +
...
var file_gcommon_v1_metrics_messages_label_definition_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_metrics_messages_label_definition_proto_init() }
func file_gcommon_v1_metrics_messages_label_definition_proto_init() {
	if File_gcommon_v1_metrics_messages_label_definition_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_metrics_messages_label_definition_proto_rawDesc), len(file_gcommon_v1_metrics_messages_label_definition_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_metrics_messages_label_definition_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_metrics_messages_label_definition_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_metrics_messages_label_definition_proto_msgTypes,
	}.Build()
	File_gcommon_v1_metrics_messages_label_definition_proto = out.File
	file_gcommon_v1_metrics_messages_label_definition_proto_goTypes = nil
	file_gcommon_v1_metrics_messages_label_definition_proto_depIdxs = nil
}
