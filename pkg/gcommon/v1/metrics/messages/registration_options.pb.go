...
// 	protoc        (unknown)
// source: gcommon/v1/metrics/messages/registration_options.proto
...
func (x *RegistrationOptions) Reset() {
	*x = RegistrationOptions{}
	mi := &file_gcommon_v1_metrics_messages_registration_options_proto_msgTypes[0]
...
var File_gcommon_v1_metrics_messages_registration_options_proto protoreflect.FileDescriptor

const file_gcommon_v1_metrics_messages_registration_options_proto_rawDesc = "" +
	"\n" +
	"6gcommon/v1/metrics/messages/registration_options.proto\x12\x12gcommon.v1.metrics\x1a!google/protobuf/go_features.proto\"\xaf\x01\n" +
...
var file_gcommon_v1_metrics_messages_registration_options_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_metrics_messages_registration_options_proto_init() }
func file_gcommon_v1_metrics_messages_registration_options_proto_init() {
	if File_gcommon_v1_metrics_messages_registration_options_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_metrics_messages_registration_options_proto_rawDesc), len(file_gcommon_v1_metrics_messages_registration_options_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_metrics_messages_registration_options_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_metrics_messages_registration_options_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_metrics_messages_registration_options_proto_msgTypes,
	}.Build()
	File_gcommon_v1_metrics_messages_registration_options_proto = out.File
	file_gcommon_v1_metrics_messages_registration_options_proto_goTypes = nil
	file_gcommon_v1_metrics_messages_registration_options_proto_depIdxs = nil
}
