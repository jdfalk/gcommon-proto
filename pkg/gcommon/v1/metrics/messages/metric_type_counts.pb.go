...
// 	protoc        (unknown)
// source: gcommon/v1/metrics/messages/metric_type_counts.proto
...
func (x *MetricTypeCounts) Reset() {
	*x = MetricTypeCounts{}
	mi := &file_gcommon_v1_metrics_messages_metric_type_counts_proto_msgTypes[0]
...
var File_gcommon_v1_metrics_messages_metric_type_counts_proto protoreflect.FileDescriptor

const file_gcommon_v1_metrics_messages_metric_type_counts_proto_rawDesc = "" +
	"\n" +
	"4gcommon/v1/metrics/messages/metric_type_counts.proto\x12\x12gcommon.v1.metrics\x1a!google/protobuf/go_features.proto\"\xea\x01\n" +
	...
	"timerCount\x12!\n" +
	"\fcustom_count\x18\x06 \x01(\x03R\vcustomCountB\xdc\x01\n" +
	"\x16com.gcommon.v1.metricsB\x15MetricTypeCountsProtoP\x01Z9github.com/jdfalk/gcommon/pkg/gcommon/v1/metrics/messages\xa2\x02\x03GVM\xaa\x02\x12Gcommon.V1.Metrics\xca\x02\x12Gcommon\\V1\\Metrics\xe2\x02\x1eGcommon\\V1\\Metrics\\GPBMetadata\xea\x02\x14Gcommon::V1::Metrics\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_metrics_messages_metric_type_counts_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_metrics_messages_metric_type_counts_proto_goTypes = []any{
	(*MetricTypeCounts)(nil), // 0: gcommon.v1.metrics.MetricTypeCounts
}
var file_gcommon_v1_metrics_messages_metric_type_counts_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_metrics_messages_metric_type_counts_proto_init() }
func file_gcommon_v1_metrics_messages_metric_type_counts_proto_init() {
	if File_gcommon_v1_metrics_messages_metric_type_counts_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_metrics_messages_metric_type_counts_proto_rawDesc), len(file_gcommon_v1_metrics_messages_metric_type_counts_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_metrics_messages_metric_type_counts_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_metrics_messages_metric_type_counts_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_metrics_messages_metric_type_counts_proto_msgTypes,
	}.Build()
	File_gcommon_v1_metrics_messages_metric_type_counts_proto = out.File
	file_gcommon_v1_metrics_messages_metric_type_counts_proto_goTypes = nil
	file_gcommon_v1_metrics_messages_metric_type_counts_proto_depIdxs = nil
}
