...
func (x *AggregationSpec) Reset() {
	*x = AggregationSpec{}
	mi := &file_gcommon_v1_metrics_messages_aggregation_spec_proto_msgTypes[0]
...
var File_gcommon_v1_metrics_messages_aggregation_spec_proto protoreflect.FileDescriptor

const file_gcommon_v1_metrics_messages_aggregation_spec_proto_rawDesc = "" +
	"\n" +
	...
	"\x16com.gcommon.v1.metricsB\x14AggregationSpecProtoP\x01Z9github.com/jdfalk/gcommon/pkg/gcommon/v1/metrics/messages\xa2\x02\x03GVM\xaa\x02\x12Gcommon.V1.Metrics\xca\x02\x12Gcommon\\V1\\Metrics\xe2\x02\x1eGcommon\\V1\\Metrics\\GPBMetadata\xea\x02\x14Gcommon::V1::Metrics\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
func init() { file_gcommon_v1_metrics_messages_aggregation_spec_proto_init() }
func file_gcommon_v1_metrics_messages_aggregation_spec_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_metrics_messages_aggregation_spec_proto_rawDesc), len(file_gcommon_v1_metrics_messages_aggregation_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_metrics_messages_aggregation_spec_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_metrics_messages_aggregation_spec_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_metrics_messages_aggregation_spec_proto_msgTypes,
	}.Build()
	File_gcommon_v1_metrics_messages_aggregation_spec_proto = out.File
	file_gcommon_v1_metrics_messages_aggregation_spec_proto_goTypes = nil
	file_gcommon_v1_metrics_messages_aggregation_spec_proto_depIdxs = nil
}
