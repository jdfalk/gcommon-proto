...
func (x *MetricSeries) Reset() {
	*x = MetricSeries{}
	mi := &file_gcommon_v1_metrics_messages_metric_series_proto_msgTypes[0]
...
var File_gcommon_v1_metrics_messages_metric_series_proto protoreflect.FileDescriptor

const file_gcommon_v1_metrics_messages_metric_series_proto_rawDesc = "" +
	"\n" +
...
func init() { file_gcommon_v1_metrics_messages_metric_series_proto_init() }
func file_gcommon_v1_metrics_messages_metric_series_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_metrics_messages_metric_series_proto_rawDesc), len(file_gcommon_v1_metrics_messages_metric_series_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_metrics_messages_metric_series_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_metrics_messages_metric_series_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_metrics_messages_metric_series_proto_msgTypes,
	}.Build()
	File_gcommon_v1_metrics_messages_metric_series_proto = out.File
	file_gcommon_v1_metrics_messages_metric_series_proto_goTypes = nil
	file_gcommon_v1_metrics_messages_metric_series_proto_depIdxs = nil
}
