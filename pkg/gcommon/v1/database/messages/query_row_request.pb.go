...
func (x *QueryRowRequest) Reset() {
	*x = QueryRowRequest{}
	mi := &file_gcommon_v1_database_messages_query_row_request_proto_msgTypes[0]
...
func (x *QueryRowRequest) GetMetadata() *messages.RequestMetadata {
	if x != nil {
...
func (x *QueryRowRequest) SetMetadata(v *messages.RequestMetadata) {
...
var File_gcommon_v1_database_messages_query_row_request_proto protoreflect.FileDescriptor

const file_gcommon_v1_database_messages_query_row_request_proto_rawDesc = "" +
	"\n" +
	"4gcommon/v1/database/messages/query_row_request.proto\x12\x13gcommon.v1.database\x1a1gcommon/v1/common/messages/request_metadata.proto\x1a0gcommon/v1/database/messages/query_options.proto\x1a2gcommon/v1/database/messages/query_parameter.proto\x1a!google/protobuf/go_features.proto\"\xb4\x02\n" +
	...
	"\bmetadata\x18\x06 \x01(\v2\".gcommon.v1.common.RequestMetadataR\bmetadataB\xe1\x01\n" +
	"\x17com.gcommon.v1.databaseB\x14QueryRowRequestProtoP\x01Z:github.com/jdfalk/gcommon/pkg/gcommon/v1/database/messages\xa2\x02\x03GVD\xaa\x02\x13Gcommon.V1.Database\xca\x02\x13Gcommon\\V1\\Database\xe2\x02\x1fGcommon\\V1\\Database\\GPBMetadata\xea\x02\x15Gcommon::V1::Database\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_database_messages_query_row_request_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_database_messages_query_row_request_proto_goTypes = []any{
...
var file_gcommon_v1_database_messages_query_row_request_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_database_messages_query_row_request_proto_init() }
func file_gcommon_v1_database_messages_query_row_request_proto_init() {
	if File_gcommon_v1_database_messages_query_row_request_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_database_messages_query_row_request_proto_rawDesc), len(file_gcommon_v1_database_messages_query_row_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_database_messages_query_row_request_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_database_messages_query_row_request_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_database_messages_query_row_request_proto_msgTypes,
	}.Build()
	File_gcommon_v1_database_messages_query_row_request_proto = out.File
	file_gcommon_v1_database_messages_query_row_request_proto_goTypes = nil
	file_gcommon_v1_database_messages_query_row_request_proto_depIdxs = nil
}
