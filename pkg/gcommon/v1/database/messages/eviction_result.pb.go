...
// 	protoc        (unknown)
// source: gcommon/v1/database/messages/eviction_result.proto
...
func (x *EvictionResult) Reset() {
	*x = EvictionResult{}
	mi := &file_gcommon_v1_database_messages_eviction_result_proto_msgTypes[0]
...
var File_gcommon_v1_database_messages_eviction_result_proto protoreflect.FileDescriptor

const file_gcommon_v1_database_messages_eviction_result_proto_rawDesc = "" +
	"\n" +
	"2gcommon/v1/database/messages/eviction_result.proto\x12\x13gcommon.v1.database\x1a-gcommon/v1/common/enums/eviction_policy.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xbd\x02\n" +
	...
	"\asuccess\x18\a \x01(\bR\asuccessB\xe0\x01\n" +
	"\x17com.gcommon.v1.databaseB\x13EvictionResultProtoP\x01Z:github.com/jdfalk/gcommon/pkg/gcommon/v1/database/messages\xa2\x02\x03GVD\xaa\x02\x13Gcommon.V1.Database\xca\x02\x13Gcommon\\V1\\Database\xe2\x02\x1fGcommon\\V1\\Database\\GPBMetadata\xea\x02\x15Gcommon::V1::Database\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
var file_gcommon_v1_database_messages_eviction_result_proto_depIdxs = []int32{
	1, // 0: gcommon.v1.database.EvictionResult.policy_used:type_name -> gcommon.v1.common.EvictionPolicy
	2, // 1: gcommon.v1.database.EvictionResult.evicted_at:type_name -> google.protobuf.Timestamp
...
func init() { file_gcommon_v1_database_messages_eviction_result_proto_init() }
func file_gcommon_v1_database_messages_eviction_result_proto_init() {
	if File_gcommon_v1_database_messages_eviction_result_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_database_messages_eviction_result_proto_rawDesc), len(file_gcommon_v1_database_messages_eviction_result_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_database_messages_eviction_result_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_database_messages_eviction_result_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_database_messages_eviction_result_proto_msgTypes,
	}.Build()
	File_gcommon_v1_database_messages_eviction_result_proto = out.File
	file_gcommon_v1_database_messages_eviction_result_proto_goTypes = nil
	file_gcommon_v1_database_messages_eviction_result_proto_depIdxs = nil
}
