...
func (x *QueryOptions) Reset() {
	*x = QueryOptions{}
	mi := &file_gcommon_v1_database_messages_query_options_proto_msgTypes[0]
...
var File_gcommon_v1_database_messages_query_options_proto protoreflect.FileDescriptor

const file_gcommon_v1_database_messages_query_options_proto_rawDesc = "" +
	"\n" +
	"0gcommon/v1/database/messages/query_options.proto\x12\x13gcommon.v1.database\x1a1gcommon/v1/database/enums/consistency_level.proto\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\"\xf1\x01\n" +
	...
	"\vconsistency\x18\x05 \x01(\x0e2-.gcommon.v1.database.DatabaseConsistencyLevelR\vconsistencyB\xde\x01\n" +
...
var file_gcommon_v1_database_messages_query_options_proto_depIdxs = []int32{
	...
	2, // 1: gcommon.v1.database.QueryOptions.consistency:type_name -> gcommon.v1.database.DatabaseConsistencyLevel
...
func init() { file_gcommon_v1_database_messages_query_options_proto_init() }
func file_gcommon_v1_database_messages_query_options_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_database_messages_query_options_proto_rawDesc), len(file_gcommon_v1_database_messages_query_options_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_database_messages_query_options_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_database_messages_query_options_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_database_messages_query_options_proto_msgTypes,
	}.Build()
	File_gcommon_v1_database_messages_query_options_proto = out.File
	file_gcommon_v1_database_messages_query_options_proto_goTypes = nil
	file_gcommon_v1_database_messages_query_options_proto_depIdxs = nil
}
