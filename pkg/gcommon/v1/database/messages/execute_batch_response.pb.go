...
// 	protoc        (unknown)
// source: gcommon/v1/database/messages/execute_batch_response.proto

package messages

import (
	messages1 "github.com/jdfalk/gcommon/pkg/gcommon/v1/common/messages"
...
type ExecuteBatchResponse struct {
	...
	xxx_hidden_Stats   *messages.MetricsBatchStats `protobuf:"bytes,2,opt,name=stats"`
...
func (x *ExecuteBatchResponse) Reset() {
	*x = ExecuteBatchResponse{}
	mi := &file_gcommon_v1_database_messages_execute_batch_response_proto_msgTypes[0]
...
func (x *ExecuteBatchResponse) GetStats() *messages.MetricsBatchStats {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 1) {
			if protoimpl.X.AtomicCheckPointerIsNil(&x.xxx_hidden_Stats) {
				protoimpl.X.UnmarshalField(x, 2)
			}
			var rv *messages.MetricsBatchStats
...
func (x *ExecuteBatchResponse) SetStats(v *messages.MetricsBatchStats) {
...
func (x *ExecuteBatchResponse) ClearStats() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 1)
	protoimpl.X.AtomicSetPointer(&x.xxx_hidden_Stats, (*messages.MetricsBatchStats)(nil))
}
...
type ExecuteBatchResponse_builder struct {
	...
	Stats *messages.MetricsBatchStats
...
var File_gcommon_v1_database_messages_execute_batch_response_proto protoreflect.FileDescriptor

const file_gcommon_v1_database_messages_execute_batch_response_proto_rawDesc = "" +
	"\n" +
	"9gcommon/v1/database/messages/execute_batch_response.proto\x12\x13gcommon.v1.database\x1a&gcommon/v1/common/messages/error.proto\x1a9gcommon/v1/database/messages/batch_operation_result.proto\x1a-gcommon/v1/metrics/messages/batch_stats.proto\x1a!google/protobuf/go_features.proto\"\xd4\x01\n" +
	...
	"\x05error\x18\x03 \x01(\v2\x18.gcommon.v1.common.ErrorB\x02(\x01R\x05errorB\xe6\x01\n" +
	"\x17com.gcommon.v1.databaseB\x19ExecuteBatchResponseProtoP\x01Z:github.com/jdfalk/gcommon/pkg/gcommon/v1/database/messages\xa2\x02\x03GVD\xaa\x02\x13Gcommon.V1.Database\xca\x02\x13Gcommon\\V1\\Database\xe2\x02\x1fGcommon\\V1\\Database\\GPBMetadata\xea\x02\x15Gcommon::V1::Database\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
var file_gcommon_v1_database_messages_execute_batch_response_proto_goTypes = []any{
	...
	(*messages.MetricsBatchStats)(nil), // 2: gcommon.v1.metrics.MetricsBatchStats
...
var file_gcommon_v1_database_messages_execute_batch_response_proto_depIdxs = []int32{
	...
	2, // 1: gcommon.v1.database.ExecuteBatchResponse.stats:type_name -> gcommon.v1.metrics.MetricsBatchStats
...
func init() { file_gcommon_v1_database_messages_execute_batch_response_proto_init() }
func file_gcommon_v1_database_messages_execute_batch_response_proto_init() {
	if File_gcommon_v1_database_messages_execute_batch_response_proto != nil {
		return
	}
	file_gcommon_v1_database_messages_batch_operation_result_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_database_messages_execute_batch_response_proto_rawDesc), len(file_gcommon_v1_database_messages_execute_batch_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_database_messages_execute_batch_response_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_database_messages_execute_batch_response_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_database_messages_execute_batch_response_proto_msgTypes,
	}.Build()
	File_gcommon_v1_database_messages_execute_batch_response_proto = out.File
	file_gcommon_v1_database_messages_execute_batch_response_proto_goTypes = nil
	file_gcommon_v1_database_messages_execute_batch_response_proto_depIdxs = nil
}
