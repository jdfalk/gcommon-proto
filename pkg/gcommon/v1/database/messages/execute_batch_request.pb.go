...
// 	protoc        (unknown)
// source: gcommon/v1/database/messages/execute_batch_request.proto
...
func (x *ExecuteBatchRequest) Reset() {
	*x = ExecuteBatchRequest{}
	mi := &file_gcommon_v1_database_messages_execute_batch_request_proto_msgTypes[0]
...
var File_gcommon_v1_database_messages_execute_batch_request_proto protoreflect.FileDescriptor

const file_gcommon_v1_database_messages_execute_batch_request_proto_rawDesc = "" +
	"\n" +
	"8gcommon/v1/database/messages/execute_batch_request.proto\x12\x13gcommon.v1.database\x1a1gcommon/v1/common/messages/request_metadata.proto\x1a8gcommon/v1/database/messages/batch_execute_options.proto\x1a2gcommon/v1/database/messages/batch_operation.proto\x1a!google/protobuf/go_features.proto\"\xb5\x02\n" +
	"\x13ExecuteBatchRequest\x12O\n" +
	"\n" +
	"operations\x18\x01 \x03(\v2+.gcommon.v1.database.DatabaseBatchOperationB\x02(\x01R\n" +
	"operations\x12\x1a\n" +
	...
	"\x0etransaction_id\x18\x05 \x01(\tR\rtransactionIdB\xe5\x01\n" +
...
func init() { file_gcommon_v1_database_messages_execute_batch_request_proto_init() }
func file_gcommon_v1_database_messages_execute_batch_request_proto_init() {
	if File_gcommon_v1_database_messages_execute_batch_request_proto != nil {
		return
	}
	file_gcommon_v1_database_messages_batch_execute_options_proto_init()
	file_gcommon_v1_database_messages_batch_operation_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_database_messages_execute_batch_request_proto_rawDesc), len(file_gcommon_v1_database_messages_execute_batch_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_database_messages_execute_batch_request_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_database_messages_execute_batch_request_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_database_messages_execute_batch_request_proto_msgTypes,
	}.Build()
	File_gcommon_v1_database_messages_execute_batch_request_proto = out.File
	file_gcommon_v1_database_messages_execute_batch_request_proto_goTypes = nil
	file_gcommon_v1_database_messages_execute_batch_request_proto_depIdxs = nil
}
