...
var File_gcommon_v1_database_services_database_admin_service_proto protoreflect.FileDescriptor

const file_gcommon_v1_database_services_database_admin_service_proto_rawDesc = "" +
	"\n" +
	"9gcommon/v1/database/services/database_admin_service.proto\x12\x13gcommon.v1.database\x1a:gcommon/v1/database/messages/create_database_request.proto\x1a;gcommon/v1/database/messages/create_database_response.proto\x1a8gcommon/v1/database/messages/create_schema_request.proto\x1a9gcommon/v1/database/messages/create_schema_response.proto\x1a8gcommon/v1/database/messages/drop_database_request.proto\x1a6gcommon/v1/database/messages/drop_schema_request.proto\x1a<gcommon/v1/database/messages/get_database_info_request.proto\x1a=gcommon/v1/database/messages/get_database_info_response.proto\x1a9gcommon/v1/database/messages/list_databases_request.proto\x1a:gcommon/v1/database/messages/list_databases_response.proto\x1a7gcommon/v1/database/messages/list_schemas_request.proto\x1a8gcommon/v1/database/messages/list_schemas_response.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a!google/protobuf/go_features.proto2\xbe\x05\n" +
	...
	"\vListSchemas\x12'.gcommon.v1.database.ListSchemasRequest\x1a(.gcommon.v1.database.ListSchemasResponseB\xe6\x01\n" +
...
func init() { file_gcommon_v1_database_services_database_admin_service_proto_init() }
func file_gcommon_v1_database_services_database_admin_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_database_services_database_admin_service_proto_rawDesc), len(file_gcommon_v1_database_services_database_admin_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_gcommon_v1_database_services_database_admin_service_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_database_services_database_admin_service_proto_depIdxs,
	}.Build()
	File_gcommon_v1_database_services_database_admin_service_proto = out.File
	file_gcommon_v1_database_services_database_admin_service_proto_goTypes = nil
	file_gcommon_v1_database_services_database_admin_service_proto_depIdxs = nil
}
