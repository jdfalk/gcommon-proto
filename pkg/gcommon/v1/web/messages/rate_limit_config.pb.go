...
type WebRateLimitConfig struct {
	...
	xxx_hidden_Strategy          enums.RateLimitStrategy `protobuf:"varint,4,opt,name=strategy,enum=gcommon.v1.web.RateLimitStrategy"`
...
func (x *WebRateLimitConfig) GetStrategy() enums.RateLimitStrategy {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 3) {
			return x.xxx_hidden_Strategy
		}
	}
	return enums.RateLimitStrategy(0)
}
...
func (x *WebRateLimitConfig) SetStrategy(v enums.RateLimitStrategy) {
...
func (x *WebRateLimitConfig) ClearStrategy() {
	...
	x.xxx_hidden_Strategy = enums.RateLimitStrategy_RATE_LIMIT_STRATEGY_UNSPECIFIED
}
...
type WebRateLimitConfig_builder struct {
	...
	BurstSize *int32
	// Rate limit strategy
	Strategy *enums.RateLimitStrategy
...
const file_gcommon_v1_web_messages_rate_limit_config_proto_rawDesc = "" +
	...
	"\x0fskip_conditions\x18\x06 \x03(\tR\x0eskipConditionsB\xc3\x01\n" +
	"\x12com.gcommon.v1.webB\x14RateLimitConfigProtoP\x01Z5github.com/jdfalk/gcommon/pkg/gcommon/v1/web/messages\xa2\x02\x03GVW\xaa\x02\x0eGcommon.V1.Web\xca\x02\x0eGcommon\\V1\\Web\xe2\x02\x1aGcommon\\V1\\Web\\GPBMetadata\xea\x02\x10Gcommon::V1::Web\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
var file_gcommon_v1_web_messages_rate_limit_config_proto_goTypes = []any{
	...
	(enums.RateLimitStrategy)(0), // 1: gcommon.v1.web.RateLimitStrategy
}
