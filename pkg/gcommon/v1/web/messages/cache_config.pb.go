...
func (x *WebCacheConfig) SetPolicy(v *messages.CachePolicy) {
...
func (x *WebCacheConfig) ClearPolicy() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 1)
	protoimpl.X.AtomicSetPointer(&x.xxx_hidden_Policy, (*messages.CachePolicy)(nil))
}
...
const file_gcommon_v1_web_messages_cache_config_proto_rawDesc = "" +
	...
	"\x12com.gcommon.v1.webB\x10CacheConfigProtoP\x01Z5github.com/jdfalk/gcommon/pkg/gcommon/v1/web/messages\xa2\x02\x03GVW\xaa\x02\x0eGcommon.V1.Web\xca\x02\x0eGcommon\\V1\\Web\xe2\x02\x1aGcommon\\V1\\Web\\GPBMetadata\xea\x02\x10Gcommon::V1::Web\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
