...
func (x *CookieConfig) Reset() {
	*x = CookieConfig{}
	mi := &file_gcommon_v1_web_messages_cookie_config_proto_msgTypes[0]
...
var File_gcommon_v1_web_messages_cookie_config_proto protoreflect.FileDescriptor

const file_gcommon_v1_web_messages_cookie_config_proto_rawDesc = "" +
	"\n" +
	...
	"\amax_age\x18\a \x01(\v2\x19.google.protobuf.DurationR\x06maxAgeB\xc0\x01\n" +
	"\x12com.gcommon.v1.webB\x11CookieConfigProtoP\x01Z5github.com/jdfalk/gcommon/pkg/gcommon/v1/web/messages\xa2\x02\x03GVW\xaa\x02\x0eGcommon.V1.Web\xca\x02\x0eGcommon\\V1\\Web\xe2\x02\x1aGcommon\\V1\\Web\\GPBMetadata\xea\x02\x10Gcommon::V1::Web\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
func init() { file_gcommon_v1_web_messages_cookie_config_proto_init() }
func file_gcommon_v1_web_messages_cookie_config_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_web_messages_cookie_config_proto_rawDesc), len(file_gcommon_v1_web_messages_cookie_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_web_messages_cookie_config_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_web_messages_cookie_config_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_web_messages_cookie_config_proto_msgTypes,
	}.Build()
	File_gcommon_v1_web_messages_cookie_config_proto = out.File
	file_gcommon_v1_web_messages_cookie_config_proto_goTypes = nil
	file_gcommon_v1_web_messages_cookie_config_proto_depIdxs = nil
}
