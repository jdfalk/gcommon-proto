...
func (x *WebsocketMessage) Reset() {
	*x = WebsocketMessage{}
	mi := &file_gcommon_v1_web_messages_websocket_message_proto_msgTypes[0]
...
var File_gcommon_v1_web_messages_websocket_message_proto protoreflect.FileDescriptor

const file_gcommon_v1_web_messages_websocket_message_proto_rawDesc = "" +
	"\n" +
	"/gcommon/v1/web/messages/websocket_message.proto\x12\x0egcommon.v1.web\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xa3\x01\n" +
	...
	"\asent_at\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\x06sentAtB\xc4\x01\n" +
	"\x12com.gcommon.v1.webB\x15WebsocketMessageProtoP\x01Z5github.com/jdfalk/gcommon/pkg/gcommon/v1/web/messages\xa2\x02\x03GVW\xaa\x02\x0eGcommon.V1.Web\xca\x02\x0eGcommon\\V1\\Web\xe2\x02\x1aGcommon\\V1\\Web\\GPBMetadata\xea\x02\x10Gcommon::V1::Web\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
var file_gcommon_v1_web_messages_websocket_message_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_web_messages_websocket_message_proto_init() }
func file_gcommon_v1_web_messages_websocket_message_proto_init() {
	if File_gcommon_v1_web_messages_websocket_message_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_web_messages_websocket_message_proto_rawDesc), len(file_gcommon_v1_web_messages_websocket_message_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_web_messages_websocket_message_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_web_messages_websocket_message_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_web_messages_websocket_message_proto_msgTypes,
	}.Build()
	File_gcommon_v1_web_messages_websocket_message_proto = out.File
	file_gcommon_v1_web_messages_websocket_message_proto_goTypes = nil
	file_gcommon_v1_web_messages_websocket_message_proto_depIdxs = nil
}
