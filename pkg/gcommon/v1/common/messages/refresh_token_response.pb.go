...
func (x *RefreshTokenResponse) Reset() {
	*x = RefreshTokenResponse{}
	mi := &file_gcommon_v1_common_messages_refresh_token_response_proto_msgTypes[0]
...
var File_gcommon_v1_common_messages_refresh_token_response_proto protoreflect.FileDescriptor

const file_gcommon_v1_common_messages_refresh_token_response_proto_rawDesc = "" +
	"\n" +
	"7gcommon/v1/common/messages/refresh_token_response.proto\x12\x11gcommon.v1.common\x1a!google/protobuf/go_features.proto\"\xb4\x01\n" +
...
var file_gcommon_v1_common_messages_refresh_token_response_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_common_messages_refresh_token_response_proto_init() }
func file_gcommon_v1_common_messages_refresh_token_response_proto_init() {
	if File_gcommon_v1_common_messages_refresh_token_response_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_common_messages_refresh_token_response_proto_rawDesc), len(file_gcommon_v1_common_messages_refresh_token_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_common_messages_refresh_token_response_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_common_messages_refresh_token_response_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_common_messages_refresh_token_response_proto_msgTypes,
	}.Build()
	File_gcommon_v1_common_messages_refresh_token_response_proto = out.File
	file_gcommon_v1_common_messages_refresh_token_response_proto_goTypes = nil
	file_gcommon_v1_common_messages_refresh_token_response_proto_depIdxs = nil
}
