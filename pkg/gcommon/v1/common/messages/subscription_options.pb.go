...
func (x *SubscriptionOptions) Reset() {
	*x = SubscriptionOptions{}
	mi := &file_gcommon_v1_common_messages_subscription_options_proto_msgTypes[0]
...
var File_gcommon_v1_common_messages_subscription_options_proto protoreflect.FileDescriptor

const file_gcommon_v1_common_messages_subscription_options_proto_rawDesc = "" +
	"\n" +
	"5gcommon/v1/common/messages/subscription_options.proto\x12\x11gcommon.v1.common\x1a&gcommon/v1/common/enums/ack_mode.proto\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\"\xd5\x01\n" +
...
func init() { file_gcommon_v1_common_messages_subscription_options_proto_init() }
func file_gcommon_v1_common_messages_subscription_options_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_common_messages_subscription_options_proto_rawDesc), len(file_gcommon_v1_common_messages_subscription_options_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_common_messages_subscription_options_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_common_messages_subscription_options_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_common_messages_subscription_options_proto_msgTypes,
	}.Build()
	File_gcommon_v1_common_messages_subscription_options_proto = out.File
	file_gcommon_v1_common_messages_subscription_options_proto_goTypes = nil
	file_gcommon_v1_common_messages_subscription_options_proto_depIdxs = nil
}
