...
type CachePolicy struct {
	...
	xxx_hidden_Expiration   enums.ExpirationPolicy `protobuf:"varint,1,opt,name=expiration,enum=gcommon.v1.common.ExpirationPolicy"`
	xxx_hidden_Eviction     enums.EvictionPolicy   `protobuf:"varint,2,opt,name=eviction,enum=gcommon.v1.common.EvictionPolicy"`
...
func (x *CachePolicy) Reset() {
	*x = CachePolicy{}
	mi := &file_gcommon_v1_common_messages_cache_policy_proto_msgTypes[0]
...
func (x *CachePolicy) ClearExpiration() {
	...
	x.xxx_hidden_Expiration = enums.ExpirationPolicy_EXPIRATION_POLICY_UNSPECIFIED
}

func (x *CachePolicy) ClearEviction() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 1)
	x.xxx_hidden_Eviction = enums.EvictionPolicy_EVICTION_POLICY_UNSPECIFIED
}
...
var File_gcommon_v1_common_messages_cache_policy_proto protoreflect.FileDescriptor

const file_gcommon_v1_common_messages_cache_policy_proto_rawDesc = "" +
	"\n" +
	...
	"\fenable_stats\x18\a \x01(\bR\venableStatsB\xd1\x01\n" +
	"\x15com.gcommon.v1.commonB\x10CachePolicyProtoP\x01Z8github.com/jdfalk/gcommon/pkg/gcommon/v1/common/messages\xa2\x02\x03GVC\xaa\x02\x11Gcommon.V1.Common\xca\x02\x11Gcommon\\V1\\Common\xe2\x02\x1dGcommon\\V1\\Common\\GPBMetadata\xea\x02\x13Gcommon::V1::Common\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_common_messages_cache_policy_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_common_messages_cache_policy_proto_goTypes = []any{
...
var file_gcommon_v1_common_messages_cache_policy_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_common_messages_cache_policy_proto_init() }
func file_gcommon_v1_common_messages_cache_policy_proto_init() {
	if File_gcommon_v1_common_messages_cache_policy_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_common_messages_cache_policy_proto_rawDesc), len(file_gcommon_v1_common_messages_cache_policy_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_common_messages_cache_policy_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_common_messages_cache_policy_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_common_messages_cache_policy_proto_msgTypes,
	}.Build()
	File_gcommon_v1_common_messages_cache_policy_proto = out.File
	file_gcommon_v1_common_messages_cache_policy_proto_goTypes = nil
	file_gcommon_v1_common_messages_cache_policy_proto_depIdxs = nil
}
