...
func (x *HealthCheckAllRequest) Reset() {
	*x = HealthCheckAllRequest{}
	mi := &file_gcommon_v1_common_messages_health_check_all_request_proto_msgTypes[0]
...
var File_gcommon_v1_common_messages_health_check_all_request_proto protoreflect.FileDescriptor

const file_gcommon_v1_common_messages_health_check_all_request_proto_rawDesc = "" +
	"\n" +
	...
	"\x0ftimeout_seconds\x18\x03 \x01(\x05R\x0etimeoutSecondsB\xdb\x01\n" +
	"\x15com.gcommon.v1.commonB\x1aHealthCheckAllRequestProtoP\x01Z8github.com/jdfalk/gcommon/pkg/gcommon/v1/common/messages\xa2\x02\x03GVC\xaa\x02\x11Gcommon.V1.Common\xca\x02\x11Gcommon\\V1\\Common\xe2\x02\x1dGcommon\\V1\\Common\\GPBMetadata\xea\x02\x13Gcommon::V1::Common\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
func init() { file_gcommon_v1_common_messages_health_check_all_request_proto_init() }
func file_gcommon_v1_common_messages_health_check_all_request_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_common_messages_health_check_all_request_proto_rawDesc), len(file_gcommon_v1_common_messages_health_check_all_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_common_messages_health_check_all_request_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_common_messages_health_check_all_request_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_common_messages_health_check_all_request_proto_msgTypes,
	}.Build()
	File_gcommon_v1_common_messages_health_check_all_request_proto = out.File
	file_gcommon_v1_common_messages_health_check_all_request_proto_goTypes = nil
	file_gcommon_v1_common_messages_health_check_all_request_proto_depIdxs = nil
}
