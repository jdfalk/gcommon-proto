...
type RunCheckResponse struct {
	...
	xxx_hidden_Status        enums.CommonHealthStatus `protobuf:"varint,3,opt,name=status,enum=gcommon.v1.common.CommonHealthStatus"`
...
func (x *RunCheckResponse) GetStatus() enums.CommonHealthStatus {
	if x != nil {
...
func (x *RunCheckResponse) SetStatus(v enums.CommonHealthStatus) {
...
const file_gcommon_v1_common_messages_run_check_response_proto_rawDesc = "" +
	...
	"\x05error\x18\a \x01(\v2\x18.gcommon.v1.common.ErrorR\x05errorB\xd6\x01\n" +
	"\x15com.gcommon.v1.commonB\x15RunCheckResponseProtoP\x01Z8github.com/jdfalk/gcommon/pkg/gcommon/v1/common/messages\xa2\x02\x03GVC\xaa\x02\x11Gcommon.V1.Common\xca\x02\x11Gcommon\\V1\\Common\xe2\x02\x1dGcommon\\V1\\Common\\GPBMetadata\xea\x02\x13Gcommon::V1::Common\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
