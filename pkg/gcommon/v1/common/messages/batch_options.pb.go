...
func (x *CommonBatchOptions) Reset() {
	*x = CommonBatchOptions{}
	mi := &file_gcommon_v1_common_messages_batch_options_proto_msgTypes[0]
...
var File_gcommon_v1_common_messages_batch_options_proto protoreflect.FileDescriptor

const file_gcommon_v1_common_messages_batch_options_proto_rawDesc = "" +
	"\n" +
	".gcommon/v1/common/messages/batch_options.proto\x12\x11gcommon.v1.common\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\"\xb0\x01\n" +
	...
	"\x0ereturn_partial\x18\x04 \x01(\bR\rreturnPartialB\xd2\x01\n" +
	"\x15com.gcommon.v1.commonB\x11BatchOptionsProtoP\x01Z8github.com/jdfalk/gcommon/pkg/gcommon/v1/common/messages\xa2\x02\x03GVC\xaa\x02\x11Gcommon.V1.Common\xca\x02\x11Gcommon\\V1\\Common\xe2\x02\x1dGcommon\\V1\\Common\\GPBMetadata\xea\x02\x13Gcommon::V1::Common\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
var file_gcommon_v1_common_messages_batch_options_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_common_messages_batch_options_proto_init() }
func file_gcommon_v1_common_messages_batch_options_proto_init() {
	if File_gcommon_v1_common_messages_batch_options_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_common_messages_batch_options_proto_rawDesc), len(file_gcommon_v1_common_messages_batch_options_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_common_messages_batch_options_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_common_messages_batch_options_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_common_messages_batch_options_proto_msgTypes,
	}.Build()
	File_gcommon_v1_common_messages_batch_options_proto = out.File
	file_gcommon_v1_common_messages_batch_options_proto_goTypes = nil
	file_gcommon_v1_common_messages_batch_options_proto_depIdxs = nil
}
