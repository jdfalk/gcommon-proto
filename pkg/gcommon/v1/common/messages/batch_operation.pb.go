...
func (x *CommonBatchOperation) Reset() {
	*x = CommonBatchOperation{}
	mi := &file_gcommon_v1_common_messages_batch_operation_proto_msgTypes[0]
...
var File_gcommon_v1_common_messages_batch_operation_proto protoreflect.FileDescriptor

const file_gcommon_v1_common_messages_batch_operation_proto_rawDesc = "" +
	"\n" +
	"0gcommon/v1/common/messages/batch_operation.proto\x12\x11gcommon.v1.common\x1a.gcommon/v1/common/messages/batch_options.proto\x1a1gcommon/v1/common/messages/request_metadata.proto\x1a\x19google/protobuf/any.proto\x1a!google/protobuf/go_features.proto\"\x9b\x02\n" +
	...
	"\bmetadata\x18\x05 \x01(\v2\".gcommon.v1.common.RequestMetadataB\x02(\x01R\bmetadataB\xd4\x01\n" +
	"\x15com.gcommon.v1.commonB\x13BatchOperationProtoP\x01Z8github.com/jdfalk/gcommon/pkg/gcommon/v1/common/messages\xa2\x02\x03GVC\xaa\x02\x11Gcommon.V1.Common\xca\x02\x11Gcommon\\V1\\Common\xe2\x02\x1dGcommon\\V1\\Common\\GPBMetadata\xea\x02\x13Gcommon::V1::Common\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
var file_gcommon_v1_common_messages_batch_operation_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_common_messages_batch_operation_proto_init() }
func file_gcommon_v1_common_messages_batch_operation_proto_init() {
	if File_gcommon_v1_common_messages_batch_operation_proto != nil {
		return
	}
	file_gcommon_v1_common_messages_batch_options_proto_init()
	file_gcommon_v1_common_messages_request_metadata_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_common_messages_batch_operation_proto_rawDesc), len(file_gcommon_v1_common_messages_batch_operation_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_common_messages_batch_operation_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_common_messages_batch_operation_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_common_messages_batch_operation_proto_msgTypes,
	}.Build()
	File_gcommon_v1_common_messages_batch_operation_proto = out.File
	file_gcommon_v1_common_messages_batch_operation_proto_goTypes = nil
	file_gcommon_v1_common_messages_batch_operation_proto_depIdxs = nil
}
