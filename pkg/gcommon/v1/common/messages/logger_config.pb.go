...
func (x *LoggerConfig) Reset() {
	*x = LoggerConfig{}
	mi := &file_gcommon_v1_common_messages_logger_config_proto_msgTypes[0]
...
var File_gcommon_v1_common_messages_logger_config_proto protoreflect.FileDescriptor

const file_gcommon_v1_common_messages_logger_config_proto_rawDesc = "" +
	"\n" +
	".gcommon/v1/common/messages/logger_config.proto\x12\x11gcommon.v1.common\x1a'gcommon/v1/common/enums/log_level.proto\x1a0gcommon/v1/common/messages/appender_config.proto\x1a!google/protobuf/go_features.proto\"\xdd\x02\n" +
	"\fLoggerConfig\x121\n" +
	...
	"\tpropagate\x18\x04 \x01(\bR\tpropagate\x12O\n" +
	"\n" +
	"properties\x18\x05 \x03(\v2/.gcommon.v1.common.LoggerConfig.PropertiesEntryR\n" +
	"properties\x1a=\n" +
	"\x0fPropertiesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\xd2\x01\n" +
	"\x15com.gcommon.v1.commonB\x11LoggerConfigProtoP\x01Z8github.com/jdfalk/gcommon/pkg/gcommon/v1/common/messages\xa2\x02\x03GVC\xaa\x02\x11Gcommon.V1.Common\xca\x02\x11Gcommon\\V1\\Common\xe2\x02\x1dGcommon\\V1\\Common\\GPBMetadata\xea\x02\x13Gcommon::V1::Common\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
var file_gcommon_v1_common_messages_logger_config_proto_depIdxs = []int32{
	2, // 0: gcommon.v1.common.LoggerConfig.level:type_name -> gcommon.v1.common.LogLevel
	3, // 1: gcommon.v1.common.LoggerConfig.appenders:type_name -> gcommon.v1.common.AppenderConfig
	1, // 2: gcommon.v1.common.LoggerConfig.properties:type_name -> gcommon.v1.common.LoggerConfig.PropertiesEntry
...
func init() { file_gcommon_v1_common_messages_logger_config_proto_init() }
func file_gcommon_v1_common_messages_logger_config_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_common_messages_logger_config_proto_rawDesc), len(file_gcommon_v1_common_messages_logger_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_common_messages_logger_config_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_common_messages_logger_config_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_common_messages_logger_config_proto_msgTypes,
	}.Build()
	File_gcommon_v1_common_messages_logger_config_proto = out.File
	file_gcommon_v1_common_messages_logger_config_proto_goTypes = nil
	file_gcommon_v1_common_messages_logger_config_proto_depIdxs = nil
}
