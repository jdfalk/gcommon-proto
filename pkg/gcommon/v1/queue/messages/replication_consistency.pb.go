...
type ReplicationConsistency struct {
	...
	xxx_hidden_ReplicationLevel      enums.ReplicationLevel `protobuf:"varint,4,opt,name=replication_level,json=replicationLevel,enum=gcommon.v1.queue.ReplicationLevel"`
...
func (x *ReplicationConsistency) Reset() {
	*x = ReplicationConsistency{}
	mi := &file_gcommon_v1_queue_messages_replication_consistency_proto_msgTypes[0]
...
func (x *ReplicationConsistency) GetReplicationLevel() enums.ReplicationLevel {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 3) {
			return x.xxx_hidden_ReplicationLevel
		}
	}
	return enums.ReplicationLevel(0)
}
...
func (x *ReplicationConsistency) SetReplicationLevel(v enums.ReplicationLevel) {
...
func (x *ReplicationConsistency) ClearReplicationLevel() {
	...
	x.xxx_hidden_ReplicationLevel = enums.ReplicationLevel_REPLICATION_LEVEL_UNSPECIFIED
}
...
type ReplicationConsistency_builder struct {
	...
	ReplicationLevel *enums.ReplicationLevel
...
var File_gcommon_v1_queue_messages_replication_consistency_proto protoreflect.FileDescriptor

const file_gcommon_v1_queue_messages_replication_consistency_proto_rawDesc = "" +
	"\n" +
	...
	"\x17repair_interval_seconds\x18\x06 \x01(\x05R\x15repairIntervalSecondsB\xd6\x01\n" +
	"\x14com.gcommon.v1.queueB\x1bReplicationConsistencyProtoP\x01Z7github.com/jdfalk/gcommon/pkg/gcommon/v1/queue/messages\xa2\x02\x03GVQ\xaa\x02\x10Gcommon.V1.Queue\xca\x02\x10Gcommon\\V1\\Queue\xe2\x02\x1cGcommon\\V1\\Queue\\GPBMetadata\xea\x02\x12Gcommon::V1::Queue\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
var file_gcommon_v1_queue_messages_replication_consistency_proto_goTypes = []any{
	...
	(enums.ReplicationLevel)(0),    // 1: gcommon.v1.queue.ReplicationLevel
}
var file_gcommon_v1_queue_messages_replication_consistency_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_queue_messages_replication_consistency_proto_init() }
func file_gcommon_v1_queue_messages_replication_consistency_proto_init() {
	if File_gcommon_v1_queue_messages_replication_consistency_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_queue_messages_replication_consistency_proto_rawDesc), len(file_gcommon_v1_queue_messages_replication_consistency_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_queue_messages_replication_consistency_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_queue_messages_replication_consistency_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_queue_messages_replication_consistency_proto_msgTypes,
	}.Build()
	File_gcommon_v1_queue_messages_replication_consistency_proto = out.File
	file_gcommon_v1_queue_messages_replication_consistency_proto_goTypes = nil
	file_gcommon_v1_queue_messages_replication_consistency_proto_depIdxs = nil
}
