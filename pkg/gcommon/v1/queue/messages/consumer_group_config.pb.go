...
func (x *ConsumerGroupConfig) Reset() {
	*x = ConsumerGroupConfig{}
	mi := &file_gcommon_v1_queue_messages_consumer_group_config_proto_msgTypes[0]
...
var File_gcommon_v1_queue_messages_consumer_group_config_proto protoreflect.FileDescriptor

const file_gcommon_v1_queue_messages_consumer_group_config_proto_rawDesc = "" +
	"\n" +
	"5gcommon/v1/queue/messages/consumer_group_config.proto\x12\x10gcommon.v1.queue\x1a4gcommon/v1/queue/enums/load_balancing_strategy.proto\x1a2gcommon/v1/queue/enums/offset_reset_strategy.proto\x1a/gcommon/v1/queue/enums/rebalance_strategy.proto\x1a2gcommon/v1/queue/messages/auto_commit_config.proto\x1a8gcommon/v1/queue/messages/dead_letter_queue_config.proto\x1a!google/protobuf/go_features.proto\"\x9c\x05\n" +
	...
	"\n" +
	"dlq_config\x18\n" +
	" \x01(\v2'.gcommon.v1.queue.DeadLetterQueueConfigR\tdlqConfigB\xd3\x01\n" +
	"\x14com.gcommon.v1.queueB\x18ConsumerGroupConfigProtoP\x01Z7github.com/jdfalk/gcommon/pkg/gcommon/v1/queue/messages\xa2\x02\x03GVQ\xaa\x02\x10Gcommon.V1.Queue\xca\x02\x10Gcommon\\V1\\Queue\xe2\x02\x1cGcommon\\V1\\Queue\\GPBMetadata\xea\x02\x12Gcommon::V1::Queue\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
func init() { file_gcommon_v1_queue_messages_consumer_group_config_proto_init() }
func file_gcommon_v1_queue_messages_consumer_group_config_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_queue_messages_consumer_group_config_proto_rawDesc), len(file_gcommon_v1_queue_messages_consumer_group_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_queue_messages_consumer_group_config_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_queue_messages_consumer_group_config_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_queue_messages_consumer_group_config_proto_msgTypes,
	}.Build()
	File_gcommon_v1_queue_messages_consumer_group_config_proto = out.File
	file_gcommon_v1_queue_messages_consumer_group_config_proto_goTypes = nil
	file_gcommon_v1_queue_messages_consumer_group_config_proto_depIdxs = nil
}
