...
func (x *QueueRetryPolicy) Reset() {
	*x = QueueRetryPolicy{}
	mi := &file_gcommon_v1_queue_messages_retry_policy_proto_msgTypes[0]
...
var File_gcommon_v1_queue_messages_retry_policy_proto protoreflect.FileDescriptor

const file_gcommon_v1_queue_messages_retry_policy_proto_rawDesc = "" +
	"\n" +
	",gcommon/v1/queue/messages/retry_policy.proto\x12\x10gcommon.v1.queue\x1a1gcommon/v1/queue/enums/retry_delay_strategy.proto\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\"\xf3\x02\n" +
	...
	"\rjitter_factor\x18\a \x01(\x01R\fjitterFactorB\xcb\x01\n" +
	"\x14com.gcommon.v1.queueB\x10RetryPolicyProtoP\x01Z7github.com/jdfalk/gcommon/pkg/gcommon/v1/queue/messages\xa2\x02\x03GVQ\xaa\x02\x10Gcommon.V1.Queue\xca\x02\x10Gcommon\\V1\\Queue\xe2\x02\x1cGcommon\\V1\\Queue\\GPBMetadata\xea\x02\x12Gcommon::V1::Queue\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
func init() { file_gcommon_v1_queue_messages_retry_policy_proto_init() }
func file_gcommon_v1_queue_messages_retry_policy_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_queue_messages_retry_policy_proto_rawDesc), len(file_gcommon_v1_queue_messages_retry_policy_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_queue_messages_retry_policy_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_queue_messages_retry_policy_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_queue_messages_retry_policy_proto_msgTypes,
	}.Build()
	File_gcommon_v1_queue_messages_retry_policy_proto = out.File
	file_gcommon_v1_queue_messages_retry_policy_proto_goTypes = nil
	file_gcommon_v1_queue_messages_retry_policy_proto_depIdxs = nil
}
