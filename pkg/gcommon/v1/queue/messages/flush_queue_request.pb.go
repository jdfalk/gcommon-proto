...
// 	protoc        (unknown)
// source: gcommon/v1/queue/messages/flush_queue_request.proto
...
func (x *FlushQueueRequest) Reset() {
	*x = FlushQueueRequest{}
	mi := &file_gcommon_v1_queue_messages_flush_queue_request_proto_msgTypes[0]
...
func (x *FlushQueueRequest) GetFlushPolicy() enums.FlushPolicy {
	if x != nil {
...
func (x *FlushQueueRequest) SetFlushPolicy(v enums.FlushPolicy) {
...
var File_gcommon_v1_queue_messages_flush_queue_request_proto protoreflect.FileDescriptor

const file_gcommon_v1_queue_messages_flush_queue_request_proto_rawDesc = "" +
	"\n" +
	"3gcommon/v1/queue/messages/flush_queue_request.proto\x12\x10gcommon.v1.queue\x1a)gcommon/v1/queue/enums/flush_policy.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xce\x03\n" +
	...
	"\x14com.gcommon.v1.queueB\x16FlushQueueRequestProtoP\x01Z7github.com/jdfalk/gcommon/pkg/gcommon/v1/queue/messages\xa2\x02\x03GVQ\xaa\x02\x10Gcommon.V1.Queue\xca\x02\x10Gcommon\\V1\\Queue\xe2\x02\x1cGcommon\\V1\\Queue\\GPBMetadata\xea\x02\x12Gcommon::V1::Queue\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_queue_messages_flush_queue_request_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_gcommon_v1_queue_messages_flush_queue_request_proto_goTypes = []any{
	(*FlushQueueRequest)(nil),     // 0: gcommon.v1.queue.FlushQueueRequest
	nil,                           // 1: gcommon.v1.queue.FlushQueueRequest.MetadataEntry
	(enums.FlushPolicy)(0),        // 2: gcommon.v1.queue.FlushPolicy
	(*timestamppb.Timestamp)(nil), // 3: google.protobuf.Timestamp
}
var file_gcommon_v1_queue_messages_flush_queue_request_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_queue_messages_flush_queue_request_proto_init() }
func file_gcommon_v1_queue_messages_flush_queue_request_proto_init() {
	if File_gcommon_v1_queue_messages_flush_queue_request_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_queue_messages_flush_queue_request_proto_rawDesc), len(file_gcommon_v1_queue_messages_flush_queue_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_queue_messages_flush_queue_request_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_queue_messages_flush_queue_request_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_queue_messages_flush_queue_request_proto_msgTypes,
	}.Build()
	File_gcommon_v1_queue_messages_flush_queue_request_proto = out.File
	file_gcommon_v1_queue_messages_flush_queue_request_proto_goTypes = nil
	file_gcommon_v1_queue_messages_flush_queue_request_proto_depIdxs = nil
}
