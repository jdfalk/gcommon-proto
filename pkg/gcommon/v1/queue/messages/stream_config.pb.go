...
// 	protoc        (unknown)
// source: gcommon/v1/queue/messages/stream_config.proto
...
type StreamConfig struct {
	...
	xxx_hidden_RestartPolicy          enums.StreamRestartPolicy `protobuf:"varint,9,opt,name=restart_policy,json=restartPolicy,enum=gcommon.v1.queue.StreamRestartPolicy"`
...
func (x *StreamConfig) Reset() {
	*x = StreamConfig{}
	mi := &file_gcommon_v1_queue_messages_stream_config_proto_msgTypes[0]
...
func (x *StreamConfig) GetRestartPolicy() enums.StreamRestartPolicy {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 8) {
			return x.xxx_hidden_RestartPolicy
		}
	}
	return enums.StreamRestartPolicy(0)
}
...
func (x *StreamConfig) SetRestartPolicy(v enums.StreamRestartPolicy) {
...
func (x *StreamConfig) ClearRestartPolicy() {
	...
	x.xxx_hidden_RestartPolicy = enums.StreamRestartPolicy_STREAM_RESTART_POLICY_UNSPECIFIED
}
...
type StreamConfig_builder struct {
	...
	RestartPolicy *enums.StreamRestartPolicy
}
...
var File_gcommon_v1_queue_messages_stream_config_proto protoreflect.FileDescriptor

const file_gcommon_v1_queue_messages_stream_config_proto_rawDesc = "" +
	"\n" +
	"-gcommon/v1/queue/messages/stream_config.proto\x12\x10gcommon.v1.queue\x1a2gcommon/v1/queue/enums/stream_restart_policy.proto\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\"\xec\x03\n" +
	...
	"\x0erestart_policy\x18\t \x01(\x0e2%.gcommon.v1.queue.StreamRestartPolicyR\rrestartPolicyB\xcc\x01\n" +
	"\x14com.gcommon.v1.queueB\x11StreamConfigProtoP\x01Z7github.com/jdfalk/gcommon/pkg/gcommon/v1/queue/messages\xa2\x02\x03GVQ\xaa\x02\x10Gcommon.V1.Queue\xca\x02\x10Gcommon\\V1\\Queue\xe2\x02\x1cGcommon\\V1\\Queue\\GPBMetadata\xea\x02\x12Gcommon::V1::Queue\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
var file_gcommon_v1_queue_messages_stream_config_proto_goTypes = []any{
	...
	(enums.StreamRestartPolicy)(0), // 2: gcommon.v1.queue.StreamRestartPolicy
}
var file_gcommon_v1_queue_messages_stream_config_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_queue_messages_stream_config_proto_init() }
func file_gcommon_v1_queue_messages_stream_config_proto_init() {
	if File_gcommon_v1_queue_messages_stream_config_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_queue_messages_stream_config_proto_rawDesc), len(file_gcommon_v1_queue_messages_stream_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_queue_messages_stream_config_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_queue_messages_stream_config_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_queue_messages_stream_config_proto_msgTypes,
	}.Build()
	File_gcommon_v1_queue_messages_stream_config_proto = out.File
	file_gcommon_v1_queue_messages_stream_config_proto_goTypes = nil
	file_gcommon_v1_queue_messages_stream_config_proto_depIdxs = nil
}
