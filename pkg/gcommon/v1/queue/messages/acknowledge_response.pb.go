...
// 	protoc        (unknown)
// source: gcommon/v1/queue/messages/acknowledge_response.proto
...
func (x *AcknowledgeResponse) Reset() {
	*x = AcknowledgeResponse{}
	mi := &file_gcommon_v1_queue_messages_acknowledge_response_proto_msgTypes[0]
...
var File_gcommon_v1_queue_messages_acknowledge_response_proto protoreflect.FileDescriptor

const file_gcommon_v1_queue_messages_acknowledge_response_proto_rawDesc = "" +
	"\n" +
	"4gcommon/v1/queue/messages/acknowledge_response.proto\x12\x10gcommon.v1.queue\x1a&gcommon/v1/common/messages/error.proto\x1a1gcommon/v1/common/messages/request_metadata.proto\x1a2gcommon/v1/queue/messages/message_ack_result.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xdf\x05\n" +
	...
	"\x14com.gcommon.v1.queueB\x18AcknowledgeResponseProtoP\x01Z7github.com/jdfalk/gcommon/pkg/gcommon/v1/queue/messages\xa2\x02\x03GVQ\xaa\x02\x10Gcommon.V1.Queue\xca\x02\x10Gcommon\\V1\\Queue\xe2\x02\x1cGcommon\\V1\\Queue\\GPBMetadata\xea\x02\x12Gcommon::V1::Queue\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
func init() { file_gcommon_v1_queue_messages_acknowledge_response_proto_init() }
func file_gcommon_v1_queue_messages_acknowledge_response_proto_init() {
	if File_gcommon_v1_queue_messages_acknowledge_response_proto != nil {
		return
	}
	file_gcommon_v1_queue_messages_message_ack_result_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_queue_messages_acknowledge_response_proto_rawDesc), len(file_gcommon_v1_queue_messages_acknowledge_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_queue_messages_acknowledge_response_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_queue_messages_acknowledge_response_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_queue_messages_acknowledge_response_proto_msgTypes,
	}.Build()
	File_gcommon_v1_queue_messages_acknowledge_response_proto = out.File
	file_gcommon_v1_queue_messages_acknowledge_response_proto_goTypes = nil
	file_gcommon_v1_queue_messages_acknowledge_response_proto_depIdxs = nil
}
