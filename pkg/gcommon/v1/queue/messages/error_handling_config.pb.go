...
func (x *ErrorHandlingConfig) Reset() {
	*x = ErrorHandlingConfig{}
	mi := &file_gcommon_v1_queue_messages_error_handling_config_proto_msgTypes[0]
...
var File_gcommon_v1_queue_messages_error_handling_config_proto protoreflect.FileDescriptor

const file_gcommon_v1_queue_messages_error_handling_config_proto_rawDesc = "" +
	"\n" +
	"5gcommon/v1/queue/messages/error_handling_config.proto\x12\x10gcommon.v1.queue\x1a8gcommon/v1/queue/messages/dead_letter_queue_config.proto\x1a3gcommon/v1/queue/messages/error_action_config.proto\x1a9gcommon/v1/queue/messages/error_notification_config.proto\x1a!google/protobuf/go_features.proto\"\xe9\x02\n" +
	...
	"\x13notification_config\x18\x05 \x01(\v2).gcommon.v1.queue.ErrorNotificationConfigR\x12notificationConfigB\xd3\x01\n" +
	"\x14com.gcommon.v1.queueB\x18ErrorHandlingConfigProtoP\x01Z7github.com/jdfalk/gcommon/pkg/gcommon/v1/queue/messages\xa2\x02\x03GVQ\xaa\x02\x10Gcommon.V1.Queue\xca\x02\x10Gcommon\\V1\\Queue\xe2\x02\x1cGcommon\\V1\\Queue\\GPBMetadata\xea\x02\x12Gcommon::V1::Queue\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
var file_gcommon_v1_queue_messages_error_handling_config_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_queue_messages_error_handling_config_proto_init() }
func file_gcommon_v1_queue_messages_error_handling_config_proto_init() {
	if File_gcommon_v1_queue_messages_error_handling_config_proto != nil {
		return
	}
	file_gcommon_v1_queue_messages_dead_letter_queue_config_proto_init()
	file_gcommon_v1_queue_messages_error_action_config_proto_init()
	file_gcommon_v1_queue_messages_error_notification_config_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_queue_messages_error_handling_config_proto_rawDesc), len(file_gcommon_v1_queue_messages_error_handling_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_queue_messages_error_handling_config_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_queue_messages_error_handling_config_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_queue_messages_error_handling_config_proto_msgTypes,
	}.Build()
	File_gcommon_v1_queue_messages_error_handling_config_proto = out.File
	file_gcommon_v1_queue_messages_error_handling_config_proto_goTypes = nil
	file_gcommon_v1_queue_messages_error_handling_config_proto_depIdxs = nil
}
