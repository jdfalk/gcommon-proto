...
// 	protoc        (unknown)
// source: gcommon/v1/queue/messages/circuit_breaker_config.proto
...
func (x *QueueCircuitBreakerConfig) Reset() {
	*x = QueueCircuitBreakerConfig{}
	mi := &file_gcommon_v1_queue_messages_circuit_breaker_config_proto_msgTypes[0]
...
var File_gcommon_v1_queue_messages_circuit_breaker_config_proto protoreflect.FileDescriptor

const file_gcommon_v1_queue_messages_circuit_breaker_config_proto_rawDesc = "" +
	"\n" +
	"6gcommon/v1/queue/messages/circuit_breaker_config.proto\x12\x10gcommon.v1.queue\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\"\x9e\x02\n" +
	...
	"\binterval\x18\x06 \x01(\v2\x19.google.protobuf.DurationR\bintervalB\xd4\x01\n" +
	"\x14com.gcommon.v1.queueB\x19CircuitBreakerConfigProtoP\x01Z7github.com/jdfalk/gcommon/pkg/gcommon/v1/queue/messages\xa2\x02\x03GVQ\xaa\x02\x10Gcommon.V1.Queue\xca\x02\x10Gcommon\\V1\\Queue\xe2\x02\x1cGcommon\\V1\\Queue\\GPBMetadata\xea\x02\x12Gcommon::V1::Queue\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_queue_messages_circuit_breaker_config_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_queue_messages_circuit_breaker_config_proto_goTypes = []any{
	(*QueueCircuitBreakerConfig)(nil), // 0: gcommon.v1.queue.QueueCircuitBreakerConfig
	(*durationpb.Duration)(nil),       // 1: google.protobuf.Duration
}
var file_gcommon_v1_queue_messages_circuit_breaker_config_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_queue_messages_circuit_breaker_config_proto_init() }
func file_gcommon_v1_queue_messages_circuit_breaker_config_proto_init() {
	if File_gcommon_v1_queue_messages_circuit_breaker_config_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_queue_messages_circuit_breaker_config_proto_rawDesc), len(file_gcommon_v1_queue_messages_circuit_breaker_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_queue_messages_circuit_breaker_config_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_queue_messages_circuit_breaker_config_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_queue_messages_circuit_breaker_config_proto_msgTypes,
	}.Build()
	File_gcommon_v1_queue_messages_circuit_breaker_config_proto = out.File
	file_gcommon_v1_queue_messages_circuit_breaker_config_proto_goTypes = nil
	file_gcommon_v1_queue_messages_circuit_breaker_config_proto_depIdxs = nil
}
