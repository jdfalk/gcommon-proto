...
type LoadBalancingConfig struct {
	...
	xxx_hidden_Strategy              enums.LoadBalancingStrategy `protobuf:"varint,1,opt,name=strategy,enum=gcommon.v1.queue.LoadBalancingStrategy"`
...
func (x *LoadBalancingConfig) GetStrategy() enums.LoadBalancingStrategy {
	if x != nil {
...
func (x *LoadBalancingConfig) SetStrategy(v enums.LoadBalancingStrategy) {
...
func (x *LoadBalancingConfig) ClearStrategy() {
	...
	x.xxx_hidden_Strategy = enums.LoadBalancingStrategy_LOAD_BALANCING_STRATEGY_UNSPECIFIED
}
...
type LoadBalancingConfig_builder struct {
	...
	Strategy *enums.LoadBalancingStrategy
...
const file_gcommon_v1_queue_messages_load_balancing_config_proto_rawDesc = "" +
	...
	"\faffinity_key\x18\a \x01(\tR\vaffinityKeyB\xd3\x01\n" +
	"\x14com.gcommon.v1.queueB\x18LoadBalancingConfigProtoP\x01Z7github.com/jdfalk/gcommon/pkg/gcommon/v1/queue/messages\xa2\x02\x03GVQ\xaa\x02\x10Gcommon.V1.Queue\xca\x02\x10Gcommon\\V1\\Queue\xe2\x02\x1cGcommon\\V1\\Queue\\GPBMetadata\xea\x02\x12Gcommon::V1::Queue\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
