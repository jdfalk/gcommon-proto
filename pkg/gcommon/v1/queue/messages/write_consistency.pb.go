...
func (x *WriteConsistency) Reset() {
	*x = WriteConsistency{}
	mi := &file_gcommon_v1_queue_messages_write_consistency_proto_msgTypes[0]
...
var File_gcommon_v1_queue_messages_write_consistency_proto protoreflect.FileDescriptor

const file_gcommon_v1_queue_messages_write_consistency_proto_rawDesc = "" +
	"\n" +
	"1gcommon/v1/queue/messages/write_consistency.proto\x12\x10gcommon.v1.queue\x1a(gcommon/v1/queue/enums/write_level.proto\x1a2gcommon/v1/queue/messages/conflict_detection.proto\x1a0gcommon/v1/queue/messages/sync_replication.proto\x1a2gcommon/v1/queue/messages/write_retry_config.proto\x1a!google/protobuf/go_features.proto\"\xce\x02\n" +
	...
	"\fretry_config\x18\x05 \x01(\v2\".gcommon.v1.queue.WriteRetryConfigR\vretryConfigB\xd0\x01\n" +
	"\x14com.gcommon.v1.queueB\x15WriteConsistencyProtoP\x01Z7github.com/jdfalk/gcommon/pkg/gcommon/v1/queue/messages\xa2\x02\x03GVQ\xaa\x02\x10Gcommon.V1.Queue\xca\x02\x10Gcommon\\V1\\Queue\xe2\x02\x1cGcommon\\V1\\Queue\\GPBMetadata\xea\x02\x12Gcommon::V1::Queue\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
var file_gcommon_v1_queue_messages_write_consistency_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_queue_messages_write_consistency_proto_init() }
func file_gcommon_v1_queue_messages_write_consistency_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_queue_messages_write_consistency_proto_rawDesc), len(file_gcommon_v1_queue_messages_write_consistency_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_queue_messages_write_consistency_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_queue_messages_write_consistency_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_queue_messages_write_consistency_proto_msgTypes,
	}.Build()
	File_gcommon_v1_queue_messages_write_consistency_proto = out.File
	file_gcommon_v1_queue_messages_write_consistency_proto_goTypes = nil
	file_gcommon_v1_queue_messages_write_consistency_proto_depIdxs = nil
}
