...
// 	protoc        (unknown)
// source: gcommon/v1/queue/messages/flow_control_settings.proto
...
func (x *FlowControlSettings) Reset() {
	*x = FlowControlSettings{}
	mi := &file_gcommon_v1_queue_messages_flow_control_settings_proto_msgTypes[0]
...
var File_gcommon_v1_queue_messages_flow_control_settings_proto protoreflect.FileDescriptor

const file_gcommon_v1_queue_messages_flow_control_settings_proto_rawDesc = "" +
	"\n" +
	"5gcommon/v1/queue/messages/flow_control_settings.proto\x12\x10gcommon.v1.queue\x1a!google/protobuf/go_features.proto\"\xa1\x01\n" +
	...
	"\talgorithm\x18\x03 \x01(\tR\talgorithmB\xd3\x01\n" +
	"\x14com.gcommon.v1.queueB\x18FlowControlSettingsProtoP\x01Z7github.com/jdfalk/gcommon/pkg/gcommon/v1/queue/messages\xa2\x02\x03GVQ\xaa\x02\x10Gcommon.V1.Queue\xca\x02\x10Gcommon\\V1\\Queue\xe2\x02\x1cGcommon\\V1\\Queue\\GPBMetadata\xea\x02\x12Gcommon::V1::Queue\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
var file_gcommon_v1_queue_messages_flow_control_settings_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_queue_messages_flow_control_settings_proto_init() }
func file_gcommon_v1_queue_messages_flow_control_settings_proto_init() {
	if File_gcommon_v1_queue_messages_flow_control_settings_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_queue_messages_flow_control_settings_proto_rawDesc), len(file_gcommon_v1_queue_messages_flow_control_settings_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_queue_messages_flow_control_settings_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_queue_messages_flow_control_settings_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_queue_messages_flow_control_settings_proto_msgTypes,
	}.Build()
	File_gcommon_v1_queue_messages_flow_control_settings_proto = out.File
	file_gcommon_v1_queue_messages_flow_control_settings_proto_goTypes = nil
	file_gcommon_v1_queue_messages_flow_control_settings_proto_depIdxs = nil
}
