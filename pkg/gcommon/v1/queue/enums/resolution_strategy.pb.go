...
func (ResolutionStrategy) Descriptor() protoreflect.EnumDescriptor {
	return file_gcommon_v1_queue_enums_resolution_strategy_proto_enumTypes[0].Descriptor()
}

func (ResolutionStrategy) Type() protoreflect.EnumType {
	return &file_gcommon_v1_queue_enums_resolution_strategy_proto_enumTypes[0]
}
...
var File_gcommon_v1_queue_enums_resolution_strategy_proto protoreflect.FileDescriptor

const file_gcommon_v1_queue_enums_resolution_strategy_proto_rawDesc = "" +
	"\n" +
	...
	"\x1fRESOLUTION_STRATEGY_MULTI_VALUE\x10\x05B\xcf\x01\n" +
	"\x14com.gcommon.v1.queueB\x17ResolutionStrategyProtoP\x01Z4github.com/jdfalk/gcommon/pkg/gcommon/v1/queue/enums\xa2\x02\x03GVQ\xaa\x02\x10Gcommon.V1.Queue\xca\x02\x10Gcommon\\V1\\Queue\xe2\x02\x1cGcommon\\V1\\Queue\\GPBMetadata\xea\x02\x12Gcommon::V1::Queue\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
var file_gcommon_v1_queue_enums_resolution_strategy_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_queue_enums_resolution_strategy_proto_init() }
func file_gcommon_v1_queue_enums_resolution_strategy_proto_init() {
	if File_gcommon_v1_queue_enums_resolution_strategy_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_queue_enums_resolution_strategy_proto_rawDesc), len(file_gcommon_v1_queue_enums_resolution_strategy_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_queue_enums_resolution_strategy_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_queue_enums_resolution_strategy_proto_depIdxs,
		EnumInfos:         file_gcommon_v1_queue_enums_resolution_strategy_proto_enumTypes,
	}.Build()
	File_gcommon_v1_queue_enums_resolution_strategy_proto = out.File
	file_gcommon_v1_queue_enums_resolution_strategy_proto_goTypes = nil
	file_gcommon_v1_queue_enums_resolution_strategy_proto_depIdxs = nil
}
