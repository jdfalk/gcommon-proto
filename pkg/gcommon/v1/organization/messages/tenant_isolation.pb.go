...
type TenantIsolation struct {
	...
	xxx_hidden_Level         enums.OrganizationIsolationLevel `protobuf:"varint,2,opt,name=level,enum=gcommon.v1.organization.OrganizationIsolationLevel"`
...
func (x *TenantIsolation) Reset() {
	*x = TenantIsolation{}
	mi := &file_gcommon_v1_organization_messages_tenant_isolation_proto_msgTypes[0]
...
func (x *TenantIsolation) GetLevel() enums.OrganizationIsolationLevel {
	if x != nil {
...
func (x *TenantIsolation) SetLevel(v enums.OrganizationIsolationLevel) {
...
func (x *TenantIsolation) ClearLevel() {
	...
	x.xxx_hidden_Level = enums.OrganizationIsolationLevel_ISOLATION_LEVEL_UNSPECIFIED
}
...
type TenantIsolation_builder struct {
	...
	Level *enums.OrganizationIsolationLevel
...
var File_gcommon_v1_organization_messages_tenant_isolation_proto protoreflect.FileDescriptor

const file_gcommon_v1_organization_messages_tenant_isolation_proto_rawDesc = "" +
	"\n" +
	"7gcommon/v1/organization/messages/tenant_isolation.proto\x12\x17gcommon.v1.organization\x1a*gcommon/v1/common/messages/key_value.proto\x1a3gcommon/v1/organization/enums/isolation_level.proto\x1a5gcommon/v1/organization/messages/access_control.proto\x1a3gcommon/v1/organization/messages/audit_config.proto\x1a8gcommon/v1/organization/messages/compute_isolation.proto\x1a9gcommon/v1/organization/messages/database_isolation.proto\x1a8gcommon/v1/organization/messages/encryption_config.proto\x1a8gcommon/v1/organization/messages/network_isolation.proto\x1a8gcommon/v1/organization/messages/storage_isolation.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xde\x06\n" +
	...
	"\rconfigured_by\x18\r \x01(\tR\fconfiguredByB\xf9\x01\n" +
	"\x1bcom.gcommon.v1.organizationB\x14TenantIsolationProtoP\x01Z>github.com/jdfalk/gcommon/pkg/gcommon/v1/organization/messages\xa2\x02\x03GVO\xaa\x02\x17Gcommon.V1.Organization\xca\x02\x17Gcommon\\V1\\Organization\xe2\x02#Gcommon\\V1\\Organization\\GPBMetadata\xea\x02\x19Gcommon::V1::Organization\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
var file_gcommon_v1_organization_messages_tenant_isolation_proto_goTypes = []any{
	...
	(enums.OrganizationIsolationLevel)(0), // 1: gcommon.v1.organization.OrganizationIsolationLevel
...
func init() { file_gcommon_v1_organization_messages_tenant_isolation_proto_init() }
func file_gcommon_v1_organization_messages_tenant_isolation_proto_init() {
	if File_gcommon_v1_organization_messages_tenant_isolation_proto != nil {
		return
	}
	file_gcommon_v1_organization_messages_access_control_proto_init()
	file_gcommon_v1_organization_messages_audit_config_proto_init()
	file_gcommon_v1_organization_messages_compute_isolation_proto_init()
	file_gcommon_v1_organization_messages_database_isolation_proto_init()
	file_gcommon_v1_organization_messages_encryption_config_proto_init()
	file_gcommon_v1_organization_messages_network_isolation_proto_init()
	file_gcommon_v1_organization_messages_storage_isolation_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_organization_messages_tenant_isolation_proto_rawDesc), len(file_gcommon_v1_organization_messages_tenant_isolation_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_organization_messages_tenant_isolation_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_organization_messages_tenant_isolation_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_organization_messages_tenant_isolation_proto_msgTypes,
	}.Build()
	File_gcommon_v1_organization_messages_tenant_isolation_proto = out.File
	file_gcommon_v1_organization_messages_tenant_isolation_proto_goTypes = nil
	file_gcommon_v1_organization_messages_tenant_isolation_proto_depIdxs = nil
}
