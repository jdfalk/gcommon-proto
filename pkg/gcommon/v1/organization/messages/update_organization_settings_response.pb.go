...
// 	protoc        (unknown)
// source: gcommon/v1/organization/messages/update_organization_settings_response.proto
...
func (x *UpdateOrganizationSettingsResponse) Reset() {
	*x = UpdateOrganizationSettingsResponse{}
	mi := &file_gcommon_v1_organization_messages_update_organization_settings_response_proto_msgTypes[0]
...
func (x *UpdateOrganizationSettingsResponse) GetErrors() []*messages.Error {
	if x != nil {
...
func (x *UpdateOrganizationSettingsResponse) SetErrors(v []*messages.Error) {
...
var File_gcommon_v1_organization_messages_update_organization_settings_response_proto protoreflect.FileDescriptor

const file_gcommon_v1_organization_messages_update_organization_settings_response_proto_rawDesc = "" +
	"\n" +
	...
	"\bsettings\x18\x03 \x01(\v2-.gcommon.v1.organization.OrganizationSettingsB\x02(\x01R\bsettingsB\x8c\x02\n" +
...
var file_gcommon_v1_organization_messages_update_organization_settings_response_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_organization_messages_update_organization_settings_response_proto_goTypes = []any{
...
var file_gcommon_v1_organization_messages_update_organization_settings_response_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_organization_messages_update_organization_settings_response_proto_init() }
func file_gcommon_v1_organization_messages_update_organization_settings_response_proto_init() {
	if File_gcommon_v1_organization_messages_update_organization_settings_response_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_organization_messages_update_organization_settings_response_proto_rawDesc), len(file_gcommon_v1_organization_messages_update_organization_settings_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_organization_messages_update_organization_settings_response_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_organization_messages_update_organization_settings_response_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_organization_messages_update_organization_settings_response_proto_msgTypes,
	}.Build()
	File_gcommon_v1_organization_messages_update_organization_settings_response_proto = out.File
	file_gcommon_v1_organization_messages_update_organization_settings_response_proto_goTypes = nil
	file_gcommon_v1_organization_messages_update_organization_settings_response_proto_depIdxs = nil
}
