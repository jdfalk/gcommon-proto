...
func (x *NetworkIsolation) Reset() {
	*x = NetworkIsolation{}
	mi := &file_gcommon_v1_organization_messages_network_isolation_proto_msgTypes[0]
...
var File_gcommon_v1_organization_messages_network_isolation_proto protoreflect.FileDescriptor

const file_gcommon_v1_organization_messages_network_isolation_proto_rawDesc = "" +
	"\n" +
	"8gcommon/v1/organization/messages/network_isolation.proto\x12\x17gcommon.v1.organization\x1a1gcommon/v1/organization/messages/cdn_config.proto\x1a4gcommon/v1/organization/messages/domain_config.proto\x1a;gcommon/v1/organization/messages/load_balancer_config.proto\x1a7gcommon/v1/organization/messages/network_acl_rule.proto\x1a!google/protobuf/go_features.proto\"\xba\x03\n" +
...
var file_gcommon_v1_organization_messages_network_isolation_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_organization_messages_network_isolation_proto_init() }
func file_gcommon_v1_organization_messages_network_isolation_proto_init() {
	if File_gcommon_v1_organization_messages_network_isolation_proto != nil {
		return
	}
	file_gcommon_v1_organization_messages_cdn_config_proto_init()
	file_gcommon_v1_organization_messages_domain_config_proto_init()
	file_gcommon_v1_organization_messages_load_balancer_config_proto_init()
	file_gcommon_v1_organization_messages_network_acl_rule_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_organization_messages_network_isolation_proto_rawDesc), len(file_gcommon_v1_organization_messages_network_isolation_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_organization_messages_network_isolation_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_organization_messages_network_isolation_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_organization_messages_network_isolation_proto_msgTypes,
	}.Build()
	File_gcommon_v1_organization_messages_network_isolation_proto = out.File
	file_gcommon_v1_organization_messages_network_isolation_proto_goTypes = nil
	file_gcommon_v1_organization_messages_network_isolation_proto_depIdxs = nil
}
