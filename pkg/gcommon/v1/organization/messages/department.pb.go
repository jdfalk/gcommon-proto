...
func (x *Department) GetMetadata() []*messages.KeyValue {
	if x != nil {
...
func (x *Department) SetMetadata(v []*messages.KeyValue) {
...
const file_gcommon_v1_organization_messages_department_proto_rawDesc = "" +
	...
	"\bteam_ids\x18\x16 \x03(\tR\ateamIdsB\xf4\x01\n" +
	"\x1bcom.gcommon.v1.organizationB\x0fDepartmentProtoP\x01Z>github.com/jdfalk/gcommon/pkg/gcommon/v1/organization/messages\xa2\x02\x03GVO\xaa\x02\x17Gcommon.V1.Organization\xca\x02\x17Gcommon\\V1\\Organization\xe2\x02#Gcommon\\V1\\Organization\\GPBMetadata\xea\x02\x19Gcommon::V1::Organization\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
