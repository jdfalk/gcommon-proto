...
func (x *StorageEncryption) Reset() {
	*x = StorageEncryption{}
	mi := &file_gcommon_v1_organization_messages_storage_encryption_proto_msgTypes[0]
...
var File_gcommon_v1_organization_messages_storage_encryption_proto protoreflect.FileDescriptor

const file_gcommon_v1_organization_messages_storage_encryption_proto_rawDesc = "" +
	"\n" +
...
var file_gcommon_v1_organization_messages_storage_encryption_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_organization_messages_storage_encryption_proto_init() }
func file_gcommon_v1_organization_messages_storage_encryption_proto_init() {
	if File_gcommon_v1_organization_messages_storage_encryption_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_organization_messages_storage_encryption_proto_rawDesc), len(file_gcommon_v1_organization_messages_storage_encryption_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_organization_messages_storage_encryption_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_organization_messages_storage_encryption_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_organization_messages_storage_encryption_proto_msgTypes,
	}.Build()
	File_gcommon_v1_organization_messages_storage_encryption_proto = out.File
	file_gcommon_v1_organization_messages_storage_encryption_proto_goTypes = nil
	file_gcommon_v1_organization_messages_storage_encryption_proto_depIdxs = nil
}
