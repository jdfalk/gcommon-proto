...
// 	protoc        (unknown)
// source: gcommon/v1/organization/messages/network_acl_rule.proto
...
func (x *NetworkACLRule) Reset() {
	*x = NetworkACLRule{}
	mi := &file_gcommon_v1_organization_messages_network_acl_rule_proto_msgTypes[0]
...
var File_gcommon_v1_organization_messages_network_acl_rule_proto protoreflect.FileDescriptor

const file_gcommon_v1_organization_messages_network_acl_rule_proto_rawDesc = "" +
	"\n" +
	...
	"\bpriority\x18\x06 \x01(\x05R\bpriorityB\xf8\x01\n" +
...
var file_gcommon_v1_organization_messages_network_acl_rule_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_organization_messages_network_acl_rule_proto_init() }
func file_gcommon_v1_organization_messages_network_acl_rule_proto_init() {
	if File_gcommon_v1_organization_messages_network_acl_rule_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_organization_messages_network_acl_rule_proto_rawDesc), len(file_gcommon_v1_organization_messages_network_acl_rule_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_organization_messages_network_acl_rule_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_organization_messages_network_acl_rule_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_organization_messages_network_acl_rule_proto_msgTypes,
	}.Build()
	File_gcommon_v1_organization_messages_network_acl_rule_proto = out.File
	file_gcommon_v1_organization_messages_network_acl_rule_proto_goTypes = nil
	file_gcommon_v1_organization_messages_network_acl_rule_proto_depIdxs = nil
}
