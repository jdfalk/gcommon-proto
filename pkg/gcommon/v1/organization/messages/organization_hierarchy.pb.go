...
func (x *OrganizationHierarchy) Reset() {
	*x = OrganizationHierarchy{}
	mi := &file_gcommon_v1_organization_messages_organization_hierarchy_proto_msgTypes[0]
...
var File_gcommon_v1_organization_messages_organization_hierarchy_proto protoreflect.FileDescriptor

const file_gcommon_v1_organization_messages_organization_hierarchy_proto_rawDesc = "" +
	"\n" +
	"=gcommon/v1/organization/messages/organization_hierarchy.proto\x12\x17gcommon.v1.organization\x1a*gcommon/v1/common/messages/key_value.proto\x1a2gcommon/v1/organization/enums/hierarchy_type.proto\x1a5gcommon/v1/organization/messages/hierarchy_node.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xab\x04\n" +
	...
	"\n" +
	"updated_by\x18\f \x01(\tR\tupdatedByB\xff\x01\n" +
...
func init() { file_gcommon_v1_organization_messages_organization_hierarchy_proto_init() }
func file_gcommon_v1_organization_messages_organization_hierarchy_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_organization_messages_organization_hierarchy_proto_rawDesc), len(file_gcommon_v1_organization_messages_organization_hierarchy_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_organization_messages_organization_hierarchy_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_organization_messages_organization_hierarchy_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_organization_messages_organization_hierarchy_proto_msgTypes,
	}.Build()
	File_gcommon_v1_organization_messages_organization_hierarchy_proto = out.File
	file_gcommon_v1_organization_messages_organization_hierarchy_proto_goTypes = nil
	file_gcommon_v1_organization_messages_organization_hierarchy_proto_depIdxs = nil
}
