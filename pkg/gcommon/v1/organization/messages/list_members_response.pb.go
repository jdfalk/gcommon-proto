...
func (x *ListMembersResponse) Reset() {
	*x = ListMembersResponse{}
	mi := &file_gcommon_v1_organization_messages_list_members_response_proto_msgTypes[0]
...
func (x *ListMembersResponse) GetErrors() []*messages.Error {
	if x != nil {
...
func (x *ListMembersResponse) GetPagination() *messages.PaginatedResponse {
	if x != nil {
...
func (x *ListMembersResponse) SetErrors(v []*messages.Error) {
...
func (x *ListMembersResponse) SetPagination(v *messages.PaginatedResponse) {
...
var File_gcommon_v1_organization_messages_list_members_response_proto protoreflect.FileDescriptor

const file_gcommon_v1_organization_messages_list_members_response_proto_rawDesc = "" +
	"\n" +
	"<gcommon/v1/organization/messages/list_members_response.proto\x12\x17gcommon.v1.organization\x1a&gcommon/v1/common/messages/error.proto\x1a3gcommon/v1/common/messages/paginated_response.proto\x1a:gcommon/v1/organization/messages/organization_member.proto\x1a!google/protobuf/go_features.proto\"\xf2\x01\n" +
	...
	"paginationB\xfd\x01\n" +
	"\x1bcom.gcommon.v1.organizationB\x18ListMembersResponseProtoP\x01Z>github.com/jdfalk/gcommon/pkg/gcommon/v1/organization/messages\xa2\x02\x03GVO\xaa\x02\x17Gcommon.V1.Organization\xca\x02\x17Gcommon\\V1\\Organization\xe2\x02#Gcommon\\V1\\Organization\\GPBMetadata\xea\x02\x19Gcommon::V1::Organization\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
var file_gcommon_v1_organization_messages_list_members_response_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_organization_messages_list_members_response_proto_init() }
func file_gcommon_v1_organization_messages_list_members_response_proto_init() {
	if File_gcommon_v1_organization_messages_list_members_response_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_organization_messages_list_members_response_proto_rawDesc), len(file_gcommon_v1_organization_messages_list_members_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_organization_messages_list_members_response_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_organization_messages_list_members_response_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_organization_messages_list_members_response_proto_msgTypes,
	}.Build()
	File_gcommon_v1_organization_messages_list_members_response_proto = out.File
	file_gcommon_v1_organization_messages_list_members_response_proto_goTypes = nil
	file_gcommon_v1_organization_messages_list_members_response_proto_depIdxs = nil
}
