...
func (x *CacheBehavior) Reset() {
	*x = CacheBehavior{}
	mi := &file_gcommon_v1_organization_messages_cache_behavior_proto_msgTypes[0]
...
var File_gcommon_v1_organization_messages_cache_behavior_proto protoreflect.FileDescriptor

const file_gcommon_v1_organization_messages_cache_behavior_proto_rawDesc = "" +
	"\n" +
	"5gcommon/v1/organization/messages/cache_behavior.proto\x12\x17gcommon.v1.organization\x1a7gcommon/v1/organization/messages/cache_key_policy.proto\x1a!google/protobuf/go_features.proto\"\xde\x01\n" +
	"\rCacheBehavior\x12!\n" +
	...
	"\tcache_key\x18\x05 \x01(\v2'.gcommon.v1.organization.CacheKeyPolicyR\bcacheKeyB\xf7\x01\n" +
	"\x1bcom.gcommon.v1.organizationB\x12CacheBehaviorProtoP\x01Z>github.com/jdfalk/gcommon/pkg/gcommon/v1/organization/messages\xa2\x02\x03GVO\xaa\x02\x17Gcommon.V1.Organization\xca\x02\x17Gcommon\\V1\\Organization\xe2\x02#Gcommon\\V1\\Organization\\GPBMetadata\xea\x02\x19Gcommon::V1::Organization\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
var file_gcommon_v1_organization_messages_cache_behavior_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_organization_messages_cache_behavior_proto_init() }
func file_gcommon_v1_organization_messages_cache_behavior_proto_init() {
	if File_gcommon_v1_organization_messages_cache_behavior_proto != nil {
		return
	}
	file_gcommon_v1_organization_messages_cache_key_policy_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_organization_messages_cache_behavior_proto_rawDesc), len(file_gcommon_v1_organization_messages_cache_behavior_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_organization_messages_cache_behavior_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_organization_messages_cache_behavior_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_organization_messages_cache_behavior_proto_msgTypes,
	}.Build()
	File_gcommon_v1_organization_messages_cache_behavior_proto = out.File
	file_gcommon_v1_organization_messages_cache_behavior_proto_goTypes = nil
	file_gcommon_v1_organization_messages_cache_behavior_proto_depIdxs = nil
}
