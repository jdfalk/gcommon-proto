...
func (x *Organization) Reset() {
	*x = Organization{}
	mi := &file_gcommon_v1_organization_messages_organization_proto_msgTypes[0]
...
var File_gcommon_v1_organization_messages_organization_proto protoreflect.FileDescriptor

const file_gcommon_v1_organization_messages_organization_proto_rawDesc = "" +
	"\n" +
	"3gcommon/v1/organization/messages/organization.proto\x12\x17gcommon.v1.organization\x1a*gcommon/v1/common/messages/key_value.proto\x1a7gcommon/v1/organization/enums/organization_status.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x93\x06\n" +
	...
	"\rbilling_email\x18\x16 \x01(\tR\fbillingEmailB\xf6\x01\n" +
...
func init() { file_gcommon_v1_organization_messages_organization_proto_init() }
func file_gcommon_v1_organization_messages_organization_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_organization_messages_organization_proto_rawDesc), len(file_gcommon_v1_organization_messages_organization_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_organization_messages_organization_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_organization_messages_organization_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_organization_messages_organization_proto_msgTypes,
	}.Build()
	File_gcommon_v1_organization_messages_organization_proto = out.File
	file_gcommon_v1_organization_messages_organization_proto_goTypes = nil
	file_gcommon_v1_organization_messages_organization_proto_depIdxs = nil
}
