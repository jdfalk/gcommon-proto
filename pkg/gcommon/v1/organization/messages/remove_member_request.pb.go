...
// 	protoc        (unknown)
// source: gcommon/v1/organization/messages/remove_member_request.proto
...
func (x *RemoveMemberRequest) Reset() {
	*x = RemoveMemberRequest{}
	mi := &file_gcommon_v1_organization_messages_remove_member_request_proto_msgTypes[0]
...
var File_gcommon_v1_organization_messages_remove_member_request_proto protoreflect.FileDescriptor

const file_gcommon_v1_organization_messages_remove_member_request_proto_rawDesc = "" +
	"\n" +
	"<gcommon/v1/organization/messages/remove_member_request.proto\x12\x17gcommon.v1.organization\x1a1gcommon/v1/common/messages/request_metadata.proto\x1a!google/protobuf/go_features.proto\"\x9b\x01\n" +
	...
	"\tmember_id\x18\x03 \x01(\tR\bmemberIdB\xfd\x01\n" +
	"\x1bcom.gcommon.v1.organizationB\x18RemoveMemberRequestProtoP\x01Z>github.com/jdfalk/gcommon/pkg/gcommon/v1/organization/messages\xa2\x02\x03GVO\xaa\x02\x17Gcommon.V1.Organization\xca\x02\x17Gcommon\\V1\\Organization\xe2\x02#Gcommon\\V1\\Organization\\GPBMetadata\xea\x02\x19Gcommon::V1::Organization\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
func init() { file_gcommon_v1_organization_messages_remove_member_request_proto_init() }
func file_gcommon_v1_organization_messages_remove_member_request_proto_init() {
	if File_gcommon_v1_organization_messages_remove_member_request_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_organization_messages_remove_member_request_proto_rawDesc), len(file_gcommon_v1_organization_messages_remove_member_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_organization_messages_remove_member_request_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_organization_messages_remove_member_request_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_organization_messages_remove_member_request_proto_msgTypes,
	}.Build()
	File_gcommon_v1_organization_messages_remove_member_request_proto = out.File
	file_gcommon_v1_organization_messages_remove_member_request_proto_goTypes = nil
	file_gcommon_v1_organization_messages_remove_member_request_proto_depIdxs = nil
}
