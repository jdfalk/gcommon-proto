...
// 	protoc        (unknown)
// source: gcommon/v1/config/messages/approval_info.proto
...
type ApprovalInfo struct {
	...
	xxx_hidden_Status      enums.ApprovalStatus   `protobuf:"varint,2,opt,name=status,enum=gcommon.v1.config.ApprovalStatus"`
...
func (x *ApprovalInfo) Reset() {
	*x = ApprovalInfo{}
	mi := &file_gcommon_v1_config_messages_approval_info_proto_msgTypes[0]
...
func (x *ApprovalInfo) GetStatus() enums.ApprovalStatus {
	if x != nil {
...
func (x *ApprovalInfo) SetStatus(v enums.ApprovalStatus) {
...
func (x *ApprovalInfo) ClearStatus() {
	...
	x.xxx_hidden_Status = enums.ApprovalStatus_APPROVAL_STATUS_UNSPECIFIED
}
...
var File_gcommon_v1_config_messages_approval_info_proto protoreflect.FileDescriptor

const file_gcommon_v1_config_messages_approval_info_proto_rawDesc = "" +
	"\n" +
	".gcommon/v1/config/messages/approval_info.proto\x12\x11gcommon.v1.config\x1a-gcommon/v1/config/enums/approval_status.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xa1\x02\n" +
	...
	"policyNameB\xd2\x01\n" +
	"\x15com.gcommon.v1.configB\x11ApprovalInfoProtoP\x01Z8github.com/jdfalk/gcommon/pkg/gcommon/v1/config/messages\xa2\x02\x03GVC\xaa\x02\x11Gcommon.V1.Config\xca\x02\x11Gcommon\\V1\\Config\xe2\x02\x1dGcommon\\V1\\Config\\GPBMetadata\xea\x02\x13Gcommon::V1::Config\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_gcommon_v1_config_messages_approval_info_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gcommon_v1_config_messages_approval_info_proto_goTypes = []any{
	(*ApprovalInfo)(nil),          // 0: gcommon.v1.config.ApprovalInfo
	(enums.ApprovalStatus)(0),     // 1: gcommon.v1.config.ApprovalStatus
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
}
var file_gcommon_v1_config_messages_approval_info_proto_depIdxs = []int32{
...
func init() { file_gcommon_v1_config_messages_approval_info_proto_init() }
func file_gcommon_v1_config_messages_approval_info_proto_init() {
	if File_gcommon_v1_config_messages_approval_info_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_config_messages_approval_info_proto_rawDesc), len(file_gcommon_v1_config_messages_approval_info_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_config_messages_approval_info_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_config_messages_approval_info_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_config_messages_approval_info_proto_msgTypes,
	}.Build()
	File_gcommon_v1_config_messages_approval_info_proto = out.File
	file_gcommon_v1_config_messages_approval_info_proto_goTypes = nil
	file_gcommon_v1_config_messages_approval_info_proto_depIdxs = nil
}
