...
func (x *HealthCheck) Reset() {
	*x = HealthCheck{}
	mi := &file_gcommon_v1_config_messages_health_check_proto_msgTypes[0]
...
var File_gcommon_v1_config_messages_health_check_proto protoreflect.FileDescriptor

const file_gcommon_v1_config_messages_health_check_proto_rawDesc = "" +
	"\n" +
	"-gcommon/v1/config/messages/health_check.proto\x12\x11gcommon.v1.config\x1a/gcommon/v1/config/enums/health_check_type.proto\x1a!google/protobuf/go_features.proto\"\x83\x02\n" +
	...
	"conditionsB\xd1\x01\n" +
	"\x15com.gcommon.v1.configB\x10HealthCheckProtoP\x01Z8github.com/jdfalk/gcommon/pkg/gcommon/v1/config/messages\xa2\x02\x03GVC\xaa\x02\x11Gcommon.V1.Config\xca\x02\x11Gcommon\\V1\\Config\xe2\x02\x1dGcommon\\V1\\Config\\GPBMetadata\xea\x02\x13Gcommon::V1::Config\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
func init() { file_gcommon_v1_config_messages_health_check_proto_init() }
func file_gcommon_v1_config_messages_health_check_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_config_messages_health_check_proto_rawDesc), len(file_gcommon_v1_config_messages_health_check_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcommon_v1_config_messages_health_check_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_config_messages_health_check_proto_depIdxs,
		MessageInfos:      file_gcommon_v1_config_messages_health_check_proto_msgTypes,
	}.Build()
	File_gcommon_v1_config_messages_health_check_proto = out.File
	file_gcommon_v1_config_messages_health_check_proto_goTypes = nil
	file_gcommon_v1_config_messages_health_check_proto_depIdxs = nil
}
