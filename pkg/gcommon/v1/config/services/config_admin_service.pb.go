...
var File_gcommon_v1_config_services_config_admin_service_proto protoreflect.FileDescriptor

const file_gcommon_v1_config_services_config_admin_service_proto_rawDesc = "" +
	"\n" +
	"5gcommon/v1/config/services/config_admin_service.proto\x12\x11gcommon.v1.config\x1a6gcommon/v1/config/messages/backup_config_request.proto\x1a.gcommon/v1/config/messages/config_backup.proto\x1a0gcommon/v1/config/messages/config_snapshot.proto\x1a6gcommon/v1/config/messages/export_config_request.proto\x1a;gcommon/v1/config/messages/get_config_history_request.proto\x1a<gcommon/v1/config/messages/get_config_history_response.proto\x1a9gcommon/v1/config/messages/get_config_stats_request.proto\x1a:gcommon/v1/config/messages/get_config_stats_response.proto\x1a5gcommon/v1/config/messages/health_check_request.proto\x1a6gcommon/v1/config/messages/health_check_response.proto\x1a6gcommon/v1/config/messages/import_config_request.proto\x1a6gcommon/v1/config/messages/reload_config_request.proto\x1a7gcommon/v1/config/messages/restore_config_request.proto\x1a8gcommon/v1/config/messages/rollback_config_request.proto\x1a:gcommon/v1/config/messages/set_config_schema_request.proto\x1a7gcommon/v1/config/messages/unwatch_config_request.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a!google/protobuf/go_features.proto2\xf4\a\n" +
...
func init() { file_gcommon_v1_config_services_config_admin_service_proto_init() }
func file_gcommon_v1_config_services_config_admin_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gcommon_v1_config_services_config_admin_service_proto_rawDesc), len(file_gcommon_v1_config_services_config_admin_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_gcommon_v1_config_services_config_admin_service_proto_goTypes,
		DependencyIndexes: file_gcommon_v1_config_services_config_admin_service_proto_depIdxs,
	}.Build()
	File_gcommon_v1_config_services_config_admin_service_proto = out.File
	file_gcommon_v1_config_services_config_admin_service_proto_goTypes = nil
	file_gcommon_v1_config_services_config_admin_service_proto_depIdxs = nil
}
