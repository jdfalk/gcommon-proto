...
const file_pkg_db_proto_result_set_proto_rawDesc = "" +
	"\n" +
	"\x1dpkg/db/proto/result_set.proto\x12\x13gcommon.v1.database\x1a!google/protobuf/go_features.proto\x1a\"pkg/db/proto/column_metadata.proto\x1a\x16pkg/db/proto/row.proto\"\xbc\x01\n" +
	"\tResultSet\x12A\n" +
	...
	"totalCount\x12\x19\n" +
	"\bhas_more\x18\x04 \x01(\bR\ahasMoreB\xc7\x01\n" +
	"\x17com.gcommon.v1.databaseB\x0eResultSetProtoP\x01Z&github.com/jdfalk/gcommon/pkg/db/proto\xa2\x02\x03GVD\xaa\x02\x13Gcommon.V1.Database\xca\x02\x13Gcommon\\V1\\Database\xe2\x02\x1fGcommon\\V1\\Database\\GPBMetadata\xea\x02\x15Gcommon::V1::Database\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
