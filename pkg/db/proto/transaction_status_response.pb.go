...
const file_pkg_db_proto_transaction_status_response_proto_rawDesc = "" +
	"\n" +
	".pkg/db/proto/transaction_status_response.proto\x12\x13gcommon.v1.database\x1a!google/protobuf/go_features.proto\x1a\x1cpkg/common/proto/error.proto\"g\n" +
	"\x19TransactionStatusResponse\x12\x16\n" +
	"\x06status\x18\x01 \x01(\tR\x06status\x122\n" +
	"\x05error\x18\x02 \x01(\v2\x18.gcommon.v1.common.ErrorB\x02(\x01R\x05errorB\xd7\x01\n" +
