...
// 	protoc        (unknown)
// source: pkg/db/proto/responses/create_schema_response.proto
...
func (x *CreateSchemaResponse) Reset() {
	*x = CreateSchemaResponse{}
	mi := &file_pkg_db_proto_responses_create_schema_response_proto_msgTypes[0]
...
var File_pkg_db_proto_responses_create_schema_response_proto protoreflect.FileDescriptor

const file_pkg_db_proto_responses_create_schema_response_proto_rawDesc = "" +
	"\n" +
	...
	"\x05error\x18\x02 \x01(\v2\x18.gcommon.v1.common.ErrorB\x02(\x01R\x05errorB\xdc\x01\n" +
	"\x17com.gcommon.v1.databaseB\x19CreateSchemaResponseProtoP\x01Z0github.com/jdfalk/gcommon/pkg/db/proto/responses\xa2\x02\x03GVD\xaa\x02\x13Gcommon.V1.Database\xca\x02\x13Gcommon\\V1\\Database\xe2\x02\x1fGcommon\\V1\\Database\\GPBMetadata\xea\x02\x15Gcommon::V1::Database\x92\x03\x05\xd2>\x02\x10\x02b\beditionsp\xe8\a"
...
func init() { file_pkg_db_proto_responses_create_schema_response_proto_init() }
func file_pkg_db_proto_responses_create_schema_response_proto_init() {
	if File_pkg_db_proto_responses_create_schema_response_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_db_proto_responses_create_schema_response_proto_rawDesc), len(file_pkg_db_proto_responses_create_schema_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_db_proto_responses_create_schema_response_proto_goTypes,
		DependencyIndexes: file_pkg_db_proto_responses_create_schema_response_proto_depIdxs,
		MessageInfos:      file_pkg_db_proto_responses_create_schema_response_proto_msgTypes,
	}.Build()
	File_pkg_db_proto_responses_create_schema_response_proto = out.File
	file_pkg_db_proto_responses_create_schema_response_proto_goTypes = nil
	file_pkg_db_proto_responses_create_schema_response_proto_depIdxs = nil
}
