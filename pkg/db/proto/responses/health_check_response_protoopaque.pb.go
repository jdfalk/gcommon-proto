...
// 	protoc        (unknown)
// source: pkg/db/proto/responses/health_check_response.proto
...
func (x *HealthCheckResponse) Reset() {
	*x = HealthCheckResponse{}
	mi := &file_pkg_db_proto_responses_health_check_response_proto_msgTypes[0]
...
var File_pkg_db_proto_responses_health_check_response_proto protoreflect.FileDescriptor

const file_pkg_db_proto_responses_health_check_response_proto_rawDesc = "" +
	"\n" +
	"2pkg/db/proto/responses/health_check_response.proto\x12\x13gcommon.v1.database\x1a*pkg/common/proto/enums/health_status.proto\x1a%pkg/common/proto/messages/error.proto\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\"\xeb\x01\n" +
	...
	"\x05error\x18\x04 \x01(\v2\x18.gcommon.v1.common.ErrorB\x02(\x01R\x05errorB\xc8\x01\n" +
	"\x17com.gcommon.v1.databaseB\x18HealthCheckResponseProtoP\x01Z\x1d../../../../pkg/db/proto;dbpb\xa2\x02\x03GVD\xaa\x02\x13Gcommon.V1.Database\xca\x02\x13Gcommon\\V1\\Database\xe2\x02\x1fGcommon\\V1\\Database\\GPBMetadata\xea\x02\x15Gcommon::V1::Database\x92\x03\x05\xd2>\x02\x10\x02b\beditionsp\xe8\a"
...
func init() { file_pkg_db_proto_responses_health_check_response_proto_init() }
func file_pkg_db_proto_responses_health_check_response_proto_init() {
	if File_pkg_db_proto_responses_health_check_response_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_db_proto_responses_health_check_response_proto_rawDesc), len(file_pkg_db_proto_responses_health_check_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_db_proto_responses_health_check_response_proto_goTypes,
		DependencyIndexes: file_pkg_db_proto_responses_health_check_response_proto_depIdxs,
		MessageInfos:      file_pkg_db_proto_responses_health_check_response_proto_msgTypes,
	}.Build()
	File_pkg_db_proto_responses_health_check_response_proto = out.File
	file_pkg_db_proto_responses_health_check_response_proto_goTypes = nil
	file_pkg_db_proto_responses_health_check_response_proto_depIdxs = nil
}
