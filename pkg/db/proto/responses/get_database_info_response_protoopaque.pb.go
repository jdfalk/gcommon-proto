...
// 	protoc        (unknown)
// source: pkg/db/proto/responses/get_database_info_response.proto
...
type GetDatabaseInfoResponse struct {
	...
	xxx_hidden_Info *messages.DatabaseInfo `protobuf:"bytes,1,opt,name=info"`
...
func (x *GetDatabaseInfoResponse) Reset() {
	*x = GetDatabaseInfoResponse{}
	mi := &file_pkg_db_proto_responses_get_database_info_response_proto_msgTypes[0]
...
func (x *GetDatabaseInfoResponse) ClearInfo() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 0)
	protoimpl.X.AtomicSetPointer(&x.xxx_hidden_Info, (*messages.DatabaseInfo)(nil))
}
...
var File_pkg_db_proto_responses_get_database_info_response_proto protoreflect.FileDescriptor

const file_pkg_db_proto_responses_get_database_info_response_proto_rawDesc = "" +
	"\n" +
...
func init() { file_pkg_db_proto_responses_get_database_info_response_proto_init() }
func file_pkg_db_proto_responses_get_database_info_response_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_db_proto_responses_get_database_info_response_proto_rawDesc), len(file_pkg_db_proto_responses_get_database_info_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_db_proto_responses_get_database_info_response_proto_goTypes,
		DependencyIndexes: file_pkg_db_proto_responses_get_database_info_response_proto_depIdxs,
		MessageInfos:      file_pkg_db_proto_responses_get_database_info_response_proto_msgTypes,
	}.Build()
	File_pkg_db_proto_responses_get_database_info_response_proto = out.File
	file_pkg_db_proto_responses_get_database_info_response_proto_goTypes = nil
	file_pkg_db_proto_responses_get_database_info_response_proto_depIdxs = nil
}
