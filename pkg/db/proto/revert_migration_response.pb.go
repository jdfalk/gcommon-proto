...
const file_pkg_db_proto_revert_migration_response_proto_rawDesc = "" +
	"\n" +
	",pkg/db/proto/revert_migration_response.proto\x12\x13gcommon.v1.database\x1a!google/protobuf/go_features.proto\x1a\x1cpkg/common/proto/error.proto\"\x88\x01\n" +
