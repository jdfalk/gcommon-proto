...
func (x *ExecuteRequest) SetMetadata(v *proto.RequestMetadata) {
...
const file_pkg_db_proto_execute_request_proto_rawDesc = "" +
	"\n" +
	"\"pkg/db/proto/execute_request.proto\x12\x13gcommon.v1.database\x1a!google/protobuf/go_features.proto\x1a'pkg/common/proto/request_metadata.proto\x1a\"pkg/db/proto/execute_options.proto\x1a\"pkg/db/proto/query_parameter.proto\"\xc1\x02\n" +
	...
	"\x0etransaction_id\x18\x06 \x01(\tR\rtransactionIdB\xcc\x01\n" +
	"\x17com.gcommon.v1.databaseB\x13ExecuteRequestProtoP\x01Z&github.com/jdfalk/gcommon/pkg/db/proto\xa2\x02\x03GVD\xaa\x02\x13Gcommon.V1.Database\xca\x02\x13Gcommon\\V1\\Database\xe2\x02\x1fGcommon\\V1\\Database\\GPBMetadata\xea\x02\x15Gcommon::V1::Database\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
