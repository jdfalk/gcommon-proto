...
type BeginTransactionRequest struct {
	...
	xxx_hidden_Options  *messages.TransactionOptions `protobuf:"bytes,2,opt,name=options"`
...
func (x *BeginTransactionRequest) GetOptions() *messages.TransactionOptions {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 1) {
			...
			var rv *messages.TransactionOptions
...
func (x *BeginTransactionRequest) ClearOptions() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 1)
	protoimpl.X.AtomicSetPointer(&x.xxx_hidden_Options, (*messages.TransactionOptions)(nil))
}
