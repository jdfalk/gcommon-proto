...
func (x *ConsumerGroupConfig) Reset() {
	*x = ConsumerGroupConfig{}
	mi := &file_pkg_queue_proto_consumer_group_config_proto_msgTypes[0]
...
var File_pkg_queue_proto_consumer_group_config_proto protoreflect.FileDescriptor

const file_pkg_queue_proto_consumer_group_config_proto_rawDesc = "" +
	"\n" +
	...
	"\n" +
	"dlq_config\x18\n" +
	" \x01(\v2'.gcommon.v1.queue.DeadLetterQueueConfigR\tdlqConfigB\xc5\x01\n" +
	"\x14com.gcommon.v1.queueB\x18ConsumerGroupConfigProtoP\x01Z)github.com/jdfalk/gcommon/pkg/queue/proto\xa2\x02\x03GVQ\xaa\x02\x10Gcommon.V1.Queue\xca\x02\x10Gcommon\\V1\\Queue\xe2\x02\x1cGcommon\\V1\\Queue\\GPBMetadata\xea\x02\x12Gcommon::V1::Queue\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_pkg_queue_proto_consumer_group_config_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_pkg_queue_proto_consumer_group_config_proto_goTypes = []any{
...
var file_pkg_queue_proto_consumer_group_config_proto_depIdxs = []int32{
	1, // 0: gcommon.v1.queue.ConsumerGroupConfig.load_balancing_strategy:type_name -> gcommon.v1.queue.LoadBalancingStrategy
	2, // 1: gcommon.v1.queue.ConsumerGroupConfig.rebalance_strategy:type_name -> gcommon.v1.queue.RebalanceStrategy
	3, // 2: gcommon.v1.queue.ConsumerGroupConfig.auto_commit:type_name -> gcommon.v1.queue.AutoCommitConfig
	4, // 3: gcommon.v1.queue.ConsumerGroupConfig.offset_reset_strategy:type_name -> gcommon.v1.queue.OffsetResetStrategy
...
func init() { file_pkg_queue_proto_consumer_group_config_proto_init() }
func file_pkg_queue_proto_consumer_group_config_proto_init() {
	if File_pkg_queue_proto_consumer_group_config_proto != nil {
		return
	}
	file_pkg_queue_proto_auto_commit_config_proto_init()
	...
	file_pkg_queue_proto_offset_reset_strategy_proto_init()
	file_pkg_queue_proto_rebalance_strategy_proto_init()
	file_pkg_queue_proto_subscribe_request_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_queue_proto_consumer_group_config_proto_rawDesc), len(file_pkg_queue_proto_consumer_group_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_queue_proto_consumer_group_config_proto_goTypes,
		DependencyIndexes: file_pkg_queue_proto_consumer_group_config_proto_depIdxs,
		MessageInfos:      file_pkg_queue_proto_consumer_group_config_proto_msgTypes,
	}.Build()
	File_pkg_queue_proto_consumer_group_config_proto = out.File
	file_pkg_queue_proto_consumer_group_config_proto_goTypes = nil
	file_pkg_queue_proto_consumer_group_config_proto_depIdxs = nil
}
