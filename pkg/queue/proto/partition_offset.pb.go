...
type PartitionOffset struct {
	...
	// Offset timestamp
	OffsetTimestamp *timestamppb.Timestamp `protobuf:"bytes,3,opt,name=offset_timestamp,json=offsetTimestamp" json:"offset_timestamp,omitempty"`
	// High water mark for this partition
	HighWaterMark *int64 `protobuf:"varint,4,opt,name=high_water_mark,json=highWaterMark" json:"high_water_mark,omitempty"`
...
func (*PartitionOffset) Descriptor() ([]byte, []int) {
	return file_pkg_queue_proto_partition_offset_proto_rawDescGZIP(), []int{0}
}
...
const file_pkg_queue_proto_partition_offset_proto_rawDesc = "" +
	"\n" +
	"&pkg/queue/proto/partition_offset.proto\x12\x10gcommon.v1.queue\x1a\x1fgoogle/protobuf/timestamp.proto\"\xbb\x01\n" +
	...
	"\x0fhigh_water_mark\x18\x04 \x01(\x03R\rhighWaterMarkB\xb9\x01\n" +
	"\x14com.gcommon.v1.queueB\x14PartitionOffsetProtoP\x01Z)github.com/jdfalk/gcommon/pkg/queue/proto\xa2\x02\x03GVQ\xaa\x02\x10Gcommon.V1.Queue\xca\x02\x10Gcommon\\V1\\Queue\xe2\x02\x1cGcommon\\V1\\Queue\\GPBMetadata\xea\x02\x12Gcommon::V1::Queueb\beditionsp\xe8\a"

var (
	file_pkg_queue_proto_partition_offset_proto_rawDescOnce sync.Once
	file_pkg_queue_proto_partition_offset_proto_rawDescData []byte
)

func file_pkg_queue_proto_partition_offset_proto_rawDescGZIP() []byte {
	file_pkg_queue_proto_partition_offset_proto_rawDescOnce.Do(func() {
		file_pkg_queue_proto_partition_offset_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_queue_proto_partition_offset_proto_rawDesc), len(file_pkg_queue_proto_partition_offset_proto_rawDesc)))
	})
	return file_pkg_queue_proto_partition_offset_proto_rawDescData
}
