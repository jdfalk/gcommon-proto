...
type ConsistencyConfig struct {
	...
	xxx_hidden_ConflictResolution proto.ConfigConflictResolution `protobuf:"varint,7,opt,name=conflict_resolution,json=conflictResolution,enum=gcommon.v1.config.ConfigConflictResolution"`
...
func (x *ConsistencyConfig) GetConflictResolution() proto.ConfigConflictResolution {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 6) {
			return x.xxx_hidden_ConflictResolution
		}
	}
	return proto.ConfigConflictResolution(0)
}
...
func (x *ConsistencyConfig) SetConflictResolution(v proto.ConfigConflictResolution) {
...
func (x *ConsistencyConfig) ClearConflictResolution() {
	...
	x.xxx_hidden_ConflictResolution = proto.ConfigConflictResolution_CONFLICT_RESOLUTION_UNSPECIFIED
}
...
type ConsistencyConfig_builder struct {
	...
	ConflictResolution *proto.ConfigConflictResolution
...
var file_pkg_queue_proto_consistency_config_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_pkg_queue_proto_consistency_config_proto_goTypes = []any{
	...
	(proto.ConfigConflictResolution)(0), // 7: gcommon.v1.config.ConfigConflictResolution
...
func file_pkg_queue_proto_consistency_config_proto_init() {
	...
	file_pkg_queue_proto_consistency_validation_proto_init()
	file_pkg_queue_proto_durability_level_proto_init()
	file_pkg_queue_proto_ordering_config_proto_init()
	file_pkg_queue_proto_read_consistency_proto_init()
	file_pkg_queue_proto_replication_consistency_proto_init()
	file_pkg_queue_proto_write_consistency_proto_init()
	type x struct{}
