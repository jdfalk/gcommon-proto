...
func (x *BatchPublishRequest) SetMetadata(v *proto.RequestMetadata) {
...
const file_pkg_queue_proto_batch_publish_request_proto_rawDesc = "" +
	"\n" +
	"+pkg/queue/proto/batch_publish_request.proto\x12\x10gcommon.v1.queue\x1a!google/protobuf/go_features.proto\x1a'pkg/common/proto/request_metadata.proto\x1a#pkg/queue/proto/queue_message.proto\"\xd6\x02\n" +
	...
	"maxRetries\x12\x19\n" +
	"\bbatch_id\x18\b \x01(\tR\abatchIdB\xc5\x01\n" +
	"\x14com.gcommon.v1.queueB\x18BatchPublishRequestProtoP\x01Z)github.com/jdfalk/gcommon/pkg/queue/proto\xa2\x02\x03GVQ\xaa\x02\x10Gcommon.V1.Queue\xca\x02\x10Gcommon\\V1\\Queue\xe2\x02\x1cGcommon\\V1\\Queue\\GPBMetadata\xea\x02\x12Gcommon::V1::Queue\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
