...
func (*DequeueRequest) Descriptor() ([]byte, []int) {
	return file_pkg_queue_proto_dequeue_request_proto_rawDescGZIP(), []int{0}
}
...
const file_pkg_queue_proto_dequeue_request_proto_rawDesc = "" +
	"\n" +
	"%pkg/queue/proto/dequeue_request.proto\x12\x10gcommon.v1.queue\x1a\x1egoogle/protobuf/duration.proto\x1a'pkg/common/proto/request_metadata.proto\"\xd1\x05\n" +
	...
	"\x14com.gcommon.v1.queueB\x13DequeueRequestProtoP\x01Z)github.com/jdfalk/gcommon/pkg/queue/proto\xa2\x02\x03GVQ\xaa\x02\x10Gcommon.V1.Queue\xca\x02\x10Gcommon\\V1\\Queue\xe2\x02\x1cGcommon\\V1\\Queue\\GPBMetadata\xea\x02\x12Gcommon::V1::Queueb\beditionsp\xe8\a"

var (
	file_pkg_queue_proto_dequeue_request_proto_rawDescOnce sync.Once
	file_pkg_queue_proto_dequeue_request_proto_rawDescData []byte
)

func file_pkg_queue_proto_dequeue_request_proto_rawDescGZIP() []byte {
	file_pkg_queue_proto_dequeue_request_proto_rawDescOnce.Do(func() {
		file_pkg_queue_proto_dequeue_request_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_queue_proto_dequeue_request_proto_rawDesc), len(file_pkg_queue_proto_dequeue_request_proto_rawDesc)))
	})
	return file_pkg_queue_proto_dequeue_request_proto_rawDescData
}
