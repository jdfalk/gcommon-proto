...
// 	protoc        (unknown)
// source: pkg/queue/proto/restore_options.proto
...
func (x *RestoreOptions) Reset() {
	*x = RestoreOptions{}
	mi := &file_pkg_queue_proto_restore_options_proto_msgTypes[0]
...
func (x *RestoreOptions) GetTimeRange() *proto.MetricsTimeRange {
	if x != nil {
...
func (x *RestoreOptions) SetTimeRange(v *proto.MetricsTimeRange) {
...
var File_pkg_queue_proto_restore_options_proto protoreflect.FileDescriptor

const file_pkg_queue_proto_restore_options_proto_rawDesc = "" +
	"\n" +
	"%pkg/queue/proto/restore_options.proto\x12\x10gcommon.v1.queue\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a!pkg/common/proto/time_range.proto\x1a\"pkg/metrics/proto/time_range.proto\x1a%pkg/queue/proto/filter_criteria.proto\x1a\"pkg/queue/proto/offset_range.proto\x1a)pkg/queue/proto/performance_options.proto\"\xcd\x03\n" +
	...
	"\vperformance\x18\b \x01(\v2$.gcommon.v1.queue.PerformanceOptionsR\vperformanceB\xc0\x01\n" +
	"\x14com.gcommon.v1.queueB\x13RestoreOptionsProtoP\x01Z)github.com/jdfalk/gcommon/pkg/queue/proto\xa2\x02\x03GVQ\xaa\x02\x10Gcommon.V1.Queue\xca\x02\x10Gcommon\\V1\\Queue\xe2\x02\x1cGcommon\\V1\\Queue\\GPBMetadata\xea\x02\x12Gcommon::V1::Queue\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_pkg_queue_proto_restore_options_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_pkg_queue_proto_restore_options_proto_goTypes = []any{
	(*RestoreOptions)(nil),         // 0: gcommon.v1.queue.RestoreOptions
	(*OffsetRange)(nil),            // 1: gcommon.v1.queue.OffsetRange
	(*proto.MetricsTimeRange)(nil), // 2: gcommon.v1.metrics.MetricsTimeRange
	(*FilterCriteria)(nil),         // 3: gcommon.v1.queue.FilterCriteria
	(*PerformanceOptions)(nil),     // 4: gcommon.v1.queue.PerformanceOptions
}
var file_pkg_queue_proto_restore_options_proto_depIdxs = []int32{
...
func init() { file_pkg_queue_proto_restore_options_proto_init() }
func file_pkg_queue_proto_restore_options_proto_init() {
	if File_pkg_queue_proto_restore_options_proto != nil {
		return
	}
	file_pkg_queue_proto_filter_criteria_proto_init()
	file_pkg_queue_proto_offset_range_proto_init()
	file_pkg_queue_proto_performance_options_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_queue_proto_restore_options_proto_rawDesc), len(file_pkg_queue_proto_restore_options_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_queue_proto_restore_options_proto_goTypes,
		DependencyIndexes: file_pkg_queue_proto_restore_options_proto_depIdxs,
		MessageInfos:      file_pkg_queue_proto_restore_options_proto_msgTypes,
	}.Build()
	File_pkg_queue_proto_restore_options_proto = out.File
	file_pkg_queue_proto_restore_options_proto_goTypes = nil
	file_pkg_queue_proto_restore_options_proto_depIdxs = nil
}
