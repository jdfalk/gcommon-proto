...
// 	protoc        (unknown)
// source: pkg/queue/proto/batch_settings.proto
...
func (x *BatchSettings) Reset() {
	*x = BatchSettings{}
	mi := &file_pkg_queue_proto_batch_settings_proto_msgTypes[0]
...
var File_pkg_queue_proto_batch_settings_proto protoreflect.FileDescriptor

const file_pkg_queue_proto_batch_settings_proto_rawDesc = "" +
	"\n" +
	"$pkg/queue/proto/batch_settings.proto\x12\x10gcommon.v1.queue\x1a\x19google/protobuf/any.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xcd\x01\n" +
	...
	"\x11flush_on_complete\x18\x05 \x01(\bR\x0fflushOnCompleteB\xbf\x01\n" +
	"\x14com.gcommon.v1.queueB\x12BatchSettingsProtoP\x01Z)github.com/jdfalk/gcommon/pkg/queue/proto\xa2\x02\x03GVQ\xaa\x02\x10Gcommon.V1.Queue\xca\x02\x10Gcommon\\V1\\Queue\xe2\x02\x1cGcommon\\V1\\Queue\\GPBMetadata\xea\x02\x12Gcommon::V1::Queue\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_pkg_queue_proto_batch_settings_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_pkg_queue_proto_batch_settings_proto_goTypes = []any{
	(*BatchSettings)(nil), // 0: gcommon.v1.queue.BatchSettings
}
var file_pkg_queue_proto_batch_settings_proto_depIdxs = []int32{
...
func init() { file_pkg_queue_proto_batch_settings_proto_init() }
func file_pkg_queue_proto_batch_settings_proto_init() {
	if File_pkg_queue_proto_batch_settings_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_queue_proto_batch_settings_proto_rawDesc), len(file_pkg_queue_proto_batch_settings_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_queue_proto_batch_settings_proto_goTypes,
		DependencyIndexes: file_pkg_queue_proto_batch_settings_proto_depIdxs,
		MessageInfos:      file_pkg_queue_proto_batch_settings_proto_msgTypes,
	}.Build()
	File_pkg_queue_proto_batch_settings_proto = out.File
	file_pkg_queue_proto_batch_settings_proto_goTypes = nil
	file_pkg_queue_proto_batch_settings_proto_depIdxs = nil
}
