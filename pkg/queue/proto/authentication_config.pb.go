...
var file_pkg_queue_proto_authentication_config_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
...
func file_pkg_queue_proto_authentication_config_proto_init() {
	...
	file_pkg_queue_proto_o_auth2_auth_proto_init()
	file_pkg_queue_proto_sasl_auth_proto_init()
	file_pkg_queue_proto_tls_auth_proto_init()
	file_pkg_queue_proto_username_password_auth_proto_init()
