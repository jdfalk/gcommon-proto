...
// 	protoc        (unknown)
// source: pkg/queue/proto/acknowledge_response.proto
...
func (x *MessageAckResult) Reset() {
	*x = MessageAckResult{}
	mi := &file_pkg_queue_proto_acknowledge_response_proto_msgTypes[0]
...
func (x *AcknowledgeResponse) Reset() {
	*x = AcknowledgeResponse{}
	mi := &file_pkg_queue_proto_acknowledge_response_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *AcknowledgeResponse) SetRequestMetadata(v *proto.RequestMetadata) {
...
func (x *AcknowledgeResponse) SetError(v *proto.Error) {
	x.xxx_hidden_Error = v
}
...
var File_pkg_queue_proto_acknowledge_response_proto protoreflect.FileDescriptor

const file_pkg_queue_proto_acknowledge_response_proto_rawDesc = "" +
	"\n" +
	"*pkg/queue/proto/acknowledge_response.proto\x12\x10gcommon.v1.queue\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1cpkg/common/proto/error.proto\x1a'pkg/common/proto/request_metadata.proto\"\xcf\x01\n" +
	...
	"\x14com.gcommon.v1.queueB\x18AcknowledgeResponseProtoP\x01Z)github.com/jdfalk/gcommon/pkg/queue/proto\xa2\x02\x03GVQ\xaa\x02\x10Gcommon.V1.Queue\xca\x02\x10Gcommon\\V1\\Queue\xe2\x02\x1cGcommon\\V1\\Queue\\GPBMetadata\xea\x02\x12Gcommon::V1::Queue\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_pkg_queue_proto_acknowledge_response_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_pkg_queue_proto_acknowledge_response_proto_goTypes = []any{
...
var file_pkg_queue_proto_acknowledge_response_proto_depIdxs = []int32{
...
func init() { file_pkg_queue_proto_acknowledge_response_proto_init() }
func file_pkg_queue_proto_acknowledge_response_proto_init() {
	if File_pkg_queue_proto_acknowledge_response_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_queue_proto_acknowledge_response_proto_rawDesc), len(file_pkg_queue_proto_acknowledge_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_queue_proto_acknowledge_response_proto_goTypes,
		DependencyIndexes: file_pkg_queue_proto_acknowledge_response_proto_depIdxs,
		MessageInfos:      file_pkg_queue_proto_acknowledge_response_proto_msgTypes,
	}.Build()
	File_pkg_queue_proto_acknowledge_response_proto = out.File
	file_pkg_queue_proto_acknowledge_response_proto_goTypes = nil
	file_pkg_queue_proto_acknowledge_response_proto_depIdxs = nil
}
