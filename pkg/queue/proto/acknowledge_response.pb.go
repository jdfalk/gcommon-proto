...
const file_pkg_queue_proto_acknowledge_response_proto_rawDesc = "" +
	"\n" +
	"*pkg/queue/proto/acknowledge_response.proto\x12\x10gcommon.v1.queue\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1cpkg/common/proto/error.proto\x1a'pkg/common/proto/request_metadata.proto\x1a(pkg/queue/proto/message_ack_result.proto\"\xdf\x05\n" +
...
var file_pkg_queue_proto_acknowledge_response_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
...
func file_pkg_queue_proto_acknowledge_response_proto_init() {
	...
	file_pkg_queue_proto_message_ack_result_proto_init()
	type x struct{}
