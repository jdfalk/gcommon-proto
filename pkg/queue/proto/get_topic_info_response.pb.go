...
type GetTopicInfoResponse struct {
	...
	xxx_hidden_Retention   *proto.MetricsRetentionInfo `protobuf:"bytes,14,opt,name=retention"`
...
func (x *GetTopicInfoResponse) GetRetention() *proto.MetricsRetentionInfo {
	if x != nil {
...
func (x *GetTopicInfoResponse) SetRetention(v *proto.MetricsRetentionInfo) {
...
type GetTopicInfoResponse_builder struct {
	...
	Retention *proto.MetricsRetentionInfo
}
...
var file_pkg_queue_proto_get_topic_info_response_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_pkg_queue_proto_get_topic_info_response_proto_goTypes = []any{
	...
	(*proto.MetricsRetentionInfo)(nil), // 8: gcommon.v1.metrics.MetricsRetentionInfo
}
...
func file_pkg_queue_proto_get_topic_info_response_proto_init() {
	...
	file_pkg_queue_proto_owner_info_proto_init()
	file_pkg_queue_proto_partition_info_proto_init()
	file_pkg_queue_proto_topic_configuration_proto_init()
	file_pkg_queue_proto_topic_permissions_proto_init()
