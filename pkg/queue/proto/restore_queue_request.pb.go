...
var file_pkg_queue_proto_restore_queue_request_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
...
func file_pkg_queue_proto_restore_queue_request_proto_init() {
	...
	file_pkg_queue_proto_backup_source_proto_init()
	file_pkg_queue_proto_restore_config_proto_init()
	file_pkg_queue_proto_restore_options_proto_init()
