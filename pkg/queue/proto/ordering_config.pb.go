...
// 	protoc        (unknown)
// source: pkg/queue/proto/ordering_config.proto
...
func (x *OrderingConfig) Reset() {
	*x = OrderingConfig{}
	mi := &file_pkg_queue_proto_ordering_config_proto_msgTypes[0]
...
var File_pkg_queue_proto_ordering_config_proto protoreflect.FileDescriptor

const file_pkg_queue_proto_ordering_config_proto_rawDesc = "" +
	"\n" +
	"%pkg/queue/proto/ordering_config.proto\x12\x10gcommon.v1.queue\x1a!google/protobuf/go_features.proto\x1a$pkg/queue/proto/ordering_level.proto\"\xd1\x02\n" +
	...
	"\x13ordering_timeout_ms\x18\x05 \x01(\x05R\x11orderingTimeoutMsB\xc0\x01\n" +
	"\x14com.gcommon.v1.queueB\x13OrderingConfigProtoP\x01Z)github.com/jdfalk/gcommon/pkg/queue/proto\xa2\x02\x03GVQ\xaa\x02\x10Gcommon.V1.Queue\xca\x02\x10Gcommon\\V1\\Queue\xe2\x02\x1cGcommon\\V1\\Queue\\GPBMetadata\xea\x02\x12Gcommon::V1::Queue\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_pkg_queue_proto_ordering_config_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_pkg_queue_proto_ordering_config_proto_goTypes = []any{
	(*OrderingConfig)(nil), // 0: gcommon.v1.queue.OrderingConfig
	(OrderingLevel)(0),     // 1: gcommon.v1.queue.OrderingLevel
}
var file_pkg_queue_proto_ordering_config_proto_depIdxs = []int32{
	1, // 0: gcommon.v1.queue.OrderingConfig.global_ordering:type_name -> gcommon.v1.queue.OrderingLevel
	1, // 1: gcommon.v1.queue.OrderingConfig.partition_ordering:type_name -> gcommon.v1.queue.OrderingLevel
	1, // 2: gcommon.v1.queue.OrderingConfig.producer_ordering:type_name -> gcommon.v1.queue.OrderingLevel
...
func init() { file_pkg_queue_proto_ordering_config_proto_init() }
func file_pkg_queue_proto_ordering_config_proto_init() {
	if File_pkg_queue_proto_ordering_config_proto != nil {
		return
	}
	file_pkg_queue_proto_ordering_level_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_queue_proto_ordering_config_proto_rawDesc), len(file_pkg_queue_proto_ordering_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_queue_proto_ordering_config_proto_goTypes,
		DependencyIndexes: file_pkg_queue_proto_ordering_config_proto_depIdxs,
		MessageInfos:      file_pkg_queue_proto_ordering_config_proto_msgTypes,
	}.Build()
	File_pkg_queue_proto_ordering_config_proto = out.File
	file_pkg_queue_proto_ordering_config_proto_goTypes = nil
	file_pkg_queue_proto_ordering_config_proto_depIdxs = nil
}
