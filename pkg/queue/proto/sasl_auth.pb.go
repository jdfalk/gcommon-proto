...
// 	protoc        (unknown)
// source: pkg/queue/proto/sasl_auth.proto
...
func (x *SASLAuth) Reset() {
	*x = SASLAuth{}
	mi := &file_pkg_queue_proto_sasl_auth_proto_msgTypes[0]
...
var File_pkg_queue_proto_sasl_auth_proto protoreflect.FileDescriptor

const file_pkg_queue_proto_sasl_auth_proto_rawDesc = "" +
	"\n" +
	"\x1fpkg/queue/proto/sasl_auth.proto\x12\x10gcommon.v1.queue\x1a!google/protobuf/go_features.proto\"\xeb\x01\n" +
	"\bSASLAuth\x12\x1c\n" +
	...
	"\x14com.gcommon.v1.queueB\rSaslAuthProtoP\x01Z)github.com/jdfalk/gcommon/pkg/queue/proto\xa2\x02\x03GVQ\xaa\x02\x10Gcommon.V1.Queue\xca\x02\x10Gcommon\\V1\\Queue\xe2\x02\x1cGcommon\\V1\\Queue\\GPBMetadata\xea\x02\x12Gcommon::V1::Queue\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_pkg_queue_proto_sasl_auth_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_pkg_queue_proto_sasl_auth_proto_goTypes = []any{
	(*SASLAuth)(nil), // 0: gcommon.v1.queue.SASLAuth
	nil,              // 1: gcommon.v1.queue.SASLAuth.PropertiesEntry
}
var file_pkg_queue_proto_sasl_auth_proto_depIdxs = []int32{
...
func init() { file_pkg_queue_proto_sasl_auth_proto_init() }
func file_pkg_queue_proto_sasl_auth_proto_init() {
	if File_pkg_queue_proto_sasl_auth_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_queue_proto_sasl_auth_proto_rawDesc), len(file_pkg_queue_proto_sasl_auth_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_queue_proto_sasl_auth_proto_goTypes,
		DependencyIndexes: file_pkg_queue_proto_sasl_auth_proto_depIdxs,
		MessageInfos:      file_pkg_queue_proto_sasl_auth_proto_msgTypes,
	}.Build()
	File_pkg_queue_proto_sasl_auth_proto = out.File
	file_pkg_queue_proto_sasl_auth_proto_goTypes = nil
	file_pkg_queue_proto_sasl_auth_proto_depIdxs = nil
}
