...
const file_pkg_queue_proto_queue_monitoring_service_proto_rawDesc = "" +
	...
	"\rStreamMetrics\x12+.gcommon.v1.queue.QueueStreamMetricsRequest\x1a\x1e.gcommon.v1.queue.MetricsEvent0\x01B\xc8\x01\n" +
...
func file_pkg_queue_proto_queue_monitoring_service_proto_init() {
	...
	file_pkg_queue_proto_stream_metrics_request_proto_init()
	...
	file_pkg_queue_proto_get_queue_health_request_proto_init()
	file_pkg_queue_proto_get_queue_health_response_proto_init()
	...
	file_pkg_queue_proto_metrics_event_proto_init()
	file_pkg_queue_proto_queue_stats_response_proto_init()
