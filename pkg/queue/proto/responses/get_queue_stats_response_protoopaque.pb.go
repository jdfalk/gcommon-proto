...
type GetQueueStatsResponse struct {
	...
	xxx_hidden_Metadata           *pb.ResponseMetadata   `protobuf:"bytes,1,opt,name=metadata"`
...
func (x *GetQueueStatsResponse) GetMetadata() *pb.ResponseMetadata {
	if x != nil {
...
func (x *GetQueueStatsResponse) SetMetadata(v *pb.ResponseMetadata) {
...
const file_pkg_queue_proto_responses_get_queue_stats_response_proto_rawDesc = "" +
	"\n" +
	"8pkg/queue/proto/responses/get_queue_stats_response.proto\x12\x10gcommon.v1.queue\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/duration.proto\x1a1pkg/common/proto/messages/response_metadata.proto\"\xc1\x04\n" +
	...
	"\x0fmax_connections\x18\b \x01(\x05R\x0emaxConnectionsB\xbe\x01\n" +
	"\x14com.gcommon.v1.queueB\x1aGetQueueStatsResponseProtoP\x01Z ../../../../pkg/queue/pb;queuepb\xa2\x02\x03GVQ\xaa\x02\x10Gcommon.V1.Queue\xca\x02\x10Gcommon\\V1\\Queue\xe2\x02\x1cGcommon\\V1\\Queue\\GPBMetadata\xea\x02\x12Gcommon::V1::Queue\x92\x03\x05\xd2>\x02\x10\x02b\beditionsp\xe8\a"
...
var file_pkg_queue_proto_responses_get_queue_stats_response_proto_goTypes = []any{
	...
	(*pb.ResponseMetadata)(nil),   // 18: gcommon.v1.common.ResponseMetadata
