...
const file_pkg_queue_proto_stream_messages_request_proto_rawDesc = "" +
	...
	"\rstream_config\x18\x0e \x01(\v2\x1e.gcommon.v1.queue.StreamConfigR\fstreamConfigB\xc7\x01\n" +
...
var file_pkg_queue_proto_stream_messages_request_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
...
func file_pkg_queue_proto_stream_messages_request_proto_init() {
	...
	file_pkg_queue_proto_message_filter_proto_init()
	file_pkg_queue_proto_offset_config_proto_init()
