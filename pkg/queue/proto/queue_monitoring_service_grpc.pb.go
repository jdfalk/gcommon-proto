...
func (c *queueMonitoringServiceClient) StreamMetrics(ctx context.Context, in *StreamMetricsRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[MetricsEvent], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
// All implementations should embed UnimplementedQueueMonitoringServiceServer
...
// UnimplementedQueueMonitoringServiceServer should be embedded to have
...
func (UnimplementedQueueMonitoringServiceServer) StreamMetrics(*StreamMetricsRequest, grpc.ServerStreamingServer[MetricsEvent]) error {
...
func _QueueMonitoringService_StreamMetrics_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(QueueMonitoringServiceServer).StreamMetrics(m, &grpc.GenericServerStream[StreamMetricsRequest, MetricsEvent]{ServerStream: stream})
}
...
var QueueMonitoringService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "pkg/queue/proto/queue_monitoring_service.proto",
}
