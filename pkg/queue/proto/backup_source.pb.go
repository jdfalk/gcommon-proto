...
// 	protoc        (unknown)
// source: pkg/queue/proto/backup_source.proto
...
func (x *BackupSource) Reset() {
	*x = BackupSource{}
	mi := &file_pkg_queue_proto_backup_source_proto_msgTypes[0]
...
var File_pkg_queue_proto_backup_source_proto protoreflect.FileDescriptor

const file_pkg_queue_proto_backup_source_proto_rawDesc = "" +
	"\n" +
	"#pkg/queue/proto/backup_source.proto\x12\x10gcommon.v1.queue\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a%pkg/queue/proto/encryption_info.proto\x1a)pkg/queue/proto/original_queue_info.proto\x1a$pkg/queue/proto/restore_config.proto\x1a,pkg/queue/proto/restore_queue_response.proto\x1a pkg/queue/proto/time_range.proto\"\xad\x04\n" +
	...
	"\x14com.gcommon.v1.queueB\x11BackupSourceProtoP\x01Z)github.com/jdfalk/gcommon/pkg/queue/proto\xa2\x02\x03GVQ\xaa\x02\x10Gcommon.V1.Queue\xca\x02\x10Gcommon\\V1\\Queue\xe2\x02\x1cGcommon\\V1\\Queue\\GPBMetadata\xea\x02\x12Gcommon::V1::Queue\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_pkg_queue_proto_backup_source_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_pkg_queue_proto_backup_source_proto_goTypes = []any{
...
var file_pkg_queue_proto_backup_source_proto_depIdxs = []int32{
...
func init() { file_pkg_queue_proto_backup_source_proto_init() }
func file_pkg_queue_proto_backup_source_proto_init() {
	if File_pkg_queue_proto_backup_source_proto != nil {
		return
	}
	file_pkg_queue_proto_encryption_info_proto_init()
	file_pkg_queue_proto_original_queue_info_proto_init()
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_queue_proto_backup_source_proto_rawDesc), len(file_pkg_queue_proto_backup_source_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_queue_proto_backup_source_proto_goTypes,
		DependencyIndexes: file_pkg_queue_proto_backup_source_proto_depIdxs,
		MessageInfos:      file_pkg_queue_proto_backup_source_proto_msgTypes,
	}.Build()
	File_pkg_queue_proto_backup_source_proto = out.File
	file_pkg_queue_proto_backup_source_proto_goTypes = nil
	file_pkg_queue_proto_backup_source_proto_depIdxs = nil
}
