...
// 	protoc        (unknown)
// source: pkg/queue/proto/partition_commit_result.proto
...
func (x *PartitionCommitResult) Reset() {
	*x = PartitionCommitResult{}
	mi := &file_pkg_queue_proto_partition_commit_result_proto_msgTypes[0]
...
var File_pkg_queue_proto_partition_commit_result_proto protoreflect.FileDescriptor

const file_pkg_queue_proto_partition_commit_result_proto_rawDesc = "" +
	"\n" +
	"-pkg/queue/proto/partition_commit_result.proto\x12\x10gcommon.v1.queue\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xe8\x03\n" +
	...
	"\x14com.gcommon.v1.queueB\x1aPartitionCommitResultProtoP\x01Z)github.com/jdfalk/gcommon/pkg/queue/proto\xa2\x02\x03GVQ\xaa\x02\x10Gcommon.V1.Queue\xca\x02\x10Gcommon\\V1\\Queue\xe2\x02\x1cGcommon\\V1\\Queue\\GPBMetadata\xea\x02\x12Gcommon::V1::Queue\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_pkg_queue_proto_partition_commit_result_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_pkg_queue_proto_partition_commit_result_proto_goTypes = []any{
...
var file_pkg_queue_proto_partition_commit_result_proto_depIdxs = []int32{
...
func init() { file_pkg_queue_proto_partition_commit_result_proto_init() }
func file_pkg_queue_proto_partition_commit_result_proto_init() {
	if File_pkg_queue_proto_partition_commit_result_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_queue_proto_partition_commit_result_proto_rawDesc), len(file_pkg_queue_proto_partition_commit_result_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_queue_proto_partition_commit_result_proto_goTypes,
		DependencyIndexes: file_pkg_queue_proto_partition_commit_result_proto_depIdxs,
		MessageInfos:      file_pkg_queue_proto_partition_commit_result_proto_msgTypes,
	}.Build()
	File_pkg_queue_proto_partition_commit_result_proto = out.File
	file_pkg_queue_proto_partition_commit_result_proto_goTypes = nil
	file_pkg_queue_proto_partition_commit_result_proto_depIdxs = nil
}
