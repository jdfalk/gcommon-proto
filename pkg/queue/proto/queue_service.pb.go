...
var File_pkg_queue_proto_queue_service_proto protoreflect.FileDescriptor

const file_pkg_queue_proto_queue_service_proto_rawDesc = "" +
	"\n" +
	...
	"\aPublish\x12%.gcommon.v1.queue.QueuePublishRequest\x1a!.gcommon.v1.queue.PublishResponseB\xbe\x01\n" +
	"\x14com.gcommon.v1.queueB\x11QueueServiceProtoP\x01Z)github.com/jdfalk/gcommon/pkg/queue/proto\xa2\x02\x03GVQ\xaa\x02\x10Gcommon.V1.Queue\xca\x02\x10Gcommon\\V1\\Queue\xe2\x02\x1cGcommon\\V1\\Queue\\GPBMetadata\xea\x02\x12Gcommon::V1::Queue\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_pkg_queue_proto_queue_service_proto_goTypes = []any{
...
var file_pkg_queue_proto_queue_service_proto_depIdxs = []int32{
...
func init() { file_pkg_queue_proto_queue_service_proto_init() }
func file_pkg_queue_proto_queue_service_proto_init() {
	if File_pkg_queue_proto_queue_service_proto != nil {
		return
	}
	file_pkg_queue_proto_dequeue_request_proto_init()
	file_pkg_queue_proto_dequeue_response_proto_init()
	file_pkg_queue_proto_enqueue_request_proto_init()
	file_pkg_queue_proto_enqueue_response_proto_init()
	file_pkg_queue_proto_get_queue_info_request_proto_init()
	file_pkg_queue_proto_get_queue_info_response_proto_init()
	file_pkg_queue_proto_get_queue_stats_request_proto_init()
	file_pkg_queue_proto_get_queue_stats_response_proto_init()
	file_pkg_queue_proto_peek_request_proto_init()
	file_pkg_queue_proto_peek_response_proto_init()
	file_pkg_queue_proto_publish_request_proto_init()
	file_pkg_queue_proto_publish_response_proto_init()
	file_pkg_queue_proto_subscribe_request_proto_init()
	file_pkg_queue_proto_subscribe_response_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_queue_proto_queue_service_proto_rawDesc), len(file_pkg_queue_proto_queue_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_pkg_queue_proto_queue_service_proto_goTypes,
		DependencyIndexes: file_pkg_queue_proto_queue_service_proto_depIdxs,
	}.Build()
	File_pkg_queue_proto_queue_service_proto = out.File
	file_pkg_queue_proto_queue_service_proto_goTypes = nil
	file_pkg_queue_proto_queue_service_proto_depIdxs = nil
}
