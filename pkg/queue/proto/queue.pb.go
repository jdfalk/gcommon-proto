...
const file_pkg_queue_proto_queue_proto_rawDesc = "" +
	...
	"\aPublish\x12 .gcommon.v1.queue.PublishRequest\x1a!.gcommon.v1.queue.PublishResponseB\xb7\x01\n" +
	"\x14com.gcommon.v1.queueB\n" +
	"QueueProtoP\x01Z)github.com/jdfalk/gcommon/pkg/queue/proto\xa2\x02\x03GVQ\xaa\x02\x10Gcommon.V1.Queue\xca\x02\x10Gcommon\\V1\\Queue\xe2\x02\x1cGcommon\\V1\\Queue\\GPBMetadata\xea\x02\x12Gcommon::V1::Queue\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
var file_pkg_queue_proto_queue_proto_goTypes = []any{
	...
	(*SubscribeRequest)(nil),      // 5: gcommon.v1.queue.SubscribeRequest
	(*PublishRequest)(nil),        // 6: gcommon.v1.queue.PublishRequest
...
var file_pkg_queue_proto_queue_proto_depIdxs = []int32{
	...
	5,  // 5: gcommon.v1.queue.QueueService.Subscribe:input_type -> gcommon.v1.queue.SubscribeRequest
	6,  // 6: gcommon.v1.queue.QueueService.Publish:input_type -> gcommon.v1.queue.PublishRequest
...
func file_pkg_queue_proto_queue_proto_init() {
	...
	file_pkg_queue_proto_queue_monitoring_service_proto_init()
