...
type TopicConfig struct {
	...
	xxx_hidden_RetentionPolicy   *RetentionPolicy       `protobuf:"bytes,3,opt,name=retention_policy,json=retentionPolicy"`
...
func (x *TopicConfig) SetRetentionPolicy(v *RetentionPolicy) {
...
const file_pkg_queue_proto_topic_config_proto_rawDesc = "" +
	...
	"\x11enable_compaction\x18\b \x01(\bR\x10enableCompactionB\xbd\x01\n" +
	"\x14com.gcommon.v1.queueB\x10TopicConfigProtoP\x01Z)github.com/jdfalk/gcommon/pkg/queue/proto\xa2\x02\x03GVQ\xaa\x02\x10Gcommon.V1.Queue\xca\x02\x10Gcommon\\V1\\Queue\xe2\x02\x1cGcommon\\V1\\Queue\\GPBMetadata\xea\x02\x12Gcommon::V1::Queue\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
