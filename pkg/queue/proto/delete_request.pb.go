...
func (x *QueueDeleteRequest) GetMetadata() *proto.RequestMetadata {
	if x != nil {
...
func (x *QueueDeleteRequest) SetMetadata(v *proto.RequestMetadata) {
...
const file_pkg_queue_proto_delete_request_proto_rawDesc = "" +
	...
	"\bmetadata\x18d \x01(\v2\".gcommon.v1.common.RequestMetadataR\bmetadataB\xbf\x01\n" +
...
var file_pkg_queue_proto_delete_request_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
...
func file_pkg_queue_proto_delete_request_proto_init() {
	...
	file_pkg_queue_proto_delete_criteria_proto_init()
