...
// 	protoc        (unknown)
// source: pkg/queue/proto/offset_config.proto
...
func (x *OffsetConfig) Reset() {
	*x = OffsetConfig{}
	mi := &file_pkg_queue_proto_offset_config_proto_msgTypes[0]
...
var File_pkg_queue_proto_offset_config_proto protoreflect.FileDescriptor

const file_pkg_queue_proto_offset_config_proto_rawDesc = "" +
	"\n" +
	"#pkg/queue/proto/offset_config.proto\x12\x10gcommon.v1.queue\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1fpkg/queue/proto/ack_level.proto\x1a!pkg/queue/proto/offset_type.proto\x1a#pkg/queue/proto/stream_config.proto\"\xe2\x01\n" +
	"\fOffsetConfig\x12=\n" +
	...
	"\x12reset_on_not_found\x18\x04 \x01(\bR\x0fresetOnNotFoundB\xbe\x01\n" +
	"\x14com.gcommon.v1.queueB\x11OffsetConfigProtoP\x01Z)github.com/jdfalk/gcommon/pkg/queue/proto\xa2\x02\x03GVQ\xaa\x02\x10Gcommon.V1.Queue\xca\x02\x10Gcommon\\V1\\Queue\xe2\x02\x1cGcommon\\V1\\Queue\\GPBMetadata\xea\x02\x12Gcommon::V1::Queue\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_pkg_queue_proto_offset_config_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_pkg_queue_proto_offset_config_proto_goTypes = []any{
	(*OffsetConfig)(nil),          // 0: gcommon.v1.queue.OffsetConfig
	(OffsetType)(0),               // 1: gcommon.v1.queue.OffsetType
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
}
var file_pkg_queue_proto_offset_config_proto_depIdxs = []int32{
...
func init() { file_pkg_queue_proto_offset_config_proto_init() }
func file_pkg_queue_proto_offset_config_proto_init() {
	if File_pkg_queue_proto_offset_config_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_queue_proto_offset_config_proto_rawDesc), len(file_pkg_queue_proto_offset_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_queue_proto_offset_config_proto_goTypes,
		DependencyIndexes: file_pkg_queue_proto_offset_config_proto_depIdxs,
		MessageInfos:      file_pkg_queue_proto_offset_config_proto_msgTypes,
	}.Build()
	File_pkg_queue_proto_offset_config_proto = out.File
	file_pkg_queue_proto_offset_config_proto_goTypes = nil
	file_pkg_queue_proto_offset_config_proto_depIdxs = nil
}
