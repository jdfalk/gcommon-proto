...
// 	protoc        (unknown)
// source: pkg/queue/proto/requests/acknowledge_request.proto
...
func (x *AcknowledgeRequest) Reset() {
	*x = AcknowledgeRequest{}
	mi := &file_pkg_queue_proto_requests_acknowledge_request_proto_msgTypes[0]
...
func (*AcknowledgeRequest) Descriptor() ([]byte, []int) {
	return file_pkg_queue_proto_requests_acknowledge_request_proto_rawDescGZIP(), []int{0}
}
...
var File_pkg_queue_proto_requests_acknowledge_request_proto protoreflect.FileDescriptor

const file_pkg_queue_proto_requests_acknowledge_request_proto_rawDesc = "" +
	"\n" +
	"2pkg/queue/proto/requests/acknowledge_request.proto\x12\x10gcommon.v1.queue\x1a\x1dpkg/common/proto/common.proto\"\x93\x03\n" +
	...
	"\n" +
	"batch_mode\x18\x11 \x01(\bR\tbatchModeB\xc5\x01\n" +
	"\x14com.gcommon.v1.queueB\x17AcknowledgeRequestProtoP\x01Z2github.com/jdfalk/gcommon/pkg/queue/proto/requests\xa2\x02\x03GVQ\xaa\x02\x10Gcommon.V1.Queue\xca\x02\x10Gcommon\\V1\\Queue\xe2\x02\x1cGcommon\\V1\\Queue\\GPBMetadata\xea\x02\x12Gcommon::V1::Queueb\beditionsp\xe8\a"

var (
	file_pkg_queue_proto_requests_acknowledge_request_proto_rawDescOnce sync.Once
	file_pkg_queue_proto_requests_acknowledge_request_proto_rawDescData []byte
)

func file_pkg_queue_proto_requests_acknowledge_request_proto_rawDescGZIP() []byte {
	file_pkg_queue_proto_requests_acknowledge_request_proto_rawDescOnce.Do(func() {
		file_pkg_queue_proto_requests_acknowledge_request_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_queue_proto_requests_acknowledge_request_proto_rawDesc), len(file_pkg_queue_proto_requests_acknowledge_request_proto_rawDesc)))
	})
	return file_pkg_queue_proto_requests_acknowledge_request_proto_rawDescData
}
...
func init() { file_pkg_queue_proto_requests_acknowledge_request_proto_init() }
func file_pkg_queue_proto_requests_acknowledge_request_proto_init() {
	if File_pkg_queue_proto_requests_acknowledge_request_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_queue_proto_requests_acknowledge_request_proto_rawDesc), len(file_pkg_queue_proto_requests_acknowledge_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_queue_proto_requests_acknowledge_request_proto_goTypes,
		DependencyIndexes: file_pkg_queue_proto_requests_acknowledge_request_proto_depIdxs,
		MessageInfos:      file_pkg_queue_proto_requests_acknowledge_request_proto_msgTypes,
	}.Build()
	File_pkg_queue_proto_requests_acknowledge_request_proto = out.File
	file_pkg_queue_proto_requests_acknowledge_request_proto_goTypes = nil
	file_pkg_queue_proto_requests_acknowledge_request_proto_depIdxs = nil
}
