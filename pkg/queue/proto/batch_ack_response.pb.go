...
func (x *BatchAckResponse) SetMetadata(v *proto.ResponseMetadata) {
...
const file_pkg_queue_proto_batch_ack_response_proto_rawDesc = "" +
	...
	"\bbatch_id\x18\x06 \x01(\tR\abatchIdB\xc2\x01\n" +
	"\x14com.gcommon.v1.queueB\x15BatchAckResponseProtoP\x01Z)github.com/jdfalk/gcommon/pkg/queue/proto\xa2\x02\x03GVQ\xaa\x02\x10Gcommon.V1.Queue\xca\x02\x10Gcommon\\V1\\Queue\xe2\x02\x1cGcommon\\V1\\Queue\\GPBMetadata\xea\x02\x12Gcommon::V1::Queue\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_pkg_queue_proto_batch_ack_response_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
...
func file_pkg_queue_proto_batch_ack_response_proto_init() {
	...
	file_pkg_queue_proto_failed_ack_proto_init()
	type x struct{}
