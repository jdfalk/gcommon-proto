...
var file_pkg_queue_proto_consumer_group_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
...
func file_pkg_queue_proto_consumer_group_proto_init() {
	...
	file_pkg_queue_proto_consumer_proto_init()
	file_pkg_queue_proto_consumer_group_config_proto_init()
	file_pkg_queue_proto_consumer_group_state_proto_init()
	file_pkg_queue_proto_consumer_group_stats_proto_init()
	file_pkg_queue_proto_consumer_state_proto_init()
	file_pkg_queue_proto_consumer_stats_proto_init()
	file_pkg_queue_proto_group_coordinator_proto_init()
	file_pkg_queue_proto_load_balancing_strategy_proto_init()
	file_pkg_queue_proto_partition_assignment_proto_init()
