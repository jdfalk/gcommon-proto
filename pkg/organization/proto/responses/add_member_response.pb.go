...
func (x *AddMemberResponse) GetErrors() []*pb.Error {
	if x != nil {
		return x.Errors
	}
	return nil
...
func (x *AddMemberResponse) SetErrors(v []*pb.Error) {
	x.Errors = v
}
...
const file_pkg_organization_proto_responses_add_member_response_proto_rawDesc = "" +
	...
	"\x06member\x18\x03 \x01(\v2+.gcommon.v1.organization.OrganizationMemberR\x06memberB\xeb\x01\n" +
	"\x1bcom.gcommon.v1.organizationB\x16AddMemberResponseProtoP\x01Z.../../../../pkg/organization/pb;organizationpb\xa2\x02\x03GVO\xaa\x02\x17Gcommon.V1.Organization\xca\x02\x17Gcommon\\V1\\Organization\xe2\x02#Gcommon\\V1\\Organization\\GPBMetadata\xea\x02\x19Gcommon::V1::Organization\x92\x03\x05\xd2>\x02\x10\x02b\beditionsp\xe8\a"
