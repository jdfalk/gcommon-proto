...
// 	protoc        (unknown)
// source: pkg/organization/proto/responses/update_team_response.proto
...
func (x *UpdateTeamResponse) Reset() {
	*x = UpdateTeamResponse{}
	mi := &file_pkg_organization_proto_responses_update_team_response_proto_msgTypes[0]
...
var File_pkg_organization_proto_responses_update_team_response_proto protoreflect.FileDescriptor
...
const file_pkg_organization_proto_responses_update_team_response_proto_rawDesc = "" +
	...
	"\x1bcom.gcommon.v1.organizationB\x17UpdateTeamResponseProtoP\x01Z:github.com/jdfalk/gcommon/pkg/organization/proto/responses\xa2\x02\x03GVO\xaa\x02\x17Gcommon.V1.Organization\xca\x02\x17Gcommon\\V1\\Organization\xe2\x02#Gcommon\\V1\\Organization\\GPBMetadata\xea\x02\x19Gcommon::V1::Organization\x92\x03\x05\xd2>\x02\x10\x02b\beditionsp\xe8\a"
...
func file_pkg_organization_proto_responses_update_team_response_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_organization_proto_responses_update_team_response_proto_rawDesc), len(file_pkg_organization_proto_responses_update_team_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_organization_proto_responses_update_team_response_proto_goTypes,
		DependencyIndexes: file_pkg_organization_proto_responses_update_team_response_proto_depIdxs,
		MessageInfos:      file_pkg_organization_proto_responses_update_team_response_proto_msgTypes,
	}.Build()
	File_pkg_organization_proto_responses_update_team_response_proto = out.File
	file_pkg_organization_proto_responses_update_team_response_proto_goTypes = nil
	file_pkg_organization_proto_responses_update_team_response_proto_depIdxs = nil
}
