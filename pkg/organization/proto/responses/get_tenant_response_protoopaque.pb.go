...
func (x *GetTenantResponse) GetErrors() []*pb.Error {
	if x != nil {
...
func (x *GetTenantResponse) SetErrors(v []*pb.Error) {
...
const file_pkg_organization_proto_responses_get_tenant_response_proto_rawDesc = "" +
	...
	"\x06tenant\x18\x03 \x01(\v2\x1f.gcommon.v1.organization.TenantR\x06tenantB\xeb\x01\n" +
