...
// 	protoc        (unknown)
// source: pkg/organization/proto/storage_encryption.proto
...
func (x *StorageEncryption) Reset() {
	*x = StorageEncryption{}
	mi := &file_pkg_organization_proto_storage_encryption_proto_msgTypes[0]
...
var File_pkg_organization_proto_storage_encryption_proto protoreflect.FileDescriptor

const file_pkg_organization_proto_storage_encryption_proto_rawDesc = "" +
	"\n" +
	"/pkg/organization/proto/storage_encryption.proto\x12\x17gcommon.v1.organization\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x80\x01\n" +
...
func init() { file_pkg_organization_proto_storage_encryption_proto_init() }
func file_pkg_organization_proto_storage_encryption_proto_init() {
	if File_pkg_organization_proto_storage_encryption_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_organization_proto_storage_encryption_proto_rawDesc), len(file_pkg_organization_proto_storage_encryption_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_organization_proto_storage_encryption_proto_goTypes,
		DependencyIndexes: file_pkg_organization_proto_storage_encryption_proto_depIdxs,
		MessageInfos:      file_pkg_organization_proto_storage_encryption_proto_msgTypes,
	}.Build()
	File_pkg_organization_proto_storage_encryption_proto = out.File
	file_pkg_organization_proto_storage_encryption_proto_goTypes = nil
	file_pkg_organization_proto_storage_encryption_proto_depIdxs = nil
}
