...
func (x *HierarchyNode) Reset() {
	*x = HierarchyNode{}
	mi := &file_pkg_organization_proto_hierarchy_node_proto_msgTypes[0]
...
var File_pkg_organization_proto_hierarchy_node_proto protoreflect.FileDescriptor

const file_pkg_organization_proto_hierarchy_node_proto_rawDesc = "" +
	"\n" +
	...
	"\x06active\x18\f \x01(\bR\x06activeB\xe9\x01\n" +
...
var file_pkg_organization_proto_hierarchy_node_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_pkg_organization_proto_hierarchy_node_proto_goTypes = []any{
	(*HierarchyNode)(nil),  // 0: gcommon.v1.organization.HierarchyNode
	(*proto.KeyValue)(nil), // 1: gcommon.v1.common.KeyValue
}
var file_pkg_organization_proto_hierarchy_node_proto_depIdxs = []int32{
...
func init() { file_pkg_organization_proto_hierarchy_node_proto_init() }
func file_pkg_organization_proto_hierarchy_node_proto_init() {
	if File_pkg_organization_proto_hierarchy_node_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_organization_proto_hierarchy_node_proto_rawDesc), len(file_pkg_organization_proto_hierarchy_node_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_organization_proto_hierarchy_node_proto_goTypes,
		DependencyIndexes: file_pkg_organization_proto_hierarchy_node_proto_depIdxs,
		MessageInfos:      file_pkg_organization_proto_hierarchy_node_proto_msgTypes,
	}.Build()
	File_pkg_organization_proto_hierarchy_node_proto = out.File
	file_pkg_organization_proto_hierarchy_node_proto_goTypes = nil
	file_pkg_organization_proto_hierarchy_node_proto_depIdxs = nil
}
