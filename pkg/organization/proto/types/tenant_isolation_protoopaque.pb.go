...
type TenantIsolation struct {
	...
	xxx_hidden_Level         enums.IsolationLevel   `protobuf:"varint,2,opt,name=level,enum=gcommon.v1.organization.IsolationLevel"`
...
func (x *TenantIsolation) ClearLevel() {
	...
	x.xxx_hidden_Level = enums.IsolationLevel_ISOLATION_LEVEL_UNSPECIFIED
}
...
type DatabaseIsolation struct {
	...
	xxx_hidden_ConnectionParams    *[]*types.KeyValue     `protobuf:"bytes,3,rep,name=connection_params,json=connectionParams"`
...
type OriginConfig struct {
	...
	xxx_hidden_CustomHeaders  *[]*types.KeyValue     `protobuf:"bytes,4,rep,name=custom_headers,json=customHeaders"`
	XXX_raceDetectHookData    protoimpl.RaceDetectHookData
	XXX_presence              [1]uint32
	unknownFields             protoimpl.UnknownFields
	sizeCache                 protoimpl.SizeCache
