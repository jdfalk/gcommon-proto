...
// 	protoc        (unknown)
// source: pkg/organization/proto/domain_config.proto
...
func (x *DomainConfig) Reset() {
	*x = DomainConfig{}
	mi := &file_pkg_organization_proto_domain_config_proto_msgTypes[0]
...
var File_pkg_organization_proto_domain_config_proto protoreflect.FileDescriptor

const file_pkg_organization_proto_domain_config_proto_rawDesc = "" +
	"\n" +
	"*pkg/organization/proto/domain_config.proto\x12\x17gcommon.v1.organization\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a'pkg/organization/proto/dns_config.proto\"\xbb\x01\n" +
	...
	"\x11validation_status\x18\x04 \x01(\tR\x10validationStatusB\xe8\x01\n" +
...
var file_pkg_organization_proto_domain_config_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_pkg_organization_proto_domain_config_proto_goTypes = []any{
	(*DomainConfig)(nil), // 0: gcommon.v1.organization.DomainConfig
	(*DNSConfig)(nil),    // 1: gcommon.v1.organization.DNSConfig
}
var file_pkg_organization_proto_domain_config_proto_depIdxs = []int32{
...
func init() { file_pkg_organization_proto_domain_config_proto_init() }
func file_pkg_organization_proto_domain_config_proto_init() {
	if File_pkg_organization_proto_domain_config_proto != nil {
		return
	}
	file_pkg_organization_proto_dns_config_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_organization_proto_domain_config_proto_rawDesc), len(file_pkg_organization_proto_domain_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_organization_proto_domain_config_proto_goTypes,
		DependencyIndexes: file_pkg_organization_proto_domain_config_proto_depIdxs,
		MessageInfos:      file_pkg_organization_proto_domain_config_proto_msgTypes,
	}.Build()
	File_pkg_organization_proto_domain_config_proto = out.File
	file_pkg_organization_proto_domain_config_proto_goTypes = nil
	file_pkg_organization_proto_domain_config_proto_depIdxs = nil
}
