...
// 	protoc        (unknown)
// source: pkg/organization/proto/audit_alert.proto
...
func (x *AuditAlert) Reset() {
	*x = AuditAlert{}
	mi := &file_pkg_organization_proto_audit_alert_proto_msgTypes[0]
...
var File_pkg_organization_proto_audit_alert_proto protoreflect.FileDescriptor

const file_pkg_organization_proto_audit_alert_proto_rawDesc = "" +
	"\n" +
	"(pkg/organization/proto/audit_alert.proto\x12\x17gcommon.v1.organization\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xe6\x01\n" +
	"\n" +
	"AuditAlert\x12\x12\n" +
	...
	"\x13time_window_minutes\x18\x06 \x01(\x05R\x11timeWindowMinutesB\xe6\x01\n" +
	"\x1bcom.gcommon.v1.organizationB\x0fAuditAlertProtoP\x01Z0github.com/jdfalk/gcommon/pkg/organization/proto\xa2\x02\x03GVO\xaa\x02\x17Gcommon.V1.Organization\xca\x02\x17Gcommon\\V1\\Organization\xe2\x02#Gcommon\\V1\\Organization\\GPBMetadata\xea\x02\x19Gcommon::V1::Organization\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_pkg_organization_proto_audit_alert_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_pkg_organization_proto_audit_alert_proto_goTypes = []any{
	(*AuditAlert)(nil), // 0: gcommon.v1.organization.AuditAlert
}
var file_pkg_organization_proto_audit_alert_proto_depIdxs = []int32{
...
func init() { file_pkg_organization_proto_audit_alert_proto_init() }
func file_pkg_organization_proto_audit_alert_proto_init() {
	if File_pkg_organization_proto_audit_alert_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_organization_proto_audit_alert_proto_rawDesc), len(file_pkg_organization_proto_audit_alert_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_organization_proto_audit_alert_proto_goTypes,
		DependencyIndexes: file_pkg_organization_proto_audit_alert_proto_depIdxs,
		MessageInfos:      file_pkg_organization_proto_audit_alert_proto_msgTypes,
	}.Build()
	File_pkg_organization_proto_audit_alert_proto = out.File
	file_pkg_organization_proto_audit_alert_proto_goTypes = nil
	file_pkg_organization_proto_audit_alert_proto_depIdxs = nil
}
