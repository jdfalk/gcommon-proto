...
func (x *OrganizationHierarchy) SetMetadata(v []*proto.KeyValue) {
...
type HierarchyNode struct {
	...
	xxx_hidden_Metadata  *[]*proto.KeyValue     `protobuf:"bytes,11,rep,name=metadata"`
...
func (x *HierarchyNode) SetMetadata(v []*proto.KeyValue) {
	var sv *[]*proto.KeyValue
	protoimpl.X.AtomicLoadPointer(protoimpl.Pointer(&x.xxx_hidden_Metadata), protoimpl.Pointer(&sv))
	if sv == nil {
		sv = &[]*proto.KeyValue{}
...
const file_pkg_organization_proto_organization_hierarchy_proto_rawDesc = "" +
	"\n" +
	"3pkg/organization/proto/organization_hierarchy.proto\x12\x17gcommon.v1.organization\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a pkg/common/proto/key_value.proto\x1a+pkg/organization/proto/hierarchy_type.proto\"\xab\x04\n" +
	...
	"\n" +
	"path_nodes\x18\x04 \x03(\tR\tpathNodesB\xf1\x01\n" +
