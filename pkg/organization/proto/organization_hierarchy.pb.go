...
const file_pkg_organization_proto_organization_hierarchy_proto_rawDesc = "" +
	"\n" +
	"3pkg/organization/proto/organization_hierarchy.proto\x12\x17gcommon.v1.organization\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a pkg/common/proto/key_value.proto\x1a+pkg/organization/proto/hierarchy_node.proto\x1a+pkg/organization/proto/hierarchy_type.proto\"\xab\x04\n" +
	...
	"\n" +
	"updated_by\x18\f \x01(\tR\tupdatedByB\xf1\x01\n" +
...
var file_pkg_organization_proto_organization_hierarchy_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
...
var file_pkg_organization_proto_organization_hierarchy_proto_depIdxs = []int32{
	1, // 0: gcommon.v1.organization.OrganizationHierarchy.hierarchy_type:type_name -> gcommon.v1.organization.HierarchyType
...
func file_pkg_organization_proto_organization_hierarchy_proto_init() {
	...
	file_pkg_organization_proto_hierarchy_node_proto_init()
