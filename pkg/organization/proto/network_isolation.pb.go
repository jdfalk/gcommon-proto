...
// 	protoc        (unknown)
// source: pkg/organization/proto/network_isolation.proto
...
func (x *NetworkIsolation) Reset() {
	*x = NetworkIsolation{}
	mi := &file_pkg_organization_proto_network_isolation_proto_msgTypes[0]
...
var File_pkg_organization_proto_network_isolation_proto protoreflect.FileDescriptor

const file_pkg_organization_proto_network_isolation_proto_rawDesc = "" +
	"\n" +
	".pkg/organization/proto/network_isolation.proto\x12\x17gcommon.v1.organization\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a'pkg/organization/proto/cdn_config.proto\x1a*pkg/organization/proto/domain_config.proto\x1a1pkg/organization/proto/load_balancer_config.proto\x1a-pkg/organization/proto/network_acl_rule.proto\"\xba\x03\n" +
	...
	"\x06domain\x18\b \x01(\v2%.gcommon.v1.organization.DomainConfigR\x06domainB\xec\x01\n" +
...
var file_pkg_organization_proto_network_isolation_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_pkg_organization_proto_network_isolation_proto_goTypes = []any{
...
var file_pkg_organization_proto_network_isolation_proto_depIdxs = []int32{
...
func init() { file_pkg_organization_proto_network_isolation_proto_init() }
func file_pkg_organization_proto_network_isolation_proto_init() {
	if File_pkg_organization_proto_network_isolation_proto != nil {
		return
	}
	file_pkg_organization_proto_cdn_config_proto_init()
	file_pkg_organization_proto_domain_config_proto_init()
	file_pkg_organization_proto_load_balancer_config_proto_init()
	file_pkg_organization_proto_network_acl_rule_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_organization_proto_network_isolation_proto_rawDesc), len(file_pkg_organization_proto_network_isolation_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_organization_proto_network_isolation_proto_goTypes,
		DependencyIndexes: file_pkg_organization_proto_network_isolation_proto_depIdxs,
		MessageInfos:      file_pkg_organization_proto_network_isolation_proto_msgTypes,
	}.Build()
	File_pkg_organization_proto_network_isolation_proto = out.File
	file_pkg_organization_proto_network_isolation_proto_goTypes = nil
	file_pkg_organization_proto_network_isolation_proto_depIdxs = nil
}
