...
// 	protoc        (unknown)
// source: pkg/organization/proto/compute_isolation.proto
...
func (x *ComputeIsolation) Reset() {
	*x = ComputeIsolation{}
	mi := &file_pkg_organization_proto_compute_isolation_proto_msgTypes[0]
...
var File_pkg_organization_proto_compute_isolation_proto protoreflect.FileDescriptor

const file_pkg_organization_proto_compute_isolation_proto_rawDesc = "" +
	"\n" +
	".pkg/organization/proto/compute_isolation.proto\x12\x17gcommon.v1.organization\x1a!google/protobuf/go_features.proto\x1a0pkg/organization/proto/auto_scaling_config.proto\x1a+pkg/organization/proto/cpu_allocation.proto\x1a.pkg/organization/proto/memory_allocation.proto\x1a,pkg/organization/proto/resource_limits.proto\"\xa1\x03\n" +
	...
	"\fauto_scaling\x18\a \x01(\v2*.gcommon.v1.organization.AutoScalingConfigR\vautoScalingB\xec\x01\n" +
...
var file_pkg_organization_proto_compute_isolation_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_pkg_organization_proto_compute_isolation_proto_goTypes = []any{
...
var file_pkg_organization_proto_compute_isolation_proto_depIdxs = []int32{
...
func init() { file_pkg_organization_proto_compute_isolation_proto_init() }
func file_pkg_organization_proto_compute_isolation_proto_init() {
	if File_pkg_organization_proto_compute_isolation_proto != nil {
		return
	}
	file_pkg_organization_proto_auto_scaling_config_proto_init()
	file_pkg_organization_proto_cpu_allocation_proto_init()
	file_pkg_organization_proto_memory_allocation_proto_init()
	file_pkg_organization_proto_resource_limits_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_organization_proto_compute_isolation_proto_rawDesc), len(file_pkg_organization_proto_compute_isolation_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_organization_proto_compute_isolation_proto_goTypes,
		DependencyIndexes: file_pkg_organization_proto_compute_isolation_proto_depIdxs,
		MessageInfos:      file_pkg_organization_proto_compute_isolation_proto_msgTypes,
	}.Build()
	File_pkg_organization_proto_compute_isolation_proto = out.File
	file_pkg_organization_proto_compute_isolation_proto_goTypes = nil
	file_pkg_organization_proto_compute_isolation_proto_depIdxs = nil
}
