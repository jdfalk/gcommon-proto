...
type FilterOptions struct {
	...
	xxx_hidden_TimeRange   *proto.MetricsTimeRange `protobuf:"bytes,3,opt,name=time_range,json=timeRange"`
...
func (x *FilterOptions) GetTimeRange() *proto.MetricsTimeRange {
	if x != nil {
...
func (x *FilterOptions) SetTimeRange(v *proto.MetricsTimeRange) {
...
const file_pkg_common_proto_filter_options_proto_rawDesc = "" +
	"\n" +
	"%pkg/common/proto/filter_options.proto\x12\x11gcommon.v1.common\x1a!google/protobuf/go_features.proto\x1a#pkg/common/proto/filter_value.proto\x1a\"pkg/metrics/proto/time_range.proto\"\x9c\x02\n" +
	"\rFilterOptions\x12G\n" +
