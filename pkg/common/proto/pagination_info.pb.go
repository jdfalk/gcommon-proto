...
// 	protoc        (unknown)
// source: pkg/common/proto/pagination_info.proto
...
func (x *CommonPaginationInfo) Reset() {
	*x = CommonPaginationInfo{}
	mi := &file_pkg_common_proto_pagination_info_proto_msgTypes[0]
...
var File_pkg_common_proto_pagination_info_proto protoreflect.FileDescriptor

const file_pkg_common_proto_pagination_info_proto_rawDesc = "" +
	"\n" +
	"&pkg/common/proto/pagination_info.proto\x12\x11gcommon.v1.common\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xae\x02\n" +
	...
	"\x13previous_page_token\x18\b \x01(\tR\x11previousPageTokenB\xc6\x01\n" +
	"\x15com.gcommon.v1.commonB\x13PaginationInfoProtoP\x01Z*github.com/jdfalk/gcommon/pkg/common/proto\xa2\x02\x03GVC\xaa\x02\x11Gcommon.V1.Common\xca\x02\x11Gcommon\\V1\\Common\xe2\x02\x1dGcommon\\V1\\Common\\GPBMetadata\xea\x02\x13Gcommon::V1::Common\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_pkg_common_proto_pagination_info_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_pkg_common_proto_pagination_info_proto_goTypes = []any{
	(*CommonPaginationInfo)(nil), // 0: gcommon.v1.common.CommonPaginationInfo
}
var file_pkg_common_proto_pagination_info_proto_depIdxs = []int32{
...
func init() { file_pkg_common_proto_pagination_info_proto_init() }
func file_pkg_common_proto_pagination_info_proto_init() {
	if File_pkg_common_proto_pagination_info_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_common_proto_pagination_info_proto_rawDesc), len(file_pkg_common_proto_pagination_info_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_common_proto_pagination_info_proto_goTypes,
		DependencyIndexes: file_pkg_common_proto_pagination_info_proto_depIdxs,
		MessageInfos:      file_pkg_common_proto_pagination_info_proto_msgTypes,
	}.Build()
	File_pkg_common_proto_pagination_info_proto = out.File
	file_pkg_common_proto_pagination_info_proto_goTypes = nil
	file_pkg_common_proto_pagination_info_proto_depIdxs = nil
}
