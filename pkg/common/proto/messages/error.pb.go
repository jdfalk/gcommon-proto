...
type Error struct {
	...
	Code *enums.ErrorCode `protobuf:"varint,1,opt,name=code,enum=gcommon.v1.common.ErrorCode" json:"code,omitempty"`
...
const file_pkg_common_proto_messages_error_proto_rawDesc = "" +
	...
	"ErrorProtoP\x01Z3github.com/jdfalk/gcommon/pkg/common/proto/messages\xa2\x02\x03GVC\xaa\x02\x11Gcommon.V1.Common\xca\x02\x11Gcommon\\V1\\Common\xe2\x02\x1dGcommon\\V1\\Common\\GPBMetadata\xea\x02\x13Gcommon::V1::Common\x92\x03\x05\xd2>\x02\x10\x02b\beditionsp\xe8\a"
