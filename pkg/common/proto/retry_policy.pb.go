...
func (x *CommonRetryPolicy) Reset() {
	*x = CommonRetryPolicy{}
	mi := &file_pkg_common_proto_retry_policy_proto_msgTypes[0]
...
const file_pkg_common_proto_retry_policy_proto_rawDesc = "" +
	"\n" +
	"#pkg/common/proto/retry_policy.proto\x12\x11gcommon.v1.common\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a!pkg/common/proto/error_code.proto\"\x8b\x03\n" +
...
var file_pkg_common_proto_retry_policy_proto_depIdxs = []int32{
...
func init() { file_pkg_common_proto_retry_policy_proto_init() }
func file_pkg_common_proto_retry_policy_proto_init() {
	if File_pkg_common_proto_retry_policy_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_common_proto_retry_policy_proto_rawDesc), len(file_pkg_common_proto_retry_policy_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_common_proto_retry_policy_proto_goTypes,
		DependencyIndexes: file_pkg_common_proto_retry_policy_proto_depIdxs,
		MessageInfos:      file_pkg_common_proto_retry_policy_proto_msgTypes,
	}.Build()
	File_pkg_common_proto_retry_policy_proto = out.File
	file_pkg_common_proto_retry_policy_proto_goTypes = nil
	file_pkg_common_proto_retry_policy_proto_depIdxs = nil
}
