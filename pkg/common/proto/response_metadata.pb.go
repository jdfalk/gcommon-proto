...
type ResponseMetadata struct {
	...
	xxx_hidden_Pagination     *proto.MetricsPaginationInfo `protobuf:"bytes,10,opt,name=pagination"`
...
func (x *ResponseMetadata) GetPagination() *proto.MetricsPaginationInfo {
	if x != nil {
...
func (x *ResponseMetadata) SetPagination(v *proto.MetricsPaginationInfo) {
...
type ResponseMetadata_builder struct {
	...
	Pagination *proto.MetricsPaginationInfo
}
...
var file_pkg_common_proto_response_metadata_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_pkg_common_proto_response_metadata_proto_goTypes = []any{
	...
	(*proto.MetricsPaginationInfo)(nil), // 6: gcommon.v1.metrics.MetricsPaginationInfo
}
...
func file_pkg_common_proto_response_metadata_proto_init() {
	...
	file_pkg_common_proto_rate_limit_info_proto_init()
	type x struct{}
