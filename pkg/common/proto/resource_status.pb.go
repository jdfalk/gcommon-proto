...
func (ResourceStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_pkg_common_proto_resource_status_proto_enumTypes[0].Descriptor()
}

func (ResourceStatus) Type() protoreflect.EnumType {
	return &file_pkg_common_proto_resource_status_proto_enumTypes[0]
}
...
var file_pkg_common_proto_resource_status_proto_depIdxs = []int32{
...
func init() { file_pkg_common_proto_resource_status_proto_init() }
func file_pkg_common_proto_resource_status_proto_init() {
	if File_pkg_common_proto_resource_status_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_common_proto_resource_status_proto_rawDesc), len(file_pkg_common_proto_resource_status_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_common_proto_resource_status_proto_goTypes,
		DependencyIndexes: file_pkg_common_proto_resource_status_proto_depIdxs,
		EnumInfos:         file_pkg_common_proto_resource_status_proto_enumTypes,
	}.Build()
	File_pkg_common_proto_resource_status_proto = out.File
	file_pkg_common_proto_resource_status_proto_goTypes = nil
	file_pkg_common_proto_resource_status_proto_depIdxs = nil
}
