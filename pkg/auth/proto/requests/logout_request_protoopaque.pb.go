...
// 	protoc        (unknown)
// source: pkg/auth/proto/requests/logout_request.proto
...
func (x *LogoutRequest) GetMetadata() *pb.RequestMetadata {
	if x != nil {
...
func (x *LogoutRequest) SetMetadata(v *pb.RequestMetadata) {
...
const file_pkg_auth_proto_requests_logout_request_proto_rawDesc = "" +
	"\n" +
	",pkg/auth/proto/requests/logout_request.proto\x12\x0fgcommon.v1.auth\x1a!google/protobuf/go_features.proto\x1a0pkg/common/proto/messages/request_metadata.proto\"\x87\x01\n" +
	"\rLogoutRequest\x12\x1d\n" +
	"\n" +
	"session_id\x18\x01 \x01(\tR\tsessionId\x12\x17\n" +
	"\auser_id\x18\x02 \x01(\tR\x06userId\x12>\n" +
	"\bmetadata\x18\x03 \x01(\v2\".gcommon.v1.common.RequestMetadataR\bmetadataB\xaf\x01\n" +
	"\x13com.gcommon.v1.authB\x12LogoutRequestProtoP\x01Z\x1e../../../../pkg/auth/pb;authpb\xa2\x02\x03GVA\xaa\x02\x0fGcommon.V1.Auth\xca\x02\x0fGcommon\\V1\\Auth\xe2\x02\x1bGcommon\\V1\\Auth\\GPBMetadata\xea\x02\x11Gcommon::V1::Auth\x92\x03\x05\xd2>\x02\x10\x02b\beditionsp\xe8\a"
...
func file_pkg_auth_proto_requests_logout_request_proto_init() {
	if File_pkg_auth_proto_requests_logout_request_proto != nil {
		return
	}
	type x struct{}
	...
	file_pkg_auth_proto_requests_logout_request_proto_depIdxs = nil
}
