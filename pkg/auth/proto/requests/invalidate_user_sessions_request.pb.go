...
func (x *InvalidateUserSessionsRequest) GetMetadata() *messages.RequestMetadata {
	if x != nil {
		return x.Metadata
	}
	return nil
...
func (x *InvalidateUserSessionsRequest) SetMetadata(v *messages.RequestMetadata) {
	x.Metadata = v
}
...
const file_pkg_auth_proto_requests_invalidate_user_sessions_request_proto_rawDesc = "" +
	...
	"\x13com.gcommon.v1.authB\"InvalidateUserSessionsRequestProtoP\x01Z1github.com/jdfalk/gcommon/pkg/auth/proto/requests\xa2\x02\x03GVA\xaa\x02\x0fGcommon.V1.Auth\xca\x02\x0fGcommon\\V1\\Auth\xe2\x02\x1bGcommon\\V1\\Auth\\GPBMetadata\xea\x02\x11Gcommon::V1::Auth\x92\x03\x05\xd2>\x02\x10\x02b\beditionsp\xe8\a"
