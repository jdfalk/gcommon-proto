...
// 	protoc        (unknown)
// source: pkg/auth/proto/api_key_stats.proto
...
func (x *ApiKeyStats) Reset() {
	*x = ApiKeyStats{}
	mi := &file_pkg_auth_proto_api_key_stats_proto_msgTypes[0]
...
var File_pkg_auth_proto_api_key_stats_proto protoreflect.FileDescriptor

const file_pkg_auth_proto_api_key_stats_proto_rawDesc = "" +
	"\n" +
	"\"pkg/auth/proto/api_key_stats.proto\x12\x0fgcommon.v1.auth\x1a!google/protobuf/go_features.proto\x1a pkg/auth/proto/daily_usage.proto\"\xee\x01\n" +
	"\vApiKeyStats\x12%\n" +
	...
	"dailyUsageB\xb7\x01\n" +
	"\x13com.gcommon.v1.authB\x10ApiKeyStatsProtoP\x01Z(github.com/jdfalk/gcommon/pkg/auth/proto\xa2\x02\x03GVA\xaa\x02\x0fGcommon.V1.Auth\xca\x02\x0fGcommon\\V1\\Auth\xe2\x02\x1bGcommon\\V1\\Auth\\GPBMetadata\xea\x02\x11Gcommon::V1::Auth\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_pkg_auth_proto_api_key_stats_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_pkg_auth_proto_api_key_stats_proto_goTypes = []any{
	(*ApiKeyStats)(nil), // 0: gcommon.v1.auth.ApiKeyStats
	(*DailyUsage)(nil),  // 1: gcommon.v1.auth.DailyUsage
}
var file_pkg_auth_proto_api_key_stats_proto_depIdxs = []int32{
	1, // 0: gcommon.v1.auth.ApiKeyStats.daily_usage:type_name -> gcommon.v1.auth.DailyUsage
...
func init() { file_pkg_auth_proto_api_key_stats_proto_init() }
func file_pkg_auth_proto_api_key_stats_proto_init() {
	if File_pkg_auth_proto_api_key_stats_proto != nil {
		return
	}
	file_pkg_auth_proto_daily_usage_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_auth_proto_api_key_stats_proto_rawDesc), len(file_pkg_auth_proto_api_key_stats_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_auth_proto_api_key_stats_proto_goTypes,
		DependencyIndexes: file_pkg_auth_proto_api_key_stats_proto_depIdxs,
		MessageInfos:      file_pkg_auth_proto_api_key_stats_proto_msgTypes,
	}.Build()
	File_pkg_auth_proto_api_key_stats_proto = out.File
	file_pkg_auth_proto_api_key_stats_proto_goTypes = nil
	file_pkg_auth_proto_api_key_stats_proto_depIdxs = nil
}
