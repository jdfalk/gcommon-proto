...
// 	protoc        (unknown)
// source: pkg/auth/proto/verification_status.proto
...
func (x *VerificationStatus) Reset() {
	*x = VerificationStatus{}
	mi := &file_pkg_auth_proto_verification_status_proto_msgTypes[0]
...
var File_pkg_auth_proto_verification_status_proto protoreflect.FileDescriptor

const file_pkg_auth_proto_verification_status_proto_rawDesc = "" +
	"\n" +
	"(pkg/auth/proto/verification_status.proto\x12\x0fgcommon.v1.auth\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xed\x02\n" +
	...
	"\x14identity_verified_at\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\x12identityVerifiedAtB\xbe\x01\n" +
	"\x13com.gcommon.v1.authB\x17VerificationStatusProtoP\x01Z(github.com/jdfalk/gcommon/pkg/auth/proto\xa2\x02\x03GVA\xaa\x02\x0fGcommon.V1.Auth\xca\x02\x0fGcommon\\V1\\Auth\xe2\x02\x1bGcommon\\V1\\Auth\\GPBMetadata\xea\x02\x11Gcommon::V1::Auth\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_pkg_auth_proto_verification_status_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_pkg_auth_proto_verification_status_proto_goTypes = []any{
	(*VerificationStatus)(nil),    // 0: gcommon.v1.auth.VerificationStatus
	(*timestamppb.Timestamp)(nil), // 1: google.protobuf.Timestamp
}
var file_pkg_auth_proto_verification_status_proto_depIdxs = []int32{
	1, // 0: gcommon.v1.auth.VerificationStatus.email_verified_at:type_name -> google.protobuf.Timestamp
	1, // 1: gcommon.v1.auth.VerificationStatus.phone_verified_at:type_name -> google.protobuf.Timestamp
	1, // 2: gcommon.v1.auth.VerificationStatus.identity_verified_at:type_name -> google.protobuf.Timestamp
...
func init() { file_pkg_auth_proto_verification_status_proto_init() }
func file_pkg_auth_proto_verification_status_proto_init() {
	if File_pkg_auth_proto_verification_status_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_auth_proto_verification_status_proto_rawDesc), len(file_pkg_auth_proto_verification_status_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_auth_proto_verification_status_proto_goTypes,
		DependencyIndexes: file_pkg_auth_proto_verification_status_proto_depIdxs,
		MessageInfos:      file_pkg_auth_proto_verification_status_proto_msgTypes,
	}.Build()
	File_pkg_auth_proto_verification_status_proto = out.File
	file_pkg_auth_proto_verification_status_proto_goTypes = nil
	file_pkg_auth_proto_verification_status_proto_depIdxs = nil
}
