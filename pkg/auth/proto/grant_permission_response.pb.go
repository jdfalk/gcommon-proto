...
// 	protoc        (unknown)
// source: pkg/auth/proto/grant_permission_response.proto
...
func (x *GrantPermissionResponse) Reset() {
	*x = GrantPermissionResponse{}
	mi := &file_pkg_auth_proto_grant_permission_response_proto_msgTypes[0]
...
var file_pkg_auth_proto_grant_permission_response_proto_goTypes = []any{
	(*GrantPermissionResponse)(nil), // 0: gcommon.v1.auth.GrantPermissionResponse
	(*proto.ResponseMetadata)(nil),  // 1: gcommon.v1.common.ResponseMetadata
}
var file_pkg_auth_proto_grant_permission_response_proto_depIdxs = []int32{
	1, // 0: gcommon.v1.auth.GrantPermissionResponse.metadata:type_name -> gcommon.v1.common.ResponseMetadata
...
func init() { file_pkg_auth_proto_grant_permission_response_proto_init() }
func file_pkg_auth_proto_grant_permission_response_proto_init() {
	if File_pkg_auth_proto_grant_permission_response_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_auth_proto_grant_permission_response_proto_rawDesc), len(file_pkg_auth_proto_grant_permission_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_auth_proto_grant_permission_response_proto_goTypes,
		DependencyIndexes: file_pkg_auth_proto_grant_permission_response_proto_depIdxs,
		MessageInfos:      file_pkg_auth_proto_grant_permission_response_proto_msgTypes,
	}.Build()
	File_pkg_auth_proto_grant_permission_response_proto = out.File
	file_pkg_auth_proto_grant_permission_response_proto_goTypes = nil
	file_pkg_auth_proto_grant_permission_response_proto_depIdxs = nil
}
