...
func (x *AuthAuthenticateResponse) GetRateLimit() *proto.RateLimit {
	if x != nil {
...
func (x *AuthAuthenticateResponse) SetRateLimit(v *proto.RateLimit) {
...
const file_pkg_auth_proto_authenticate_response_proto_rawDesc = "" +
	"\n" +
	"*pkg/auth/proto/authenticate_response.proto\x12\x0fgcommon.v1.auth\x1a!google/protobuf/go_features.proto\x1a\x1cpkg/auth/proto/session.proto\x1a\x1epkg/auth/proto/user_info.proto\x1a!pkg/common/proto/rate_limit.proto\x1a(pkg/common/proto/response_metadata.proto\"\xed\x02\n" +
...
var file_pkg_auth_proto_authenticate_response_proto_goTypes = []any{
	(*AuthAuthenticateResponse)(nil), // 0: gcommon.v1.auth.AuthAuthenticateResponse
...
var file_pkg_auth_proto_authenticate_response_proto_depIdxs = []int32{
	1, // 0: gcommon.v1.auth.AuthAuthenticateResponse.user_info:type_name -> gcommon.v1.auth.UserInfo
	2, // 1: gcommon.v1.auth.AuthAuthenticateResponse.session:type_name -> gcommon.v1.auth.Session
	3, // 2: gcommon.v1.auth.AuthAuthenticateResponse.rate_limit:type_name -> gcommon.v1.common.RateLimit
