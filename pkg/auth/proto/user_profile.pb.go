...
// 	protoc        (unknown)
// source: pkg/auth/proto/user_profile.proto
...
func (x *UserProfile) Reset() {
	*x = UserProfile{}
	mi := &file_pkg_auth_proto_user_profile_proto_msgTypes[0]
...
var File_pkg_auth_proto_user_profile_proto protoreflect.FileDescriptor

const file_pkg_auth_proto_user_profile_proto_rawDesc = "" +
	"\n" +
	"!pkg/auth/proto/user_profile.proto\x12\x0fgcommon.v1.auth\x1a!google/protobuf/go_features.proto\"\x8f\x02\n" +
	"\vUserProfile\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\x12!\n" +
	"\fdisplay_name\x18\x02 \x01(\tR\vdisplayName\x12\x14\n" +
	"\x05email\x18\x03 \x01(\tR\x05email\x12\x1d\n" +
	"\n" +
	"avatar_url\x18\x04 \x01(\tR\tavatarUrl\x12P\n" +
	"\n" +
	"attributes\x18\x05 \x03(\v2,.gcommon.v1.auth.UserProfile.AttributesEntryB\x02(\x01R\n" +
	"attributes\x1a=\n" +
...
var file_pkg_auth_proto_user_profile_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_pkg_auth_proto_user_profile_proto_goTypes = []any{
	(*UserProfile)(nil), // 0: gcommon.v1.auth.UserProfile
	nil,                 // 1: gcommon.v1.auth.UserProfile.AttributesEntry
}
var file_pkg_auth_proto_user_profile_proto_depIdxs = []int32{
	1, // 0: gcommon.v1.auth.UserProfile.attributes:type_name -> gcommon.v1.auth.UserProfile.AttributesEntry
...
func init() { file_pkg_auth_proto_user_profile_proto_init() }
func file_pkg_auth_proto_user_profile_proto_init() {
	if File_pkg_auth_proto_user_profile_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_auth_proto_user_profile_proto_rawDesc), len(file_pkg_auth_proto_user_profile_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_auth_proto_user_profile_proto_goTypes,
		DependencyIndexes: file_pkg_auth_proto_user_profile_proto_depIdxs,
		MessageInfos:      file_pkg_auth_proto_user_profile_proto_msgTypes,
	}.Build()
	File_pkg_auth_proto_user_profile_proto = out.File
	file_pkg_auth_proto_user_profile_proto_goTypes = nil
	file_pkg_auth_proto_user_profile_proto_depIdxs = nil
}
