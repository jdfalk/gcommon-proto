...
type Token struct {
	...
	xxx_hidden_Type           TokenType              `protobuf:"varint,3,opt,name=type,enum=gcommon.v1.auth.TokenType"`
	xxx_hidden_Status         TokenStatus            `protobuf:"varint,4,opt,name=status,enum=gcommon.v1.auth.TokenStatus"`
...
const file_pkg_auth_proto_token_proto_rawDesc = "" +
	"\n" +
	"\x1apkg/auth/proto/token.proto\x12\x0fgcommon.v1.auth\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a!pkg/auth/proto/token_status.proto\x1a\x1fpkg/auth/proto/token_type.proto\"\x8c\x05\n" +
	"\x05Token\x12\x0e\n" +
	...
	"TokenProtoP\x01Z(github.com/jdfalk/gcommon/pkg/auth/proto\xa2\x02\x03GVA\xaa\x02\x0fGcommon.V1.Auth\xca\x02\x0fGcommon\\V1\\Auth\xe2\x02\x1bGcommon\\V1\\Auth\\GPBMetadata\xea\x02\x11Gcommon::V1::Auth\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
