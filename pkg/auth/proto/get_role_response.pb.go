...
func (x *GetRoleResponse) Reset() {
	*x = GetRoleResponse{}
	mi := &file_pkg_auth_proto_get_role_response_proto_msgTypes[0]
...
var file_pkg_auth_proto_get_role_response_proto_depIdxs = []int32{
...
func init() { file_pkg_auth_proto_get_role_response_proto_init() }
func file_pkg_auth_proto_get_role_response_proto_init() {
	if File_pkg_auth_proto_get_role_response_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_auth_proto_get_role_response_proto_rawDesc), len(file_pkg_auth_proto_get_role_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_auth_proto_get_role_response_proto_goTypes,
		DependencyIndexes: file_pkg_auth_proto_get_role_response_proto_depIdxs,
		MessageInfos:      file_pkg_auth_proto_get_role_response_proto_msgTypes,
	}.Build()
	File_pkg_auth_proto_get_role_response_proto = out.File
	file_pkg_auth_proto_get_role_response_proto_goTypes = nil
	file_pkg_auth_proto_get_role_response_proto_depIdxs = nil
}
