...
// 	protoc        (unknown)
// source: pkg/auth/proto/o_auth_client.proto
...
type OAuthClient struct {
	...
	xxx_hidden_Status        proto.ResourceStatus   `protobuf:"varint,11,opt,name=status,enum=gcommon.v1.common.ResourceStatus"`
...
func (x *OAuthClient) Reset() {
	*x = OAuthClient{}
	mi := &file_pkg_auth_proto_o_auth_client_proto_msgTypes[0]
...
var File_pkg_auth_proto_o_auth_client_proto protoreflect.FileDescriptor

const file_pkg_auth_proto_o_auth_client_proto_rawDesc = "" +
	"\n" +
	"\"pkg/auth/proto/o_auth_client.proto\x12\x0fgcommon.v1.auth\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a'pkg/common/proto/request_metadata.proto\x1a&pkg/common/proto/resource_status.proto\"\x8e\x05\n" +
	...
	"\x13com.gcommon.v1.authB\x10OAuthClientProtoP\x01Z(github.com/jdfalk/gcommon/pkg/auth/proto\xa2\x02\x03GVA\xaa\x02\x0fGcommon.V1.Auth\xca\x02\x0fGcommon\\V1\\Auth\xe2\x02\x1bGcommon\\V1\\Auth\\GPBMetadata\xea\x02\x11Gcommon::V1::Auth\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_pkg_auth_proto_o_auth_client_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_pkg_auth_proto_o_auth_client_proto_goTypes = []any{
...
var file_pkg_auth_proto_o_auth_client_proto_depIdxs = []int32{
...
func init() { file_pkg_auth_proto_o_auth_client_proto_init() }
func file_pkg_auth_proto_o_auth_client_proto_init() {
	if File_pkg_auth_proto_o_auth_client_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_auth_proto_o_auth_client_proto_rawDesc), len(file_pkg_auth_proto_o_auth_client_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_auth_proto_o_auth_client_proto_goTypes,
		DependencyIndexes: file_pkg_auth_proto_o_auth_client_proto_depIdxs,
		MessageInfos:      file_pkg_auth_proto_o_auth_client_proto_msgTypes,
	}.Build()
	File_pkg_auth_proto_o_auth_client_proto = out.File
	file_pkg_auth_proto_o_auth_client_proto_goTypes = nil
	file_pkg_auth_proto_o_auth_client_proto_depIdxs = nil
}
