...
var file_pkg_auth_proto_list_sessions_response_proto_goTypes = []any{
	(*ListSessionsResponse)(nil),    // 0: gcommon.v1.auth.ListSessionsResponse
...
var file_pkg_auth_proto_list_sessions_response_proto_depIdxs = []int32{
	1, // 0: gcommon.v1.auth.ListSessionsResponse.sessions:type_name -> gcommon.v1.auth.Session
	2, // 1: gcommon.v1.auth.ListSessionsResponse.pagination:type_name -> gcommon.v1.common.PaginatedResponse
