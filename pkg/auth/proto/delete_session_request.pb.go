...
const file_pkg_auth_proto_delete_session_request_proto_rawDesc = "" +
	"\n" +
	"+pkg/auth/proto/delete_session_request.proto\x12\x0fgcommon.v1.auth\x1a!google/protobuf/go_features.proto\"O\n" +
...
var file_pkg_auth_proto_delete_session_request_proto_goTypes = []any{
	(*AuthDeleteSessionRequest)(nil), // 0: gcommon.v1.auth.AuthDeleteSessionRequest
}
