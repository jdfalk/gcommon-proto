...
type Role struct {
	...
	Status        *enums.ResourceStatus `protobuf:"varint,7,opt,name=status,enum=gcommon.v1.common.ResourceStatus" json:"status,omitempty"`
...
const file_pkg_auth_proto_types_role_proto_rawDesc = "" +
	...
	"\x13com.gcommon.v1.authB\tRoleProtoP\x01Z.github.com/jdfalk/gcommon/pkg/auth/proto/types\xa2\x02\x03GVA\xaa\x02\x0fGcommon.V1.Auth\xca\x02\x0fGcommon\\V1\\Auth\xe2\x02\x1bGcommon\\V1\\Auth\\GPBMetadata\xea\x02\x11Gcommon::V1::Auth\x92\x03\x05\xd2>\x02\x10\x02b\beditionsp\xe8\a"
