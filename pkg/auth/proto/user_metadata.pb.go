...
var file_pkg_auth_proto_user_metadata_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_pkg_auth_proto_user_metadata_proto_goTypes = []any{
	(*UserMetadata)(nil),          // 0: gcommon.v1.auth.UserMetadata
	nil,                           // 1: gcommon.v1.auth.UserMetadata.CustomFieldsEntry
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
	(*UserPreferences)(nil),       // 3: gcommon.v1.auth.UserPreferences
	(*VerificationStatus)(nil),    // 4: gcommon.v1.auth.VerificationStatus
}
var file_pkg_auth_proto_user_metadata_proto_depIdxs = []int32{
	2, // 0: gcommon.v1.auth.UserMetadata.birth_date:type_name -> google.protobuf.Timestamp
	1, // 1: gcommon.v1.auth.UserMetadata.custom_fields:type_name -> gcommon.v1.auth.UserMetadata.CustomFieldsEntry
	3, // 2: gcommon.v1.auth.UserMetadata.preferences:type_name -> gcommon.v1.auth.UserPreferences
	4, // 3: gcommon.v1.auth.UserMetadata.verification:type_name -> gcommon.v1.auth.VerificationStatus
...
func file_pkg_auth_proto_user_metadata_proto_init() {
	...
	file_pkg_auth_proto_user_preferences_proto_init()
	file_pkg_auth_proto_verification_status_proto_init()
	type x struct{}
