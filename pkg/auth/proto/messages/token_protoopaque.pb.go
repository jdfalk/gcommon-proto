...
type Token struct {
	...
	xxx_hidden_Type           enums.TokenType        `protobuf:"varint,3,opt,name=type,enum=gcommon.v1.auth.TokenType"`
	xxx_hidden_Status         enums.TokenStatus      `protobuf:"varint,4,opt,name=status,enum=gcommon.v1.auth.TokenStatus"`
