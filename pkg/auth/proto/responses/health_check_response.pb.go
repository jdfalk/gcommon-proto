...
// 	protoc        (unknown)
// source: pkg/auth/proto/responses/health_check_response.proto
...
const file_pkg_auth_proto_responses_health_check_response_proto_rawDesc = "" +
	"\n" +
	"4pkg/auth/proto/responses/health_check_response.proto\x12\x0fgcommon.v1.auth\x1a!google/protobuf/go_features.protoB\xc9\x01\n" +
	"\x13com.gcommon.v1.authB\x18HealthCheckResponseProtoP\x01Z2github.com/jdfalk/gcommon/pkg/auth/proto/responses\xa2\x02\x03GVA\xaa\x02\x0fGcommon.V1.Auth\xca\x02\x0fGcommon\\V1\\Auth\xe2\x02\x1bGcommon\\V1\\Auth\\GPBMetadata\xea\x02\x11Gcommon::V1::Auth\x92\x03\x05\xd2>\x02\x10\x02b\beditionsp\xe8\a"
...
func file_pkg_auth_proto_responses_health_check_response_proto_init() {
	if File_pkg_auth_proto_responses_health_check_response_proto != nil {
		return
	}
	type x struct{}
	...
	file_pkg_auth_proto_responses_health_check_response_proto_depIdxs = nil
}
