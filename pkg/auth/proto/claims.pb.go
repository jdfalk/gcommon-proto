...
// 	protoc        (unknown)
// source: pkg/auth/proto/claims.proto
...
func (x *Claims) Reset() {
	*x = Claims{}
	mi := &file_pkg_auth_proto_claims_proto_msgTypes[0]
...
var File_pkg_auth_proto_claims_proto protoreflect.FileDescriptor

const file_pkg_auth_proto_claims_proto_rawDesc = "" +
	"\n" +
	"\x1bpkg/auth/proto/claims.proto\x12\x0fgcommon.v1.auth\x1a!google/protobuf/go_features.proto\"\x95\x05\n" +
	"\x06Claims\x12\x16\n" +
	...
	"\x10is_refresh_token\x18\x12 \x01(\bR\x0eisRefreshToken\x12A\n" +
	"\bmetadata\x18\x13 \x03(\v2%.gcommon.v1.auth.Claims.MetadataEntryR\bmetadata\x1a;\n" +
	"\rMetadataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\xb2\x01\n" +
	"\x13com.gcommon.v1.authB\vClaimsProtoP\x01Z(github.com/jdfalk/gcommon/pkg/auth/proto\xa2\x02\x03GVA\xaa\x02\x0fGcommon.V1.Auth\xca\x02\x0fGcommon\\V1\\Auth\xe2\x02\x1bGcommon\\V1\\Auth\\GPBMetadata\xea\x02\x11Gcommon::V1::Auth\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_pkg_auth_proto_claims_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_pkg_auth_proto_claims_proto_goTypes = []any{
	(*Claims)(nil), // 0: gcommon.v1.auth.Claims
	nil,            // 1: gcommon.v1.auth.Claims.MetadataEntry
}
var file_pkg_auth_proto_claims_proto_depIdxs = []int32{
	1, // 0: gcommon.v1.auth.Claims.metadata:type_name -> gcommon.v1.auth.Claims.MetadataEntry
...
func init() { file_pkg_auth_proto_claims_proto_init() }
func file_pkg_auth_proto_claims_proto_init() {
	if File_pkg_auth_proto_claims_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_auth_proto_claims_proto_rawDesc), len(file_pkg_auth_proto_claims_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_auth_proto_claims_proto_goTypes,
		DependencyIndexes: file_pkg_auth_proto_claims_proto_depIdxs,
		MessageInfos:      file_pkg_auth_proto_claims_proto_msgTypes,
	}.Build()
	File_pkg_auth_proto_claims_proto = out.File
	file_pkg_auth_proto_claims_proto_goTypes = nil
	file_pkg_auth_proto_claims_proto_depIdxs = nil
}
