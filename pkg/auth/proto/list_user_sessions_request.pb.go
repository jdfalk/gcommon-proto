...
func (*ListUserSessionsRequest) Descriptor() ([]byte, []int) {
	return file_pkg_auth_proto_list_user_sessions_request_proto_rawDescGZIP(), []int{0}
}
...
const file_pkg_auth_proto_list_user_sessions_request_proto_rawDesc = "" +
	"\n" +
	"/pkg/auth/proto/list_user_sessions_request.proto\x12\x0fgcommon.v1.auth\x1a\x1fgoogle/protobuf/timestamp.proto\x1a)pkg/common/proto/pagination_options.proto\x1a'pkg/common/proto/request_metadata.proto\"\xd7\x03\n" +
	...
	"\n" +
	"sort_order\x18\x12 \x01(\tR\tsortOrderB\xbb\x01\n" +
	"\x13com.gcommon.v1.authB\x1cListUserSessionsRequestProtoP\x01Z(github.com/jdfalk/gcommon/pkg/auth/proto\xa2\x02\x03GVA\xaa\x02\x0fGcommon.V1.Auth\xca\x02\x0fGcommon\\V1\\Auth\xe2\x02\x1bGcommon\\V1\\Auth\\GPBMetadata\xea\x02\x11Gcommon::V1::Authb\beditionsp\xe8\a"

var (
	file_pkg_auth_proto_list_user_sessions_request_proto_rawDescOnce sync.Once
	file_pkg_auth_proto_list_user_sessions_request_proto_rawDescData []byte
)

func file_pkg_auth_proto_list_user_sessions_request_proto_rawDescGZIP() []byte {
	file_pkg_auth_proto_list_user_sessions_request_proto_rawDescOnce.Do(func() {
		file_pkg_auth_proto_list_user_sessions_request_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_auth_proto_list_user_sessions_request_proto_rawDesc), len(file_pkg_auth_proto_list_user_sessions_request_proto_rawDesc)))
	})
	return file_pkg_auth_proto_list_user_sessions_request_proto_rawDescData
}
