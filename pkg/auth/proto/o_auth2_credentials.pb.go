...
// 	protoc        (unknown)
// source: pkg/auth/proto/o_auth2_credentials.proto
...
func (x *OAuth2Credentials) Reset() {
	*x = OAuth2Credentials{}
	mi := &file_pkg_auth_proto_o_auth2_credentials_proto_msgTypes[0]
...
var File_pkg_auth_proto_o_auth2_credentials_proto protoreflect.FileDescriptor

const file_pkg_auth_proto_o_auth2_credentials_proto_rawDesc = "" +
	"\n" +
	"(pkg/auth/proto/o_auth2_credentials.proto\x12\x0fgcommon.v1.auth\x1a!google/protobuf/go_features.proto\"\x8c\x01\n" +
	"\x11OAuth2Credentials\x12\x12\n" +
	"\x04code\x18\x01 \x01(\tR\x04code\x12!\n" +
	"\fredirect_uri\x18\x02 \x01(\tR\vredirectUri\x12\x1b\n" +
	"\tclient_id\x18\x03 \x01(\tR\bclientId\x12#\n" +
	"\rclient_secret\x18\x04 \x01(\tR\fclientSecretB\xbd\x01\n" +
	"\x13com.gcommon.v1.authB\x16OAuth2CredentialsProtoP\x01Z(github.com/jdfalk/gcommon/pkg/auth/proto\xa2\x02\x03GVA\xaa\x02\x0fGcommon.V1.Auth\xca\x02\x0fGcommon\\V1\\Auth\xe2\x02\x1bGcommon\\V1\\Auth\\GPBMetadata\xea\x02\x11Gcommon::V1::Auth\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_pkg_auth_proto_o_auth2_credentials_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_pkg_auth_proto_o_auth2_credentials_proto_goTypes = []any{
	(*OAuth2Credentials)(nil), // 0: gcommon.v1.auth.OAuth2Credentials
}
var file_pkg_auth_proto_o_auth2_credentials_proto_depIdxs = []int32{
...
func init() { file_pkg_auth_proto_o_auth2_credentials_proto_init() }
func file_pkg_auth_proto_o_auth2_credentials_proto_init() {
	if File_pkg_auth_proto_o_auth2_credentials_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_auth_proto_o_auth2_credentials_proto_rawDesc), len(file_pkg_auth_proto_o_auth2_credentials_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_auth_proto_o_auth2_credentials_proto_goTypes,
		DependencyIndexes: file_pkg_auth_proto_o_auth2_credentials_proto_depIdxs,
		MessageInfos:      file_pkg_auth_proto_o_auth2_credentials_proto_msgTypes,
	}.Build()
	File_pkg_auth_proto_o_auth2_credentials_proto = out.File
	file_pkg_auth_proto_o_auth2_credentials_proto_goTypes = nil
	file_pkg_auth_proto_o_auth2_credentials_proto_depIdxs = nil
}
