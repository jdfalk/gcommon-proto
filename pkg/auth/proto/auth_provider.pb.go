...
// 	protoc        (unknown)
// source: pkg/auth/proto/auth_provider.proto
...
type AuthProvider struct {
	...
	xxx_hidden_Type        AuthProviderType       `protobuf:"varint,3,opt,name=type,enum=gcommon.v1.auth.AuthProviderType"`
...
func (x *AuthProvider) Reset() {
	*x = AuthProvider{}
	mi := &file_pkg_auth_proto_auth_provider_proto_msgTypes[0]
...
const file_pkg_auth_proto_auth_provider_proto_rawDesc = "" +
	"\n" +
	"\"pkg/auth/proto/auth_provider.proto\x12\x0fgcommon.v1.auth\x1a!google/protobuf/go_features.proto\x1a\"pkg/auth/proto/provider_type.proto\"\x81\x01\n" +
	"\fAuthProvider\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x125\n" +
	"\x04type\x18\x03 \x01(\x0e2!.gcommon.v1.auth.AuthProviderTypeR\x04type\x12\x16\n" +
...
var file_pkg_auth_proto_auth_provider_proto_goTypes = []any{
	...
	(AuthProviderType)(0), // 1: gcommon.v1.auth.AuthProviderType
}
var file_pkg_auth_proto_auth_provider_proto_depIdxs = []int32{
	1, // 0: gcommon.v1.auth.AuthProvider.type:type_name -> gcommon.v1.auth.AuthProviderType
...
func init() { file_pkg_auth_proto_auth_provider_proto_init() }
func file_pkg_auth_proto_auth_provider_proto_init() {
	if File_pkg_auth_proto_auth_provider_proto != nil {
		return
	}
	file_pkg_auth_proto_provider_type_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_auth_proto_auth_provider_proto_rawDesc), len(file_pkg_auth_proto_auth_provider_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_auth_proto_auth_provider_proto_goTypes,
		DependencyIndexes: file_pkg_auth_proto_auth_provider_proto_depIdxs,
		MessageInfos:      file_pkg_auth_proto_auth_provider_proto_msgTypes,
	}.Build()
	File_pkg_auth_proto_auth_provider_proto = out.File
	file_pkg_auth_proto_auth_provider_proto_goTypes = nil
	file_pkg_auth_proto_auth_provider_proto_depIdxs = nil
}
