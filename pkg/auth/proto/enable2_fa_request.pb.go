...
// 	protoc        (unknown)
// source: pkg/auth/proto/enable2_fa_request.proto
...
func (x *Enable2FaRequest) Reset() {
	*x = Enable2FaRequest{}
	mi := &file_pkg_auth_proto_enable2_fa_request_proto_msgTypes[0]
...
var File_pkg_auth_proto_enable2_fa_request_proto protoreflect.FileDescriptor

const file_pkg_auth_proto_enable2_fa_request_proto_rawDesc = "" +
	"\n" +
	"'pkg/auth/proto/enable2_fa_request.proto\x12\x0fgcommon.v1.auth\x1a!google/protobuf/go_features.proto\"\xaf\x01\n" +
...
var file_pkg_auth_proto_enable2_fa_request_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_pkg_auth_proto_enable2_fa_request_proto_goTypes = []any{
	(*Enable2FaRequest)(nil), // 0: gcommon.v1.auth.Enable2FaRequest
}
var file_pkg_auth_proto_enable2_fa_request_proto_depIdxs = []int32{
...
func init() { file_pkg_auth_proto_enable2_fa_request_proto_init() }
func file_pkg_auth_proto_enable2_fa_request_proto_init() {
	if File_pkg_auth_proto_enable2_fa_request_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_auth_proto_enable2_fa_request_proto_rawDesc), len(file_pkg_auth_proto_enable2_fa_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_auth_proto_enable2_fa_request_proto_goTypes,
		DependencyIndexes: file_pkg_auth_proto_enable2_fa_request_proto_depIdxs,
		MessageInfos:      file_pkg_auth_proto_enable2_fa_request_proto_msgTypes,
	}.Build()
	File_pkg_auth_proto_enable2_fa_request_proto = out.File
	file_pkg_auth_proto_enable2_fa_request_proto_goTypes = nil
	file_pkg_auth_proto_enable2_fa_request_proto_depIdxs = nil
}
