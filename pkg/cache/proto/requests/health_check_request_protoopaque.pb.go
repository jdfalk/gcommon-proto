...
// 	protoc        (unknown)
// source: pkg/cache/proto/requests/health_check_request.proto
...
func (x *HealthCheckRequest) Reset() {
	*x = HealthCheckRequest{}
	mi := &file_pkg_cache_proto_requests_health_check_request_proto_msgTypes[0]
...
var File_pkg_cache_proto_requests_health_check_request_proto protoreflect.FileDescriptor

const file_pkg_cache_proto_requests_health_check_request_proto_rawDesc = "" +
	"\n" +
	...
	"\x14com.gcommon.v1.cacheB\x17HealthCheckRequestProtoP\x01Z#../../../../pkg/cache/proto;cachepb\xa2\x02\x03GVC\xaa\x02\x10Gcommon.V1.Cache\xca\x02\x10Gcommon\\V1\\Cache\xe2\x02\x1cGcommon\\V1\\Cache\\GPBMetadata\xea\x02\x12Gcommon::V1::Cache\x92\x03\x05\xd2>\x02\x10\x02b\beditionsp\xe8\a"
...
func init() { file_pkg_cache_proto_requests_health_check_request_proto_init() }
func file_pkg_cache_proto_requests_health_check_request_proto_init() {
	if File_pkg_cache_proto_requests_health_check_request_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_cache_proto_requests_health_check_request_proto_rawDesc), len(file_pkg_cache_proto_requests_health_check_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_cache_proto_requests_health_check_request_proto_goTypes,
		DependencyIndexes: file_pkg_cache_proto_requests_health_check_request_proto_depIdxs,
		MessageInfos:      file_pkg_cache_proto_requests_health_check_request_proto_msgTypes,
	}.Build()
	File_pkg_cache_proto_requests_health_check_request_proto = out.File
	file_pkg_cache_proto_requests_health_check_request_proto_goTypes = nil
	file_pkg_cache_proto_requests_health_check_request_proto_depIdxs = nil
}
