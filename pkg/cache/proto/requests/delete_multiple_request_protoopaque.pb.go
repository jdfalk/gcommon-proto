...
func (x *DeleteMultipleRequest) GetMetadata() *pb.RequestMetadata {
	if x != nil {
...
func (x *DeleteMultipleRequest) SetMetadata(v *pb.RequestMetadata) {
...
const file_pkg_cache_proto_requests_delete_multiple_request_proto_rawDesc = "" +
	...
	"\bmetadata\x18\x03 \x01(\v2\".gcommon.v1.common.RequestMetadataB\x02(\x01R\bmetadataB\xbe\x01\n" +
	"\x14com.gcommon.v1.cacheB\x1aDeleteMultipleRequestProtoP\x01Z ../../../../pkg/cache/pb;cachepb\xa2\x02\x03GVC\xaa\x02\x10Gcommon.V1.Cache\xca\x02\x10Gcommon\\V1\\Cache\xe2\x02\x1cGcommon\\V1\\Cache\\GPBMetadata\xea\x02\x12Gcommon::V1::Cache\x92\x03\x05\xd2>\x02\x10\x02b\beditionsp\xe8\a"
