...
// 	protoc        (unknown)
// source: pkg/cache/proto/requests/clear_request.proto
...
func (x *ClearRequest) Reset() {
	*x = ClearRequest{}
	mi := &file_pkg_cache_proto_requests_clear_request_proto_msgTypes[0]
...
var File_pkg_cache_proto_requests_clear_request_proto protoreflect.FileDescriptor

const file_pkg_cache_proto_requests_clear_request_proto_rawDesc = "" +
	"\n" +
...
func init() { file_pkg_cache_proto_requests_clear_request_proto_init() }
func file_pkg_cache_proto_requests_clear_request_proto_init() {
	if File_pkg_cache_proto_requests_clear_request_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_cache_proto_requests_clear_request_proto_rawDesc), len(file_pkg_cache_proto_requests_clear_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_cache_proto_requests_clear_request_proto_goTypes,
		DependencyIndexes: file_pkg_cache_proto_requests_clear_request_proto_depIdxs,
		MessageInfos:      file_pkg_cache_proto_requests_clear_request_proto_msgTypes,
	}.Build()
	File_pkg_cache_proto_requests_clear_request_proto = out.File
	file_pkg_cache_proto_requests_clear_request_proto_goTypes = nil
	file_pkg_cache_proto_requests_clear_request_proto_depIdxs = nil
}
