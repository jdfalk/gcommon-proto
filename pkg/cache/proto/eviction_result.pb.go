...
// Deprecated: Use EvictionResult.ProtoReflect.Descriptor instead.
func (*EvictionResult) Descriptor() ([]byte, []int) {
	return file_pkg_cache_proto_eviction_result_proto_rawDescGZIP(), []int{0}
}
...
const file_pkg_cache_proto_eviction_result_proto_rawDesc = "" +
	"\n" +
	"%pkg/cache/proto/eviction_result.proto\x12\x10gcommon.v1.cache\x1a&pkg/common/proto/eviction_policy.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xbd\x02\n" +
	...
	"\asuccess\x18\a \x01(\bR\asuccessB\xb8\x01\n" +
	"\x14com.gcommon.v1.cacheB\x13EvictionResultProtoP\x01Z)github.com/jdfalk/gcommon/pkg/cache/proto\xa2\x02\x03GVC\xaa\x02\x10Gcommon.V1.Cache\xca\x02\x10Gcommon\\V1\\Cache\xe2\x02\x1cGcommon\\V1\\Cache\\GPBMetadata\xea\x02\x12Gcommon::V1::Cacheb\beditionsp\xe8\a"

var (
	file_pkg_cache_proto_eviction_result_proto_rawDescOnce sync.Once
	file_pkg_cache_proto_eviction_result_proto_rawDescData []byte
)

func file_pkg_cache_proto_eviction_result_proto_rawDescGZIP() []byte {
	file_pkg_cache_proto_eviction_result_proto_rawDescOnce.Do(func() {
		file_pkg_cache_proto_eviction_result_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_cache_proto_eviction_result_proto_rawDesc), len(file_pkg_cache_proto_eviction_result_proto_rawDesc)))
	})
	return file_pkg_cache_proto_eviction_result_proto_rawDescData
}
