...
type GetResponse struct {
	...
	xxx_hidden_Entry    *messages.CacheEntry   `protobuf:"bytes,1,opt,name=entry"`
...
func (x *GetResponse) ClearEntry() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 0)
	protoimpl.X.AtomicSetPointer(&x.xxx_hidden_Entry, (*messages.CacheEntry)(nil))
}
