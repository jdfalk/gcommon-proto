...
func (*CacheStats) Descriptor() ([]byte, []int) {
	return file_pkg_cache_proto_cache_stats_proto_rawDescGZIP(), []int{0}
}
...
const file_pkg_cache_proto_cache_stats_proto_rawDesc = "" +
	"\n" +
	"!pkg/cache/proto/cache_stats.proto\x12\x10gcommon.v1.cache\x1a\x1fgoogle/protobuf/timestamp.proto\"\xab\x03\n" +
	"\n" +
	"CacheStats\x12\x1f\n" +
	...
	"\x0euptime_seconds\x18\v \x01(\x03R\ruptimeSecondsB\xb4\x01\n" +
	"\x14com.gcommon.v1.cacheB\x0fCacheStatsProtoP\x01Z)github.com/jdfalk/gcommon/pkg/cache/proto\xa2\x02\x03GVC\xaa\x02\x10Gcommon.V1.Cache\xca\x02\x10Gcommon\\V1\\Cache\xe2\x02\x1cGcommon\\V1\\Cache\\GPBMetadata\xea\x02\x12Gcommon::V1::Cacheb\beditionsp\xe8\a"

var (
	file_pkg_cache_proto_cache_stats_proto_rawDescOnce sync.Once
	file_pkg_cache_proto_cache_stats_proto_rawDescData []byte
)

func file_pkg_cache_proto_cache_stats_proto_rawDescGZIP() []byte {
	file_pkg_cache_proto_cache_stats_proto_rawDescOnce.Do(func() {
		file_pkg_cache_proto_cache_stats_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_cache_proto_cache_stats_proto_rawDesc), len(file_pkg_cache_proto_cache_stats_proto_rawDesc)))
	})
	return file_pkg_cache_proto_cache_stats_proto_rawDescData
}
