...
- **🔄 Health Module**: 12.5% complete (2/16 files) - 14 files need implementation
...
```json
[
  { "action": "create", "title": "New Feature", "body": "Description", "labels": ["enhancement"] },
  { "action": "update", "number": 42, "state": "closed", "labels": ["completed"] },
