...
// 	protoc        (unknown)
// source: pkg/web/proto/responses/health_check_response.proto
...
func (x *HealthCheckResponse) Reset() {
	*x = HealthCheckResponse{}
	mi := &file_pkg_web_proto_responses_health_check_response_proto_msgTypes[0]
...
var File_pkg_web_proto_responses_health_check_response_proto protoreflect.FileDescriptor

const file_pkg_web_proto_responses_health_check_response_proto_rawDesc = "" +
	"\n" +
	"3pkg/web/proto/responses/health_check_response.proto\x12\x0egcommon.v1.web\x1a!google/protobuf/go_features.proto\x1a\x1egoogle/protobuf/duration.proto\x1a*pkg/common/proto/enums/health_status.proto\x1a%pkg/common/proto/messages/error.proto\"\xc6\x01\n" +
	...
	"\x12com.gcommon.v1.webB\x18HealthCheckResponseProtoP\x01Z-github.com/jdfalk/gcommon/pkg/web/proto;webpb\xa2\x02\x03GVW\xaa\x02\x0eGcommon.V1.Web\xca\x02\x0eGcommon\\V1\\Web\xe2\x02\x1aGcommon\\V1\\Web\\GPBMetadata\xea\x02\x10Gcommon::V1::Web\x92\x03\x05\xd2>\x02\x10\x02b\beditionsp\xe8\a"
...
func init() { file_pkg_web_proto_responses_health_check_response_proto_init() }
func file_pkg_web_proto_responses_health_check_response_proto_init() {
	if File_pkg_web_proto_responses_health_check_response_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_web_proto_responses_health_check_response_proto_rawDesc), len(file_pkg_web_proto_responses_health_check_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_web_proto_responses_health_check_response_proto_goTypes,
		DependencyIndexes: file_pkg_web_proto_responses_health_check_response_proto_depIdxs,
		MessageInfos:      file_pkg_web_proto_responses_health_check_response_proto_msgTypes,
	}.Build()
	File_pkg_web_proto_responses_health_check_response_proto = out.File
	file_pkg_web_proto_responses_health_check_response_proto_goTypes = nil
	file_pkg_web_proto_responses_health_check_response_proto_depIdxs = nil
}
