...
func (x *CookieData) GetPlaceholder() string {
	if x != nil {
...
func (x *CookieData) SetPlaceholder(v string) {
	x.xxx_hidden_Placeholder = &v
	protoimpl.X.SetPresent(&(x.XXX_presence[0]), 0, 1)
}

func (x *CookieData) HasPlaceholder() bool {
	if x == nil {
		return false
	}
...
func (x *CookieData) ClearPlaceholder() {
...
const file_pkg_web_proto_messages_cookie_data_proto_rawDesc = "" +
	"\n" +
	"(pkg/web/proto/messages/cookie_data.proto\x12\x0egcommon.v1.web\x1a!google/protobuf/go_features.proto\".\n" +
	"\n" +
	"CookieData\x12 \n" +
	"\vplaceholder\x18\x01 \x01(\tR\vplaceholderB\xb6\x01\n" +
	"\x12com.gcommon.v1.webB\x0fCookieDataProtoP\x01Z-github.com/jdfalk/gcommon/pkg/web/proto;webpb\xa2\x02\x03GVW\xaa\x02\x0eGcommon.V1.Web\xca\x02\x0eGcommon\\V1\\Web\xe2\x02\x1aGcommon\\V1\\Web\\GPBMetadata\xea\x02\x10Gcommon::V1::Web\x92\x03\x05\xd2>\x02\x10\x02b\beditionsp\xe8\a"
