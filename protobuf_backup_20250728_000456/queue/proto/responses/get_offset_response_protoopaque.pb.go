...
// 	protoc        (unknown)
// source: pkg/queue/proto/responses/get_offset_response.proto
...
func (x *GetOffsetResponse) Reset() {
	*x = GetOffsetResponse{}
	mi := &file_pkg_queue_proto_responses_get_offset_response_proto_msgTypes[0]
...
var File_pkg_queue_proto_responses_get_offset_response_proto protoreflect.FileDescriptor

const file_pkg_queue_proto_responses_get_offset_response_proto_rawDesc = "" +
	"\n" +
	"3pkg/queue/proto/responses/get_offset_response.proto\x12\x10gcommon.v1.queue\x1a!google/protobuf/go_features.proto\x1a\x1dpkg/common/proto/common.proto\"\x8a\x01\n" +
...
func init() { file_pkg_queue_proto_responses_get_offset_response_proto_init() }
func file_pkg_queue_proto_responses_get_offset_response_proto_init() {
	if File_pkg_queue_proto_responses_get_offset_response_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_queue_proto_responses_get_offset_response_proto_rawDesc), len(file_pkg_queue_proto_responses_get_offset_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_queue_proto_responses_get_offset_response_proto_goTypes,
		DependencyIndexes: file_pkg_queue_proto_responses_get_offset_response_proto_depIdxs,
		MessageInfos:      file_pkg_queue_proto_responses_get_offset_response_proto_msgTypes,
	}.Build()
	File_pkg_queue_proto_responses_get_offset_response_proto = out.File
	file_pkg_queue_proto_responses_get_offset_response_proto_goTypes = nil
	file_pkg_queue_proto_responses_get_offset_response_proto_depIdxs = nil
}
