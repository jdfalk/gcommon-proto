...
The metrics module provides a flexible and extensible way to collect and expose metrics from your application. It supports multiple backend providers, including Prometheus and OpenTelemetry, and offers a consistent API regardless of the
backend used.
